...
//
//	==> Generation Date : Thu Oct 16 13:29:38 2014
//
...
//	==> Flops complexity : 22293
//
//	==> Generation Time :  0.250 seconds
//	==> Post-Processing :  0.300 seconds
//
//-------------------------------------------------------------
//
...
// Forward Kinematics 
  ...
  BeF314 = BS314+OpF214;
  BeF614 = BS614-OpF113;
  AlF114 = AlF113+BeF213*s->dpt[2][22];
  AlF214 = C14*(AlF213+BS513*s->dpt[2][22])+S14*(AlF313+BeF813*s->dpt[2][22]);
  AlF314 = C14*(AlF313+BeF813*s->dpt[2][22])-S14*(AlF213+BS513*s->dpt[2][22]);
  ...
  AlM114_4 = AlM113_4-OpM313_4*s->dpt[2][22];
  AlM214_4 = S14*(AlM313_4+OpM113_4*s->dpt[2][22]);
  AlM314_4 = C14*(AlM313_4+OpM113_4*s->dpt[2][22]);
  OpM214_5 = OpM313_5*S14+C14*C6;
  OpM314_5 = OpM313_5*C14-S14*C6;
  AlM114_5 = AlM113_5-OpM313_5*s->dpt[2][22];
  AlM214_5 = S14*(AlM313_5+OpM113_5*s->dpt[2][22]);
  AlM314_5 = C14*(AlM313_5+OpM113_5*s->dpt[2][22]);
  OpM214_6 = C13*S14;
  OpM314_6 = C13*C14;
  AlM114_6 = AlM113_6-s->dpt[2][22]*C13;
  AlM214_6 = S14*(AlM313_6-s->dpt[2][22]*S13);
  AlM314_6 = C14*(AlM313_6-s->dpt[2][22]*S13);
  ...
  BeF315 = BS315+OpF215;
  BeF615 = BS615-OpF115;
  AlF115 = C15*(AlF114+BeF314*s->dpt[3][24])+S15*(AlF214+BeF614*s->dpt[3][24]);
  AlF215 = C15*(AlF214+BeF614*s->dpt[3][24])-S15*(AlF114+BeF314*s->dpt[3][24]);
  AlF315 = AlF314+BS914*s->dpt[3][24];
  ...
  AlM115_4 = C15*(AlM114_4+OpM214_4*s->dpt[3][24])+S15*(AlM214_4-OpM113_4*s->dpt[3][24]);
  AlM215_4 = C15*(AlM214_4-OpM113_4*s->dpt[3][24])-S15*(AlM114_4+OpM214_4*s->dpt[3][24]);
  OpM115_5 = OpM113_5*C15+OpM214_5*S15;
  OpM215_5 = -(OpM113_5*S15-OpM214_5*C15);
  AlM115_5 = C15*(AlM114_5+OpM214_5*s->dpt[3][24])+S15*(AlM214_5-OpM113_5*s->dpt[3][24]);
  AlM215_5 = C15*(AlM214_5-OpM113_5*s->dpt[3][24])-S15*(AlM114_5+OpM214_5*s->dpt[3][24]);
  OpM115_6 = OpM214_6*S15-S13*C15;
  OpM215_6 = OpM214_6*C15+S13*S15;
  AlM115_6 = C15*(AlM114_6+OpM214_6*s->dpt[3][24])+S15*(AlM214_6+s->dpt[3][24]*S13);
  AlM215_6 = C15*(AlM214_6+s->dpt[3][24]*S13)-S15*(AlM114_6+OpM214_6*s->dpt[3][24]);
  OpM115_13 = C14*S15;
  OpM215_13 = C14*C15;
  AlM115_13 = s->dpt[3][24]*C14*C15;
  AlM215_13 = -s->dpt[3][24]*C14*S15;
  ...
  BeF316 = BS316+OpF215;
  BeF616 = BS616-OpF116;
  AlF116 = C16*(AlF115+BeF315*s->dpt[3][26])-S16*(AlF315+BS915*s->dpt[3][26]);
  AlF216 = AlF215+BeF615*s->dpt[3][26];
  AlF316 = C16*(AlF315+BS915*s->dpt[3][26])+S16*(AlF115+BeF315*s->dpt[3][26]);
  ...
  AlM116_4 = -(AlM314_4*S16-C16*(AlM115_4+OpM215_4*s->dpt[3][26]));
  AlM216_4 = AlM215_4-OpM115_4*s->dpt[3][26];
  AlM316_4 = AlM314_4*C16+S16*(AlM115_4+OpM215_4*s->dpt[3][26]);
  OpM116_5 = OpM115_5*C16-OpM314_5*S16;
  OpM316_5 = OpM115_5*S16+OpM314_5*C16;
  AlM116_5 = -(AlM314_5*S16-C16*(AlM115_5+OpM215_5*s->dpt[3][26]));
  AlM216_5 = AlM215_5-OpM115_5*s->dpt[3][26];
  AlM316_5 = AlM314_5*C16+S16*(AlM115_5+OpM215_5*s->dpt[3][26]);
  OpM116_6 = OpM115_6*C16-OpM314_6*S16;
  OpM316_6 = OpM115_6*S16+OpM314_6*C16;
  AlM116_6 = -(AlM314_6*S16-C16*(AlM115_6+OpM215_6*s->dpt[3][26]));
  AlM216_6 = AlM215_6-OpM115_6*s->dpt[3][26];
  AlM316_6 = AlM314_6*C16+S16*(AlM115_6+OpM215_6*s->dpt[3][26]);
  OpM116_13 = OpM115_13*C16+S14*S16;
  OpM316_13 = OpM115_13*S16-S14*C16;
  AlM116_13 = C16*(AlM115_13+OpM215_13*s->dpt[3][26]);
  AlM216_13 = AlM215_13-OpM115_13*s->dpt[3][26];
  AlM316_13 = S16*(AlM115_13+OpM215_13*s->dpt[3][26]);
  OpM116_14 = C15*C16;
  OpM316_14 = C15*S16;
  AlM116_14 = C16*(AlM115_14-s->dpt[3][26]*S15);
  AlM216_14 = AlM215_14-s->dpt[3][26]*C15;
  AlM316_14 = S16*(AlM115_14-s->dpt[3][26]*S15);
  OM117 = qd[17]+OM116;
...
// Forward Kinematics 
  ...
  BeF721 = BS321-OpF221;
  BeF821 = BS621+OpF121;
  AlF121 = C21*(AlF120+BeF320*s->dpt[3][40])+S21*(AlF219+BeF620*s->dpt[3][40]);
  AlF221 = C21*(AlF219+BeF620*s->dpt[3][40])-S21*(AlF120+BeF320*s->dpt[3][40]);
  AlF321 = AlF320+BS920*s->dpt[3][40];
  ...
  AlM121_4 = C21*(AlM120_4+OpM219_4*s->dpt[3][40])+S21*(AlM219_4-OpM120_4*s->dpt[3][40]);
  AlM221_4 = C21*(AlM219_4-OpM120_4*s->dpt[3][40])-S21*(AlM120_4+OpM219_4*s->dpt[3][40]);
  OpM121_5 = OpM120_5*C21+OpM219_5*S21;
  OpM221_5 = -(OpM120_5*S21-OpM219_5*C21);
  AlM121_5 = C21*(AlM120_5+OpM219_5*s->dpt[3][40])+S21*(AlM219_5-OpM120_5*s->dpt[3][40]);
  AlM221_5 = C21*(AlM219_5-OpM120_5*s->dpt[3][40])-S21*(AlM120_5+OpM219_5*s->dpt[3][40]);
  OpM121_6 = OpM120_6*C21+S19*S21;
  OpM221_6 = -(OpM120_6*S21-S19*C21);
  AlM121_6 = C21*(AlM120_6+s->dpt[3][40]*S19)+S21*(AlM219_6-OpM120_6*s->dpt[3][40]);
  AlM221_6 = C21*(AlM219_6-OpM120_6*s->dpt[3][40])-S21*(AlM120_6+s->dpt[3][40]*S19);
  OpM121_19 = C20*C21;
  OpM221_19 = -C20*S21;
  AlM121_19 = -s->dpt[3][40]*C20*S21;
  AlM221_19 = -s->dpt[3][40]*C20*C21;
...
// Forward Kinematics 
 ...
 BeF221*s->dpt[2][44]+BeF321*s->dpt[3][44]);
  ...
  AlM122_4 = C22*(AlM121_4+OpM221_4*s->dpt[3][44]-OpM320_4*s->dpt[2][44])-S22*(AlM320_4+OpM121_4*s->dpt[2][44]-OpM221_4*
 s->dpt[1][44]);
  AlM222_4 = AlM221_4-OpM121_4*s->dpt[3][44]+OpM320_4*s->dpt[1][44];
  AlM322_4 = C22*(AlM320_4+OpM121_4*s->dpt[2][44]-OpM221_4*s->dpt[1][44])+S22*(AlM121_4+OpM221_4*s->dpt[3][44]-OpM320_4*
 s->dpt[2][44]);
  OpM122_5 = OpM121_5*C22-OpM320_5*S22;
  OpM322_5 = OpM121_5*S22+OpM320_5*C22;
  AlM122_5 = C22*(AlM121_5+OpM221_5*s->dpt[3][44]-OpM320_5*s->dpt[2][44])-S22*(AlM320_5+OpM121_5*s->dpt[2][44]-OpM221_5*
 s->dpt[1][44]);
  AlM222_5 = AlM221_5-OpM121_5*s->dpt[3][44]+OpM320_5*s->dpt[1][44];
  AlM322_5 = C22*(AlM320_5+OpM121_5*s->dpt[2][44]-OpM221_5*s->dpt[1][44])+S22*(AlM121_5+OpM221_5*s->dpt[3][44]-OpM320_5*
 s->dpt[2][44]);
  OpM122_6 = OpM121_6*C22-OpM320_6*S22;
  OpM322_6 = OpM121_6*S22+OpM320_6*C22;
  AlM122_6 = C22*(AlM121_6+OpM221_6*s->dpt[3][44]-OpM320_6*s->dpt[2][44])-S22*(AlM320_6+OpM121_6*s->dpt[2][44]-OpM221_6*
 s->dpt[1][44]);
  AlM222_6 = AlM221_6-OpM121_6*s->dpt[3][44]+OpM320_6*s->dpt[1][44];
  AlM322_6 = C22*(AlM320_6+OpM121_6*s->dpt[2][44]-OpM221_6*s->dpt[1][44])+S22*(AlM121_6+OpM221_6*s->dpt[3][44]-OpM320_6*
 s->dpt[2][44]);
  OpM122_19 = OpM121_19*C22-S20*S22;
  OpM322_19 = OpM121_19*S22+S20*C22;
  AlM122_19 = C22*(AlM121_19+OpM221_19*s->dpt[3][44]-s->dpt[2][44]*S20)-S22*(OpM121_19*s->dpt[2][44]-OpM221_19*
 s->dpt[1][44]);
  AlM222_19 = AlM221_19-OpM121_19*s->dpt[3][44]+s->dpt[1][44]*S20;
  AlM322_19 = C22*(OpM121_19*s->dpt[2][44]-OpM221_19*s->dpt[1][44])+S22*(AlM121_19+OpM221_19*s->dpt[3][44]-s->dpt[2][44]
 *S20);
  OpM122_20 = S21*C22;
  OpM322_20 = S21*S22;
  AlM122_20 = C21*C22*(s->dpt[3][40]+s->dpt[3][44])+S22*(s->dpt[1][44]*C21-s->dpt[2][44]*S21);
  AlM222_20 = AlM221_20-s->dpt[3][44]*S21;
  AlM322_20 = C21*S22*(s->dpt[3][40]+s->dpt[3][44])-C22*(s->dpt[1][44]*C21-s->dpt[2][44]*S21);
  ...
  AlF123 = AlF122+BeF222*s->dpt[2][48];
  AlF223 = C23*(AlF222+BS522*s->dpt[2][48])+S23*(AlF322+BeF822*s->dpt[2][48]);
  AlF323 = C23*(AlF322+BeF822*s->dpt[2][48])-S23*(AlF222+BS522*s->dpt[2][48]);
  ...
  AlM123_4 = AlM122_4-OpM322_4*s->dpt[2][48];
  AlM223_4 = AlM222_4*C23+S23*(AlM322_4+OpM122_4*s->dpt[2][48]);
  AlM323_4 = -(AlM222_4*S23-C23*(AlM322_4+OpM122_4*s->dpt[2][48]));
  OpM223_5 = OpM221_5*C23+OpM322_5*S23;
  OpM323_5 = -(OpM221_5*S23-OpM322_5*C23);
  AlM123_5 = AlM122_5-OpM322_5*s->dpt[2][48];
  AlM223_5 = AlM222_5*C23+S23*(AlM322_5+OpM122_5*s->dpt[2][48]);
  AlM323_5 = -(AlM222_5*S23-C23*(AlM322_5+OpM122_5*s->dpt[2][48]));
  OpM223_6 = OpM221_6*C23+OpM322_6*S23;
  OpM323_6 = -(OpM221_6*S23-OpM322_6*C23);
  AlM123_6 = AlM122_6-OpM322_6*s->dpt[2][48];
  AlM223_6 = AlM222_6*C23+S23*(AlM322_6+OpM122_6*s->dpt[2][48]);
  AlM323_6 = -(AlM222_6*S23-C23*(AlM322_6+OpM122_6*s->dpt[2][48]));
  OpM223_19 = OpM221_19*C23+OpM322_19*S23;
  OpM323_19 = -(OpM221_19*S23-OpM322_19*C23);
  AlM123_19 = AlM122_19-OpM322_19*s->dpt[2][48];
  AlM223_19 = AlM222_19*C23+S23*(AlM322_19+OpM122_19*s->dpt[2][48]);
  AlM323_19 = -(AlM222_19*S23-C23*(AlM322_19+OpM122_19*s->dpt[2][48]));
  OpM223_20 = OpM322_20*S23+C21*C23;
  OpM323_20 = OpM322_20*C23-C21*S23;
  AlM123_20 = AlM122_20-OpM322_20*s->dpt[2][48];
  AlM223_20 = AlM222_20*C23+S23*(AlM322_20+OpM122_20*s->dpt[2][48]);
  AlM323_20 = -(AlM222_20*S23-C23*(AlM322_20+OpM122_20*s->dpt[2][48]));
  OpM223_21 = C22*S23;
  OpM323_21 = C22*C23;
  AlM123_21 = AlM122_21-s->dpt[2][48]*C22;
  AlM223_21 = s->dpt[1][44]*C23-S22*S23*(s->dpt[2][44]+s->dpt[2][48]);
  AlM323_21 = -(s->dpt[1][44]*S23+S22*C23*(s->dpt[2][44]+s->dpt[2][48]));
  ...
  BeF224 = BS224-OpF324;
  BeF824 = BS624+OpF124;
  AlF124 = C24*(AlF123+BeF223*s->dpt[2][50])-S24*(AlF323+BeF823*s->dpt[2][50]);
  AlF224 = AlF223+BS523*s->dpt[2][50];
  AlF324 = C24*(AlF323+BeF823*s->dpt[2][50])+S24*(AlF123+BeF223*s->dpt[2][50]);
  ...
  AlM124_4 = C24*(AlM123_4-OpM323_4*s->dpt[2][50])-S24*(AlM323_4+OpM122_4*s->dpt[2][50]);
  AlM324_4 = C24*(AlM323_4+OpM122_4*s->dpt[2][50])+S24*(AlM123_4-OpM323_4*s->dpt[2][50]);
  OpM124_5 = OpM122_5*C24-OpM323_5*S24;
  OpM324_5 = OpM122_5*S24+OpM323_5*C24;
  AlM124_5 = C24*(AlM123_5-OpM323_5*s->dpt[2][50])-S24*(AlM323_5+OpM122_5*s->dpt[2][50]);
  AlM324_5 = C24*(AlM323_5+OpM122_5*s->dpt[2][50])+S24*(AlM123_5-OpM323_5*s->dpt[2][50]);
  OpM124_6 = OpM122_6*C24-OpM323_6*S24;
  OpM324_6 = OpM122_6*S24+OpM323_6*C24;
  AlM124_6 = C24*(AlM123_6-OpM323_6*s->dpt[2][50])-S24*(AlM323_6+OpM122_6*s->dpt[2][50]);
  AlM324_6 = C24*(AlM323_6+OpM122_6*s->dpt[2][50])+S24*(AlM123_6-OpM323_6*s->dpt[2][50]);
  OpM124_19 = OpM122_19*C24-OpM323_19*S24;
  OpM324_19 = OpM122_19*S24+OpM323_19*C24;
  AlM124_19 = C24*(AlM123_19-OpM323_19*s->dpt[2][50])-S24*(AlM323_19+OpM122_19*s->dpt[2][50]);
  AlM324_19 = C24*(AlM323_19+OpM122_19*s->dpt[2][50])+S24*(AlM123_19-OpM323_19*s->dpt[2][50]);
  OpM124_20 = OpM122_20*C24-OpM323_20*S24;
  OpM324_20 = OpM122_20*S24+OpM323_20*C24;
  AlM124_20 = C24*(AlM123_20-OpM323_20*s->dpt[2][50])-S24*(AlM323_20+OpM122_20*s->dpt[2][50]);
  AlM324_20 = C24*(AlM323_20+OpM122_20*s->dpt[2][50])+S24*(AlM123_20-OpM323_20*s->dpt[2][50]);
  OpM124_21 = -(OpM323_21*S24+S22*C24);
  OpM324_21 = OpM323_21*C24-S22*S24;
  AlM124_21 = C24*(AlM123_21-OpM323_21*s->dpt[2][50])-S24*(AlM323_21-s->dpt[2][50]*S22);
  AlM324_21 = C24*(AlM323_21-s->dpt[2][50]*S22)+S24*(AlM123_21-OpM323_21*s->dpt[2][50]);
  OpM124_22 = S23*S24;
  OpM324_22 = -S23*C24;
  AlM124_22 = s->dpt[2][50]*S23*C24;
  AlM324_22 = s->dpt[2][50]*S23*S24;
  ...
  BeF425 = BS225+OpF324;
  BeF725 = BS325-OpF225;
  AlF125 = C25*(AlF124+BeF224*s->dpt[2][52])+S25*(AlF224+BS524*s->dpt[2][52]);
  AlF225 = C25*(AlF224+BS524*s->dpt[2][52])-S25*(AlF124+BeF224*s->dpt[2][52]);
  AlF325 = AlF324+BeF824*s->dpt[2][52];
  ...
  AlM125_4 = AlM223_4*S25+C25*(AlM124_4-OpM324_4*s->dpt[2][52]);
  AlM225_4 = AlM223_4*C25-S25*(AlM124_4-OpM324_4*s->dpt[2][52]);
  AlM325_4 = AlM324_4+OpM124_4*s->dpt[2][52];
  OpM125_5 = OpM124_5*C25+OpM223_5*S25;
  OpM225_5 = -(OpM124_5*S25-OpM223_5*C25);
  AlM125_5 = AlM223_5*S25+C25*(AlM124_5-OpM324_5*s->dpt[2][52]);
  AlM225_5 = AlM223_5*C25-S25*(AlM124_5-OpM324_5*s->dpt[2][52]);
  AlM325_5 = AlM324_5+OpM124_5*s->dpt[2][52];
  OpM125_6 = OpM124_6*C25+OpM223_6*S25;
  OpM225_6 = -(OpM124_6*S25-OpM223_6*C25);
  AlM125_6 = AlM223_6*S25+C25*(AlM124_6-OpM324_6*s->dpt[2][52]);
  AlM225_6 = AlM223_6*C25-S25*(AlM124_6-OpM324_6*s->dpt[2][52]);
  AlM325_6 = AlM324_6+OpM124_6*s->dpt[2][52];
  OpM125_19 = OpM124_19*C25+OpM223_19*S25;
  OpM225_19 = -(OpM124_19*S25-OpM223_19*C25);
  AlM125_19 = AlM223_19*S25+C25*(AlM124_19-OpM324_19*s->dpt[2][52]);
  AlM225_19 = AlM223_19*C25-S25*(AlM124_19-OpM324_19*s->dpt[2][52]);
  AlM325_19 = AlM324_19+OpM124_19*s->dpt[2][52];
  OpM125_20 = OpM124_20*C25+OpM223_20*S25;
  OpM225_20 = -(OpM124_20*S25-OpM223_20*C25);
  AlM125_20 = AlM223_20*S25+C25*(AlM124_20-OpM324_20*s->dpt[2][52]);
  AlM225_20 = AlM223_20*C25-S25*(AlM124_20-OpM324_20*s->dpt[2][52]);
  AlM325_20 = AlM324_20+OpM124_20*s->dpt[2][52];
  OpM125_21 = OpM124_21*C25+OpM223_21*S25;
  OpM225_21 = -(OpM124_21*S25-OpM223_21*C25);
  AlM125_21 = AlM223_21*S25+C25*(AlM124_21-OpM324_21*s->dpt[2][52]);
  AlM225_21 = AlM223_21*C25-S25*(AlM124_21-OpM324_21*s->dpt[2][52]);
  AlM325_21 = AlM324_21+OpM124_21*s->dpt[2][52];
  OpM125_22 = OpM124_22*C25+C23*S25;
  OpM225_22 = -(OpM124_22*S25-C23*C25);
  AlM125_22 = C25*(AlM124_22-OpM324_22*s->dpt[2][52]);
  AlM225_22 = -S25*(AlM124_22-OpM324_22*s->dpt[2][52]);
  AlM325_22 = AlM324_22+OpM124_22*s->dpt[2][52];
  OpM125_23 = C24*C25;
  OpM225_23 = -C24*S25;
  AlM125_23 = C25*(AlM124_23-s->dpt[2][52]*S24);
  AlM225_23 = S24*S25*(s->dpt[2][50]+s->dpt[2][52]);
  ...
  AlF126 = C26*(AlF125+BS125*s->dpt[1][54])-S26*(AlF325+BeF725*s->dpt[1][54]);
  AlF226 = AlF225+BeF425*s->dpt[1][54];
  AlF326 = C26*(AlF325+BeF725*s->dpt[1][54])+S26*(AlF125+BS125*s->dpt[1][54]);
  ...
  AlM126_4 = AlM125_4*C26-S26*(AlM325_4-OpM225_4*s->dpt[1][54]);
  AlM226_4 = AlM225_4+OpM324_4*s->dpt[1][54];
  AlM326_4 = AlM125_4*S26+C26*(AlM325_4-OpM225_4*s->dpt[1][54]);
  OpM126_5 = OpM125_5*C26-OpM324_5*S26;
  OpM326_5 = OpM125_5*S26+OpM324_5*C26;
  AlM126_5 = AlM125_5*C26-S26*(AlM325_5-OpM225_5*s->dpt[1][54]);
  AlM226_5 = AlM225_5+OpM324_5*s->dpt[1][54];
  AlM326_5 = AlM125_5*S26+C26*(AlM325_5-OpM225_5*s->dpt[1][54]);
  OpM126_6 = OpM125_6*C26-OpM324_6*S26;
  OpM326_6 = OpM125_6*S26+OpM324_6*C26;
  AlM126_6 = AlM125_6*C26-S26*(AlM325_6-OpM225_6*s->dpt[1][54]);
  AlM226_6 = AlM225_6+OpM324_6*s->dpt[1][54];
  AlM326_6 = AlM125_6*S26+C26*(AlM325_6-OpM225_6*s->dpt[1][54]);
  OpM126_19 = OpM125_19*C26-OpM324_19*S26;
  OpM326_19 = OpM125_19*S26+OpM324_19*C26;
  AlM126_19 = AlM125_19*C26-S26*(AlM325_19-OpM225_19*s->dpt[1][54]);
  AlM226_19 = AlM225_19+OpM324_19*s->dpt[1][54];
  AlM326_19 = AlM125_19*S26+C26*(AlM325_19-OpM225_19*s->dpt[1][54]);
  OpM126_20 = OpM125_20*C26-OpM324_20*S26;
  OpM326_20 = OpM125_20*S26+OpM324_20*C26;
  AlM126_20 = AlM125_20*C26-S26*(AlM325_20-OpM225_20*s->dpt[1][54]);
  AlM226_20 = AlM225_20+OpM324_20*s->dpt[1][54];
  AlM326_20 = AlM125_20*S26+C26*(AlM325_20-OpM225_20*s->dpt[1][54]);
  OpM126_21 = OpM125_21*C26-OpM324_21*S26;
  OpM326_21 = OpM125_21*S26+OpM324_21*C26;
  AlM126_21 = AlM125_21*C26-S26*(AlM325_21-OpM225_21*s->dpt[1][54]);
  AlM226_21 = AlM225_21+OpM324_21*s->dpt[1][54];
  AlM326_21 = AlM125_21*S26+C26*(AlM325_21-OpM225_21*s->dpt[1][54]);
  OpM126_22 = OpM125_22*C26-OpM324_22*S26;
  OpM326_22 = OpM125_22*S26+OpM324_22*C26;
  AlM126_22 = AlM125_22*C26-S26*(AlM325_22-OpM225_22*s->dpt[1][54]);
  AlM226_22 = AlM225_22+OpM324_22*s->dpt[1][54];
  AlM326_22 = AlM125_22*S26+C26*(AlM325_22-OpM225_22*s->dpt[1][54]);
  OpM126_23 = OpM125_23*C26-S24*S26;
  OpM326_23 = OpM125_23*S26+S24*C26;
  AlM126_23 = AlM125_23*C26-S26*(AlM325_23-OpM225_23*s->dpt[1][54]);
  AlM226_23 = AlM225_23+s->dpt[1][54]*S24;
  AlM326_23 = AlM125_23*S26+C26*(AlM325_23-OpM225_23*s->dpt[1][54]);
  OpM126_24 = S25*C26;
  OpM326_24 = S25*S26;
  AlM126_24 = s->dpt[1][54]*C25*S26;
  AlM326_24 = -s->dpt[1][54]*C25*C26;
  ...
  AlF127 = C27*(AlF126+BeF226*s->dpt[2][55])+S27*(AlF226+BS526*s->dpt[2][55]);
  AlF227 = C27*(AlF226+BS526*s->dpt[2][55])-S27*(AlF126+BeF226*s->dpt[2][55]);
  AlF327 = AlF326+BeF826*s->dpt[2][55];
  ...
  AlM127_4 = AlM226_4*S27+C27*(AlM126_4-OpM326_4*s->dpt[2][55]);
  AlM227_4 = AlM226_4*C27-S27*(AlM126_4-OpM326_4*s->dpt[2][55]);
  AlM327_4 = AlM326_4+OpM126_4*s->dpt[2][55];
  OpM127_5 = OpM126_5*C27+OpM225_5*S27;
  OpM227_5 = -(OpM126_5*S27-OpM225_5*C27);
  AlM127_5 = AlM226_5*S27+C27*(AlM126_5-OpM326_5*s->dpt[2][55]);
  AlM227_5 = AlM226_5*C27-S27*(AlM126_5-OpM326_5*s->dpt[2][55]);
  AlM327_5 = AlM326_5+OpM126_5*s->dpt[2][55];
  OpM127_6 = OpM126_6*C27+OpM225_6*S27;
  OpM227_6 = -(OpM126_6*S27-OpM225_6*C27);
  AlM127_6 = AlM226_6*S27+C27*(AlM126_6-OpM326_6*s->dpt[2][55]);
  AlM227_6 = AlM226_6*C27-S27*(AlM126_6-OpM326_6*s->dpt[2][55]);
  AlM327_6 = AlM326_6+OpM126_6*s->dpt[2][55];
  OpM127_19 = OpM126_19*C27+OpM225_19*S27;
  OpM227_19 = -(OpM126_19*S27-OpM225_19*C27);
  AlM127_19 = AlM226_19*S27+C27*(AlM126_19-OpM326_19*s->dpt[2][55]);
  AlM227_19 = AlM226_19*C27-S27*(AlM126_19-OpM326_19*s->dpt[2][55]);
  AlM327_19 = AlM326_19+OpM126_19*s->dpt[2][55];
  OpM127_20 = OpM126_20*C27+OpM225_20*S27;
  OpM227_20 = -(OpM126_20*S27-OpM225_20*C27);
  AlM127_20 = AlM226_20*S27+C27*(AlM126_20-OpM326_20*s->dpt[2][55]);
  AlM227_20 = AlM226_20*C27-S27*(AlM126_20-OpM326_20*s->dpt[2][55]);
  AlM327_20 = AlM326_20+OpM126_20*s->dpt[2][55];
  OpM127_21 = OpM126_21*C27+OpM225_21*S27;
  OpM227_21 = -(OpM126_21*S27-OpM225_21*C27);
  AlM127_21 = AlM226_21*S27+C27*(AlM126_21-OpM326_21*s->dpt[2][55]);
  AlM227_21 = AlM226_21*C27-S27*(AlM126_21-OpM326_21*s->dpt[2][55]);
  AlM327_21 = AlM326_21+OpM126_21*s->dpt[2][55];
  OpM127_22 = OpM126_22*C27+OpM225_22*S27;
  OpM227_22 = -(OpM126_22*S27-OpM225_22*C27);
  AlM127_22 = AlM226_22*S27+C27*(AlM126_22-OpM326_22*s->dpt[2][55]);
  AlM227_22 = AlM226_22*C27-S27*(AlM126_22-OpM326_22*s->dpt[2][55]);
  AlM327_22 = AlM326_22+OpM126_22*s->dpt[2][55];
  OpM127_23 = OpM126_23*C27+OpM225_23*S27;
  OpM227_23 = -(OpM126_23*S27-OpM225_23*C27);
  AlM127_23 = AlM226_23*S27+C27*(AlM126_23-OpM326_23*s->dpt[2][55]);
  AlM227_23 = AlM226_23*C27-S27*(AlM126_23-OpM326_23*s->dpt[2][55]);
  AlM327_23 = AlM326_23+OpM126_23*s->dpt[2][55];
  OpM127_24 = OpM126_24*C27+C25*S27;
  OpM227_24 = -(OpM126_24*S27-C25*C27);
  AlM127_24 = C27*(AlM126_24-OpM326_24*s->dpt[2][55]);
  AlM227_24 = -S27*(AlM126_24-OpM326_24*s->dpt[2][55]);
  AlM327_24 = AlM326_24+OpM126_24*s->dpt[2][55];
  OpM127_25 = -S26*C27;
  OpM227_25 = S26*S27;
  AlM127_25 = s->dpt[1][54]*S27-s->dpt[2][55]*C26*C27;
  AlM227_25 = s->dpt[1][54]*C27+s->dpt[2][55]*C26*S27;
  AlM327_25 = -s->dpt[2][55]*S26;
  OM128 = qd[28]+OM127;
...
// Forward Kinematics 
 ...
 BeF221*s->dpt[2][45]+BeF321*s->dpt[3][45]);
  ...
  AlM129_4 = C29*(AlM121_4+OpM221_4*s->dpt[3][45]-OpM320_4*s->dpt[2][45])-S29*(AlM320_4+OpM121_4*s->dpt[2][45]-OpM221_4*
 s->dpt[1][45]);
  AlM229_4 = AlM221_4-OpM121_4*s->dpt[3][45]+OpM320_4*s->dpt[1][45];
  AlM329_4 = C29*(AlM320_4+OpM121_4*s->dpt[2][45]-OpM221_4*s->dpt[1][45])+S29*(AlM121_4+OpM221_4*s->dpt[3][45]-OpM320_4*
 s->dpt[2][45]);
  OpM129_5 = OpM121_5*C29-OpM320_5*S29;
  OpM329_5 = OpM121_5*S29+OpM320_5*C29;
  AlM129_5 = C29*(AlM121_5+OpM221_5*s->dpt[3][45]-OpM320_5*s->dpt[2][45])-S29*(AlM320_5+OpM121_5*s->dpt[2][45]-OpM221_5*
 s->dpt[1][45]);
  AlM229_5 = AlM221_5-OpM121_5*s->dpt[3][45]+OpM320_5*s->dpt[1][45];
  AlM329_5 = C29*(AlM320_5+OpM121_5*s->dpt[2][45]-OpM221_5*s->dpt[1][45])+S29*(AlM121_5+OpM221_5*s->dpt[3][45]-OpM320_5*
 s->dpt[2][45]);
  OpM129_6 = OpM121_6*C29-OpM320_6*S29;
  OpM329_6 = OpM121_6*S29+OpM320_6*C29;
  AlM129_6 = C29*(AlM121_6+OpM221_6*s->dpt[3][45]-OpM320_6*s->dpt[2][45])-S29*(AlM320_6+OpM121_6*s->dpt[2][45]-OpM221_6*
 s->dpt[1][45]);
  AlM229_6 = AlM221_6-OpM121_6*s->dpt[3][45]+OpM320_6*s->dpt[1][45];
  AlM329_6 = C29*(AlM320_6+OpM121_6*s->dpt[2][45]-OpM221_6*s->dpt[1][45])+S29*(AlM121_6+OpM221_6*s->dpt[3][45]-OpM320_6*
 s->dpt[2][45]);
  OpM129_19 = OpM121_19*C29-S20*S29;
  OpM329_19 = OpM121_19*S29+S20*C29;
  AlM129_19 = C29*(AlM121_19+OpM221_19*s->dpt[3][45]-s->dpt[2][45]*S20)-S29*(OpM121_19*s->dpt[2][45]-OpM221_19*
 s->dpt[1][45]);
  AlM229_19 = AlM221_19-OpM121_19*s->dpt[3][45]+s->dpt[1][45]*S20;
  AlM329_19 = C29*(OpM121_19*s->dpt[2][45]-OpM221_19*s->dpt[1][45])+S29*(AlM121_19+OpM221_19*s->dpt[3][45]-s->dpt[2][45]
 *S20);
  OpM129_20 = S21*C29;
  OpM329_20 = S21*S29;
  AlM129_20 = C21*C29*(s->dpt[3][40]+s->dpt[3][45])+S29*(s->dpt[1][45]*C21-s->dpt[2][45]*S21);
  AlM229_20 = AlM221_20-s->dpt[3][45]*S21;
  AlM329_20 = C21*S29*(s->dpt[3][40]+s->dpt[3][45])-C29*(s->dpt[1][45]*C21-s->dpt[2][45]*S21);
  ...
  BeF230 = BS230-OpF330;
  BeF830 = BS630+OpF129;
  AlF130 = AlF129+BeF229*s->dpt[2][59];
  AlF230 = C30*(AlF229+BS529*s->dpt[2][59])+S30*(AlF329+BeF829*s->dpt[2][59]);
  AlF330 = C30*(AlF329+BeF829*s->dpt[2][59])-S30*(AlF229+BS529*s->dpt[2][59]);
  ...
  AlM130_4 = AlM129_4-OpM329_4*s->dpt[2][59];
  AlM230_4 = AlM229_4*C30+S30*(AlM329_4+OpM129_4*s->dpt[2][59]);
  AlM330_4 = -(AlM229_4*S30-C30*(AlM329_4+OpM129_4*s->dpt[2][59]));
  OpM230_5 = OpM221_5*C30+OpM329_5*S30;
  OpM330_5 = -(OpM221_5*S30-OpM329_5*C30);
  AlM130_5 = AlM129_5-OpM329_5*s->dpt[2][59];
  AlM230_5 = AlM229_5*C30+S30*(AlM329_5+OpM129_5*s->dpt[2][59]);
  AlM330_5 = -(AlM229_5*S30-C30*(AlM329_5+OpM129_5*s->dpt[2][59]));
  OpM230_6 = OpM221_6*C30+OpM329_6*S30;
  OpM330_6 = -(OpM221_6*S30-OpM329_6*C30);
  AlM130_6 = AlM129_6-OpM329_6*s->dpt[2][59];
  AlM230_6 = AlM229_6*C30+S30*(AlM329_6+OpM129_6*s->dpt[2][59]);
  AlM330_6 = -(AlM229_6*S30-C30*(AlM329_6+OpM129_6*s->dpt[2][59]));
  OpM230_19 = OpM221_19*C30+OpM329_19*S30;
  OpM330_19 = -(OpM221_19*S30-OpM329_19*C30);
  AlM130_19 = AlM129_19-OpM329_19*s->dpt[2][59];
  AlM230_19 = AlM229_19*C30+S30*(AlM329_19+OpM129_19*s->dpt[2][59]);
  AlM330_19 = -(AlM229_19*S30-C30*(AlM329_19+OpM129_19*s->dpt[2][59]));
  OpM230_20 = OpM329_20*S30+C21*C30;
  OpM330_20 = OpM329_20*C30-C21*S30;
  AlM130_20 = AlM129_20-OpM329_20*s->dpt[2][59];
  AlM230_20 = AlM229_20*C30+S30*(AlM329_20+OpM129_20*s->dpt[2][59]);
  AlM330_20 = -(AlM229_20*S30-C30*(AlM329_20+OpM129_20*s->dpt[2][59]));
  OpM230_21 = C29*S30;
  OpM330_21 = C29*C30;
  AlM130_21 = AlM129_21-s->dpt[2][59]*C29;
  AlM230_21 = s->dpt[1][45]*C30-S29*S30*(s->dpt[2][45]+s->dpt[2][59]);
  AlM330_21 = -(s->dpt[1][45]*S30+S29*C30*(s->dpt[2][45]+s->dpt[2][59]));
  ...
  BeF731 = BS331-OpF230;
  BeF831 = BS631+OpF131;
  AlF131 = C31*(AlF130+BeF230*s->dpt[2][61])-S31*(AlF330+BeF830*s->dpt[2][61]);
  AlF231 = AlF230+BS530*s->dpt[2][61];
  AlF331 = C31*(AlF330+BeF830*s->dpt[2][61])+S31*(AlF130+BeF230*s->dpt[2][61]);
  ...
  AlM131_4 = C31*(AlM130_4-OpM330_4*s->dpt[2][61])-S31*(AlM330_4+OpM129_4*s->dpt[2][61]);
  AlM331_4 = C31*(AlM330_4+OpM129_4*s->dpt[2][61])+S31*(AlM130_4-OpM330_4*s->dpt[2][61]);
  OpM131_5 = OpM129_5*C31-OpM330_5*S31;
  OpM331_5 = OpM129_5*S31+OpM330_5*C31;
  AlM131_5 = C31*(AlM130_5-OpM330_5*s->dpt[2][61])-S31*(AlM330_5+OpM129_5*s->dpt[2][61]);
  AlM331_5 = C31*(AlM330_5+OpM129_5*s->dpt[2][61])+S31*(AlM130_5-OpM330_5*s->dpt[2][61]);
  OpM131_6 = OpM129_6*C31-OpM330_6*S31;
  OpM331_6 = OpM129_6*S31+OpM330_6*C31;
  AlM131_6 = C31*(AlM130_6-OpM330_6*s->dpt[2][61])-S31*(AlM330_6+OpM129_6*s->dpt[2][61]);
  AlM331_6 = C31*(AlM330_6+OpM129_6*s->dpt[2][61])+S31*(AlM130_6-OpM330_6*s->dpt[2][61]);
  OpM131_19 = OpM129_19*C31-OpM330_19*S31;
  OpM331_19 = OpM129_19*S31+OpM330_19*C31;
  AlM131_19 = C31*(AlM130_19-OpM330_19*s->dpt[2][61])-S31*(AlM330_19+OpM129_19*s->dpt[2][61]);
  AlM331_19 = C31*(AlM330_19+OpM129_19*s->dpt[2][61])+S31*(AlM130_19-OpM330_19*s->dpt[2][61]);
  OpM131_20 = OpM129_20*C31-OpM330_20*S31;
  OpM331_20 = OpM129_20*S31+OpM330_20*C31;
  AlM131_20 = C31*(AlM130_20-OpM330_20*s->dpt[2][61])-S31*(AlM330_20+OpM129_20*s->dpt[2][61]);
  AlM331_20 = C31*(AlM330_20+OpM129_20*s->dpt[2][61])+S31*(AlM130_20-OpM330_20*s->dpt[2][61]);
  OpM131_21 = -(OpM330_21*S31+S29*C31);
  OpM331_21 = OpM330_21*C31-S29*S31;
  AlM131_21 = C31*(AlM130_21-OpM330_21*s->dpt[2][61])-S31*(AlM330_21-s->dpt[2][61]*S29);
  AlM331_21 = C31*(AlM330_21-s->dpt[2][61]*S29)+S31*(AlM130_21-OpM330_21*s->dpt[2][61]);
  OpM131_29 = S30*S31;
  OpM331_29 = -S30*C31;
  AlM131_29 = s->dpt[2][61]*S30*C31;
  AlM331_29 = s->dpt[2][61]*S30*S31;
  ...
  AlF132 = C32*(AlF131+BS131*s->dpt[1][63]+BeF231*s->dpt[2][63])+S32*(AlF231+BS531*s->dpt[2][63]+BeF431*s->dpt[1][63]);
  AlF232 = C32*(AlF231+BS531*s->dpt[2][63]+BeF431*s->dpt[1][63])-S32*(AlF131+BS131*s->dpt[1][63]+BeF231*s->dpt[2][63]);
  AlF332 = AlF331+BeF731*s->dpt[1][63]+BeF831*s->dpt[2][63];
  ...
  AlM132_4 = C32*(AlM131_4-OpM331_4*s->dpt[2][63])+S32*(AlM230_4+OpM331_4*s->dpt[1][63]);
  AlM232_4 = C32*(AlM230_4+OpM331_4*s->dpt[1][63])-S32*(AlM131_4-OpM331_4*s->dpt[2][63]);
  ...
  AlM132_5 = C32*(AlM131_5-OpM331_5*s->dpt[2][63])+S32*(AlM230_5+OpM331_5*s->dpt[1][63]);
  AlM232_5 = C32*(AlM230_5+OpM331_5*s->dpt[1][63])-S32*(AlM131_5-OpM331_5*s->dpt[2][63]);
  ...
  AlM132_6 = C32*(AlM131_6-OpM331_6*s->dpt[2][63])+S32*(AlM230_6+OpM331_6*s->dpt[1][63]);
  AlM232_6 = C32*(AlM230_6+OpM331_6*s->dpt[1][63])-S32*(AlM131_6-OpM331_6*s->dpt[2][63]);
  ...
  AlM132_19 = C32*(AlM131_19-OpM331_19*s->dpt[2][63])+S32*(AlM230_19+OpM331_19*s->dpt[1][63]);
  AlM232_19 = C32*(AlM230_19+OpM331_19*s->dpt[1][63])-S32*(AlM131_19-OpM331_19*s->dpt[2][63]);
  ...
  AlM132_20 = C32*(AlM131_20-OpM331_20*s->dpt[2][63])+S32*(AlM230_20+OpM331_20*s->dpt[1][63]);
  AlM232_20 = C32*(AlM230_20+OpM331_20*s->dpt[1][63])-S32*(AlM131_20-OpM331_20*s->dpt[2][63]);
  ...
  AlM132_21 = C32*(AlM131_21-OpM331_21*s->dpt[2][63])+S32*(AlM230_21+OpM331_21*s->dpt[1][63]);
  AlM232_21 = C32*(AlM230_21+OpM331_21*s->dpt[1][63])-S32*(AlM131_21-OpM331_21*s->dpt[2][63]);
  ...
  AlM132_29 = OpM331_29*s->dpt[1][63]*S32+C32*(AlM131_29-OpM331_29*s->dpt[2][63]);
  AlM232_29 = OpM331_29*s->dpt[1][63]*C32-S32*(AlM131_29-OpM331_29*s->dpt[2][63]);
  AlM332_29 = AlM331_29+OpM131_29*s->dpt[2][63]-s->dpt[1][63]*C30;
  OpM132_30 = C31*C32;
  OpM232_30 = -C31*S32;
  AlM132_30 = S31*(s->dpt[1][63]*S32-C32*(s->dpt[2][61]+s->dpt[2][63]));
  AlM232_30 = S31*(s->dpt[1][63]*C32+S32*(s->dpt[2][61]+s->dpt[2][63]));
  ...
  AlF133 = C33*(AlF132+BS132*s->dpt[1][65])-S33*(AlF332+BeF732*s->dpt[1][65]);
  AlF233 = AlF232+s->dpt[1][65]*(BS232+OpF331);
  AlF333 = C33*(AlF332+BeF732*s->dpt[1][65])+S33*(AlF132+BS132*s->dpt[1][65]);
  ...
  AlM133_4 = AlM132_4*C33-S33*(AlM332_4-OpM232_4*s->dpt[1][65]);
  AlM233_4 = AlM232_4+OpM331_4*s->dpt[1][65];
  AlM333_4 = AlM132_4*S33+C33*(AlM332_4-OpM232_4*s->dpt[1][65]);
  OpM133_5 = OpM132_5*C33-OpM331_5*S33;
  OpM333_5 = OpM132_5*S33+OpM331_5*C33;
  AlM133_5 = AlM132_5*C33-S33*(AlM332_5-OpM232_5*s->dpt[1][65]);
  AlM233_5 = AlM232_5+OpM331_5*s->dpt[1][65];
  AlM333_5 = AlM132_5*S33+C33*(AlM332_5-OpM232_5*s->dpt[1][65]);
  OpM133_6 = OpM132_6*C33-OpM331_6*S33;
  OpM333_6 = OpM132_6*S33+OpM331_6*C33;
  AlM133_6 = AlM132_6*C33-S33*(AlM332_6-OpM232_6*s->dpt[1][65]);
  AlM233_6 = AlM232_6+OpM331_6*s->dpt[1][65];
  AlM333_6 = AlM132_6*S33+C33*(AlM332_6-OpM232_6*s->dpt[1][65]);
  OpM133_19 = OpM132_19*C33-OpM331_19*S33;
  OpM333_19 = OpM132_19*S33+OpM331_19*C33;
  AlM133_19 = AlM132_19*C33-S33*(AlM332_19-OpM232_19*s->dpt[1][65]);
  AlM233_19 = AlM232_19+OpM331_19*s->dpt[1][65];
  AlM333_19 = AlM132_19*S33+C33*(AlM332_19-OpM232_19*s->dpt[1][65]);
  OpM133_20 = OpM132_20*C33-OpM331_20*S33;
  OpM333_20 = OpM132_20*S33+OpM331_20*C33;
  AlM133_20 = AlM132_20*C33-S33*(AlM332_20-OpM232_20*s->dpt[1][65]);
  AlM233_20 = AlM232_20+OpM331_20*s->dpt[1][65];
  AlM333_20 = AlM132_20*S33+C33*(AlM332_20-OpM232_20*s->dpt[1][65]);
  OpM133_21 = OpM132_21*C33-OpM331_21*S33;
  OpM333_21 = OpM132_21*S33+OpM331_21*C33;
  AlM133_21 = AlM132_21*C33-S33*(AlM332_21-OpM232_21*s->dpt[1][65]);
  AlM233_21 = AlM232_21+OpM331_21*s->dpt[1][65];
  AlM333_21 = AlM132_21*S33+C33*(AlM332_21-OpM232_21*s->dpt[1][65]);
  OpM133_29 = OpM132_29*C33-OpM331_29*S33;
  OpM333_29 = OpM132_29*S33+OpM331_29*C33;
  AlM133_29 = AlM132_29*C33-S33*(AlM332_29-OpM232_29*s->dpt[1][65]);
  AlM233_29 = AlM232_29+OpM331_29*s->dpt[1][65];
  AlM333_29 = AlM132_29*S33+C33*(AlM332_29-OpM232_29*s->dpt[1][65]);
  OpM133_30 = OpM132_30*C33-S31*S33;
  OpM333_30 = OpM132_30*S33+S31*C33;
  AlM133_30 = AlM132_30*C33-S33*(AlM332_30-OpM232_30*s->dpt[1][65]);
  AlM233_30 = AlM232_30+s->dpt[1][65]*S31;
  AlM333_30 = AlM132_30*S33+C33*(AlM332_30-OpM232_30*s->dpt[1][65]);
  OpM133_31 = S32*C33;
  OpM333_31 = S32*S33;
  AlM133_31 = S33*(s->dpt[1][63]+s->dpt[1][65]*C32);
  AlM333_31 = -C33*(s->dpt[1][63]+s->dpt[1][65]*C32);
  ...
  AlF134 = C34*(AlF133+BeF233*s->dpt[2][66])+S34*(AlF233+BS533*s->dpt[2][66]);
  AlF234 = C34*(AlF233+BS533*s->dpt[2][66])-S34*(AlF133+BeF233*s->dpt[2][66]);
  AlF334 = AlF333+BeF833*s->dpt[2][66];
  ...
  AlM134_4 = AlM233_4*S34+C34*(AlM133_4-OpM333_4*s->dpt[2][66]);
  AlM234_4 = AlM233_4*C34-S34*(AlM133_4-OpM333_4*s->dpt[2][66]);
  AlM334_4 = AlM333_4+OpM133_4*s->dpt[2][66];
  OpM134_5 = OpM133_5*C34+OpM232_5*S34;
  OpM234_5 = -(OpM133_5*S34-OpM232_5*C34);
  AlM134_5 = AlM233_5*S34+C34*(AlM133_5-OpM333_5*s->dpt[2][66]);
  AlM234_5 = AlM233_5*C34-S34*(AlM133_5-OpM333_5*s->dpt[2][66]);
  AlM334_5 = AlM333_5+OpM133_5*s->dpt[2][66];
  OpM134_6 = OpM133_6*C34+OpM232_6*S34;
  OpM234_6 = -(OpM133_6*S34-OpM232_6*C34);
  AlM134_6 = AlM233_6*S34+C34*(AlM133_6-OpM333_6*s->dpt[2][66]);
  AlM234_6 = AlM233_6*C34-S34*(AlM133_6-OpM333_6*s->dpt[2][66]);
  AlM334_6 = AlM333_6+OpM133_6*s->dpt[2][66];
  OpM134_19 = OpM133_19*C34+OpM232_19*S34;
  OpM234_19 = -(OpM133_19*S34-OpM232_19*C34);
  AlM134_19 = AlM233_19*S34+C34*(AlM133_19-OpM333_19*s->dpt[2][66]);
  AlM234_19 = AlM233_19*C34-S34*(AlM133_19-OpM333_19*s->dpt[2][66]);
  AlM334_19 = AlM333_19+OpM133_19*s->dpt[2][66];
  OpM134_20 = OpM133_20*C34+OpM232_20*S34;
  OpM234_20 = -(OpM133_20*S34-OpM232_20*C34);
  AlM134_20 = AlM233_20*S34+C34*(AlM133_20-OpM333_20*s->dpt[2][66]);
  AlM234_20 = AlM233_20*C34-S34*(AlM133_20-OpM333_20*s->dpt[2][66]);
  AlM334_20 = AlM333_20+OpM133_20*s->dpt[2][66];
  OpM134_21 = OpM133_21*C34+OpM232_21*S34;
  OpM234_21 = -(OpM133_21*S34-OpM232_21*C34);
  AlM134_21 = AlM233_21*S34+C34*(AlM133_21-OpM333_21*s->dpt[2][66]);
  AlM234_21 = AlM233_21*C34-S34*(AlM133_21-OpM333_21*s->dpt[2][66]);
  AlM334_21 = AlM333_21+OpM133_21*s->dpt[2][66];
  OpM134_29 = OpM133_29*C34+OpM232_29*S34;
  OpM234_29 = -(OpM133_29*S34-OpM232_29*C34);
  AlM134_29 = AlM233_29*S34+C34*(AlM133_29-OpM333_29*s->dpt[2][66]);
  AlM234_29 = AlM233_29*C34-S34*(AlM133_29-OpM333_29*s->dpt[2][66]);
  AlM334_29 = AlM333_29+OpM133_29*s->dpt[2][66];
  OpM134_30 = OpM133_30*C34+OpM232_30*S34;
  OpM234_30 = -(OpM133_30*S34-OpM232_30*C34);
  AlM134_30 = AlM233_30*S34+C34*(AlM133_30-OpM333_30*s->dpt[2][66]);
  AlM234_30 = AlM233_30*C34-S34*(AlM133_30-OpM333_30*s->dpt[2][66]);
  AlM334_30 = AlM333_30+OpM133_30*s->dpt[2][66];
  OpM134_31 = OpM133_31*C34+C32*S34;
  OpM234_31 = -(OpM133_31*S34-C32*C34);
  AlM134_31 = C34*(AlM133_31-OpM333_31*s->dpt[2][66]);
  AlM234_31 = -S34*(AlM133_31-OpM333_31*s->dpt[2][66]);
  AlM334_31 = AlM333_31+OpM133_31*s->dpt[2][66];
  OpM134_32 = -S33*C34;
  OpM234_32 = S33*S34;
  AlM134_32 = s->dpt[1][65]*S34-s->dpt[2][66]*C33*C34;
  AlM234_32 = s->dpt[1][65]*C34+s->dpt[2][66]*C33*S34;
  AlM334_32 = -s->dpt[2][66]*S33;
  OM135 = qd[35]+OM134;
...
// Backward Dynamics 
 ...
 s->In[5][28]));
  ...
  FF326 = FA326+FF327;
  CF126 = -(s->trq[1][26]-s->In[1][26]*OpF126-CF127*C27+CF227*S27-FA326*s->l[2][26]-FF327*s->dpt[2][55]+OM226*OM326*(
 s->In[5][26]-s->In[9][26]));
 ...
 s->dpt[2][55]*(FF127*C27-FF227*S27));
  ...
  CM126_1 = FB326_1*s->l[2][26]+FM327_1*s->dpt[2][55];
  CM326_1 = -(FB126_1*s->l[2][26]+s->dpt[2][55]*(FM127_1*C27-FM227_1*S27));
  ...
  CM126_2 = FB326_2*s->l[2][26]+FM327_2*s->dpt[2][55];
  CM326_2 = -(FB126_2*s->l[2][26]+s->dpt[2][55]*(FM127_2*C27-FM227_2*S27));
  ...
  CM126_3 = FB326_3*s->l[2][26]+FM327_3*s->dpt[2][55];
  CM326_3 = -(FB126_3*s->l[2][26]+s->dpt[2][55]*(FM127_3*C27-FM227_3*S27));
  ...
  CM126_4 = s->In[1][26]*OpM126_4+CM127_4*C27-CM227_4*S27+FB326_4*s->l[2][26]+FM327_4*s->dpt[2][55];
  CM226_4 = s->In[5][26]*OpM225_4+CM127_4*S27+CM227_4*C27;
  CM326_4 = CM327_4+s->In[9][26]*OpM326_4-FB126_4*s->l[2][26]-s->dpt[2][55]*(FM127_4*C27-FM227_4*S27);
  ...
  CM126_5 = s->In[1][26]*OpM126_5+CM127_5*C27-CM227_5*S27+FB326_5*s->l[2][26]+FM327_5*s->dpt[2][55];
  CM226_5 = s->In[5][26]*OpM225_5+CM127_5*S27+CM227_5*C27;
  CM326_5 = CM327_5+s->In[9][26]*OpM326_5-FB126_5*s->l[2][26]-s->dpt[2][55]*(FM127_5*C27-FM227_5*S27);
  ...
  CM126_6 = s->In[1][26]*OpM126_6+CM127_6*C27-CM227_6*S27+FB326_6*s->l[2][26]+FM327_6*s->dpt[2][55];
  CM226_6 = s->In[5][26]*OpM225_6+CM127_6*S27+CM227_6*C27;
  CM326_6 = CM327_6+s->In[9][26]*OpM326_6-FB126_6*s->l[2][26]-s->dpt[2][55]*(FM127_6*C27-FM227_6*S27);
  ...
  CM126_19 = s->In[1][26]*OpM126_19+CM127_19*C27-CM227_19*S27+FB326_19*s->l[2][26]+FM327_19*s->dpt[2][55];
  CM226_19 = s->In[5][26]*OpM225_19+CM127_19*S27+CM227_19*C27;
  CM326_19 = CM327_19+s->In[9][26]*OpM326_19-FB126_19*s->l[2][26]-s->dpt[2][55]*(FM127_19*C27-FM227_19*S27);
  ...
  CM126_20 = s->In[1][26]*OpM126_20+CM127_20*C27-CM227_20*S27+FB326_20*s->l[2][26]+FM327_20*s->dpt[2][55];
  CM226_20 = s->In[5][26]*OpM225_20+CM127_20*S27+CM227_20*C27;
  CM326_20 = CM327_20+s->In[9][26]*OpM326_20-FB126_20*s->l[2][26]-s->dpt[2][55]*(FM127_20*C27-FM227_20*S27);
  ...
  CM126_21 = s->In[1][26]*OpM126_21+CM127_21*C27-CM227_21*S27+FB326_21*s->l[2][26]+FM327_21*s->dpt[2][55];
  CM226_21 = s->In[5][26]*OpM225_21+CM127_21*S27+CM227_21*C27;
  CM326_21 = CM327_21+s->In[9][26]*OpM326_21-FB126_21*s->l[2][26]-s->dpt[2][55]*(FM127_21*C27-FM227_21*S27);
  ...
  CM126_22 = s->In[1][26]*OpM126_22+CM127_22*C27-CM227_22*S27+FB326_22*s->l[2][26]+FM327_22*s->dpt[2][55];
  CM226_22 = s->In[5][26]*OpM225_22+CM127_22*S27+CM227_22*C27;
  CM326_22 = CM327_22+s->In[9][26]*OpM326_22-FB126_22*s->l[2][26]-s->dpt[2][55]*(FM127_22*C27-FM227_22*S27);
  ...
  CM126_23 = s->In[1][26]*OpM126_23+CM127_23*C27-CM227_23*S27+FB326_23*s->l[2][26]+FM327_23*s->dpt[2][55];
  CM226_23 = s->In[5][26]*OpM225_23+CM127_23*S27+CM227_23*C27;
  CM326_23 = CM327_23+s->In[9][26]*OpM326_23-FB126_23*s->l[2][26]-s->dpt[2][55]*(FM127_23*C27-FM227_23*S27);
  FB126_24 = s->m[26]*(AlM126_24-OpM326_24*s->l[2][26]);
  FB326_24 = s->m[26]*(AlM326_24+OpM126_24*s->l[2][26]);
  CM126_24 = s->In[1][26]*OpM126_24+CM127_24*C27-CM227_24*S27+FB326_24*s->l[2][26]+FM327_24*s->dpt[2][55];
  CM226_24 = s->In[5][26]*C25+CM127_24*S27+CM227_24*C27;
  CM326_24 = CM327_24+s->In[9][26]*OpM326_24-FB126_24*s->l[2][26]-s->dpt[2][55]*(FM127_24*C27-FM227_24*S27);
 ...
 OM225)));
  ...
  CF125 = -(s->trq[1][25]-s->In[1][25]*OpF125-s->In[2][25]*OpF225-s->In[3][25]*OpF324-CF126*C26-CF326*S26+FA225*
 s->l[3][25]-FA325*s->l[2][25]-OM225*(s->In[3][25]*OM125+s->In[6][25]*OM225+s->In[9][25]*OM325)+OM325*(s->In[2][25]*OM125+
 s->In[5][25]*OM225+s->In[6][25]*OM325));
  CF225 = -(s->trq[2][25]-CF226-s->In[2][25]*OpF125-s->In[5][25]*OpF225-s->In[6][25]*OpF324-FA125*s->l[3][25]+FA325*
 s->l[1][25]+OM125*(s->In[3][25]*OM125+s->In[6][25]*OM225+s->In[9][25]*OM325)-OM325*(s->In[1][25]*OM125+s->In[2][25]*OM225+
 s->In[3][25]*OM325)-s->dpt[1][54]*(FF126*S26-FF326*C26));
  CF325 = -(s->trq[3][25]-s->In[3][25]*OpF125-s->In[6][25]*OpF225-s->In[9][25]*OpF324+CF126*S26-CF326*C26+FA125*
 s->l[2][25]-FA225*s->l[1][25]-FF226*s->dpt[1][54]-OM125*(s->In[2][25]*OM125+s->In[5][25]*OM225+s->In[6][25]*OM325)+OM225*(
 s->In[1][25]*OM125+s->In[2][25]*OM225+s->In[3][25]*OM325));
  ...
  CM225_1 = FB125_1*s->l[3][25]-FB325_1*s->l[1][25]+s->dpt[1][54]*(FM126_1*S26-FM326_1*C26);
  CM325_1 = -(CM126_1*S26-CM326_1*C26+FB125_1*s->l[2][25]-FB225_1*s->l[1][25]-FM226_1*s->dpt[1][54]);
  ...
  CM225_2 = FB125_2*s->l[3][25]-FB325_2*s->l[1][25]+s->dpt[1][54]*(FM126_2*S26-FM326_2*C26);
  CM325_2 = -(CM126_2*S26-CM326_2*C26+FB125_2*s->l[2][25]-FB225_2*s->l[1][25]-FM226_2*s->dpt[1][54]);
  ...
  CM225_3 = FB125_3*s->l[3][25]-FB325_3*s->l[1][25]+s->dpt[1][54]*(FM126_3*S26-FM326_3*C26);
  CM325_3 = -(CM126_3*S26-CM326_3*C26+FB125_3*s->l[2][25]-FB225_3*s->l[1][25]-FM226_3*s->dpt[1][54]);
  ...
  CM125_4 = s->In[1][25]*OpM125_4+s->In[2][25]*OpM225_4+s->In[3][25]*OpM324_4+CM126_4*C26+CM326_4*S26-FB225_4*
 s->l[3][25]+FB325_4*s->l[2][25];
  CM225_4 = CM226_4+s->In[2][25]*OpM125_4+s->In[5][25]*OpM225_4+s->In[6][25]*OpM324_4+FB125_4*s->l[3][25]-FB325_4*
 s->l[1][25]+s->dpt[1][54]*(FM126_4*S26-FM326_4*C26);
  CM325_4 = s->In[3][25]*OpM125_4+s->In[6][25]*OpM225_4+s->In[9][25]*OpM324_4-CM126_4*S26+CM326_4*C26-FB125_4*
 s->l[2][25]+FB225_4*s->l[1][25]+FM226_4*s->dpt[1][54];
  ...
  CM125_5 = s->In[1][25]*OpM125_5+s->In[2][25]*OpM225_5+s->In[3][25]*OpM324_5+CM126_5*C26+CM326_5*S26-FB225_5*
 s->l[3][25]+FB325_5*s->l[2][25];
  CM225_5 = CM226_5+s->In[2][25]*OpM125_5+s->In[5][25]*OpM225_5+s->In[6][25]*OpM324_5+FB125_5*s->l[3][25]-FB325_5*
 s->l[1][25]+s->dpt[1][54]*(FM126_5*S26-FM326_5*C26);
  CM325_5 = s->In[3][25]*OpM125_5+s->In[6][25]*OpM225_5+s->In[9][25]*OpM324_5-CM126_5*S26+CM326_5*C26-FB125_5*
 s->l[2][25]+FB225_5*s->l[1][25]+FM226_5*s->dpt[1][54];
  ...
  CM125_6 = s->In[1][25]*OpM125_6+s->In[2][25]*OpM225_6+s->In[3][25]*OpM324_6+CM126_6*C26+CM326_6*S26-FB225_6*
 s->l[3][25]+FB325_6*s->l[2][25];
  CM225_6 = CM226_6+s->In[2][25]*OpM125_6+s->In[5][25]*OpM225_6+s->In[6][25]*OpM324_6+FB125_6*s->l[3][25]-FB325_6*
 s->l[1][25]+s->dpt[1][54]*(FM126_6*S26-FM326_6*C26);
  CM325_6 = s->In[3][25]*OpM125_6+s->In[6][25]*OpM225_6+s->In[9][25]*OpM324_6-CM126_6*S26+CM326_6*C26-FB125_6*
 s->l[2][25]+FB225_6*s->l[1][25]+FM226_6*s->dpt[1][54];
  ...
  CM125_19 = s->In[1][25]*OpM125_19+s->In[2][25]*OpM225_19+s->In[3][25]*OpM324_19+CM126_19*C26+CM326_19*S26-FB225_19*
 s->l[3][25]+FB325_19*s->l[2][25];
  CM225_19 = CM226_19+s->In[2][25]*OpM125_19+s->In[5][25]*OpM225_19+s->In[6][25]*OpM324_19+FB125_19*s->l[3][25]-FB325_19
 *s->l[1][25]+s->dpt[1][54]*(FM126_19*S26-FM326_19*C26);
  CM325_19 = s->In[3][25]*OpM125_19+s->In[6][25]*OpM225_19+s->In[9][25]*OpM324_19-CM126_19*S26+CM326_19*C26-FB125_19*
 s->l[2][25]+FB225_19*s->l[1][25]+FM226_19*s->dpt[1][54];
  ...
  CM125_20 = s->In[1][25]*OpM125_20+s->In[2][25]*OpM225_20+s->In[3][25]*OpM324_20+CM126_20*C26+CM326_20*S26-FB225_20*
 s->l[3][25]+FB325_20*s->l[2][25];
  CM225_20 = CM226_20+s->In[2][25]*OpM125_20+s->In[5][25]*OpM225_20+s->In[6][25]*OpM324_20+FB125_20*s->l[3][25]-FB325_20
 *s->l[1][25]+s->dpt[1][54]*(FM126_20*S26-FM326_20*C26);
  CM325_20 = s->In[3][25]*OpM125_20+s->In[6][25]*OpM225_20+s->In[9][25]*OpM324_20-CM126_20*S26+CM326_20*C26-FB125_20*
 s->l[2][25]+FB225_20*s->l[1][25]+FM226_20*s->dpt[1][54];
  ...
  CM125_21 = s->In[1][25]*OpM125_21+s->In[2][25]*OpM225_21+s->In[3][25]*OpM324_21+CM126_21*C26+CM326_21*S26-FB225_21*
 s->l[3][25]+FB325_21*s->l[2][25];
  CM225_21 = CM226_21+s->In[2][25]*OpM125_21+s->In[5][25]*OpM225_21+s->In[6][25]*OpM324_21+FB125_21*s->l[3][25]-FB325_21
 *s->l[1][25]+s->dpt[1][54]*(FM126_21*S26-FM326_21*C26);
  CM325_21 = s->In[3][25]*OpM125_21+s->In[6][25]*OpM225_21+s->In[9][25]*OpM324_21-CM126_21*S26+CM326_21*C26-FB125_21*
 s->l[2][25]+FB225_21*s->l[1][25]+FM226_21*s->dpt[1][54];
  ...
  CM125_22 = s->In[1][25]*OpM125_22+s->In[2][25]*OpM225_22+s->In[3][25]*OpM324_22+CM126_22*C26+CM326_22*S26-FB225_22*
 s->l[3][25]+FB325_22*s->l[2][25];
  CM225_22 = CM226_22+s->In[2][25]*OpM125_22+s->In[5][25]*OpM225_22+s->In[6][25]*OpM324_22+FB125_22*s->l[3][25]-FB325_22
 *s->l[1][25]+s->dpt[1][54]*(FM126_22*S26-FM326_22*C26);
  CM325_22 = s->In[3][25]*OpM125_22+s->In[6][25]*OpM225_22+s->In[9][25]*OpM324_22-CM126_22*S26+CM326_22*C26-FB125_22*
 s->l[2][25]+FB225_22*s->l[1][25]+FM226_22*s->dpt[1][54];
  ...
  CM125_23 = s->In[1][25]*OpM125_23+s->In[2][25]*OpM225_23+s->In[3][25]*S24+CM126_23*C26+CM326_23*S26-FB225_23*
 s->l[3][25]+FB325_23*s->l[2][25];
  CM225_23 = CM226_23+s->In[2][25]*OpM125_23+s->In[5][25]*OpM225_23+s->In[6][25]*S24+FB125_23*s->l[3][25]-FB325_23*
 s->l[1][25]+s->dpt[1][54]*(FM126_23*S26-FM326_23*C26);
  CM325_23 = s->In[3][25]*OpM125_23+s->In[6][25]*OpM225_23+s->In[9][25]*S24-CM126_23*S26+CM326_23*C26-FB125_23*
 s->l[2][25]+FB225_23*s->l[1][25]+FM226_23*s->dpt[1][54];
  ...
  CM325_24 = s->In[3][25]*S25+s->In[6][25]*C25-CM126_24*S26+CM326_24*C26-FB125_24*s->l[2][25]+FB225_24*s->l[1][25]+
 s->dpt[1][54]*(FM127_24*S27+FM227_24*C27);
  CM325_25 = s->In[9][25]+s->m[25]*s->l[1][25]*s->l[1][25]+s->m[25]*s->l[2][25]*s->l[2][25]+s->dpt[1][54]*(s->m[26]*
 s->dpt[1][54]+FM127_25*S27+FM227_25*C27)+C26*(CM327_25+s->In[9][26]*C26+s->m[26]*s->l[2][26]*s->l[2][26]*C26-s->dpt[2][55]*(
 FM127_25*C27-FM227_25*S27))-S26*(CM127_25*C27-CM227_25*S27+s->dpt[2][55]*(s->m[27]*AlM327_25+FB228_25*S28+FB328_25*C28)-S26*
 ...
 OM224)));
  ...
  FF324 = FA324+FF325;
  CF124 = -(s->trq[1][24]-s->In[1][24]*OpF124-s->In[2][24]*OpF223-s->In[3][24]*OpF324-CF125*C25+CF225*S25+FA224*
 s->l[3][24]-FA324*s->l[2][24]-FF325*s->dpt[2][52]-OM224*(s->In[3][24]*OM124+s->In[6][24]*OM224+s->In[9][24]*OM324)+OM324*(
 s->In[2][24]*OM124+s->In[5][24]*OM224+s->In[6][24]*OM324));
  CF224 = -(s->trq[2][24]-s->In[2][24]*OpF124-s->In[5][24]*OpF223-s->In[6][24]*OpF324-CF125*S25-CF225*C25-FA124*
 s->l[3][24]+FA324*s->l[1][24]+OM124*(s->In[3][24]*OM124+s->In[6][24]*OM224+s->In[9][24]*OM324)-OM324*(s->In[1][24]*OM124+
 s->In[2][24]*OM224+s->In[3][24]*OM324));
  CF324 = -(s->trq[3][24]-CF325-s->In[3][24]*OpF124-s->In[6][24]*OpF223-s->In[9][24]*OpF324+FA124*s->l[2][24]-FA224*
 s->l[1][24]-OM124*(s->In[2][24]*OM124+s->In[5][24]*OM224+s->In[6][24]*OM324)+OM224*(s->In[1][24]*OM124+s->In[2][24]*OM224+
 s->In[3][24]*OM324)+s->dpt[2][52]*(FF125*C25-FF225*S25));
  ...
  CM124_1 = CM125_1*C25-CM225_1*S25-FB224_1*s->l[3][24]+FB324_1*s->l[2][24]+FM325_1*s->dpt[2][52];
  CM224_1 = CM125_1*S25+CM225_1*C25+FB124_1*s->l[3][24]-FB324_1*s->l[1][24];
  CM324_1 = CM325_1-FB124_1*s->l[2][24]+FB224_1*s->l[1][24]-s->dpt[2][52]*(FM125_1*C25-FM225_1*S25);
  ...
  CM124_2 = CM125_2*C25-CM225_2*S25-FB224_2*s->l[3][24]+FB324_2*s->l[2][24]+FM325_2*s->dpt[2][52];
  CM224_2 = CM125_2*S25+CM225_2*C25+FB124_2*s->l[3][24]-FB324_2*s->l[1][24];
  CM324_2 = CM325_2-FB124_2*s->l[2][24]+FB224_2*s->l[1][24]-s->dpt[2][52]*(FM125_2*C25-FM225_2*S25);
  ...
  CM124_3 = CM125_3*C25-CM225_3*S25-FB224_3*s->l[3][24]+FB324_3*s->l[2][24]+FM325_3*s->dpt[2][52];
  CM224_3 = CM125_3*S25+CM225_3*C25+FB124_3*s->l[3][24]-FB324_3*s->l[1][24];
  CM324_3 = CM325_3-FB124_3*s->l[2][24]+FB224_3*s->l[1][24]-s->dpt[2][52]*(FM125_3*C25-FM225_3*S25);
  ...
  CM124_4 = s->In[1][24]*OpM124_4+s->In[2][24]*OpM223_4+s->In[3][24]*OpM324_4+CM125_4*C25-CM225_4*S25-FB224_4*
 s->l[3][24]+FB324_4*s->l[2][24]+FM325_4*s->dpt[2][52];
  CM224_4 = s->In[2][24]*OpM124_4+s->In[5][24]*OpM223_4+s->In[6][24]*OpM324_4+CM125_4*S25+CM225_4*C25+FB124_4*
 s->l[3][24]-FB324_4*s->l[1][24];
  CM324_4 = CM325_4+s->In[3][24]*OpM124_4+s->In[6][24]*OpM223_4+s->In[9][24]*OpM324_4-FB124_4*s->l[2][24]+FB224_4*
 s->l[1][24]-s->dpt[2][52]*(FM125_4*C25-FM225_4*S25);
  ...
  CM124_5 = s->In[1][24]*OpM124_5+s->In[2][24]*OpM223_5+s->In[3][24]*OpM324_5+CM125_5*C25-CM225_5*S25-FB224_5*
 s->l[3][24]+FB324_5*s->l[2][24]+FM325_5*s->dpt[2][52];
  CM224_5 = s->In[2][24]*OpM124_5+s->In[5][24]*OpM223_5+s->In[6][24]*OpM324_5+CM125_5*S25+CM225_5*C25+FB124_5*
 s->l[3][24]-FB324_5*s->l[1][24];
  CM324_5 = CM325_5+s->In[3][24]*OpM124_5+s->In[6][24]*OpM223_5+s->In[9][24]*OpM324_5-FB124_5*s->l[2][24]+FB224_5*
 s->l[1][24]-s->dpt[2][52]*(FM125_5*C25-FM225_5*S25);
  ...
  CM124_6 = s->In[1][24]*OpM124_6+s->In[2][24]*OpM223_6+s->In[3][24]*OpM324_6+CM125_6*C25-CM225_6*S25-FB224_6*
 s->l[3][24]+FB324_6*s->l[2][24]+FM325_6*s->dpt[2][52];
  CM224_6 = s->In[2][24]*OpM124_6+s->In[5][24]*OpM223_6+s->In[6][24]*OpM324_6+CM125_6*S25+CM225_6*C25+FB124_6*
 s->l[3][24]-FB324_6*s->l[1][24];
  CM324_6 = CM325_6+s->In[3][24]*OpM124_6+s->In[6][24]*OpM223_6+s->In[9][24]*OpM324_6-FB124_6*s->l[2][24]+FB224_6*
 s->l[1][24]-s->dpt[2][52]*(FM125_6*C25-FM225_6*S25);
  ...
  CM124_19 = s->In[1][24]*OpM124_19+s->In[2][24]*OpM223_19+s->In[3][24]*OpM324_19+CM125_19*C25-CM225_19*S25-FB224_19*
 s->l[3][24]+FB324_19*s->l[2][24]+FM325_19*s->dpt[2][52];
  CM224_19 = s->In[2][24]*OpM124_19+s->In[5][24]*OpM223_19+s->In[6][24]*OpM324_19+CM125_19*S25+CM225_19*C25+FB124_19*
 s->l[3][24]-FB324_19*s->l[1][24];
  CM324_19 = CM325_19+s->In[3][24]*OpM124_19+s->In[6][24]*OpM223_19+s->In[9][24]*OpM324_19-FB124_19*s->l[2][24]+FB224_19
 *s->l[1][24]-s->dpt[2][52]*(FM125_19*C25-FM225_19*S25);
  ...
  CM124_20 = s->In[1][24]*OpM124_20+s->In[2][24]*OpM223_20+s->In[3][24]*OpM324_20+CM125_20*C25-CM225_20*S25-FB224_20*
 s->l[3][24]+FB324_20*s->l[2][24]+FM325_20*s->dpt[2][52];
  CM224_20 = s->In[2][24]*OpM124_20+s->In[5][24]*OpM223_20+s->In[6][24]*OpM324_20+CM125_20*S25+CM225_20*C25+FB124_20*
 s->l[3][24]-FB324_20*s->l[1][24];
  CM324_20 = CM325_20+s->In[3][24]*OpM124_20+s->In[6][24]*OpM223_20+s->In[9][24]*OpM324_20-FB124_20*s->l[2][24]+FB224_20
 *s->l[1][24]-s->dpt[2][52]*(FM125_20*C25-FM225_20*S25);
  ...
  CM124_21 = s->In[1][24]*OpM124_21+s->In[2][24]*OpM223_21+s->In[3][24]*OpM324_21+CM125_21*C25-CM225_21*S25-FB224_21*
 s->l[3][24]+FB324_21*s->l[2][24]+FM325_21*s->dpt[2][52];
  CM224_21 = s->In[2][24]*OpM124_21+s->In[5][24]*OpM223_21+s->In[6][24]*OpM324_21+CM125_21*S25+CM225_21*C25+FB124_21*
 s->l[3][24]-FB324_21*s->l[1][24];
  CM324_21 = CM325_21+s->In[3][24]*OpM124_21+s->In[6][24]*OpM223_21+s->In[9][24]*OpM324_21-FB124_21*s->l[2][24]+FB224_21
 *s->l[1][24]-s->dpt[2][52]*(FM125_21*C25-FM225_21*S25);
  ...
  CM124_22 = s->In[1][24]*OpM124_22+s->In[2][24]*C23+s->In[3][24]*OpM324_22+CM125_22*C25-CM225_22*S25-FB224_22*
 s->l[3][24]+FB324_22*s->l[2][24]+FM325_22*s->dpt[2][52];
  CM224_22 = s->In[2][24]*OpM124_22+s->In[5][24]*C23+s->In[6][24]*OpM324_22+CM125_22*S25+CM225_22*C25+FB124_22*
 s->l[3][24]-FB324_22*s->l[1][24];
  CM324_22 = CM325_22+s->In[3][24]*OpM124_22+s->In[6][24]*C23+s->In[9][24]*OpM324_22-FB124_22*s->l[2][24]+FB224_22*
 s->l[1][24]-s->dpt[2][52]*(FM125_22*C25-FM225_22*S25);
  FB124_23 = s->m[24]*(AlM124_23-s->l[2][24]*S24);
  FB224_23 = s->m[24]*(s->l[1][24]*S24-s->l[3][24]*C24);
  FB324_23 = s->m[24]*C24*(s->dpt[2][50]+s->l[2][24]);
  CM224_23 = s->In[2][24]*C24+s->In[6][24]*S24+CM125_23*S25+CM225_23*C25+FB124_23*s->l[3][24]-FB324_23*s->l[1][24];
  CM224_24 = s->In[5][24]+s->m[24]*s->l[1][24]*s->l[1][24]+s->m[24]*s->l[3][24]*s->l[3][24]+C25*(CM226_24+s->In[2][25]*
 S25+s->In[5][25]*C25+FB125_24*s->l[3][25]-FB325_24*s->l[1][25]-s->dpt[1][54]*(C26*(FB326_24+FM327_24)-S26*(FB126_24+FM127_24
 *C27-FM227_24*S27)))+S25*(s->In[1][25]*S25+s->In[2][25]*C25+CM126_24*C26+CM326_24*S26-FB225_24*s->l[3][25]+FB325_24*
 s->l[2][25]);
  ...
  CF123 = -(s->trq[1][23]-s->In[1][23]*OpF122-s->In[2][23]*OpF223-s->In[3][23]*OpF323-CF124*C24-CF324*S24-FA323*
 s->l[2][23]-OM223*(s->In[3][23]*OM123+s->In[6][23]*OM223+s->In[9][23]*OM323)+OM323*(s->In[2][23]*OM123+s->In[5][23]*OM223+
 s->In[6][23]*OM323)+s->dpt[2][50]*(FF124*S24-FF324*C24));
  CF223 = -(s->trq[2][23]-CF224-s->In[2][23]*OpF122-s->In[5][23]*OpF223-s->In[6][23]*OpF323+FA323*s->l[1][23]+OM123*(
 s->In[3][23]*OM123+s->In[6][23]*OM223+s->In[9][23]*OM323)-OM323*(s->In[1][23]*OM123+s->In[2][23]*OM223+s->In[3][23]*OM323));
  CF323 = -(s->trq[3][23]-s->In[3][23]*OpF122-s->In[6][23]*OpF223-s->In[9][23]*OpF323+CF124*S24-CF324*C24+FA123*
 s->l[2][23]-FA223*s->l[1][23]-OM123*(s->In[2][23]*OM123+s->In[5][23]*OM223+s->In[6][23]*OM323)+OM223*(s->In[1][23]*OM123+
 s->In[2][23]*OM223+s->In[3][23]*OM323)+s->dpt[2][50]*(FF124*C24+FF324*S24));
  ...
  CM123_1 = CM124_1*C24+CM324_1*S24+FB323_1*s->l[2][23]-s->dpt[2][50]*(FM124_1*S24-FM324_1*C24);
  CM223_1 = CM224_1-FB323_1*s->l[1][23];
  CM323_1 = -(CM124_1*S24-CM324_1*C24+FB123_1*s->l[2][23]-FB223_1*s->l[1][23]+s->dpt[2][50]*(FM124_1*C24+FM324_1*S24));
  ...
  CM123_2 = CM124_2*C24+CM324_2*S24+FB323_2*s->l[2][23]-s->dpt[2][50]*(FM124_2*S24-FM324_2*C24);
  CM223_2 = CM224_2-FB323_2*s->l[1][23];
  CM323_2 = -(CM124_2*S24-CM324_2*C24+FB123_2*s->l[2][23]-FB223_2*s->l[1][23]+s->dpt[2][50]*(FM124_2*C24+FM324_2*S24));
  ...
  CM123_3 = CM124_3*C24+CM324_3*S24+FB323_3*s->l[2][23]-s->dpt[2][50]*(FM124_3*S24-FM324_3*C24);
  CM223_3 = CM224_3-FB323_3*s->l[1][23];
  CM323_3 = -(CM124_3*S24-CM324_3*C24+FB123_3*s->l[2][23]-FB223_3*s->l[1][23]+s->dpt[2][50]*(FM124_3*C24+FM324_3*S24));
  ...
  CM123_4 = s->In[1][23]*OpM122_4+s->In[2][23]*OpM223_4+s->In[3][23]*OpM323_4+CM124_4*C24+CM324_4*S24+FB323_4*
 s->l[2][23]-s->dpt[2][50]*(FM124_4*S24-FM324_4*C24);
  CM223_4 = CM224_4+s->In[2][23]*OpM122_4+s->In[5][23]*OpM223_4+s->In[6][23]*OpM323_4-FB323_4*s->l[1][23];
  CM323_4 = s->In[3][23]*OpM122_4+s->In[6][23]*OpM223_4+s->In[9][23]*OpM323_4-CM124_4*S24+CM324_4*C24-FB123_4*
 s->l[2][23]+FB223_4*s->l[1][23]-s->dpt[2][50]*(FM124_4*C24+FM324_4*S24);
  ...
  CM123_5 = s->In[1][23]*OpM122_5+s->In[2][23]*OpM223_5+s->In[3][23]*OpM323_5+CM124_5*C24+CM324_5*S24+FB323_5*
 s->l[2][23]-s->dpt[2][50]*(FM124_5*S24-FM324_5*C24);
  CM223_5 = CM224_5+s->In[2][23]*OpM122_5+s->In[5][23]*OpM223_5+s->In[6][23]*OpM323_5-FB323_5*s->l[1][23];
  CM323_5 = s->In[3][23]*OpM122_5+s->In[6][23]*OpM223_5+s->In[9][23]*OpM323_5-CM124_5*S24+CM324_5*C24-FB123_5*
 s->l[2][23]+FB223_5*s->l[1][23]-s->dpt[2][50]*(FM124_5*C24+FM324_5*S24);
  ...
  CM123_6 = s->In[1][23]*OpM122_6+s->In[2][23]*OpM223_6+s->In[3][23]*OpM323_6+CM124_6*C24+CM324_6*S24+FB323_6*
 s->l[2][23]-s->dpt[2][50]*(FM124_6*S24-FM324_6*C24);
  CM223_6 = CM224_6+s->In[2][23]*OpM122_6+s->In[5][23]*OpM223_6+s->In[6][23]*OpM323_6-FB323_6*s->l[1][23];
  CM323_6 = s->In[3][23]*OpM122_6+s->In[6][23]*OpM223_6+s->In[9][23]*OpM323_6-CM124_6*S24+CM324_6*C24-FB123_6*
 s->l[2][23]+FB223_6*s->l[1][23]-s->dpt[2][50]*(FM124_6*C24+FM324_6*S24);
  ...
  CM123_19 = s->In[1][23]*OpM122_19+s->In[2][23]*OpM223_19+s->In[3][23]*OpM323_19+CM124_19*C24+CM324_19*S24+FB323_19*
 s->l[2][23]-s->dpt[2][50]*(FM124_19*S24-FM324_19*C24);
  CM223_19 = CM224_19+s->In[2][23]*OpM122_19+s->In[5][23]*OpM223_19+s->In[6][23]*OpM323_19-FB323_19*s->l[1][23];
  CM323_19 = s->In[3][23]*OpM122_19+s->In[6][23]*OpM223_19+s->In[9][23]*OpM323_19-CM124_19*S24+CM324_19*C24-FB123_19*
 s->l[2][23]+FB223_19*s->l[1][23]-s->dpt[2][50]*(FM124_19*C24+FM324_19*S24);
  ...
  CM123_20 = s->In[1][23]*OpM122_20+s->In[2][23]*OpM223_20+s->In[3][23]*OpM323_20+CM124_20*C24+CM324_20*S24+FB323_20*
 s->l[2][23]-s->dpt[2][50]*(FM124_20*S24-FM324_20*C24);
  CM223_20 = CM224_20+s->In[2][23]*OpM122_20+s->In[5][23]*OpM223_20+s->In[6][23]*OpM323_20-FB323_20*s->l[1][23];
  CM323_20 = s->In[3][23]*OpM122_20+s->In[6][23]*OpM223_20+s->In[9][23]*OpM323_20-CM124_20*S24+CM324_20*C24-FB123_20*
 s->l[2][23]+FB223_20*s->l[1][23]-s->dpt[2][50]*(FM124_20*C24+FM324_20*S24);
  ...
  CM123_21 = CM124_21*C24+CM324_21*S24-s->dpt[2][50]*(FM124_21*S24-FM324_21*C24)-s->In[1][23]*S22+s->In[2][23]*OpM223_21
 +s->In[3][23]*OpM323_21+FB323_21*s->l[2][23];
  CM223_21 = CM224_21-s->In[2][23]*S22+s->In[5][23]*OpM223_21+s->In[6][23]*OpM323_21-FB323_21*s->l[1][23];
  CM323_21 = -(s->In[3][23]*S22-s->In[6][23]*OpM223_21-s->In[9][23]*OpM323_21+CM124_21*S24-CM324_21*C24+FB123_21*
 s->l[2][23]-FB223_21*s->l[1][23]+s->dpt[2][50]*(FM124_21*C24+FM324_21*S24));
  FB323_22 = -s->m[23]*s->l[1][23]*C23;
  CM123_22 = s->In[2][23]*C23-s->In[3][23]*S23+CM124_22*C24+CM324_22*S24+FB323_22*s->l[2][23]-s->dpt[2][50]*(FM124_22*
 S24-FM324_22*C24);
  CM123_23 = s->In[1][23]+s->m[23]*s->l[2][23]*s->l[2][23]+s->dpt[2][50]*(C24*(FB324_23+FM325_23)-S24*(FB124_23+FM125_23
 *C25-FM225_23*S25))+C24*(s->In[1][24]*C24+s->In[3][24]*S24+CM125_23*C25-CM225_23*S25-FB224_23*s->l[3][24]+FB324_23*
 s->l[2][24]+FM325_23*s->dpt[2][52])+S24*(CM325_23+s->In[3][24]*C24+s->In[9][24]*S24-FB124_23*s->l[2][24]+FB224_23*
 s->l[1][24]-s->dpt[2][52]*(FM125_23*C25-FM225_23*S25));
 ...
 OM222)));
  ...
  CF122 = -(s->trq[1][22]-CF123-s->In[1][22]*OpF122-s->In[2][22]*OpF221-s->In[3][22]*OpF322+FA222*s->l[3][22]-FA322*
 s->l[2][22]-OM222*(s->In[3][22]*OM122+s->In[6][22]*OM222+s->In[9][22]*OM322)+OM322*(s->In[2][22]*OM122+s->In[5][22]*OM222+
 s->In[6][22]*OM322)-s->dpt[2][48]*(FF223*S23+FF323*C23));
  CF222 = -(s->trq[2][22]-s->In[2][22]*OpF122-s->In[5][22]*OpF221-s->In[6][22]*OpF322-CF223*C23+CF323*S23-FA122*
 s->l[3][22]+FA322*s->l[1][22]+OM122*(s->In[3][22]*OM122+s->In[6][22]*OM222+s->In[9][22]*OM322)-OM322*(s->In[1][22]*OM122+
 s->In[2][22]*OM222+s->In[3][22]*OM322));
  CF322 = -(s->trq[3][22]-s->In[3][22]*OpF122-s->In[6][22]*OpF221-s->In[9][22]*OpF322-CF223*S23-CF323*C23+FA122*
 s->l[2][22]-FA222*s->l[1][22]+FF123*s->dpt[2][48]-OM122*(s->In[2][22]*OM122+s->In[5][22]*OM222+s->In[6][22]*OM322)+OM222*(
 s->In[1][22]*OM122+s->In[2][22]*OM222+s->In[3][22]*OM322));
  ...
  CM122_1 = CM123_1-FB222_1*s->l[3][22]+FB322_1*s->l[2][22]+s->dpt[2][48]*(FM223_1*S23+FM323_1*C23);
  CM222_1 = CM223_1*C23-CM323_1*S23+FB122_1*s->l[3][22]-FB322_1*s->l[1][22];
  CM322_1 = CM223_1*S23+CM323_1*C23-FB122_1*s->l[2][22]+FB222_1*s->l[1][22]-FM123_1*s->dpt[2][48];
  ...
  CM122_2 = CM123_2-FB222_2*s->l[3][22]+FB322_2*s->l[2][22]+s->dpt[2][48]*(FM223_2*S23+FM323_2*C23);
  CM222_2 = CM223_2*C23-CM323_2*S23+FB122_2*s->l[3][22]-FB322_2*s->l[1][22];
  CM322_2 = CM223_2*S23+CM323_2*C23-FB122_2*s->l[2][22]+FB222_2*s->l[1][22]-FM123_2*s->dpt[2][48];
  ...
  CM122_3 = CM123_3-FB222_3*s->l[3][22]+FB322_3*s->l[2][22]+s->dpt[2][48]*(FM223_3*S23+FM323_3*C23);
  CM222_3 = CM223_3*C23-CM323_3*S23+FB122_3*s->l[3][22]-FB322_3*s->l[1][22];
  CM322_3 = CM223_3*S23+CM323_3*C23-FB122_3*s->l[2][22]+FB222_3*s->l[1][22]-FM123_3*s->dpt[2][48];
  ...
  CM122_4 = CM123_4+s->In[1][22]*OpM122_4+s->In[2][22]*OpM221_4+s->In[3][22]*OpM322_4-FB222_4*s->l[3][22]+FB322_4*
 ...
 s->l[3][22]-FB322_4*s->l[1][22];
  CM322_4 = s->In[3][22]*OpM122_4+s->In[6][22]*OpM221_4+s->In[9][22]*OpM322_4+CM223_4*S23+CM323_4*C23-FB122_4*
 s->l[2][22]+FB222_4*s->l[1][22]-FM123_4*s->dpt[2][48];
  ...
  CM122_5 = CM123_5+s->In[1][22]*OpM122_5+s->In[2][22]*OpM221_5+s->In[3][22]*OpM322_5-FB222_5*s->l[3][22]+FB322_5*
 ...
 s->l[3][22]-FB322_5*s->l[1][22];
  CM322_5 = s->In[3][22]*OpM122_5+s->In[6][22]*OpM221_5+s->In[9][22]*OpM322_5+CM223_5*S23+CM323_5*C23-FB122_5*
 s->l[2][22]+FB222_5*s->l[1][22]-FM123_5*s->dpt[2][48];
  ...
  CM122_6 = CM123_6+s->In[1][22]*OpM122_6+s->In[2][22]*OpM221_6+s->In[3][22]*OpM322_6-FB222_6*s->l[3][22]+FB322_6*
 ...
 s->l[3][22]-FB322_6*s->l[1][22];
  CM322_6 = s->In[3][22]*OpM122_6+s->In[6][22]*OpM221_6+s->In[9][22]*OpM322_6+CM223_6*S23+CM323_6*C23-FB122_6*
 s->l[2][22]+FB222_6*s->l[1][22]-FM123_6*s->dpt[2][48];
  ...
  CM122_19 = CM123_19+s->In[1][22]*OpM122_19+s->In[2][22]*OpM221_19+s->In[3][22]*OpM322_19-FB222_19*s->l[3][22]+FB322_19
 *s->l[2][22]+s->dpt[2][48]*(FM223_19*S23+FM323_19*C23);
 ...
 s->l[3][22]-FB322_19*s->l[1][22];
  CM322_19 = s->In[3][22]*OpM122_19+s->In[6][22]*OpM221_19+s->In[9][22]*OpM322_19+CM223_19*S23+CM323_19*C23-FB122_19*
 s->l[2][22]+FB222_19*s->l[1][22]-FM123_19*s->dpt[2][48];
  ...
  CM122_20 = CM123_20+s->In[1][22]*OpM122_20+s->In[2][22]*C21+s->In[3][22]*OpM322_20-FB222_20*s->l[3][22]+FB322_20*
 s->l[2][22]+s->dpt[2][48]*(FM223_20*S23+FM323_20*C23);
 ...
 s->l[3][22]-FB322_20*s->l[1][22];
  CM322_20 = s->In[3][22]*OpM122_20+s->In[6][22]*C21+s->In[9][22]*OpM322_20+CM223_20*S23+CM323_20*C23-FB122_20*
 s->l[2][22]+FB222_20*s->l[1][22]-FM123_20*s->dpt[2][48];
  ...
  FB322_21 = -s->m[22]*S22*(s->dpt[2][44]+s->l[2][22]);
 ...
 C23-s->In[6][23]*S23-FB323_22*s->l[1][23])-S23*(s->In[6][23]*C23-s->In[9][23]*S23-s->m[23]*s->l[1][23]*s->l[1][23]*S23-
 s->m[23]*s->l[2][23]*s->l[2][23]*S23-CM124_22*S24+CM324_22*C24-s->dpt[2][50]*(FM124_22*C24+FM324_22*S24));
...
// Backward Dynamics 
 ...
 s->In[5][35]));
  ...
  FF333 = FA333+FF334;
  CF133 = -(s->trq[1][33]-s->In[1][33]*OpF133-CF134*C34+CF234*S34-FA333*s->l[2][33]-FF334*s->dpt[2][66]+OM233*OM333*(
 s->In[5][33]-s->In[9][33]));
 ...
 s->dpt[2][66]*(FF134*C34-FF234*S34));
  ...
  CM133_1 = FB333_1*s->l[2][33]+FM334_1*s->dpt[2][66];
  CM333_1 = -(FB133_1*s->l[2][33]+s->dpt[2][66]*(FM134_1*C34-FM234_1*S34));
  ...
  CM133_2 = FB333_2*s->l[2][33]+FM334_2*s->dpt[2][66];
  CM333_2 = -(FB133_2*s->l[2][33]+s->dpt[2][66]*(FM134_2*C34-FM234_2*S34));
  ...
  CM133_3 = FB333_3*s->l[2][33]+FM334_3*s->dpt[2][66];
  CM333_3 = -(FB133_3*s->l[2][33]+s->dpt[2][66]*(FM134_3*C34-FM234_3*S34));
  ...
  CM133_4 = s->In[1][33]*OpM133_4+CM134_4*C34-CM234_4*S34+FB333_4*s->l[2][33]+FM334_4*s->dpt[2][66];
  CM233_4 = s->In[5][33]*OpM232_4+CM134_4*S34+CM234_4*C34;
  CM333_4 = CM334_4+s->In[9][33]*OpM333_4-FB133_4*s->l[2][33]-s->dpt[2][66]*(FM134_4*C34-FM234_4*S34);
  ...
  CM133_5 = s->In[1][33]*OpM133_5+CM134_5*C34-CM234_5*S34+FB333_5*s->l[2][33]+FM334_5*s->dpt[2][66];
  CM233_5 = s->In[5][33]*OpM232_5+CM134_5*S34+CM234_5*C34;
  CM333_5 = CM334_5+s->In[9][33]*OpM333_5-FB133_5*s->l[2][33]-s->dpt[2][66]*(FM134_5*C34-FM234_5*S34);
  ...
  CM133_6 = s->In[1][33]*OpM133_6+CM134_6*C34-CM234_6*S34+FB333_6*s->l[2][33]+FM334_6*s->dpt[2][66];
  CM233_6 = s->In[5][33]*OpM232_6+CM134_6*S34+CM234_6*C34;
  CM333_6 = CM334_6+s->In[9][33]*OpM333_6-FB133_6*s->l[2][33]-s->dpt[2][66]*(FM134_6*C34-FM234_6*S34);
  ...
  CM133_19 = s->In[1][33]*OpM133_19+CM134_19*C34-CM234_19*S34+FB333_19*s->l[2][33]+FM334_19*s->dpt[2][66];
  CM233_19 = s->In[5][33]*OpM232_19+CM134_19*S34+CM234_19*C34;
  CM333_19 = CM334_19+s->In[9][33]*OpM333_19-FB133_19*s->l[2][33]-s->dpt[2][66]*(FM134_19*C34-FM234_19*S34);
  ...
  CM133_20 = s->In[1][33]*OpM133_20+CM134_20*C34-CM234_20*S34+FB333_20*s->l[2][33]+FM334_20*s->dpt[2][66];
  CM233_20 = s->In[5][33]*OpM232_20+CM134_20*S34+CM234_20*C34;
  CM333_20 = CM334_20+s->In[9][33]*OpM333_20-FB133_20*s->l[2][33]-s->dpt[2][66]*(FM134_20*C34-FM234_20*S34);
  ...
  CM133_21 = s->In[1][33]*OpM133_21+CM134_21*C34-CM234_21*S34+FB333_21*s->l[2][33]+FM334_21*s->dpt[2][66];
  CM233_21 = s->In[5][33]*OpM232_21+CM134_21*S34+CM234_21*C34;
  CM333_21 = CM334_21+s->In[9][33]*OpM333_21-FB133_21*s->l[2][33]-s->dpt[2][66]*(FM134_21*C34-FM234_21*S34);
  ...
  CM133_29 = s->In[1][33]*OpM133_29+CM134_29*C34-CM234_29*S34+FB333_29*s->l[2][33]+FM334_29*s->dpt[2][66];
  CM233_29 = s->In[5][33]*OpM232_29+CM134_29*S34+CM234_29*C34;
  CM333_29 = CM334_29+s->In[9][33]*OpM333_29-FB133_29*s->l[2][33]-s->dpt[2][66]*(FM134_29*C34-FM234_29*S34);
  ...
  CM133_30 = s->In[1][33]*OpM133_30+CM134_30*C34-CM234_30*S34+FB333_30*s->l[2][33]+FM334_30*s->dpt[2][66];
  CM233_30 = s->In[5][33]*OpM232_30+CM134_30*S34+CM234_30*C34;
  CM333_30 = CM334_30+s->In[9][33]*OpM333_30-FB133_30*s->l[2][33]-s->dpt[2][66]*(FM134_30*C34-FM234_30*S34);
  ...
  CM133_31 = s->In[1][33]*OpM133_31+CM134_31*C34-CM234_31*S34+FB333_31*s->l[2][33]+FM334_31*s->dpt[2][66];
  CM233_31 = s->In[5][33]*C32+CM134_31*S34+CM234_31*C34;
  CM333_31 = CM334_31+s->In[9][33]*OpM333_31-FB133_31*s->l[2][33]-s->dpt[2][66]*(FM134_31*C34-FM234_31*S34);
  ...
  CF132 = -(s->trq[1][32]-s->In[1][32]*OpF132-s->In[2][32]*OpF232-s->In[3][32]*OpF331-CF133*C33-CF333*S33-FA332*
 s->l[2][32]-OM232*(s->In[3][32]*OM132+s->In[6][32]*OM232+s->In[9][32]*OM332)+OM332*(s->In[2][32]*OM132+s->In[5][32]*OM232+
 s->In[6][32]*OM332));
  CF232 = -(s->trq[2][32]-CF233-s->In[2][32]*OpF132-s->In[5][32]*OpF232-s->In[6][32]*OpF331+OM132*(s->In[3][32]*OM132+
 s->In[6][32]*OM232+s->In[9][32]*OM332)-OM332*(s->In[1][32]*OM132+s->In[2][32]*OM232+s->In[3][32]*OM332)-s->dpt[1][65]*(FF133
 *S33-FF333*C33));
  CF332 = -(s->trq[3][32]-s->In[3][32]*OpF132-s->In[6][32]*OpF232-s->In[9][32]*OpF331+CF133*S33-CF333*C33+FA132*
 s->l[2][32]-FF233*s->dpt[1][65]-OM132*(s->In[2][32]*OM132+s->In[5][32]*OM232+s->In[6][32]*OM332)+OM232*(s->In[1][32]*OM132+
 s->In[2][32]*OM232+s->In[3][32]*OM332));
  ...
  CM321_233 = s->dpt[1][65]*(FM133_1*S33-FM333_1*C33);
  CM132_1 = CM133_1*C33+CM333_1*S33+FB332_1*s->l[2][32];
  CM332_1 = -(CM133_1*S33-CM333_1*C33+FB132_1*s->l[2][32]-FM233_1*s->dpt[1][65]);
  ...
  CM322_233 = s->dpt[1][65]*(FM133_2*S33-FM333_2*C33);
  CM132_2 = CM133_2*C33+CM333_2*S33+FB332_2*s->l[2][32];
  CM332_2 = -(CM133_2*S33-CM333_2*C33+FB132_2*s->l[2][32]-FM233_2*s->dpt[1][65]);
  ...
  CM323_233 = s->dpt[1][65]*(FM133_3*S33-FM333_3*C33);
  CM132_3 = CM133_3*C33+CM333_3*S33+FB332_3*s->l[2][32];
  CM332_3 = -(CM133_3*S33-CM333_3*C33+FB132_3*s->l[2][32]-FM233_3*s->dpt[1][65]);
  ...
  CM132_4 = s->In[1][32]*OpM132_4+s->In[2][32]*OpM232_4+s->In[3][32]*OpM331_4+CM133_4*C33+CM333_4*S33+FB332_4*
 s->l[2][32];
  CM232_4 = CM233_4+s->In[2][32]*OpM132_4+s->In[5][32]*OpM232_4+s->In[6][32]*OpM331_4+s->dpt[1][65]*(FM133_4*S33-FM333_4
 *C33);
  CM332_4 = s->In[3][32]*OpM132_4+s->In[6][32]*OpM232_4+s->In[9][32]*OpM331_4-CM133_4*S33+CM333_4*C33-FB132_4*
 s->l[2][32]+FM233_4*s->dpt[1][65];
  ...
  CM132_5 = s->In[1][32]*OpM132_5+s->In[2][32]*OpM232_5+s->In[3][32]*OpM331_5+CM133_5*C33+CM333_5*S33+FB332_5*
 s->l[2][32];
  CM232_5 = CM233_5+s->In[2][32]*OpM132_5+s->In[5][32]*OpM232_5+s->In[6][32]*OpM331_5+s->dpt[1][65]*(FM133_5*S33-FM333_5
 *C33);
  CM332_5 = s->In[3][32]*OpM132_5+s->In[6][32]*OpM232_5+s->In[9][32]*OpM331_5-CM133_5*S33+CM333_5*C33-FB132_5*
 s->l[2][32]+FM233_5*s->dpt[1][65];
  ...
  CM132_6 = s->In[1][32]*OpM132_6+s->In[2][32]*OpM232_6+s->In[3][32]*OpM331_6+CM133_6*C33+CM333_6*S33+FB332_6*
 s->l[2][32];
  CM232_6 = CM233_6+s->In[2][32]*OpM132_6+s->In[5][32]*OpM232_6+s->In[6][32]*OpM331_6+s->dpt[1][65]*(FM133_6*S33-FM333_6
 *C33);
  CM332_6 = s->In[3][32]*OpM132_6+s->In[6][32]*OpM232_6+s->In[9][32]*OpM331_6-CM133_6*S33+CM333_6*C33-FB132_6*
 s->l[2][32]+FM233_6*s->dpt[1][65];
  ...
  CM132_19 = s->In[1][32]*OpM132_19+s->In[2][32]*OpM232_19+s->In[3][32]*OpM331_19+CM133_19*C33+CM333_19*S33+FB332_19*
 s->l[2][32];
  CM232_19 = CM233_19+s->In[2][32]*OpM132_19+s->In[5][32]*OpM232_19+s->In[6][32]*OpM331_19+s->dpt[1][65]*(FM133_19*S33-
 FM333_19*C33);
  CM332_19 = s->In[3][32]*OpM132_19+s->In[6][32]*OpM232_19+s->In[9][32]*OpM331_19-CM133_19*S33+CM333_19*C33-FB132_19*
 s->l[2][32]+FM233_19*s->dpt[1][65];
  ...
  CM132_20 = s->In[1][32]*OpM132_20+s->In[2][32]*OpM232_20+s->In[3][32]*OpM331_20+CM133_20*C33+CM333_20*S33+FB332_20*
 s->l[2][32];
  CM232_20 = CM233_20+s->In[2][32]*OpM132_20+s->In[5][32]*OpM232_20+s->In[6][32]*OpM331_20+s->dpt[1][65]*(FM133_20*S33-
 FM333_20*C33);
  CM332_20 = s->In[3][32]*OpM132_20+s->In[6][32]*OpM232_20+s->In[9][32]*OpM331_20-CM133_20*S33+CM333_20*C33-FB132_20*
 s->l[2][32]+FM233_20*s->dpt[1][65];
  ...
  CM132_21 = s->In[1][32]*OpM132_21+s->In[2][32]*OpM232_21+s->In[3][32]*OpM331_21+CM133_21*C33+CM333_21*S33+FB332_21*
 s->l[2][32];
  CM232_21 = CM233_21+s->In[2][32]*OpM132_21+s->In[5][32]*OpM232_21+s->In[6][32]*OpM331_21+s->dpt[1][65]*(FM133_21*S33-
 FM333_21*C33);
  CM332_21 = s->In[3][32]*OpM132_21+s->In[6][32]*OpM232_21+s->In[9][32]*OpM331_21-CM133_21*S33+CM333_21*C33-FB132_21*
 s->l[2][32]+FM233_21*s->dpt[1][65];
  ...
  CM132_29 = s->In[1][32]*OpM132_29+s->In[2][32]*OpM232_29+s->In[3][32]*OpM331_29+CM133_29*C33+CM333_29*S33+FB332_29*
 s->l[2][32];
  CM232_29 = CM233_29+s->In[2][32]*OpM132_29+s->In[5][32]*OpM232_29+s->In[6][32]*OpM331_29+s->dpt[1][65]*(FM133_29*S33-
 FM333_29*C33);
  CM332_29 = s->In[3][32]*OpM132_29+s->In[6][32]*OpM232_29+s->In[9][32]*OpM331_29-CM133_29*S33+CM333_29*C33-FB132_29*
 s->l[2][32]+FM233_29*s->dpt[1][65];
  ...
  CM132_30 = s->In[1][32]*OpM132_30+s->In[2][32]*OpM232_30+s->In[3][32]*S31+CM133_30*C33+CM333_30*S33+FB332_30*
 s->l[2][32];
  CM232_30 = CM233_30+s->In[2][32]*OpM132_30+s->In[5][32]*OpM232_30+s->In[6][32]*S31+s->dpt[1][65]*(FM133_30*S33-
 FM333_30*C33);
  CM332_30 = s->In[3][32]*OpM132_30+s->In[6][32]*OpM232_30+s->In[9][32]*S31-CM133_30*S33+CM333_30*C33-FB132_30*
 s->l[2][32]+FM233_30*s->dpt[1][65];
  FB332_31 = -s->m[32]*(s->dpt[1][63]-s->l[2][32]*S32);
  CM332_31 = s->In[3][32]*S32+s->In[6][32]*C32-CM133_31*S33+CM333_31*C33+s->dpt[1][65]*(FM134_31*S34+FM234_31*C34);
  CM332_32 = s->In[9][32]+s->m[32]*s->l[2][32]*s->l[2][32]+s->dpt[1][65]*(s->m[33]*s->dpt[1][65]+FM134_32*S34+FM234_32*
 C34)+C33*(CM334_32+s->In[9][33]*C33+s->m[33]*s->l[2][33]*s->l[2][33]*C33-s->dpt[2][66]*(FM134_32*C34-FM234_32*S34))-S33*(
 CM134_32*C34-CM234_32*S34+s->dpt[2][66]*(s->m[34]*AlM334_32+FB235_32*S35+FB335_32*C35)-S33*(s->In[1][33]+s->m[33]*
 s->l[2][33]*s->l[2][33]));
  ...
  FF331 = FA331+FF332;
  CF131 = -(s->trq[1][31]-s->In[1][31]*OpF131-s->In[2][31]*OpF230-s->In[3][31]*OpF331-CF132*C32+CF232*S32+FA231*
 s->l[3][31]-FA331*s->l[2][31]-FF332*s->dpt[2][63]-OM231*(s->In[3][31]*OM131+s->In[6][31]*OM231+s->In[9][31]*OM331)+OM331*(
 s->In[2][31]*OM131+s->In[5][31]*OM231+s->In[6][31]*OM331));
  CF231 = -(s->trq[2][31]-s->In[2][31]*OpF131-s->In[5][31]*OpF230-s->In[6][31]*OpF331-CF132*S32-CF232*C32-FA131*
 s->l[3][31]+FA331*s->l[1][31]+FF332*s->dpt[1][63]+OM131*(s->In[3][31]*OM131+s->In[6][31]*OM231+s->In[9][31]*OM331)-OM331*(
 ...
 s->In[3][31]*OM331)-s->dpt[1][63]*(FF132*S32+FF232*C32)+s->dpt[2][63]*(FF132*C32-FF232*S32));
  ...
  CM131_1 = CM132_1*C32-CM321_233*S32-FB231_1*s->l[3][31]+FB331_1*s->l[2][31]+FM332_1*s->dpt[2][63];
  CM231_1 = CM132_1*S32+CM321_233*C32+FB131_1*s->l[3][31]-FB331_1*s->l[1][31]-FM332_1*s->dpt[1][63];
 ...
 FM132_1*C32-FM232_1*S32);
  ...
  CM131_2 = CM132_2*C32-CM322_233*S32-FB231_2*s->l[3][31]+FB331_2*s->l[2][31]+FM332_2*s->dpt[2][63];
  CM231_2 = CM132_2*S32+CM322_233*C32+FB131_2*s->l[3][31]-FB331_2*s->l[1][31]-FM332_2*s->dpt[1][63];
 ...
 FM132_2*C32-FM232_2*S32);
  ...
  CM131_3 = CM132_3*C32-CM323_233*S32-FB231_3*s->l[3][31]+FB331_3*s->l[2][31]+FM332_3*s->dpt[2][63];
  CM231_3 = CM132_3*S32+CM323_233*C32+FB131_3*s->l[3][31]-FB331_3*s->l[1][31]-FM332_3*s->dpt[1][63];
 ...
 FM132_3*C32-FM232_3*S32);
  ...
  CM131_4 = s->In[1][31]*OpM131_4+s->In[2][31]*OpM230_4+s->In[3][31]*OpM331_4+CM132_4*C32-CM232_4*S32-FB231_4*
 s->l[3][31]+FB331_4*s->l[2][31]+FM332_4*s->dpt[2][63];
  CM231_4 = s->In[2][31]*OpM131_4+s->In[5][31]*OpM230_4+s->In[6][31]*OpM331_4+CM132_4*S32+CM232_4*C32+FB131_4*
 ...
 s->l[1][31]+s->dpt[1][63]*(FM132_4*S32+FM232_4*C32)-s->dpt[2][63]*(FM132_4*C32-FM232_4*S32);
  ...
  CM131_5 = s->In[1][31]*OpM131_5+s->In[2][31]*OpM230_5+s->In[3][31]*OpM331_5+CM132_5*C32-CM232_5*S32-FB231_5*
 s->l[3][31]+FB331_5*s->l[2][31]+FM332_5*s->dpt[2][63];
  CM231_5 = s->In[2][31]*OpM131_5+s->In[5][31]*OpM230_5+s->In[6][31]*OpM331_5+CM132_5*S32+CM232_5*C32+FB131_5*
 ...
 s->l[1][31]+s->dpt[1][63]*(FM132_5*S32+FM232_5*C32)-s->dpt[2][63]*(FM132_5*C32-FM232_5*S32);
  ...
  CM131_6 = s->In[1][31]*OpM131_6+s->In[2][31]*OpM230_6+s->In[3][31]*OpM331_6+CM132_6*C32-CM232_6*S32-FB231_6*
 s->l[3][31]+FB331_6*s->l[2][31]+FM332_6*s->dpt[2][63];
  CM231_6 = s->In[2][31]*OpM131_6+s->In[5][31]*OpM230_6+s->In[6][31]*OpM331_6+CM132_6*S32+CM232_6*C32+FB131_6*
 ...
 s->l[1][31]+s->dpt[1][63]*(FM132_6*S32+FM232_6*C32)-s->dpt[2][63]*(FM132_6*C32-FM232_6*S32);
  ...
  CM131_19 = s->In[1][31]*OpM131_19+s->In[2][31]*OpM230_19+s->In[3][31]*OpM331_19+CM132_19*C32-CM232_19*S32-FB231_19*
 s->l[3][31]+FB331_19*s->l[2][31]+FM332_19*s->dpt[2][63];
  CM231_19 = s->In[2][31]*OpM131_19+s->In[5][31]*OpM230_19+s->In[6][31]*OpM331_19+CM132_19*S32+CM232_19*C32+FB131_19*
 s->l[3][31]-FB331_19*s->l[1][31]-FM332_19*s->dpt[1][63];
 ...
 *s->l[1][31]+s->dpt[1][63]*(FM132_19*S32+FM232_19*C32)-s->dpt[2][63]*(FM132_19*C32-FM232_19*S32);
  ...
  CM131_20 = s->In[1][31]*OpM131_20+s->In[2][31]*OpM230_20+s->In[3][31]*OpM331_20+CM132_20*C32-CM232_20*S32-FB231_20*
 s->l[3][31]+FB331_20*s->l[2][31]+FM332_20*s->dpt[2][63];
  CM231_20 = s->In[2][31]*OpM131_20+s->In[5][31]*OpM230_20+s->In[6][31]*OpM331_20+CM132_20*S32+CM232_20*C32+FB131_20*
 s->l[3][31]-FB331_20*s->l[1][31]-FM332_20*s->dpt[1][63];
 ...
 *s->l[1][31]+s->dpt[1][63]*(FM132_20*S32+FM232_20*C32)-s->dpt[2][63]*(FM132_20*C32-FM232_20*S32);
  ...
  CM131_21 = s->In[1][31]*OpM131_21+s->In[2][31]*OpM230_21+s->In[3][31]*OpM331_21+CM132_21*C32-CM232_21*S32-FB231_21*
 s->l[3][31]+FB331_21*s->l[2][31]+FM332_21*s->dpt[2][63];
  CM231_21 = s->In[2][31]*OpM131_21+s->In[5][31]*OpM230_21+s->In[6][31]*OpM331_21+CM132_21*S32+CM232_21*C32+FB131_21*
 s->l[3][31]-FB331_21*s->l[1][31]-FM332_21*s->dpt[1][63];
 ...
 *s->l[1][31]+s->dpt[1][63]*(FM132_21*S32+FM232_21*C32)-s->dpt[2][63]*(FM132_21*C32-FM232_21*S32);
  ...
  CM131_29 = s->In[1][31]*OpM131_29+s->In[2][31]*C30+s->In[3][31]*OpM331_29+CM132_29*C32-CM232_29*S32-FB231_29*
 s->l[3][31]+FB331_29*s->l[2][31]+FM332_29*s->dpt[2][63];
  CM231_29 = s->In[2][31]*OpM131_29+s->In[5][31]*C30+s->In[6][31]*OpM331_29+CM132_29*S32+CM232_29*C32+FB131_29*
 ...
 s->l[1][31]+s->dpt[1][63]*(FM132_29*S32+FM232_29*C32)-s->dpt[2][63]*(FM132_29*C32-FM232_29*S32);
  FB131_30 = -s->m[31]*S31*(s->dpt[2][61]+s->l[2][31]);
  FB231_30 = s->m[31]*(s->l[1][31]*S31-s->l[3][31]*C31);
  FB331_30 = s->m[31]*C31*(s->dpt[2][61]+s->l[2][31]);
  CM231_30 = s->In[2][31]*C31+s->In[6][31]*S31+CM132_30*S32+CM232_30*C32+FB131_30*s->l[3][31]-FB331_30*s->l[1][31]-
 FM332_30*s->dpt[1][63];
  CM231_31 = s->In[5][31]+s->m[31]*s->l[1][31]*s->l[1][31]+s->m[31]*s->l[3][31]*s->l[3][31]-s->dpt[1][63]*(FB332_31-
 FM133_31*S33+FM333_31*C33)+C32*(CM233_31+s->In[2][32]*S32+s->In[5][32]*C32+s->dpt[1][65]*(FM133_31*S33-FM333_31*C33))+S32*(
 s->In[1][32]*S32+s->In[2][32]*C32+CM133_31*C33+CM333_31*S33+FB332_31*s->l[2][32]);
 ...
 OM230)));
  ...
  CF130 = -(s->trq[1][30]-s->In[1][30]*OpF129-s->In[2][30]*OpF230-s->In[3][30]*OpF330-CF131*C31-CF331*S31+FA230*
 s->l[3][30]-FA330*s->l[2][30]-OM230*(s->In[3][30]*OM130+s->In[6][30]*OM230+s->In[9][30]*OM330)+OM330*(s->In[2][30]*OM130+
 s->In[5][30]*OM230+s->In[6][30]*OM330)+s->dpt[2][61]*(FF131*S31-FF331*C31));
  CF230 = -(s->trq[2][30]-CF231-s->In[2][30]*OpF129-s->In[5][30]*OpF230-s->In[6][30]*OpF330-FA130*s->l[3][30]+FA330*
 s->l[1][30]+OM130*(s->In[3][30]*OM130+s->In[6][30]*OM230+s->In[9][30]*OM330)-OM330*(s->In[1][30]*OM130+s->In[2][30]*OM230+
 s->In[3][30]*OM330));
  CF330 = -(s->trq[3][30]-s->In[3][30]*OpF129-s->In[6][30]*OpF230-s->In[9][30]*OpF330+CF131*S31-CF331*C31+FA130*
 s->l[2][30]-FA230*s->l[1][30]-OM130*(s->In[2][30]*OM130+s->In[5][30]*OM230+s->In[6][30]*OM330)+OM230*(s->In[1][30]*OM130+
 s->In[2][30]*OM230+s->In[3][30]*OM330)+s->dpt[2][61]*(FF131*C31+FF331*S31));
  ...
  CM130_1 = CM131_1*C31+CM331_1*S31-FB230_1*s->l[3][30]+FB330_1*s->l[2][30]-s->dpt[2][61]*(FM131_1*S31-FM331_1*C31);
  CM230_1 = CM231_1+FB130_1*s->l[3][30]-FB330_1*s->l[1][30];
  CM330_1 = -(CM131_1*S31-CM331_1*C31+FB130_1*s->l[2][30]-FB230_1*s->l[1][30]+s->dpt[2][61]*(FM131_1*C31+FM331_1*S31));
  ...
  CM130_2 = CM131_2*C31+CM331_2*S31-FB230_2*s->l[3][30]+FB330_2*s->l[2][30]-s->dpt[2][61]*(FM131_2*S31-FM331_2*C31);
  CM230_2 = CM231_2+FB130_2*s->l[3][30]-FB330_2*s->l[1][30];
  CM330_2 = -(CM131_2*S31-CM331_2*C31+FB130_2*s->l[2][30]-FB230_2*s->l[1][30]+s->dpt[2][61]*(FM131_2*C31+FM331_2*S31));
  ...
  CM130_3 = CM131_3*C31+CM331_3*S31-FB230_3*s->l[3][30]+FB330_3*s->l[2][30]-s->dpt[2][61]*(FM131_3*S31-FM331_3*C31);
  CM230_3 = CM231_3+FB130_3*s->l[3][30]-FB330_3*s->l[1][30];
  CM330_3 = -(CM131_3*S31-CM331_3*C31+FB130_3*s->l[2][30]-FB230_3*s->l[1][30]+s->dpt[2][61]*(FM131_3*C31+FM331_3*S31));
  ...
  CM130_4 = s->In[1][30]*OpM129_4+s->In[2][30]*OpM230_4+s->In[3][30]*OpM330_4+CM131_4*C31+CM331_4*S31-FB230_4*
 s->l[3][30]+FB330_4*s->l[2][30]-s->dpt[2][61]*(FM131_4*S31-FM331_4*C31);
  CM230_4 = CM231_4+s->In[2][30]*OpM129_4+s->In[5][30]*OpM230_4+s->In[6][30]*OpM330_4+FB130_4*s->l[3][30]-FB330_4*
 s->l[1][30];
  CM330_4 = s->In[3][30]*OpM129_4+s->In[6][30]*OpM230_4+s->In[9][30]*OpM330_4-CM131_4*S31+CM331_4*C31-FB130_4*
 s->l[2][30]+FB230_4*s->l[1][30]-s->dpt[2][61]*(FM131_4*C31+FM331_4*S31);
  ...
  CM130_5 = s->In[1][30]*OpM129_5+s->In[2][30]*OpM230_5+s->In[3][30]*OpM330_5+CM131_5*C31+CM331_5*S31-FB230_5*
 s->l[3][30]+FB330_5*s->l[2][30]-s->dpt[2][61]*(FM131_5*S31-FM331_5*C31);
  CM230_5 = CM231_5+s->In[2][30]*OpM129_5+s->In[5][30]*OpM230_5+s->In[6][30]*OpM330_5+FB130_5*s->l[3][30]-FB330_5*
 s->l[1][30];
  CM330_5 = s->In[3][30]*OpM129_5+s->In[6][30]*OpM230_5+s->In[9][30]*OpM330_5-CM131_5*S31+CM331_5*C31-FB130_5*
 s->l[2][30]+FB230_5*s->l[1][30]-s->dpt[2][61]*(FM131_5*C31+FM331_5*S31);
  ...
  CM130_6 = s->In[1][30]*OpM129_6+s->In[2][30]*OpM230_6+s->In[3][30]*OpM330_6+CM131_6*C31+CM331_6*S31-FB230_6*
 s->l[3][30]+FB330_6*s->l[2][30]-s->dpt[2][61]*(FM131_6*S31-FM331_6*C31);
  CM230_6 = CM231_6+s->In[2][30]*OpM129_6+s->In[5][30]*OpM230_6+s->In[6][30]*OpM330_6+FB130_6*s->l[3][30]-FB330_6*
 s->l[1][30];
  CM330_6 = s->In[3][30]*OpM129_6+s->In[6][30]*OpM230_6+s->In[9][30]*OpM330_6-CM131_6*S31+CM331_6*C31-FB130_6*
 s->l[2][30]+FB230_6*s->l[1][30]-s->dpt[2][61]*(FM131_6*C31+FM331_6*S31);
  ...
  CM130_19 = s->In[1][30]*OpM129_19+s->In[2][30]*OpM230_19+s->In[3][30]*OpM330_19+CM131_19*C31+CM331_19*S31-FB230_19*
 s->l[3][30]+FB330_19*s->l[2][30]-s->dpt[2][61]*(FM131_19*S31-FM331_19*C31);
  CM230_19 = CM231_19+s->In[2][30]*OpM129_19+s->In[5][30]*OpM230_19+s->In[6][30]*OpM330_19+FB130_19*s->l[3][30]-FB330_19
 *s->l[1][30];
  CM330_19 = s->In[3][30]*OpM129_19+s->In[6][30]*OpM230_19+s->In[9][30]*OpM330_19-CM131_19*S31+CM331_19*C31-FB130_19*
 s->l[2][30]+FB230_19*s->l[1][30]-s->dpt[2][61]*(FM131_19*C31+FM331_19*S31);
  ...
  CM130_20 = s->In[1][30]*OpM129_20+s->In[2][30]*OpM230_20+s->In[3][30]*OpM330_20+CM131_20*C31+CM331_20*S31-FB230_20*
 s->l[3][30]+FB330_20*s->l[2][30]-s->dpt[2][61]*(FM131_20*S31-FM331_20*C31);
  CM230_20 = CM231_20+s->In[2][30]*OpM129_20+s->In[5][30]*OpM230_20+s->In[6][30]*OpM330_20+FB130_20*s->l[3][30]-FB330_20
 *s->l[1][30];
  CM330_20 = s->In[3][30]*OpM129_20+s->In[6][30]*OpM230_20+s->In[9][30]*OpM330_20-CM131_20*S31+CM331_20*C31-FB130_20*
 s->l[2][30]+FB230_20*s->l[1][30]-s->dpt[2][61]*(FM131_20*C31+FM331_20*S31);
  ...
  CM130_21 = CM131_21*C31+CM331_21*S31-s->dpt[2][61]*(FM131_21*S31-FM331_21*C31)-s->In[1][30]*S29+s->In[2][30]*OpM230_21
 +s->In[3][30]*OpM330_21-FB230_21*s->l[3][30]+FB330_21*s->l[2][30];
  CM230_21 = CM231_21-s->In[2][30]*S29+s->In[5][30]*OpM230_21+s->In[6][30]*OpM330_21+FB130_21*s->l[3][30]-FB330_21*
 s->l[1][30];
  CM330_21 = -(s->In[3][30]*S29-s->In[6][30]*OpM230_21-s->In[9][30]*OpM330_21+CM131_21*S31-CM331_21*C31+FB130_21*
 s->l[2][30]-FB230_21*s->l[1][30]+s->dpt[2][61]*(FM131_21*C31+FM331_21*S31));
  FB130_29 = s->m[30]*(s->l[2][30]*S30+s->l[3][30]*C30);
  FB230_29 = -s->m[30]*s->l[1][30]*S30;
  FB330_29 = -s->m[30]*s->l[1][30]*C30;
  CM130_29 = s->In[2][30]*C30-s->In[3][30]*S30+CM131_29*C31+CM331_29*S31-FB230_29*s->l[3][30]+FB330_29*s->l[2][30]-
 s->dpt[2][61]*(FM131_29*S31-FM331_29*C31);
  CM130_30 = s->In[1][30]+s->m[30]*s->l[2][30]*s->l[2][30]+s->m[30]*s->l[3][30]*s->l[3][30]+s->dpt[2][61]*(C31*(FB331_30
 +FM332_30)-S31*(FB131_30+FM132_30*C32-FM232_30*S32))+C31*(s->In[1][31]*C31+s->In[3][31]*S31+CM132_30*C32-CM232_30*S32-
 FB231_30*s->l[3][31]+FB331_30*s->l[2][31]+FM332_30*s->dpt[2][63])+S31*(CM332_30+s->In[3][31]*C31+s->In[9][31]*S31-FB131_30*
 s->l[2][31]+FB231_30*s->l[1][31]+s->dpt[1][63]*(FM132_30*S32+FM232_30*C32)-s->dpt[2][63]*(FM132_30*C32-FM232_30*S32));
 ...
 OM229)));
  ...
  CF129 = -(s->trq[1][29]-CF130-s->In[1][29]*OpF129-s->In[2][29]*OpF221-s->In[3][29]*OpF329+FA229*s->l[3][29]-FA329*
 s->l[2][29]-OM229*(s->In[3][29]*OM129+s->In[6][29]*OM229+s->In[9][29]*OM329)+OM329*(s->In[2][29]*OM129+s->In[5][29]*OM229+
 s->In[6][29]*OM329)-s->dpt[2][59]*(FF230*S30+FF330*C30));
  CF229 = -(s->trq[2][29]-s->In[2][29]*OpF129-s->In[5][29]*OpF221-s->In[6][29]*OpF329-CF230*C30+CF330*S30-FA129*
 ...
 s->In[2][29]*OM229+s->In[3][29]*OM329));
  CF329 = -(s->trq[3][29]-s->In[3][29]*OpF129-s->In[6][29]*OpF221-s->In[9][29]*OpF329-CF230*S30-CF330*C30+FA129*
 s->l[2][29]-FA229*s->l[1][29]+FF130*s->dpt[2][59]-OM129*(s->In[2][29]*OM129+s->In[5][29]*OM229+s->In[6][29]*OM329)+OM229*(
 s->In[1][29]*OM129+s->In[2][29]*OM229+s->In[3][29]*OM329));
  ...
  CM129_1 = CM130_1-FB229_1*s->l[3][29]+FB329_1*s->l[2][29]+s->dpt[2][59]*(FM230_1*S30+FM330_1*C30);
  CM229_1 = CM230_1*C30-CM330_1*S30+FB129_1*s->l[3][29]-FB329_1*s->l[1][29];
  CM329_1 = CM230_1*S30+CM330_1*C30-FB129_1*s->l[2][29]+FB229_1*s->l[1][29]-FM130_1*s->dpt[2][59];
  ...
  CM129_2 = CM130_2-FB229_2*s->l[3][29]+FB329_2*s->l[2][29]+s->dpt[2][59]*(FM230_2*S30+FM330_2*C30);
  CM229_2 = CM230_2*C30-CM330_2*S30+FB129_2*s->l[3][29]-FB329_2*s->l[1][29];
  CM329_2 = CM230_2*S30+CM330_2*C30-FB129_2*s->l[2][29]+FB229_2*s->l[1][29]-FM130_2*s->dpt[2][59];
  ...
  CM129_3 = CM130_3-FB229_3*s->l[3][29]+FB329_3*s->l[2][29]+s->dpt[2][59]*(FM230_3*S30+FM330_3*C30);
  CM229_3 = CM230_3*C30-CM330_3*S30+FB129_3*s->l[3][29]-FB329_3*s->l[1][29];
  CM329_3 = CM230_3*S30+CM330_3*C30-FB129_3*s->l[2][29]+FB229_3*s->l[1][29]-FM130_3*s->dpt[2][59];
  ...
  CM129_4 = CM130_4+s->In[1][29]*OpM129_4+s->In[2][29]*OpM221_4+s->In[3][29]*OpM329_4-FB229_4*s->l[3][29]+FB329_4*
 s->l[2][29]+s->dpt[2][59]*(FM230_4*S30+FM330_4*C30);
  CM229_4 = s->In[2][29]*OpM129_4+s->In[5][29]*OpM221_4+s->In[6][29]*OpM329_4+CM230_4*C30-CM330_4*S30+FB129_4*
 s->l[3][29]-FB329_4*s->l[1][29];
  CM329_4 = s->In[3][29]*OpM129_4+s->In[6][29]*OpM221_4+s->In[9][29]*OpM329_4+CM230_4*S30+CM330_4*C30-FB129_4*
 s->l[2][29]+FB229_4*s->l[1][29]-FM130_4*s->dpt[2][59];
  ...
  CM129_5 = CM130_5+s->In[1][29]*OpM129_5+s->In[2][29]*OpM221_5+s->In[3][29]*OpM329_5-FB229_5*s->l[3][29]+FB329_5*
 s->l[2][29]+s->dpt[2][59]*(FM230_5*S30+FM330_5*C30);
  CM229_5 = s->In[2][29]*OpM129_5+s->In[5][29]*OpM221_5+s->In[6][29]*OpM329_5+CM230_5*C30-CM330_5*S30+FB129_5*
 s->l[3][29]-FB329_5*s->l[1][29];
  CM329_5 = s->In[3][29]*OpM129_5+s->In[6][29]*OpM221_5+s->In[9][29]*OpM329_5+CM230_5*S30+CM330_5*C30-FB129_5*
 s->l[2][29]+FB229_5*s->l[1][29]-FM130_5*s->dpt[2][59];
  ...
  CM129_6 = CM130_6+s->In[1][29]*OpM129_6+s->In[2][29]*OpM221_6+s->In[3][29]*OpM329_6-FB229_6*s->l[3][29]+FB329_6*
 s->l[2][29]+s->dpt[2][59]*(FM230_6*S30+FM330_6*C30);
  CM229_6 = s->In[2][29]*OpM129_6+s->In[5][29]*OpM221_6+s->In[6][29]*OpM329_6+CM230_6*C30-CM330_6*S30+FB129_6*
 s->l[3][29]-FB329_6*s->l[1][29];
  CM329_6 = s->In[3][29]*OpM129_6+s->In[6][29]*OpM221_6+s->In[9][29]*OpM329_6+CM230_6*S30+CM330_6*C30-FB129_6*
 s->l[2][29]+FB229_6*s->l[1][29]-FM130_6*s->dpt[2][59];
  ...
  CM129_19 = CM130_19+s->In[1][29]*OpM129_19+s->In[2][29]*OpM221_19+s->In[3][29]*OpM329_19-FB229_19*s->l[3][29]+FB329_19
 *s->l[2][29]+s->dpt[2][59]*(FM230_19*S30+FM330_19*C30);
  CM229_19 = s->In[2][29]*OpM129_19+s->In[5][29]*OpM221_19+s->In[6][29]*OpM329_19+CM230_19*C30-CM330_19*S30+FB129_19*
 s->l[3][29]-FB329_19*s->l[1][29];
  CM329_19 = s->In[3][29]*OpM129_19+s->In[6][29]*OpM221_19+s->In[9][29]*OpM329_19+CM230_19*S30+CM330_19*C30-FB129_19*
 s->l[2][29]+FB229_19*s->l[1][29]-FM130_19*s->dpt[2][59];
  ...
  CM129_20 = CM130_20+s->In[1][29]*OpM129_20+s->In[2][29]*C21+s->In[3][29]*OpM329_20-FB229_20*s->l[3][29]+FB329_20*
 s->l[2][29]+s->dpt[2][59]*(FM230_20*S30+FM330_20*C30);
  CM229_20 = s->In[2][29]*OpM129_20+s->In[5][29]*C21+s->In[6][29]*OpM329_20+CM230_20*C30-CM330_20*S30+FB129_20*
 s->l[3][29]-FB329_20*s->l[1][29];
  CM329_20 = s->In[3][29]*OpM129_20+s->In[6][29]*C21+s->In[9][29]*OpM329_20+CM230_20*S30+CM330_20*C30-FB129_20*
 s->l[2][29]+FB229_20*s->l[1][29]-FM130_20*s->dpt[2][59];
  ...
  FB329_21 = -s->m[29]*S29*(s->dpt[2][45]+s->l[2][29]);
  CM229_21 = CM230_21*C30-CM330_21*S30-s->In[2][29]*S29+s->In[6][29]*C29+FB129_21*s->l[3][29]-FB329_21*s->l[1][29];
  CM229_29 = s->In[5][29]+s->m[29]*s->l[1][29]*s->l[1][29]+s->m[29]*s->l[3][29]*s->l[3][29]+C30*(CM231_29+s->In[5][30]*
 C30-s->In[6][30]*S30+FB130_29*s->l[3][30]-FB330_29*s->l[1][30])-S30*(s->In[6][30]*C30-s->In[9][30]*S30-CM131_29*S31+CM331_29
 *C31-FB130_29*s->l[2][30]+FB230_29*s->l[1][30]-s->dpt[2][61]*(FM131_29*C31+FM331_29*S31));
 ...
 *s->l[1][17];
 ...
 s->In[6][16]*OM316)+s->dpt[3][28]*(FF217*C17-FF317*S17));
  CF216 = -(s->trq[2][16]-s->In[2][16]*OpF116-s->In[5][16]*OpF215-s->In[6][16]*OpF316-CF217*C17+CF317*S17-FA116*
 s->l[3][16]+FA316*s->l[1][16]-FF117*s->dpt[3][28]+OM116*(s->In[3][16]*OM116+s->In[6][16]*OM216+s->In[9][16]*OM316)-OM316*(
 ...
 *s->l[2][16]-s->dpt[3][28]*(FM217_13*C17-FM317_13*S17);
 ...
 s->l[2][16]-s->dpt[3][28]*(FM217_14*C17-FM317_14*S17);
 ...
 s->l[2][16]+FB216_14*s->l[1][16];
  ...
  CM216_15 = CM217_15*C17-CM317_15*S17+s->dpt[3][28]*(FB117_15+FB118_15*C18+FB318_15*S18)-s->In[2][16]*S16+s->In[6][16]*
 ...
 s->l[3][15]-FA315*s->l[2][15]+FF216*s->dpt[3][26]-OM215*(s->In[3][15]*OM115+s->In[6][15]*OM215+s->In[9][15]*OM315)+OM315*(
 ...
 s->In[3][15]*OM315)-s->dpt[3][26]*(FF116*C16+FF316*S16));
 ...
 s->In[2][15]*OM215+s->In[3][15]*OM315));
  ...
  CM115_1 = CM116_1*C16+CM316_1*S16-FB215_1*s->l[3][15]+FB315_1*s->l[2][15]-FM216_1*s->dpt[3][26];
  CM215_1 = CM216_1+FB115_1*s->l[3][15]-FB315_1*s->l[1][15]+s->dpt[3][26]*(FM116_1*C16+FM316_1*S16);
  ...
  CM115_2 = CM116_2*C16+CM316_2*S16-FB215_2*s->l[3][15]+FB315_2*s->l[2][15]-FM216_2*s->dpt[3][26];
  CM215_2 = CM216_2+FB115_2*s->l[3][15]-FB315_2*s->l[1][15]+s->dpt[3][26]*(FM116_2*C16+FM316_2*S16);
  ...
  CM115_3 = CM116_3*C16+CM316_3*S16-FB215_3*s->l[3][15]+FB315_3*s->l[2][15]-FM216_3*s->dpt[3][26];
  CM215_3 = CM216_3+FB115_3*s->l[3][15]-FB315_3*s->l[1][15]+s->dpt[3][26]*(FM116_3*C16+FM316_3*S16);
 ...
 s->l[1][15]+s->dpt[3][26]*(FM116_13*C16+FM316_13*S16);
 ...
 s->In[5][14]*OM214+s->In[6][14]*OM314)+s->dpt[3][24]*(FF115*S15+FF215*C15));
 ...
 s->In[2][14]*OM214+s->In[3][14]*OM314)-s->dpt[3][24]*(FF115*C15-FF215*S15));
 ...
 s->In[3][14]*OM314));
  ...
  CM114_1 = CM115_1*C15-CM215_1*S15-FB214_1*s->l[3][14]+FB314_1*s->l[2][14]-s->dpt[3][24]*(FM115_1*S15+FM215_1*C15);
  CM214_1 = CM115_1*S15+CM215_1*C15+FB114_1*s->l[3][14]-FB314_1*s->l[1][14]+s->dpt[3][24]*(FM115_1*C15-FM215_1*S15);
  ...
  CM114_2 = CM115_2*C15-CM215_2*S15-FB214_2*s->l[3][14]+FB314_2*s->l[2][14]-s->dpt[3][24]*(FM115_2*S15+FM215_2*C15);
  CM214_2 = CM115_2*S15+CM215_2*C15+FB114_2*s->l[3][14]-FB314_2*s->l[1][14]+s->dpt[3][24]*(FM115_2*C15-FM215_2*S15);
  ...
  CM114_3 = CM115_3*C15-CM215_3*S15-FB214_3*s->l[3][14]+FB314_3*s->l[2][14]-s->dpt[3][24]*(FM115_3*S15+FM215_3*C15);
  CM214_3 = CM115_3*S15+CM215_3*C15+FB114_3*s->l[3][14]-FB314_3*s->l[1][14]+s->dpt[3][24]*(FM115_3*C15-FM215_3*S15);
 ...
 s->l[3][14]+FB314_4*s->l[2][14]-s->dpt[3][24]*(FM115_4*S15+FM215_4*C15);
  CM214_4 = s->In[2][14]*OpM113_4+s->In[5][14]*OpM214_4+s->In[6][14]*OpM314_4+CM115_4*S15+CM215_4*C15+FB114_4*
 s->l[3][14]-FB314_4*s->l[1][14]+s->dpt[3][24]*(FM115_4*C15-FM215_4*S15);
 ...
 s->l[3][14]+FB314_5*s->l[2][14]-s->dpt[3][24]*(FM115_5*S15+FM215_5*C15);
  CM214_5 = s->In[2][14]*OpM113_5+s->In[5][14]*OpM214_5+s->In[6][14]*OpM314_5+CM115_5*S15+CM215_5*C15+FB114_5*
 s->l[3][14]-FB314_5*s->l[1][14]+s->dpt[3][24]*(FM115_5*C15-FM215_5*S15);
 ...
 s->l[1][14];
  ...
  CM114_6 = CM115_6*C15-CM215_6*S15-s->dpt[3][24]*(FM115_6*S15+FM215_6*C15)-s->In[1][14]*S13+s->In[2][14]*OpM214_6+
 s->In[3][14]*OpM314_6-FB214_6*s->l[3][14]+FB314_6*s->l[2][14];
  CM214_6 = CM115_6*S15+CM215_6*C15+s->dpt[3][24]*(FM115_6*C15-FM215_6*S15)-s->In[2][14]*S13+s->In[5][14]*OpM214_6+
 ...
 s->dpt[3][24]*(FM115_13*S15+FM215_13*C15);
  CM114_14 = s->In[1][14]+s->m[14]*s->l[2][14]*s->l[2][14]+s->m[14]*s->l[3][14]*s->l[3][14]-s->dpt[3][24]*(C15*(FB215_14
 +FM216_14)+S15*(FB115_14+FM116_14*C16+FM316_14*S16))+C15*(s->In[1][15]*C15-s->In[2][15]*S15+CM116_14*C16+CM316_14*S16-
 FB215_14*s->l[3][15]+FB315_14*s->l[2][15]-FM216_14*s->dpt[3][26])-S15*(CM216_14+s->In[2][15]*C15-s->In[5][15]*S15+FB115_14*
 s->l[3][15]-FB315_14*s->l[1][15]+s->dpt[3][26]*(FM116_14*C16+FM316_14*S16));
 ...
 s->In[6][13]*OM313)-s->dpt[2][22]*(FF214*S14+FF314*C14));
 ...
 s->l[2][13]-FA213*s->l[1][13]+FF114*s->dpt[2][22]-OM113*(s->In[2][13]*OM113+s->In[5][13]*OM213+s->In[6][13]*OM313)+OM213*(
 s->In[1][13]*OM113+s->In[2][13]*OM213+s->In[3][13]*OM313));
  ...
  CM113_1 = CM114_1-FB213_1*s->l[3][13]+FB313_1*s->l[2][13]+s->dpt[2][22]*(FM214_1*S14+FM314_1*C14);
  CM213_1 = CM214_1*C14-CM314_1*S14+FB113_1*s->l[3][13]-FB313_1*s->l[1][13];
  CM313_1 = CM214_1*S14+CM314_1*C14-FB113_1*s->l[2][13]+FB213_1*s->l[1][13]-FM114_1*s->dpt[2][22];
  ...
  CM113_2 = CM114_2-FB213_2*s->l[3][13]+FB313_2*s->l[2][13]+s->dpt[2][22]*(FM214_2*S14+FM314_2*C14);
  CM213_2 = CM214_2*C14-CM314_2*S14+FB113_2*s->l[3][13]-FB313_2*s->l[1][13];
  CM313_2 = CM214_2*S14+CM314_2*C14-FB113_2*s->l[2][13]+FB213_2*s->l[1][13]-FM114_2*s->dpt[2][22];
  ...
  CM113_3 = CM114_3-FB213_3*s->l[3][13]+FB313_3*s->l[2][13]+s->dpt[2][22]*(FM214_3*S14+FM314_3*C14);
  CM213_3 = CM214_3*C14-CM314_3*S14+FB113_3*s->l[3][13]-FB313_3*s->l[1][13];
  CM313_3 = CM214_3*S14+CM314_3*C14-FB113_3*s->l[2][13]+FB213_3*s->l[1][13]-FM114_3*s->dpt[2][22];
 ...
 +FB213_4*s->l[1][13]-FM114_4*s->dpt[2][22];
 ...
 s->dpt[2][22]*(FM214_5*S14+FM314_5*C14);
 ...
 s->In[6][14]*S14+CM115_13*S15+CM215_13*C15+FB114_13*s->l[3][14]-FB314_13*s->l[1][14]+s->dpt[3][24]*(FM115_13*C15-FM215_13*
 ...
 *C22+FM322_19*S22)-s->dpt[2][45]*(FM129_19*C29+FM329_19*S29);
 ...
 s->In[3][22]*S22-s->In[9][22]*C22-CM223_21*S23-CM323_21*C23+FB122_21*s->l[2][22]-FB222_21*s->l[1][22]+FM123_21*s->dpt[2][48]
 )-S22*(CM123_21-s->In[1][22]*S22+s->In[3][22]*C22-FB222_21*s->l[3][22]+FB322_21*s->l[2][22]+s->dpt[2][48]*(FM223_21*S23+
 FM323_21*C23))-C29*(s->In[3][29]*S29-s->In[9][29]*C29-CM230_21*S30-CM330_21*C30+FB129_21*s->l[2][29]-FB229_21*s->l[1][29]+
 FM130_21*s->dpt[2][59])-S29*(CM130_21-s->In[1][29]*S29+s->In[3][29]*C29-FB229_21*s->l[3][29]+FB329_21*s->l[2][29]+
 s->dpt[2][59]*(FM230_21*S30+FM330_21*C30));
 ...
 s->In[5][20]*OM220+s->In[6][20]*OM320)+s->dpt[3][40]*(FF121*S21+FF221*C21));
 ...
 s->In[2][20]*OM220+s->In[3][20]*OM320)-s->dpt[3][40]*(FF121*C21-FF221*S21));
 ...
 s->In[3][20]*OM320));
  ...
  CM120_1 = CM121_1*C21-CM221_1*S21-FB220_1*s->l[3][20]+FB320_1*s->l[2][20]-s->dpt[3][40]*(FM121_1*S21+FM221_1*C21);
  CM220_1 = CM121_1*S21+CM221_1*C21+FB120_1*s->l[3][20]-FB320_1*s->l[1][20]+s->dpt[3][40]*(FM121_1*C21-FM221_1*S21);
  ...
  CM120_2 = CM121_2*C21-CM221_2*S21-FB220_2*s->l[3][20]+FB320_2*s->l[2][20]-s->dpt[3][40]*(FM121_2*S21+FM221_2*C21);
  CM220_2 = CM121_2*S21+CM221_2*C21+FB120_2*s->l[3][20]-FB320_2*s->l[1][20]+s->dpt[3][40]*(FM121_2*C21-FM221_2*S21);
  ...
  CM120_3 = CM121_3*C21-CM221_3*S21-FB220_3*s->l[3][20]+FB320_3*s->l[2][20]-s->dpt[3][40]*(FM121_3*S21+FM221_3*C21);
  CM220_3 = CM121_3*S21+CM221_3*C21+FB120_3*s->l[3][20]-FB320_3*s->l[1][20]+s->dpt[3][40]*(FM121_3*C21-FM221_3*S21);
 ...
 s->l[3][20]+FB320_4*s->l[2][20]-s->dpt[3][40]*(FM121_4*S21+FM221_4*C21);
  CM220_4 = s->In[2][20]*OpM120_4+s->In[5][20]*OpM219_4+s->In[6][20]*OpM320_4+CM121_4*S21+CM221_4*C21+FB120_4*
 s->l[3][20]-FB320_4*s->l[1][20]+s->dpt[3][40]*(FM121_4*C21-FM221_4*S21);
 ...
 s->l[3][20]+FB320_5*s->l[2][20]-s->dpt[3][40]*(FM121_5*S21+FM221_5*C21);
  CM220_5 = s->In[2][20]*OpM120_5+s->In[5][20]*OpM219_5+s->In[6][20]*OpM320_5+CM121_5*S21+CM221_5*C21+FB120_5*
 s->l[3][20]-FB320_5*s->l[1][20]+s->dpt[3][40]*(FM121_5*C21-FM221_5*S21);
 ...
 FB320_6*s->l[2][20]-s->dpt[3][40]*(FM121_6*S21+FM221_6*C21);
  CM220_6 = s->In[2][20]*OpM120_6+s->In[5][20]*S19+s->In[6][20]*OpM320_6+CM121_6*S21+CM221_6*C21+FB120_6*s->l[3][20]-
 FB320_6*s->l[1][20]+s->dpt[3][40]*(FM121_6*C21-FM221_6*S21);
 ...
 s->dpt[3][40]*(FM121_19*C21-FM221_19*S21);
  CM220_20 = s->In[5][20]+s->m[20]*s->l[1][20]*s->l[1][20]+s->m[20]*s->l[3][20]*s->l[3][20]+s->dpt[3][40]*(C21*(FB121_20
 +FM122_20*C22+FM129_20*C29+FM322_20*S22+FM329_20*S29)-S21*(FB221_20+FM222_20+FM229_20))+C21*(CM222_20+CM229_20+s->In[2][21]*
 S21+s->In[5][21]*C21+FB121_20*s->l[3][21]-FB321_20*s->l[1][21]+s->dpt[1][44]*(FM122_20*S22-FM322_20*C22)+s->dpt[1][45]*(
 FM129_20*S29-FM329_20*C29)+s->dpt[3][44]*(FM122_20*C22+FM322_20*S22)+s->dpt[3][45]*(FM129_20*C29+FM329_20*S29))+S21*(
 s->In[1][21]*S21+s->In[2][21]*C21+CM122_20*C22+CM129_20*C29+CM322_20*S22+CM329_20*S29-FB221_20*s->l[3][21]+FB321_20*
 s->l[2][21]-FM222_20*s->dpt[3][44]-FM229_20*s->dpt[3][45]-s->dpt[2][44]*(FM122_20*S22-FM322_20*C22)-s->dpt[2][45]*(FM129_20*
 S29-FM329_20*C29));
 ...
 s->In[3][20]*S20+CM121_19*C21-CM221_19*S21-FB220_19*s->l[3][20]+FB320_19*s->l[2][20]-s->dpt[3][40]*(FM121_19*S21+FM221_19*
 ...
 *C13+FM313_5*S13);
 ...
 s->l[2][13]-FB213_6*s->l[1][13]+FM114_6*s->dpt[2][22])-S13*(CM114_6-s->In[1][13]*S13+s->In[3][13]*C13-FB213_6*s->l[3][13]+
 FB313_6*s->l[2][13]+s->dpt[2][22]*(FM214_6*S14+FM314_6*C14))+C19*(s->In[6][19]*S19+s->In[9][19]*C19-CM120_6*S20+CM320_6*C20-
