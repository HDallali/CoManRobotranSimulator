...
%
%	==> Generation Date : Thu Oct 16 13:29:34 2014
%
 ...
 *s.dpt(1,45));
  ...
  ALPHA132 = C32*(ALPHA131+BETA231*s.dpt(2,63)+BS131*s.dpt(1,63))+S32*(ALPHA231+BETA431*s.dpt(1,63)+BS531*s.dpt(2,63));
  ALPHA232 = C32*(ALPHA231+BETA431*s.dpt(1,63)+BS531*s.dpt(2,63))-S32*(ALPHA131+BETA231*s.dpt(2,63)+BS131*s.dpt(1,63));
...
% Backward Dynamics 
  ...
  Cq235 = -(s.trq(2,35)-s.In(5,35)*(C35*(OMp234+qd(35)*OM334)+S35*(OMp334-qd(35)*OM234))-OM135*OM335*(s.In(1,35)-s.In(9,35)));
  Cq335 = -(s.trq(3,35)-s.In(9,35)*(C35*(OMp334-qd(35)*OM234)-S35*(OMp234+qd(35)*OM334))+OM135*OM235*(s.In(1,35)-s.In(5,35)));
  ...
  Fq333 = Fq334+Fs333;
  Cq133 = -(s.trq(1,33)-s.In(1,33)*OMp133-Cq134*C34+Cq234*S34-Fq334*s.dpt(2,66)-Fs333*s.l(2,33)+OM233*OM333*(s.In(5,33)-s.In(9,33)));
  Cq233 = -(s.trq(2,33)-s.In(5,33)*OMp233-Cq134*S34-Cq234*C34-OM133*OM333*(s.In(1,33)-s.In(9,33)));
  Cq333 = -(s.trq(3,33)-Cq334-s.In(9,33)*OMp333+Fs133*s.l(2,33)+OM133*OM233*(s.In(1,33)-s.In(5,33))+s.dpt(2,66)*(Fq134*C34-Fq234*S34));
  ...
  Cq132 = -(s.trq(1,32)-s.In(1,32)*OMp132-s.In(2,32)*OMp232-s.In(3,32)*OMp332-Cq133*C33-Cq333*S33-Fs332*s.l(2,32)-OM232*(s.In(3,32)*OM132+...
 s.In(6,32)*OM232+s.In(9,32)*OM332)+OM332*(s.In(2,32)*OM132+s.In(5,32)*OM232+s.In(6,32)*OM332));
  Cq232 = -(s.trq(2,32)-Cq233-s.In(2,32)*OMp132-s.In(5,32)*OMp232-s.In(6,32)*OMp332+OM132*(s.In(3,32)*OM132+s.In(6,32)*OM232+s.In(9,32)*OM332)-...
 OM332*(s.In(1,32)*OM132+s.In(2,32)*OM232+s.In(3,32)*OM332)-s.dpt(1,65)*(Fq133*S33-Fq333*C33));
  Cq332 = -(s.trq(3,32)-s.In(3,32)*OMp132-s.In(6,32)*OMp232-s.In(9,32)*OMp332+Cq133*S33-Cq333*C33-Fq233*s.dpt(1,65)+Fs132*s.l(2,32)-OM132*(...
 s.In(2,32)*OM132+s.In(5,32)*OM232+s.In(6,32)*OM332)+OM232*(s.In(1,32)*OM132+s.In(2,32)*OM232+s.In(3,32)*OM332));
  ...
  Fs331 = -(s.frc(3,31)-s.m(31)*(ALPHA331+BETA731*s.l(1,31)+BETA831*s.l(2,31)-s.l(3,31)*(OM131*OM131+OM231*OM231)));
  Fq131 = Fs131+Fq132*C32-Fq232*S32;
  Fq331 = Fq332+Fs331;
  Cq131 = -(s.trq(1,31)-s.In(1,31)*OMp131-s.In(2,31)*OMp231-s.In(3,31)*OMp331-Cq132*C32+Cq232*S32-Fq332*s.dpt(2,63)+Fs231*s.l(3,31)-Fs331*...
 s.l(2,31)-OM231*(s.In(3,31)*OM131+s.In(6,31)*OM231+s.In(9,31)*OM331)+OM331*(s.In(2,31)*OM131+s.In(5,31)*OM231+s.In(6,31)*OM331));
  Cq231 = -(s.trq(2,31)-s.In(2,31)*OMp131-s.In(5,31)*OMp231-s.In(6,31)*OMp331-Cq132*S32-Cq232*C32+Fq332*s.dpt(1,63)-Fs131*s.l(3,31)+Fs331*...
 s.l(1,31)+OM131*(s.In(3,31)*OM131+s.In(6,31)*OM231+s.In(9,31)*OM331)-OM331*(s.In(1,31)*OM131+s.In(2,31)*OM231+s.In(3,31)*OM331));
 ...
 C32-Fq232*S32));
  Fs130 = -(s.frc(1,30)-s.m(30)*(ALPHA130+BETA230*s.l(2,30)-s.l(1,30)*(OM230*OM230+OM330*OM330)+s.l(3,30)*(BS330+OMp230)));
  Fs230 = -(s.frc(2,30)-s.m(30)*(ALPHA230+BS530*s.l(2,30)+s.l(1,30)*(BS230+OMp330)+s.l(3,30)*(BS630-OMp130)));
  Fs330 = -(s.frc(3,30)-s.m(30)*(ALPHA330+BETA830*s.l(2,30)+s.l(1,30)*(BS330-OMp230)-s.l(3,30)*(OM130*OM130+OM230*OM230)));
  Fq130 = Fs130+Fq131*C31+Fq331*S31;
  Fq230 = Fs230+Fs231+Fq132*S32+Fq232*C32;
  Fq330 = Fs330-Fq131*S31+Fq331*C31;
  Cq130 = -(s.trq(1,30)-s.In(1,30)*OMp130-s.In(2,30)*OMp230-s.In(3,30)*OMp330-Cq131*C31-Cq331*S31+Fs230*s.l(3,30)-Fs330*s.l(2,30)-OM230*(...
 s.In(3,30)*OM130+s.In(6,30)*OM230+s.In(9,30)*OM330)+OM330*(s.In(2,30)*OM130+s.In(5,30)*OM230+s.In(6,30)*OM330)+s.dpt(2,61)*(Fq131*S31-Fq331*C31));
  Cq230 = -(s.trq(2,30)-Cq231-s.In(2,30)*OMp130-s.In(5,30)*OMp230-s.In(6,30)*OMp330-Fs130*s.l(3,30)+Fs330*s.l(1,30)+OM130*(s.In(3,30)*OM130+...
 s.In(6,30)*OM230+s.In(9,30)*OM330)-OM330*(s.In(1,30)*OM130+s.In(2,30)*OM230+s.In(3,30)*OM330));
  Cq330 = -(s.trq(3,30)-s.In(3,30)*OMp130-s.In(6,30)*OMp230-s.In(9,30)*OMp330+Cq131*S31-Cq331*C31+Fs130*s.l(2,30)-Fs230*s.l(1,30)-OM130*(...
 s.In(2,30)*OM130+s.In(5,30)*OM230+s.In(6,30)*OM330)+OM230*(s.In(1,30)*OM130+s.In(2,30)*OM230+s.In(3,30)*OM330)+s.dpt(2,61)*(Fq131*C31+Fq331*S31));
  Fs129 = -(s.frc(1,29)-s.m(29)*(ALPHA129+BETA229*s.l(2,29)-s.l(1,29)*(OM229*OM229+OM329*OM329)+s.l(3,29)*(BS329+OMp229)));
  Fs229 = -(s.frc(2,29)-s.m(29)*(ALPHA229+BS529*s.l(2,29)+s.l(1,29)*(BS229+OMp329)+s.l(3,29)*(BS629-OMp129)));
  Fs329 = -(s.frc(3,29)-s.m(29)*(ALPHA329+BETA829*s.l(2,29)+s.l(1,29)*(BS329-OMp229)-s.l(3,29)*(OM129*OM129+OM229*OM229)));
  Fq129 = Fq130+Fs129;
  Fq229 = Fs229+Fq230*C30-Fq330*S30;
  Fq329 = Fs329+Fq230*S30+Fq330*C30;
  Cq129 = -(s.trq(1,29)-Cq130-s.In(1,29)*OMp129-s.In(2,29)*OMp229-s.In(3,29)*OMp329+Fs229*s.l(3,29)-Fs329*s.l(2,29)-OM229*(s.In(3,29)*OM129+...
 s.In(6,29)*OM229+s.In(9,29)*OM329)+OM329*(s.In(2,29)*OM129+s.In(5,29)*OM229+s.In(6,29)*OM329)-s.dpt(2,59)*(Fq230*S30+Fq330*C30));
  Cq229 = -(s.trq(2,29)-s.In(2,29)*OMp129-s.In(5,29)*OMp229-s.In(6,29)*OMp329-Cq230*C30+Cq330*S30-Fs129*s.l(3,29)+Fs329*s.l(1,29)+OM129*(...
 s.In(3,29)*OM129+s.In(6,29)*OM229+s.In(9,29)*OM329)-OM329*(s.In(1,29)*OM129+s.In(2,29)*OM229+s.In(3,29)*OM329));
  Cq329 = -(s.trq(3,29)-s.In(3,29)*OMp129-s.In(6,29)*OMp229-s.In(9,29)*OMp329-Cq230*S30-Cq330*C30+Fq130*s.dpt(2,59)+Fs129*s.l(2,29)-Fs229*...
 s.l(1,29)-OM129*(s.In(2,29)*OM129+s.In(5,29)*OM229+s.In(6,29)*OM329)+OM229*(s.In(1,29)*OM129+s.In(2,29)*OM229+s.In(3,29)*OM329));
  ...
  Cq228 = -(s.trq(2,28)-s.In(5,28)*(C28*(OMp227+qd(28)*OM327)+S28*(OMp327-qd(28)*OM227))-OM128*OM328*(s.In(1,28)-s.In(9,28)));
  Cq328 = -(s.trq(3,28)-s.In(9,28)*(C28*(OMp327-qd(28)*OM227)-S28*(OMp227+qd(28)*OM327))+OM128*OM228*(s.In(1,28)-s.In(5,28)));
  ...
  Fq326 = Fq327+Fs326;
  Cq126 = -(s.trq(1,26)-s.In(1,26)*OMp126-Cq127*C27+Cq227*S27-Fq327*s.dpt(2,55)-Fs326*s.l(2,26)+OM226*OM326*(s.In(5,26)-s.In(9,26)));
  Cq226 = -(s.trq(2,26)-s.In(5,26)*OMp226-Cq127*S27-Cq227*C27-OM126*OM326*(s.In(1,26)-s.In(9,26)));
  Cq326 = -(s.trq(3,26)-Cq327-s.In(9,26)*OMp326+Fs126*s.l(2,26)+OM126*OM226*(s.In(1,26)-s.In(5,26))+s.dpt(2,55)*(Fq127*C27-Fq227*S27));
  Fs125 = -(s.frc(1,25)-s.m(25)*(ALPHA125+BS125*s.l(1,25)+s.l(2,25)*(BS225-OMp325)+s.l(3,25)*(BS325+OMp225)));
  Fs225 = -(s.frc(2,25)-s.m(25)*(ALPHA225+BETA425*s.l(1,25)-s.l(2,25)*(OM125*OM125+OM325*OM325)+s.l(3,25)*(BS625-OMp125)));
  Fs325 = -(s.frc(3,25)-s.m(25)*(ALPHA325+BETA725*s.l(1,25)+s.l(2,25)*(BS625+OMp125)-s.l(3,25)*(OM125*OM125+OM225*OM225)));
  Fq125 = Fs125+Fq126*C26+Fq326*S26;
  Fq225 = Fq226+Fs225;
  Fq325 = Fs325-Fq126*S26+Fq326*C26;
  Cq125 = -(s.trq(1,25)-s.In(1,25)*OMp125-s.In(2,25)*OMp225-s.In(3,25)*OMp325-Cq126*C26-Cq326*S26+Fs225*s.l(3,25)-Fs325*s.l(2,25)-OM225*(...
 s.In(3,25)*OM125+s.In(6,25)*OM225+s.In(9,25)*OM325)+OM325*(s.In(2,25)*OM125+s.In(5,25)*OM225+s.In(6,25)*OM325));
  Cq225 = -(s.trq(2,25)-Cq226-s.In(2,25)*OMp125-s.In(5,25)*OMp225-s.In(6,25)*OMp325-Fs125*s.l(3,25)+Fs325*s.l(1,25)+OM125*(s.In(3,25)*OM125+...
 s.In(6,25)*OM225+s.In(9,25)*OM325)-OM325*(s.In(1,25)*OM125+s.In(2,25)*OM225+s.In(3,25)*OM325)-s.dpt(1,54)*(Fq126*S26-Fq326*C26));
  Cq325 = -(s.trq(3,25)-s.In(3,25)*OMp125-s.In(6,25)*OMp225-s.In(9,25)*OMp325+Cq126*S26-Cq326*C26-Fq226*s.dpt(1,54)+Fs125*s.l(2,25)-Fs225*...
 s.l(1,25)-OM125*(s.In(2,25)*OM125+s.In(5,25)*OM225+s.In(6,25)*OM325)+OM225*(s.In(1,25)*OM125+s.In(2,25)*OM225+s.In(3,25)*OM325));
  Fs124 = -(s.frc(1,24)-s.m(24)*(ALPHA124+BETA224*s.l(2,24)-s.l(1,24)*(OM224*OM224+OM324*OM324)+s.l(3,24)*(BS324+OMp224)));
  Fs224 = -(s.frc(2,24)-s.m(24)*(ALPHA224+BS524*s.l(2,24)+s.l(1,24)*(BS224+OMp324)+s.l(3,24)*(BS624-OMp124)));
  Fs324 = -(s.frc(3,24)-s.m(24)*(ALPHA324+BETA824*s.l(2,24)+s.l(1,24)*(BS324-OMp224)-s.l(3,24)*(OM124*OM124+OM224*OM224)));
  Fq124 = Fs124+Fq125*C25-Fq225*S25;
  Fq324 = Fq325+Fs324;
  Cq124 = -(s.trq(1,24)-s.In(1,24)*OMp124-s.In(2,24)*OMp224-s.In(3,24)*OMp324-Cq125*C25+Cq225*S25-Fq325*s.dpt(2,52)+Fs224*s.l(3,24)-Fs324*...
 s.l(2,24)-OM224*(s.In(3,24)*OM124+s.In(6,24)*OM224+s.In(9,24)*OM324)+OM324*(s.In(2,24)*OM124+s.In(5,24)*OM224+s.In(6,24)*OM324));
  Cq224 = -(s.trq(2,24)-s.In(2,24)*OMp124-s.In(5,24)*OMp224-s.In(6,24)*OMp324-Cq125*S25-Cq225*C25-Fs124*s.l(3,24)+Fs324*s.l(1,24)+OM124*(...
 ...
 s.In(5,24)*OM224+s.In(6,24)*OM324)+OM224*(s.In(1,24)*OM124+s.In(2,24)*OM224+s.In(3,24)*OM324)+s.dpt(2,52)*(Fq125*C25-Fq225*S25));
  ...
  Cq123 = -(s.trq(1,23)-s.In(1,23)*OMp123-s.In(2,23)*OMp223-s.In(3,23)*OMp323-Cq124*C24-Cq324*S24-Fs323*s.l(2,23)-OM223*(s.In(3,23)*OM123+...
 s.In(6,23)*OM223+s.In(9,23)*OM323)+OM323*(s.In(2,23)*OM123+s.In(5,23)*OM223+s.In(6,23)*OM323)+s.dpt(2,50)*(Fq124*S24-Fq324*C24));
  Cq223 = -(s.trq(2,23)-Cq224-s.In(2,23)*OMp123-s.In(5,23)*OMp223-s.In(6,23)*OMp323+Fs323*s.l(1,23)+OM123*(s.In(3,23)*OM123+s.In(6,23)*OM223+...
 s.In(9,23)*OM323)-OM323*(s.In(1,23)*OM123+s.In(2,23)*OM223+s.In(3,23)*OM323));
  Cq323 = -(s.trq(3,23)-s.In(3,23)*OMp123-s.In(6,23)*OMp223-s.In(9,23)*OMp323+Cq124*S24-Cq324*C24+Fs123*s.l(2,23)-Fs223*s.l(1,23)-OM123*(...
 s.In(2,23)*OM123+s.In(5,23)*OM223+s.In(6,23)*OM323)+OM223*(s.In(1,23)*OM123+s.In(2,23)*OM223+s.In(3,23)*OM323)+s.dpt(2,50)*(Fq124*C24+Fq324*S24));
  ...
  Cq122 = -(s.trq(1,22)-Cq123-s.In(1,22)*OMp122-s.In(2,22)*OMp222-s.In(3,22)*OMp322+Fs222*s.l(3,22)-Fs322*s.l(2,22)-OM222*(s.In(3,22)*OM122+...
 s.In(6,22)*OM222+s.In(9,22)*OM322)+OM322*(s.In(2,22)*OM122+s.In(5,22)*OM222+s.In(6,22)*OM322)-s.dpt(2,48)*(Fq223*S23+Fq323*C23));
 ...
 s.In(3,22)*OM122+s.In(6,22)*OM222+s.In(9,22)*OM322)-OM322*(s.In(1,22)*OM122+s.In(2,22)*OM222+s.In(3,22)*OM322));
  Cq322 = -(s.trq(3,22)-s.In(3,22)*OMp122-s.In(6,22)*OMp222-s.In(9,22)*OMp322-Cq223*S23-Cq323*C23+Fq123*s.dpt(2,48)+Fs122*s.l(2,22)-Fs222*...
 s.l(1,22)-OM122*(s.In(2,22)*OM122+s.In(5,22)*OM222+s.In(6,22)*OM322)+OM222*(s.In(1,22)*OM122+s.In(2,22)*OM222+s.In(3,22)*OM322));
 ...
 s.In(3,21)*OM321)+s.dpt(2,44)*(Fq122*C22+Fq322*S22)+s.dpt(2,45)*(Fq129*C29+Fq329*S29));
  ...
  Cq120 = -(s.trq(1,20)-s.In(1,20)*OMp120-s.In(2,20)*OMp220-s.In(3,20)*OMp320-Cq121*C21+Cq221*S21+Fs220*s.l(3,20)-Fs320*s.l(2,20)-OM220*(...
 s.In(3,20)*OM120+s.In(6,20)*OM220+s.In(9,20)*OM320)+OM320*(s.In(2,20)*OM120+s.In(5,20)*OM220+s.In(6,20)*OM320)+s.dpt(3,40)*(Fq121*S21+Fq221*C21));
  Cq220 = -(s.trq(2,20)-s.In(2,20)*OMp120-s.In(5,20)*OMp220-s.In(6,20)*OMp320-Cq121*S21-Cq221*C21-Fs120*s.l(3,20)+Fs320*s.l(1,20)+OM120*(...
 s.In(3,20)*OM120+s.In(6,20)*OM220+s.In(9,20)*OM320)-OM320*(s.In(1,20)*OM120+s.In(2,20)*OM220+s.In(3,20)*OM320)-s.dpt(3,40)*(Fq121*C21-Fq221*S21));
  Cq320 = -(s.trq(3,20)-Cq321-s.In(3,20)*OMp120-s.In(6,20)*OMp220-s.In(9,20)*OMp320+Fs120*s.l(2,20)-Fs220*s.l(1,20)-OM120*(s.In(2,20)*OM120+...
 s.In(5,20)*OM220+s.In(6,20)*OM320)+OM220*(s.In(1,20)*OM120+s.In(2,20)*OM220+s.In(3,20)*OM320));
  ...
  Cq119 = -(s.trq(1,19)-s.In(1,19)*OMp119-s.In(2,19)*OMp219-s.In(3,19)*OMp319-Cq120*C20-Cq320*S20+Fs219*s.l(3,19)-Fs319*s.l(2,19)-OM219*(...
 s.In(3,19)*OM119+s.In(6,19)*OM219+s.In(9,19)*OM319)+OM319*(s.In(2,19)*OM119+s.In(5,19)*OM219+s.In(6,19)*OM319));
  Cq219 = -(s.trq(2,19)-Cq220-s.In(2,19)*OMp119-s.In(5,19)*OMp219-s.In(6,19)*OMp319-Fs119*s.l(3,19)+Fs319*s.l(1,19)+OM119*(s.In(3,19)*OM119+...
 s.In(6,19)*OM219+s.In(9,19)*OM319)-OM319*(s.In(1,19)*OM119+s.In(2,19)*OM219+s.In(3,19)*OM319));
  Cq319 = -(s.trq(3,19)-s.In(3,19)*OMp119-s.In(6,19)*OMp219-s.In(9,19)*OMp319+Cq120*S20-Cq320*C20+Fs119*s.l(2,19)-Fs219*s.l(1,19)-OM119*(...
 ...
 OM218+s.In(6,18)*OM318)+OM218*(s.In(1,18)*OM118+s.In(2,18)*OM218+s.In(3,18)*OM318));
  ...
  Cq117 = -(s.trq(1,17)-s.In(1,17)*OMp117-s.In(2,17)*OMp217-s.In(3,17)*OMp317-Cq118*C18-Cq318*S18+Fs217*s.l(3,17)-Fs317*s.l(2,17)-OM217*(...
 s.In(3,17)*OM117+s.In(6,17)*OM217+s.In(9,17)*OM317)+OM317*(s.In(2,17)*OM117+s.In(5,17)*OM217+s.In(6,17)*OM317));
  Cq217 = -(s.trq(2,17)-Cq218-s.In(2,17)*OMp117-s.In(5,17)*OMp217-s.In(6,17)*OMp317-Fs117*s.l(3,17)+Fs317*s.l(1,17)+OM117*(s.In(3,17)*OM117+...
 ...
 s.In(2,17)*OM117+s.In(5,17)*OM217+s.In(6,17)*OM317)+OM217*(s.In(1,17)*OM117+s.In(2,17)*OM217+s.In(3,17)*OM317));
  ...
  Cq116 = -(s.trq(1,16)-Cq117-s.In(1,16)*OMp116-s.In(2,16)*OMp216-s.In(3,16)*OMp316+Fs216*s.l(3,16)-Fs316*s.l(2,16)-OM216*(s.In(3,16)*OM116+...
 s.In(6,16)*OM216+s.In(9,16)*OM316)+OM316*(s.In(2,16)*OM116+s.In(5,16)*OM216+s.In(6,16)*OM316)+s.dpt(3,28)*(Fq217*C17-Fq317*S17));
  Cq216 = -(s.trq(2,16)-s.In(2,16)*OMp116-s.In(5,16)*OMp216-s.In(6,16)*OMp316-Cq217*C17+Cq317*S17-Fq117*s.dpt(3,28)-Fs116*s.l(3,16)+Fs316*...
 s.l(1,16)+OM116*(s.In(3,16)*OM116+s.In(6,16)*OM216+s.In(9,16)*OM316)-OM316*(s.In(1,16)*OM116+s.In(2,16)*OM216+s.In(3,16)*OM316));
  Cq316 = -(s.trq(3,16)-s.In(3,16)*OMp116-s.In(6,16)*OMp216-s.In(9,16)*OMp316-Cq217*S17-Cq317*C17+Fs116*s.l(2,16)-Fs216*s.l(1,16)-OM116*(...
 s.In(2,16)*OM116+s.In(5,16)*OM216+s.In(6,16)*OM316)+OM216*(s.In(1,16)*OM116+s.In(2,16)*OM216+s.In(3,16)*OM316));
  ...
  Fq215 = Fq216+Fs215;
  Cq115 = -(s.trq(1,15)-s.In(1,15)*OMp115-s.In(2,15)*OMp215-s.In(3,15)*OMp315-Cq116*C16-Cq316*S16+Fq216*s.dpt(3,26)+Fs215*s.l(3,15)-Fs315*...
 s.l(2,15)-OM215*(s.In(3,15)*OM115+s.In(6,15)*OM215+s.In(9,15)*OM315)+OM315*(s.In(2,15)*OM115+s.In(5,15)*OM215+s.In(6,15)*OM315));
  Cq215 = -(s.trq(2,15)-Cq216-s.In(2,15)*OMp115-s.In(5,15)*OMp215-s.In(6,15)*OMp315-Fs115*s.l(3,15)+Fs315*s.l(1,15)+OM115*(s.In(3,15)*OM115+...
 s.In(6,15)*OM215+s.In(9,15)*OM315)-OM315*(s.In(1,15)*OM115+s.In(2,15)*OM215+s.In(3,15)*OM315)-s.dpt(3,26)*(Fq116*C16+Fq316*S16));
  Cq315 = -(s.trq(3,15)-s.In(3,15)*OMp115-s.In(6,15)*OMp215-s.In(9,15)*OMp315+Cq116*S16-Cq316*C16+Fs115*s.l(2,15)-Fs215*s.l(1,15)-OM115*(...
 s.In(2,15)*OM115+s.In(5,15)*OM215+s.In(6,15)*OM315)+OM215*(s.In(1,15)*OM115+s.In(2,15)*OM215+s.In(3,15)*OM315));
  ...
  Cq114 = -(s.trq(1,14)-s.In(1,14)*OMp114-s.In(2,14)*OMp214-s.In(3,14)*OMp314-Cq115*C15+Cq215*S15+Fs214*s.l(3,14)-Fs314*s.l(2,14)-OM214*(...
 s.In(3,14)*OM114+s.In(6,14)*OM214+s.In(9,14)*OM314)+OM314*(s.In(2,14)*OM114+s.In(5,14)*OM214+s.In(6,14)*OM314)+s.dpt(3,24)*(Fq115*S15+Fq215*C15));
  Cq214 = -(s.trq(2,14)-s.In(2,14)*OMp114-s.In(5,14)*OMp214-s.In(6,14)*OMp314-Cq115*S15-Cq215*C15-Fs114*s.l(3,14)+Fs314*s.l(1,14)+OM114*(...
 s.In(3,14)*OM114+s.In(6,14)*OM214+s.In(9,14)*OM314)-OM314*(s.In(1,14)*OM114+s.In(2,14)*OM214+s.In(3,14)*OM314)-s.dpt(3,24)*(Fq115*C15-Fq215*S15));
  Cq314 = -(s.trq(3,14)-Cq315-s.In(3,14)*OMp114-s.In(6,14)*OMp214-s.In(9,14)*OMp314+Fs114*s.l(2,14)-Fs214*s.l(1,14)-OM114*(s.In(2,14)*OM114+...
 s.In(5,14)*OM214+s.In(6,14)*OM314)+OM214*(s.In(1,14)*OM114+s.In(2,14)*OM214+s.In(3,14)*OM314));
  ...
  Cq113 = -(s.trq(1,13)-Cq114-s.In(1,13)*OMp113-s.In(2,13)*OMp213-s.In(3,13)*OMp313+Fs213*s.l(3,13)-Fs313*s.l(2,13)-OM213*(s.In(3,13)*OM113+...
 s.In(6,13)*OM213+s.In(9,13)*OM313)+OM313*(s.In(2,13)*OM113+s.In(5,13)*OM213+s.In(6,13)*OM313)-s.dpt(2,22)*(Fq214*S14+Fq314*C14));
 ...
 s.In(3,13)*OM113+s.In(6,13)*OM213+s.In(9,13)*OM313)-OM313*(s.In(1,13)*OM113+s.In(2,13)*OM213+s.In(3,13)*OM313));
  Cq313 = -(s.trq(3,13)-s.In(3,13)*OMp113-s.In(6,13)*OMp213-s.In(9,13)*OMp313-Cq214*S14-Cq314*C14+Fq114*s.dpt(2,22)+Fs113*s.l(2,13)-Fs213*...
 s.l(1,13)-OM113*(s.In(2,13)*OM113+s.In(5,13)*OM213+s.In(6,13)*OM313)+OM213*(s.In(1,13)*OM113+s.In(2,13)*OM213+s.In(3,13)*OM313));
 ...
 s.In(3,11)*OM111+s.In(6,11)*OM211+s.In(9,11)*OM311)+OM311*(s.In(2,11)*OM111+s.In(5,11)*OM211+s.In(6,11)*OM311));
  Cq211 = -(s.trq(2,11)-Cq212-s.In(2,11)*OMp111-s.In(5,11)*OMp211-s.In(6,11)*OMp311-Fs111*s.l(3,11)+Fs311*s.l(1,11)+OM111*(s.In(3,11)*OM111+...
 s.In(6,11)*OM211+s.In(9,11)*OM311)-OM311*(s.In(1,11)*OM111+s.In(2,11)*OM211+s.In(3,11)*OM311));
  Cq311 = -(s.trq(3,11)-s.In(3,11)*OMp111-s.In(6,11)*OMp211-s.In(9,11)*OMp311+Cq112*S12-Cq312*C12+Fs111*s.l(2,11)-Fs211*s.l(1,11)-OM111*(...
 ...
 s.In(6,10)*OM210+s.In(9,10)*OM310)+OM310*(s.In(2,10)*OM110+s.In(5,10)*OM210+s.In(6,10)*OM310)+s.dpt(3,12)*(Fq211*C11-Fq311*S11));
  Cq210 = -(s.trq(2,10)-s.In(2,10)*OMp110-s.In(5,10)*OMp210-s.In(6,10)*OMp310-Cq211*C11+Cq311*S11-Fq111*s.dpt(3,12)-Fs110*s.l(3,10)+Fs310*...
 ...
 s.In(2,10)*OM110+s.In(5,10)*OM210+s.In(6,10)*OM310)+OM210*(s.In(1,10)*OM110+s.In(2,10)*OM210+s.In(3,10)*OM310));
  ...
  Fq29 = Fq210+Fs29;
  Cq19 = -(s.trq(1,9)-s.In(1,9)*OMp19-s.In(2,9)*OMp29-s.In(3,9)*OMp39-Cq110*C10-Cq310*S10+Fq210*s.dpt(3,10)+Fs29*s.l(3,9)-Fs39*s.l(2,9)-OM29*(...
 ...
 s.In(9,9)*OM39)-OM39*(s.In(1,9)*OM19+s.In(2,9)*OM29+s.In(3,9)*OM39)-s.dpt(3,10)*(Fq110*C10+Fq310*S10));
 ...
 s.In(5,9)*OM29+s.In(6,9)*OM39)+OM29*(s.In(1,9)*OM19+s.In(2,9)*OM29+s.In(3,9)*OM39));
  ...
  Cq18 = -(s.trq(1,8)-s.In(1,8)*OMp18-s.In(2,8)*OMp28-s.In(3,8)*OMp38-Cq19*C9+Cq29*S9+Fs28*s.l(3,8)-Fs38*s.l(2,8)-OM28*(s.In(3,8)*OM18+s.In(6,8)*...
 OM28+s.In(9,8)*OM38)+OM38*(s.In(2,8)*OM18+s.In(5,8)*OM28+s.In(6,8)*OM38)+s.dpt(3,8)*(Fq19*S9+Fq29*C9));
  Cq28 = -(s.trq(2,8)-s.In(2,8)*OMp18-s.In(5,8)*OMp28-s.In(6,8)*OMp38-Cq19*S9-Cq29*C9-Fs18*s.l(3,8)+Fs38*s.l(1,8)+OM18*(s.In(3,8)*OM18+s.In(6,8)*...
 OM28+s.In(9,8)*OM38)-OM38*(s.In(1,8)*OM18+s.In(2,8)*OM28+s.In(3,8)*OM38)-s.dpt(3,8)*(Fq19*C9-Fq29*S9));
  Cq38 = -(s.trq(3,8)-Cq39-s.In(3,8)*OMp18-s.In(6,8)*OMp28-s.In(9,8)*OMp38+Fs18*s.l(2,8)-Fs28*s.l(1,8)-OM18*(s.In(2,8)*OM18+s.In(5,8)*OM28+...
 s.In(6,8)*OM38)+OM28*(s.In(1,8)*OM18+s.In(2,8)*OM28+s.In(3,8)*OM38));
  ...
  Cq17 = -(s.trq(1,7)-Cq18-s.In(1,7)*OMp17-s.In(2,7)*OMp27-s.In(3,7)*OMp37+Fs27*s.l(3,7)-Fs37*s.l(2,7)-OM27*(s.In(3,7)*OM17+s.In(6,7)*OM27+...
 s.In(9,7)*OM37)+OM37*(s.In(2,7)*OM17+s.In(5,7)*OM27+s.In(6,7)*OM37)-s.dpt(2,6)*(Fq28*S8+Fq38*C8));
  Cq27 = -(s.trq(2,7)-s.In(2,7)*OMp17-s.In(5,7)*OMp27-s.In(6,7)*OMp37-Cq28*C8+Cq38*S8-Fs17*s.l(3,7)+Fs37*s.l(1,7)+OM17*(s.In(3,7)*OM17+s.In(6,7)*...
 OM27+s.In(9,7)*OM37)-OM37*(s.In(1,7)*OM17+s.In(2,7)*OM27+s.In(3,7)*OM37));
  Cq37 = -(s.trq(3,7)-s.In(3,7)*OMp17-s.In(6,7)*OMp27-s.In(9,7)*OMp37-Cq28*S8-Cq38*C8+Fq18*s.dpt(2,6)+Fs17*s.l(2,7)-Fs27*s.l(1,7)-OM17*(s.In(2,7)...
 *OM17+s.In(5,7)*OM27+s.In(6,7)*OM37)+OM27*(s.In(1,7)*OM17+s.In(2,7)*OM27+s.In(3,7)*OM37));
  ...
  Cq16 = -(s.trq(1,6)-Cq119-s.In(1,6)*OMp16-s.In(2,6)*OMp26-s.In(3,6)*OMp36-Cq113*C13-Cq17*C7-Cq313*S13-Cq37*S7+Fs26*s.l(3,6)-Fs36*s.l(2,6)-OM26*...
 (s.In(3,6)*OM16+s.In(6,6)*OM26+s.In(9,6)*OM36)+OM36*(s.In(2,6)*OM16+s.In(5,6)*OM26+s.In(6,6)*OM36)+s.dpt(2,1)*(Fq17*S7-Fq37*C7)+s.dpt(2,2)*(Fq113*S13...
 -Fq313*C13)+s.dpt(3,3)*(Fq219*C19-Fq319*S19));
  Cq26 = -(s.trq(2,6)-Cq213-Cq27-s.In(2,6)*OMp16-s.In(5,6)*OMp26-s.In(6,6)*OMp36-Cq219*C19+Cq319*S19-Fq119*s.dpt(3,3)-Fs16*s.l(3,6)+Fs36*s.l(1,6)...
 +OM16*(s.In(3,6)*OM16+s.In(6,6)*OM26+s.In(9,6)*OM36)-OM36*(s.In(1,6)*OM16+s.In(2,6)*OM26+s.In(3,6)*OM36)+s.dpt(1,3)*(Fq219*S19+Fq319*C19));
 ...
 s.l(1,6)-OM16*(s.In(2,6)*OM16+s.In(5,6)*OM26+s.In(6,6)*OM36)+OM26*(s.In(1,6)*OM16+s.In(2,6)*OM26+s.In(3,6)*OM36)-s.dpt(1,3)*(Fq219*C19-Fq319*S19)+...
 s.dpt(2,1)*(Fq17*C7+Fq37*S7)+s.dpt(2,2)*(Fq113*C13+Fq313*S13));
