...
#define NB_JOINTS 35 // total number of joints of the model (independent, driven and dependent)

// -- Simulation -- //

// project name
#define PROJECT_NAME_MBS "CoMan_Legs_7DofArm.mbs"

// simulation step size
#define TSIM_INIT  0.0    // inital time of the simulation     [s]
#define TSIM_END   10.0   // end time of the simulation        [s]
