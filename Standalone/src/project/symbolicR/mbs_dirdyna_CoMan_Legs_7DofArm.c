...
#include "mbs_dirdyna_CoMan_Legs_7DofArm.h" 
#define q s->q 
#define qd s->qd 
#define qdd s->qdd 
 ...
 *s->dpt[1][44]);
 ...
 s->dpt[2][44]*S20);
  ...
  AlF223 = C23*(AlF222+s->dpt[1][48]*BeF422+s->dpt[3][48]*BeF622+BS522*s->dpt[2][48])+S23*(AlF322+s->dpt[1][48]*BeF722+
 s->dpt[3][48]*BS922+BeF822*s->dpt[2][48]);
  AlF323 = C23*(AlF322+s->dpt[1][48]*BeF722+s->dpt[3][48]*BS922+BeF822*s->dpt[2][48])-S23*(AlF222+s->dpt[1][48]*BeF422+
 s->dpt[3][48]*BeF622+BS522*s->dpt[2][48]);
  ...
  AlM223_4 = C23*(AlM222_4+s->dpt[1][48]*OpM322_4-s->dpt[3][48]*OpM122_4)+S23*(AlM322_4-s->dpt[1][48]*OpM221_4+OpM122_4*
 s->dpt[2][48]);
  AlM323_4 = C23*(AlM322_4-s->dpt[1][48]*OpM221_4+OpM122_4*s->dpt[2][48])-S23*(AlM222_4+s->dpt[1][48]*OpM322_4-
 s->dpt[3][48]*OpM122_4);
  ...
  AlM223_5 = C23*(AlM222_5+s->dpt[1][48]*OpM322_5-s->dpt[3][48]*OpM122_5)+S23*(AlM322_5-s->dpt[1][48]*OpM221_5+OpM122_5*
 s->dpt[2][48]);
  AlM323_5 = C23*(AlM322_5-s->dpt[1][48]*OpM221_5+OpM122_5*s->dpt[2][48])-S23*(AlM222_5+s->dpt[1][48]*OpM322_5-
 s->dpt[3][48]*OpM122_5);
  ...
  AlM223_6 = C23*(AlM222_6+s->dpt[1][48]*OpM322_6-s->dpt[3][48]*OpM122_6)+S23*(AlM322_6-s->dpt[1][48]*OpM221_6+OpM122_6*
 s->dpt[2][48]);
  AlM323_6 = C23*(AlM322_6-s->dpt[1][48]*OpM221_6+OpM122_6*s->dpt[2][48])-S23*(AlM222_6+s->dpt[1][48]*OpM322_6-
 s->dpt[3][48]*OpM122_6);
  ...
  AlM223_19 = C23*(AlM222_19+s->dpt[1][48]*OpM322_19-s->dpt[3][48]*OpM122_19)+S23*(AlM322_19-s->dpt[1][48]*OpM221_19+
 OpM122_19*s->dpt[2][48]);
  AlM323_19 = C23*(AlM322_19-s->dpt[1][48]*OpM221_19+OpM122_19*s->dpt[2][48])-S23*(AlM222_19+s->dpt[1][48]*OpM322_19-
 s->dpt[3][48]*OpM122_19);
  OpM223_20 = OpM322_20*S23+C21*C23;
  OpM323_20 = OpM322_20*C23-C21*S23;
  AlM123_20 = AlM122_20+s->dpt[3][48]*C21-OpM322_20*s->dpt[2][48];
  AlM223_20 = C23*(AlM222_20+s->dpt[1][48]*OpM322_20-s->dpt[3][48]*OpM122_20)+S23*(AlM322_20-s->dpt[1][48]*C21+OpM122_20
 *s->dpt[2][48]);
  AlM323_20 = C23*(AlM322_20-s->dpt[1][48]*C21+OpM122_20*s->dpt[2][48])-S23*(AlM222_20+s->dpt[1][48]*OpM322_20-
 s->dpt[3][48]*OpM122_20);
  OpM223_21 = C22*S23;
  OpM323_21 = C22*C23;
  ...
  BeF724 = BS324-OpF223;
  BeF824 = BS624+OpF124;
  AlF124 = C24*(AlF123+s->dpt[1][50]*BS123+s->dpt[3][50]*BeF323+BeF223*s->dpt[2][50])-S24*(AlF323+s->dpt[1][50]*BeF723+
 s->dpt[3][50]*BS923+BeF823*s->dpt[2][50]);
  AlF224 = AlF223+s->dpt[1][50]*BeF423+s->dpt[3][50]*BeF623+BS523*s->dpt[2][50];
  AlF324 = C24*(AlF323+s->dpt[1][50]*BeF723+s->dpt[3][50]*BS923+BeF823*s->dpt[2][50])+S24*(AlF123+s->dpt[1][50]*BS123+
 s->dpt[3][50]*BeF323+BeF223*s->dpt[2][50]);
  ...
  AlM124_4 = C24*(AlM123_4+s->dpt[3][50]*OpM223_4-OpM323_4*s->dpt[2][50])-S24*(AlM323_4-s->dpt[1][50]*OpM223_4+OpM122_4*
 s->dpt[2][50]);
  AlM224_4 = AlM223_4+s->dpt[1][50]*OpM323_4-s->dpt[3][50]*OpM122_4;
  AlM324_4 = C24*(AlM323_4-s->dpt[1][50]*OpM223_4+OpM122_4*s->dpt[2][50])+S24*(AlM123_4+s->dpt[3][50]*OpM223_4-OpM323_4*
 s->dpt[2][50]);
  OpM124_5 = OpM122_5*C24-OpM323_5*S24;
  OpM324_5 = OpM122_5*S24+OpM323_5*C24;
  AlM124_5 = C24*(AlM123_5+s->dpt[3][50]*OpM223_5-OpM323_5*s->dpt[2][50])-S24*(AlM323_5-s->dpt[1][50]*OpM223_5+OpM122_5*
 s->dpt[2][50]);
  AlM224_5 = AlM223_5+s->dpt[1][50]*OpM323_5-s->dpt[3][50]*OpM122_5;
  AlM324_5 = C24*(AlM323_5-s->dpt[1][50]*OpM223_5+OpM122_5*s->dpt[2][50])+S24*(AlM123_5+s->dpt[3][50]*OpM223_5-OpM323_5*
 s->dpt[2][50]);
  OpM124_6 = OpM122_6*C24-OpM323_6*S24;
  OpM324_6 = OpM122_6*S24+OpM323_6*C24;
  AlM124_6 = C24*(AlM123_6+s->dpt[3][50]*OpM223_6-OpM323_6*s->dpt[2][50])-S24*(AlM323_6-s->dpt[1][50]*OpM223_6+OpM122_6*
 s->dpt[2][50]);
  AlM224_6 = AlM223_6+s->dpt[1][50]*OpM323_6-s->dpt[3][50]*OpM122_6;
  AlM324_6 = C24*(AlM323_6-s->dpt[1][50]*OpM223_6+OpM122_6*s->dpt[2][50])+S24*(AlM123_6+s->dpt[3][50]*OpM223_6-OpM323_6*
 s->dpt[2][50]);
  OpM124_19 = OpM122_19*C24-OpM323_19*S24;
  OpM324_19 = OpM122_19*S24+OpM323_19*C24;
  AlM124_19 = C24*(AlM123_19+s->dpt[3][50]*OpM223_19-OpM323_19*s->dpt[2][50])-S24*(AlM323_19-s->dpt[1][50]*OpM223_19+
 OpM122_19*s->dpt[2][50]);
  AlM224_19 = AlM223_19+s->dpt[1][50]*OpM323_19-s->dpt[3][50]*OpM122_19;
  AlM324_19 = C24*(AlM323_19-s->dpt[1][50]*OpM223_19+OpM122_19*s->dpt[2][50])+S24*(AlM123_19+s->dpt[3][50]*OpM223_19-
 OpM323_19*s->dpt[2][50]);
  OpM124_20 = OpM122_20*C24-OpM323_20*S24;
  OpM324_20 = OpM122_20*S24+OpM323_20*C24;
  AlM124_20 = C24*(AlM123_20+s->dpt[3][50]*OpM223_20-OpM323_20*s->dpt[2][50])-S24*(AlM323_20-s->dpt[1][50]*OpM223_20+
 OpM122_20*s->dpt[2][50]);
  AlM224_20 = AlM223_20+s->dpt[1][50]*OpM323_20-s->dpt[3][50]*OpM122_20;
  AlM324_20 = C24*(AlM323_20-s->dpt[1][50]*OpM223_20+OpM122_20*s->dpt[2][50])+S24*(AlM123_20+s->dpt[3][50]*OpM223_20-
 OpM323_20*s->dpt[2][50]);
  OpM124_21 = -(OpM323_21*S24+S22*C24);
  OpM324_21 = OpM323_21*C24-S22*S24;
  AlM124_21 = C24*(AlM123_21+s->dpt[3][50]*OpM223_21-OpM323_21*s->dpt[2][50])-S24*(AlM323_21-s->dpt[1][50]*OpM223_21-
 s->dpt[2][50]*S22);
  AlM224_21 = AlM223_21+s->dpt[1][50]*OpM323_21+s->dpt[3][50]*S22;
  AlM324_21 = C24*(AlM323_21-s->dpt[1][50]*OpM223_21-s->dpt[2][50]*S22)+S24*(AlM123_21+s->dpt[3][50]*OpM223_21-OpM323_21
 *s->dpt[2][50]);
  OpM124_22 = S23*S24;
  OpM324_22 = -S23*C24;
  ...
  BeF725 = BS325-OpF225;
  BeF825 = BS625+OpF125;
  AlF125 = C25*(AlF124+s->dpt[1][52]*BS124+s->dpt[3][52]*BeF324+BeF224*s->dpt[2][52])+S25*(AlF224+s->dpt[1][52]*BeF424+
 s->dpt[3][52]*BeF624+BS524*s->dpt[2][52]);
  AlF225 = C25*(AlF224+s->dpt[1][52]*BeF424+s->dpt[3][52]*BeF624+BS524*s->dpt[2][52])-S25*(AlF124+s->dpt[1][52]*BS124+
 s->dpt[3][52]*BeF324+BeF224*s->dpt[2][52]);
  ...
  AlM125_4 = C25*(AlM124_4+s->dpt[3][52]*OpM223_4-OpM324_4*s->dpt[2][52])+S25*(AlM224_4+s->dpt[1][52]*OpM324_4-
 s->dpt[3][52]*OpM124_4);
  AlM225_4 = C25*(AlM224_4+s->dpt[1][52]*OpM324_4-s->dpt[3][52]*OpM124_4)-S25*(AlM124_4+s->dpt[3][52]*OpM223_4-OpM324_4*
 s->dpt[2][52]);
  ...
  AlM125_5 = C25*(AlM124_5+s->dpt[3][52]*OpM223_5-OpM324_5*s->dpt[2][52])+S25*(AlM224_5+s->dpt[1][52]*OpM324_5-
 s->dpt[3][52]*OpM124_5);
  AlM225_5 = C25*(AlM224_5+s->dpt[1][52]*OpM324_5-s->dpt[3][52]*OpM124_5)-S25*(AlM124_5+s->dpt[3][52]*OpM223_5-OpM324_5*
 s->dpt[2][52]);
  ...
  AlM125_6 = C25*(AlM124_6+s->dpt[3][52]*OpM223_6-OpM324_6*s->dpt[2][52])+S25*(AlM224_6+s->dpt[1][52]*OpM324_6-
 s->dpt[3][52]*OpM124_6);
  AlM225_6 = C25*(AlM224_6+s->dpt[1][52]*OpM324_6-s->dpt[3][52]*OpM124_6)-S25*(AlM124_6+s->dpt[3][52]*OpM223_6-OpM324_6*
 s->dpt[2][52]);
  ...
  AlM125_19 = C25*(AlM124_19+s->dpt[3][52]*OpM223_19-OpM324_19*s->dpt[2][52])+S25*(AlM224_19+s->dpt[1][52]*OpM324_19-
 s->dpt[3][52]*OpM124_19);
  AlM225_19 = C25*(AlM224_19+s->dpt[1][52]*OpM324_19-s->dpt[3][52]*OpM124_19)-S25*(AlM124_19+s->dpt[3][52]*OpM223_19-
 OpM324_19*s->dpt[2][52]);
  ...
  AlM125_20 = C25*(AlM124_20+s->dpt[3][52]*OpM223_20-OpM324_20*s->dpt[2][52])+S25*(AlM224_20+s->dpt[1][52]*OpM324_20-
 s->dpt[3][52]*OpM124_20);
  AlM225_20 = C25*(AlM224_20+s->dpt[1][52]*OpM324_20-s->dpt[3][52]*OpM124_20)-S25*(AlM124_20+s->dpt[3][52]*OpM223_20-
 OpM324_20*s->dpt[2][52]);
  ...
  AlM125_21 = C25*(AlM124_21+s->dpt[3][52]*OpM223_21-OpM324_21*s->dpt[2][52])+S25*(AlM224_21+s->dpt[1][52]*OpM324_21-
 s->dpt[3][52]*OpM124_21);
  AlM225_21 = C25*(AlM224_21+s->dpt[1][52]*OpM324_21-s->dpt[3][52]*OpM124_21)-S25*(AlM124_21+s->dpt[3][52]*OpM223_21-
 OpM324_21*s->dpt[2][52]);
  ...
  AlM125_22 = C25*(AlM124_22+s->dpt[3][52]*C23-OpM324_22*s->dpt[2][52])+S25*(AlM224_22+s->dpt[1][52]*OpM324_22-
 s->dpt[3][52]*OpM124_22);
  AlM225_22 = C25*(AlM224_22+s->dpt[1][52]*OpM324_22-s->dpt[3][52]*OpM124_22)-S25*(AlM124_22+s->dpt[3][52]*C23-OpM324_22
 *s->dpt[2][52]);
  ...
  BeF726 = BS326-OpF225;
  BeF826 = BS626+OpF126;
  AlF126 = C26*(AlF125+s->dpt[2][54]*BeF225+s->dpt[3][54]*BeF325+BS125*s->dpt[1][54])-S26*(AlF325+s->dpt[2][54]*BeF825+
 s->dpt[3][54]*BS925+BeF725*s->dpt[1][54]);
  AlF226 = AlF225+s->dpt[2][54]*BS525+s->dpt[3][54]*BeF625+BeF425*s->dpt[1][54];
  AlF326 = C26*(AlF325+s->dpt[2][54]*BeF825+s->dpt[3][54]*BS925+BeF725*s->dpt[1][54])+S26*(AlF125+s->dpt[2][54]*BeF225+
 s->dpt[3][54]*BeF325+BS125*s->dpt[1][54]);
  ...
  AlM126_4 = C26*(AlM125_4-s->dpt[2][54]*OpM324_4+s->dpt[3][54]*OpM225_4)-S26*(AlM325_4+s->dpt[2][54]*OpM125_4-OpM225_4*
 s->dpt[1][54]);
  AlM226_4 = AlM225_4-s->dpt[3][54]*OpM125_4+OpM324_4*s->dpt[1][54];
  AlM326_4 = C26*(AlM325_4+s->dpt[2][54]*OpM125_4-OpM225_4*s->dpt[1][54])+S26*(AlM125_4-s->dpt[2][54]*OpM324_4+
 s->dpt[3][54]*OpM225_4);
  OpM126_5 = OpM125_5*C26-OpM324_5*S26;
  OpM326_5 = OpM125_5*S26+OpM324_5*C26;
  AlM126_5 = C26*(AlM125_5-s->dpt[2][54]*OpM324_5+s->dpt[3][54]*OpM225_5)-S26*(AlM325_5+s->dpt[2][54]*OpM125_5-OpM225_5*
 s->dpt[1][54]);
  AlM226_5 = AlM225_5-s->dpt[3][54]*OpM125_5+OpM324_5*s->dpt[1][54];
  AlM326_5 = C26*(AlM325_5+s->dpt[2][54]*OpM125_5-OpM225_5*s->dpt[1][54])+S26*(AlM125_5-s->dpt[2][54]*OpM324_5+
 s->dpt[3][54]*OpM225_5);
  OpM126_6 = OpM125_6*C26-OpM324_6*S26;
  OpM326_6 = OpM125_6*S26+OpM324_6*C26;
  AlM126_6 = C26*(AlM125_6-s->dpt[2][54]*OpM324_6+s->dpt[3][54]*OpM225_6)-S26*(AlM325_6+s->dpt[2][54]*OpM125_6-OpM225_6*
 s->dpt[1][54]);
  AlM226_6 = AlM225_6-s->dpt[3][54]*OpM125_6+OpM324_6*s->dpt[1][54];
  AlM326_6 = C26*(AlM325_6+s->dpt[2][54]*OpM125_6-OpM225_6*s->dpt[1][54])+S26*(AlM125_6-s->dpt[2][54]*OpM324_6+
 s->dpt[3][54]*OpM225_6);
  OpM126_19 = OpM125_19*C26-OpM324_19*S26;
  OpM326_19 = OpM125_19*S26+OpM324_19*C26;
  AlM126_19 = C26*(AlM125_19-s->dpt[2][54]*OpM324_19+s->dpt[3][54]*OpM225_19)-S26*(AlM325_19+s->dpt[2][54]*OpM125_19-
 OpM225_19*s->dpt[1][54]);
  AlM226_19 = AlM225_19-s->dpt[3][54]*OpM125_19+OpM324_19*s->dpt[1][54];
  AlM326_19 = C26*(AlM325_19+s->dpt[2][54]*OpM125_19-OpM225_19*s->dpt[1][54])+S26*(AlM125_19-s->dpt[2][54]*OpM324_19+
 s->dpt[3][54]*OpM225_19);
  OpM126_20 = OpM125_20*C26-OpM324_20*S26;
  OpM326_20 = OpM125_20*S26+OpM324_20*C26;
  AlM126_20 = C26*(AlM125_20-s->dpt[2][54]*OpM324_20+s->dpt[3][54]*OpM225_20)-S26*(AlM325_20+s->dpt[2][54]*OpM125_20-
 OpM225_20*s->dpt[1][54]);
  AlM226_20 = AlM225_20-s->dpt[3][54]*OpM125_20+OpM324_20*s->dpt[1][54];
  AlM326_20 = C26*(AlM325_20+s->dpt[2][54]*OpM125_20-OpM225_20*s->dpt[1][54])+S26*(AlM125_20-s->dpt[2][54]*OpM324_20+
 s->dpt[3][54]*OpM225_20);
  OpM126_21 = OpM125_21*C26-OpM324_21*S26;
  OpM326_21 = OpM125_21*S26+OpM324_21*C26;
  AlM126_21 = C26*(AlM125_21-s->dpt[2][54]*OpM324_21+s->dpt[3][54]*OpM225_21)-S26*(AlM325_21+s->dpt[2][54]*OpM125_21-
 OpM225_21*s->dpt[1][54]);
  AlM226_21 = AlM225_21-s->dpt[3][54]*OpM125_21+OpM324_21*s->dpt[1][54];
  AlM326_21 = C26*(AlM325_21+s->dpt[2][54]*OpM125_21-OpM225_21*s->dpt[1][54])+S26*(AlM125_21-s->dpt[2][54]*OpM324_21+
 s->dpt[3][54]*OpM225_21);
  OpM126_22 = OpM125_22*C26-OpM324_22*S26;
  OpM326_22 = OpM125_22*S26+OpM324_22*C26;
  AlM126_22 = C26*(AlM125_22-s->dpt[2][54]*OpM324_22+s->dpt[3][54]*OpM225_22)-S26*(AlM325_22+s->dpt[2][54]*OpM125_22-
 OpM225_22*s->dpt[1][54]);
  AlM226_22 = AlM225_22-s->dpt[3][54]*OpM125_22+OpM324_22*s->dpt[1][54];
  AlM326_22 = C26*(AlM325_22+s->dpt[2][54]*OpM125_22-OpM225_22*s->dpt[1][54])+S26*(AlM125_22-s->dpt[2][54]*OpM324_22+
 s->dpt[3][54]*OpM225_22);
  OpM126_23 = OpM125_23*C26-S24*S26;
  OpM326_23 = OpM125_23*S26+S24*C26;
  AlM126_23 = C26*(AlM125_23-s->dpt[2][54]*S24+s->dpt[3][54]*OpM225_23)-S26*(AlM325_23+s->dpt[2][54]*OpM125_23-OpM225_23
 *s->dpt[1][54]);
  AlM226_23 = AlM225_23-s->dpt[3][54]*OpM125_23+s->dpt[1][54]*S24;
  AlM326_23 = C26*(AlM325_23+s->dpt[2][54]*OpM125_23-OpM225_23*s->dpt[1][54])+S26*(AlM125_23-s->dpt[2][54]*S24+
 s->dpt[3][54]*OpM225_23);
  OpM126_24 = S25*C26;
  OpM326_24 = S25*S26;
  ...
  BeF727 = BS327-OpF227;
  BeF827 = BS627+OpF127;
  AlF127 = C27*(AlF126+s->dpt[1][55]*BS126+s->dpt[3][55]*BeF326+BeF226*s->dpt[2][55])+S27*(AlF226+s->dpt[1][55]*BeF426+
 s->dpt[3][55]*BeF626+BS526*s->dpt[2][55]);
  AlF227 = C27*(AlF226+s->dpt[1][55]*BeF426+s->dpt[3][55]*BeF626+BS526*s->dpt[2][55])-S27*(AlF126+s->dpt[1][55]*BS126+
 s->dpt[3][55]*BeF326+BeF226*s->dpt[2][55]);
  ...
  AlM127_4 = C27*(AlM126_4+s->dpt[3][55]*OpM225_4-OpM326_4*s->dpt[2][55])+S27*(AlM226_4+s->dpt[1][55]*OpM326_4-
 s->dpt[3][55]*OpM126_4);
  AlM227_4 = C27*(AlM226_4+s->dpt[1][55]*OpM326_4-s->dpt[3][55]*OpM126_4)-S27*(AlM126_4+s->dpt[3][55]*OpM225_4-OpM326_4*
 s->dpt[2][55]);
  ...
  AlM127_5 = C27*(AlM126_5+s->dpt[3][55]*OpM225_5-OpM326_5*s->dpt[2][55])+S27*(AlM226_5+s->dpt[1][55]*OpM326_5-
 s->dpt[3][55]*OpM126_5);
  AlM227_5 = C27*(AlM226_5+s->dpt[1][55]*OpM326_5-s->dpt[3][55]*OpM126_5)-S27*(AlM126_5+s->dpt[3][55]*OpM225_5-OpM326_5*
 s->dpt[2][55]);
  ...
  AlM127_6 = C27*(AlM126_6+s->dpt[3][55]*OpM225_6-OpM326_6*s->dpt[2][55])+S27*(AlM226_6+s->dpt[1][55]*OpM326_6-
 s->dpt[3][55]*OpM126_6);
  AlM227_6 = C27*(AlM226_6+s->dpt[1][55]*OpM326_6-s->dpt[3][55]*OpM126_6)-S27*(AlM126_6+s->dpt[3][55]*OpM225_6-OpM326_6*
 s->dpt[2][55]);
  ...
  AlM127_19 = C27*(AlM126_19+s->dpt[3][55]*OpM225_19-OpM326_19*s->dpt[2][55])+S27*(AlM226_19+s->dpt[1][55]*OpM326_19-
 s->dpt[3][55]*OpM126_19);
  AlM227_19 = C27*(AlM226_19+s->dpt[1][55]*OpM326_19-s->dpt[3][55]*OpM126_19)-S27*(AlM126_19+s->dpt[3][55]*OpM225_19-
 OpM326_19*s->dpt[2][55]);
  ...
  AlM127_20 = C27*(AlM126_20+s->dpt[3][55]*OpM225_20-OpM326_20*s->dpt[2][55])+S27*(AlM226_20+s->dpt[1][55]*OpM326_20-
 s->dpt[3][55]*OpM126_20);
  AlM227_20 = C27*(AlM226_20+s->dpt[1][55]*OpM326_20-s->dpt[3][55]*OpM126_20)-S27*(AlM126_20+s->dpt[3][55]*OpM225_20-
 OpM326_20*s->dpt[2][55]);
  ...
  AlM127_21 = C27*(AlM126_21+s->dpt[3][55]*OpM225_21-OpM326_21*s->dpt[2][55])+S27*(AlM226_21+s->dpt[1][55]*OpM326_21-
 s->dpt[3][55]*OpM126_21);
  AlM227_21 = C27*(AlM226_21+s->dpt[1][55]*OpM326_21-s->dpt[3][55]*OpM126_21)-S27*(AlM126_21+s->dpt[3][55]*OpM225_21-
 OpM326_21*s->dpt[2][55]);
  ...
  AlM127_22 = C27*(AlM126_22+s->dpt[3][55]*OpM225_22-OpM326_22*s->dpt[2][55])+S27*(AlM226_22+s->dpt[1][55]*OpM326_22-
 s->dpt[3][55]*OpM126_22);
  AlM227_22 = C27*(AlM226_22+s->dpt[1][55]*OpM326_22-s->dpt[3][55]*OpM126_22)-S27*(AlM126_22+s->dpt[3][55]*OpM225_22-
 OpM326_22*s->dpt[2][55]);
  ...
  AlM127_23 = C27*(AlM126_23+s->dpt[3][55]*OpM225_23-OpM326_23*s->dpt[2][55])+S27*(AlM226_23+s->dpt[1][55]*OpM326_23-
 s->dpt[3][55]*OpM126_23);
  AlM227_23 = C27*(AlM226_23+s->dpt[1][55]*OpM326_23-s->dpt[3][55]*OpM126_23)-S27*(AlM126_23+s->dpt[3][55]*OpM225_23-
 OpM326_23*s->dpt[2][55]);
  ...
  AlM127_24 = C27*(AlM126_24+s->dpt[3][55]*C25-OpM326_24*s->dpt[2][55])+S27*(AlM226_24+s->dpt[1][55]*OpM326_24-
 s->dpt[3][55]*OpM126_24);
  AlM227_24 = C27*(AlM226_24+s->dpt[1][55]*OpM326_24-s->dpt[3][55]*OpM126_24)-S27*(AlM126_24+s->dpt[3][55]*C25-OpM326_24
 *s->dpt[2][55]);
...
// Forward Kinematics 
  ...
  BeF729 = BS329-OpF221;
  BeF829 = BS629+OpF129;
  AlF129 = C29*(AlF121+BS121*s->dpt[1][45]+BeF221*s->dpt[2][45]+BeF321*s->dpt[3][45])-S29*(AlF321+BS921*s->dpt[3][45]+
 BeF721*s->dpt[1][45]+BeF821*s->dpt[2][45]);
  AlF229 = AlF221+BS521*s->dpt[2][45]+BeF421*s->dpt[1][45]+BeF621*s->dpt[3][45];
  AlF329 = C29*(AlF321+BS921*s->dpt[3][45]+BeF721*s->dpt[1][45]+BeF821*s->dpt[2][45])+S29*(AlF121+BS121*s->dpt[1][45]+
 BeF221*s->dpt[2][45]+BeF321*s->dpt[3][45]);
  ...
  AlM129_4 = C29*(AlM121_4+OpM221_4*s->dpt[3][45]-OpM320_4*s->dpt[2][45])-S29*(AlM321_4+OpM121_4*s->dpt[2][45]-OpM221_4*
 s->dpt[1][45]);
  AlM229_4 = AlM221_4-OpM121_4*s->dpt[3][45]+OpM320_4*s->dpt[1][45];
  AlM329_4 = C29*(AlM321_4+OpM121_4*s->dpt[2][45]-OpM221_4*s->dpt[1][45])+S29*(AlM121_4+OpM221_4*s->dpt[3][45]-OpM320_4*
 s->dpt[2][45]);
  OpM129_5 = OpM121_5*C29-OpM320_5*S29;
  OpM329_5 = OpM121_5*S29+OpM320_5*C29;
  AlM129_5 = C29*(AlM121_5+OpM221_5*s->dpt[3][45]-OpM320_5*s->dpt[2][45])-S29*(AlM321_5+OpM121_5*s->dpt[2][45]-OpM221_5*
 s->dpt[1][45]);
  AlM229_5 = AlM221_5-OpM121_5*s->dpt[3][45]+OpM320_5*s->dpt[1][45];
  AlM329_5 = C29*(AlM321_5+OpM121_5*s->dpt[2][45]-OpM221_5*s->dpt[1][45])+S29*(AlM121_5+OpM221_5*s->dpt[3][45]-OpM320_5*
 s->dpt[2][45]);
  OpM129_6 = OpM121_6*C29-OpM320_6*S29;
  OpM329_6 = OpM121_6*S29+OpM320_6*C29;
  AlM129_6 = C29*(AlM121_6+OpM221_6*s->dpt[3][45]-OpM320_6*s->dpt[2][45])-S29*(AlM321_6+OpM121_6*s->dpt[2][45]-OpM221_6*
 s->dpt[1][45]);
  AlM229_6 = AlM221_6-OpM121_6*s->dpt[3][45]+OpM320_6*s->dpt[1][45];
  AlM329_6 = C29*(AlM321_6+OpM121_6*s->dpt[2][45]-OpM221_6*s->dpt[1][45])+S29*(AlM121_6+OpM221_6*s->dpt[3][45]-OpM320_6*
 s->dpt[2][45]);
  OpM129_19 = OpM121_19*C29-S20*S29;
  OpM329_19 = OpM121_19*S29+S20*C29;
  AlM129_19 = C29*(AlM121_19+OpM221_19*s->dpt[3][45]-s->dpt[2][45]*S20)-S29*(AlM321_19+OpM121_19*s->dpt[2][45]-OpM221_19
 *s->dpt[1][45]);
  AlM229_19 = AlM221_19-OpM121_19*s->dpt[3][45]+s->dpt[1][45]*S20;
  AlM329_19 = C29*(AlM321_19+OpM121_19*s->dpt[2][45]-OpM221_19*s->dpt[1][45])+S29*(AlM121_19+OpM221_19*s->dpt[3][45]-
 s->dpt[2][45]*S20);
  OpM129_20 = S21*C29;
  OpM329_20 = S21*S29;
  ...
  AlF230 = C30*(AlF229+s->dpt[1][59]*BeF429+s->dpt[3][59]*BeF629+BS529*s->dpt[2][59])+S30*(AlF329+s->dpt[1][59]*BeF729+
 s->dpt[3][59]*BS929+BeF829*s->dpt[2][59]);
  AlF330 = C30*(AlF329+s->dpt[1][59]*BeF729+s->dpt[3][59]*BS929+BeF829*s->dpt[2][59])-S30*(AlF229+s->dpt[1][59]*BeF429+
 s->dpt[3][59]*BeF629+BS529*s->dpt[2][59]);
  ...
  AlM230_4 = C30*(AlM229_4+s->dpt[1][59]*OpM329_4-s->dpt[3][59]*OpM129_4)+S30*(AlM329_4-s->dpt[1][59]*OpM221_4+OpM129_4*
 s->dpt[2][59]);
  AlM330_4 = C30*(AlM329_4-s->dpt[1][59]*OpM221_4+OpM129_4*s->dpt[2][59])-S30*(AlM229_4+s->dpt[1][59]*OpM329_4-
 s->dpt[3][59]*OpM129_4);
  ...
  AlM230_5 = C30*(AlM229_5+s->dpt[1][59]*OpM329_5-s->dpt[3][59]*OpM129_5)+S30*(AlM329_5-s->dpt[1][59]*OpM221_5+OpM129_5*
 s->dpt[2][59]);
  AlM330_5 = C30*(AlM329_5-s->dpt[1][59]*OpM221_5+OpM129_5*s->dpt[2][59])-S30*(AlM229_5+s->dpt[1][59]*OpM329_5-
 s->dpt[3][59]*OpM129_5);
  ...
  AlM230_6 = C30*(AlM229_6+s->dpt[1][59]*OpM329_6-s->dpt[3][59]*OpM129_6)+S30*(AlM329_6-s->dpt[1][59]*OpM221_6+OpM129_6*
 s->dpt[2][59]);
  AlM330_6 = C30*(AlM329_6-s->dpt[1][59]*OpM221_6+OpM129_6*s->dpt[2][59])-S30*(AlM229_6+s->dpt[1][59]*OpM329_6-
 s->dpt[3][59]*OpM129_6);
  ...
  AlM230_19 = C30*(AlM229_19+s->dpt[1][59]*OpM329_19-s->dpt[3][59]*OpM129_19)+S30*(AlM329_19-s->dpt[1][59]*OpM221_19+
 OpM129_19*s->dpt[2][59]);
  AlM330_19 = C30*(AlM329_19-s->dpt[1][59]*OpM221_19+OpM129_19*s->dpt[2][59])-S30*(AlM229_19+s->dpt[1][59]*OpM329_19-
 s->dpt[3][59]*OpM129_19);
  OpM230_20 = OpM329_20*S30+C21*C30;
  OpM330_20 = OpM329_20*C30-C21*S30;
  AlM130_20 = AlM129_20+s->dpt[3][59]*C21-OpM329_20*s->dpt[2][59];
  AlM230_20 = C30*(AlM229_20+s->dpt[1][59]*OpM329_20-s->dpt[3][59]*OpM129_20)+S30*(AlM329_20-s->dpt[1][59]*C21+OpM129_20
 *s->dpt[2][59]);
  AlM330_20 = C30*(AlM329_20-s->dpt[1][59]*C21+OpM129_20*s->dpt[2][59])-S30*(AlM229_20+s->dpt[1][59]*OpM329_20-
 s->dpt[3][59]*OpM129_20);
  OpM230_21 = C29*S30;
  OpM330_21 = C29*C30;
  ...
  BeF731 = BS331-OpF230;
  BeF831 = BS631+OpF131;
  AlF131 = C31*(AlF130+s->dpt[1][61]*BS130+s->dpt[3][61]*BeF330+BeF230*s->dpt[2][61])-S31*(AlF330+s->dpt[1][61]*BeF730+
 s->dpt[3][61]*BS930+BeF830*s->dpt[2][61]);
  AlF231 = AlF230+s->dpt[1][61]*BeF430+s->dpt[3][61]*BeF630+BS530*s->dpt[2][61];
  AlF331 = C31*(AlF330+s->dpt[1][61]*BeF730+s->dpt[3][61]*BS930+BeF830*s->dpt[2][61])+S31*(AlF130+s->dpt[1][61]*BS130+
 s->dpt[3][61]*BeF330+BeF230*s->dpt[2][61]);
  ...
  AlM131_4 = C31*(AlM130_4+s->dpt[3][61]*OpM230_4-OpM330_4*s->dpt[2][61])-S31*(AlM330_4-s->dpt[1][61]*OpM230_4+OpM129_4*
 s->dpt[2][61]);
  AlM231_4 = AlM230_4+s->dpt[1][61]*OpM330_4-s->dpt[3][61]*OpM129_4;
  AlM331_4 = C31*(AlM330_4-s->dpt[1][61]*OpM230_4+OpM129_4*s->dpt[2][61])+S31*(AlM130_4+s->dpt[3][61]*OpM230_4-OpM330_4*
 s->dpt[2][61]);
  OpM131_5 = OpM129_5*C31-OpM330_5*S31;
  OpM331_5 = OpM129_5*S31+OpM330_5*C31;
  AlM131_5 = C31*(AlM130_5+s->dpt[3][61]*OpM230_5-OpM330_5*s->dpt[2][61])-S31*(AlM330_5-s->dpt[1][61]*OpM230_5+OpM129_5*
 s->dpt[2][61]);
  AlM231_5 = AlM230_5+s->dpt[1][61]*OpM330_5-s->dpt[3][61]*OpM129_5;
  AlM331_5 = C31*(AlM330_5-s->dpt[1][61]*OpM230_5+OpM129_5*s->dpt[2][61])+S31*(AlM130_5+s->dpt[3][61]*OpM230_5-OpM330_5*
 s->dpt[2][61]);
  OpM131_6 = OpM129_6*C31-OpM330_6*S31;
  OpM331_6 = OpM129_6*S31+OpM330_6*C31;
  AlM131_6 = C31*(AlM130_6+s->dpt[3][61]*OpM230_6-OpM330_6*s->dpt[2][61])-S31*(AlM330_6-s->dpt[1][61]*OpM230_6+OpM129_6*
 s->dpt[2][61]);
  AlM231_6 = AlM230_6+s->dpt[1][61]*OpM330_6-s->dpt[3][61]*OpM129_6;
  AlM331_6 = C31*(AlM330_6-s->dpt[1][61]*OpM230_6+OpM129_6*s->dpt[2][61])+S31*(AlM130_6+s->dpt[3][61]*OpM230_6-OpM330_6*
 s->dpt[2][61]);
  OpM131_19 = OpM129_19*C31-OpM330_19*S31;
  OpM331_19 = OpM129_19*S31+OpM330_19*C31;
  AlM131_19 = C31*(AlM130_19+s->dpt[3][61]*OpM230_19-OpM330_19*s->dpt[2][61])-S31*(AlM330_19-s->dpt[1][61]*OpM230_19+
 OpM129_19*s->dpt[2][61]);
  AlM231_19 = AlM230_19+s->dpt[1][61]*OpM330_19-s->dpt[3][61]*OpM129_19;
  AlM331_19 = C31*(AlM330_19-s->dpt[1][61]*OpM230_19+OpM129_19*s->dpt[2][61])+S31*(AlM130_19+s->dpt[3][61]*OpM230_19-
 OpM330_19*s->dpt[2][61]);
  OpM131_20 = OpM129_20*C31-OpM330_20*S31;
  OpM331_20 = OpM129_20*S31+OpM330_20*C31;
  AlM131_20 = C31*(AlM130_20+s->dpt[3][61]*OpM230_20-OpM330_20*s->dpt[2][61])-S31*(AlM330_20-s->dpt[1][61]*OpM230_20+
 OpM129_20*s->dpt[2][61]);
  AlM231_20 = AlM230_20+s->dpt[1][61]*OpM330_20-s->dpt[3][61]*OpM129_20;
  AlM331_20 = C31*(AlM330_20-s->dpt[1][61]*OpM230_20+OpM129_20*s->dpt[2][61])+S31*(AlM130_20+s->dpt[3][61]*OpM230_20-
 OpM330_20*s->dpt[2][61]);
  OpM131_21 = -(OpM330_21*S31+S29*C31);
  OpM331_21 = OpM330_21*C31-S29*S31;
  AlM131_21 = C31*(AlM130_21+s->dpt[3][61]*OpM230_21-OpM330_21*s->dpt[2][61])-S31*(AlM330_21-s->dpt[1][61]*OpM230_21-
 s->dpt[2][61]*S29);
  AlM231_21 = AlM230_21+s->dpt[1][61]*OpM330_21+s->dpt[3][61]*S29;
  AlM331_21 = C31*(AlM330_21-s->dpt[1][61]*OpM230_21-s->dpt[2][61]*S29)+S31*(AlM130_21+s->dpt[3][61]*OpM230_21-OpM330_21
 *s->dpt[2][61]);
  OpM131_29 = S30*S31;
  OpM331_29 = -S30*C31;
  ...
  BeF732 = BS332-OpF232;
  BeF832 = BS632+OpF132;
  AlF132 = C32*(AlF131+s->dpt[3][63]*BeF331+BS131*s->dpt[1][63]+BeF231*s->dpt[2][63])+S32*(AlF231+s->dpt[3][63]*BeF631+
 BS531*s->dpt[2][63]+BeF431*s->dpt[1][63]);
  AlF232 = C32*(AlF231+s->dpt[3][63]*BeF631+BS531*s->dpt[2][63]+BeF431*s->dpt[1][63])-S32*(AlF131+s->dpt[3][63]*BeF331+
 BS131*s->dpt[1][63]+BeF231*s->dpt[2][63]);
  ...
  AlM132_4 = C32*(AlM131_4+s->dpt[3][63]*OpM230_4-OpM331_4*s->dpt[2][63])+S32*(AlM231_4-s->dpt[3][63]*OpM131_4+OpM331_4*
 s->dpt[1][63]);
  AlM232_4 = C32*(AlM231_4-s->dpt[3][63]*OpM131_4+OpM331_4*s->dpt[1][63])-S32*(AlM131_4+s->dpt[3][63]*OpM230_4-OpM331_4*
 s->dpt[2][63]);
  ...
  AlM132_5 = C32*(AlM131_5+s->dpt[3][63]*OpM230_5-OpM331_5*s->dpt[2][63])+S32*(AlM231_5-s->dpt[3][63]*OpM131_5+OpM331_5*
 s->dpt[1][63]);
  AlM232_5 = C32*(AlM231_5-s->dpt[3][63]*OpM131_5+OpM331_5*s->dpt[1][63])-S32*(AlM131_5+s->dpt[3][63]*OpM230_5-OpM331_5*
 s->dpt[2][63]);
  ...
  AlM132_6 = C32*(AlM131_6+s->dpt[3][63]*OpM230_6-OpM331_6*s->dpt[2][63])+S32*(AlM231_6-s->dpt[3][63]*OpM131_6+OpM331_6*
 s->dpt[1][63]);
  AlM232_6 = C32*(AlM231_6-s->dpt[3][63]*OpM131_6+OpM331_6*s->dpt[1][63])-S32*(AlM131_6+s->dpt[3][63]*OpM230_6-OpM331_6*
 s->dpt[2][63]);
  ...
  AlM132_19 = C32*(AlM131_19+s->dpt[3][63]*OpM230_19-OpM331_19*s->dpt[2][63])+S32*(AlM231_19-s->dpt[3][63]*OpM131_19+
 OpM331_19*s->dpt[1][63]);
  AlM232_19 = C32*(AlM231_19-s->dpt[3][63]*OpM131_19+OpM331_19*s->dpt[1][63])-S32*(AlM131_19+s->dpt[3][63]*OpM230_19-
 OpM331_19*s->dpt[2][63]);
  ...
  AlM132_20 = C32*(AlM131_20+s->dpt[3][63]*OpM230_20-OpM331_20*s->dpt[2][63])+S32*(AlM231_20-s->dpt[3][63]*OpM131_20+
 OpM331_20*s->dpt[1][63]);
  AlM232_20 = C32*(AlM231_20-s->dpt[3][63]*OpM131_20+OpM331_20*s->dpt[1][63])-S32*(AlM131_20+s->dpt[3][63]*OpM230_20-
 OpM331_20*s->dpt[2][63]);
  ...
  AlM132_21 = C32*(AlM131_21+s->dpt[3][63]*OpM230_21-OpM331_21*s->dpt[2][63])+S32*(AlM231_21-s->dpt[3][63]*OpM131_21+
 OpM331_21*s->dpt[1][63]);
  AlM232_21 = C32*(AlM231_21-s->dpt[3][63]*OpM131_21+OpM331_21*s->dpt[1][63])-S32*(AlM131_21+s->dpt[3][63]*OpM230_21-
 OpM331_21*s->dpt[2][63]);
  ...
  AlM132_29 = C32*(AlM131_29+s->dpt[3][63]*C30-OpM331_29*s->dpt[2][63])+S32*(AlM231_29-s->dpt[3][63]*OpM131_29+OpM331_29
 *s->dpt[1][63]);
  AlM232_29 = C32*(AlM231_29-s->dpt[3][63]*OpM131_29+OpM331_29*s->dpt[1][63])-S32*(AlM131_29+s->dpt[3][63]*C30-OpM331_29
 *s->dpt[2][63]);
  ...
  BeF733 = BS333-OpF232;
  BeF833 = BS633+OpF133;
  AlF133 = C33*(AlF132+s->dpt[2][65]*BeF232+s->dpt[3][65]*BeF332+BS132*s->dpt[1][65])-S33*(AlF332+s->dpt[2][65]*BeF832+
 s->dpt[3][65]*BS932+BeF732*s->dpt[1][65]);
  AlF233 = AlF232+s->dpt[2][65]*BS532+s->dpt[3][65]*BeF632+BeF432*s->dpt[1][65];
  AlF333 = C33*(AlF332+s->dpt[2][65]*BeF832+s->dpt[3][65]*BS932+BeF732*s->dpt[1][65])+S33*(AlF132+s->dpt[2][65]*BeF232+
 s->dpt[3][65]*BeF332+BS132*s->dpt[1][65]);
  ...
  AlM133_4 = C33*(AlM132_4-s->dpt[2][65]*OpM331_4+s->dpt[3][65]*OpM232_4)-S33*(AlM332_4+s->dpt[2][65]*OpM132_4-OpM232_4*
 s->dpt[1][65]);
  AlM233_4 = AlM232_4-s->dpt[3][65]*OpM132_4+OpM331_4*s->dpt[1][65];
  AlM333_4 = C33*(AlM332_4+s->dpt[2][65]*OpM132_4-OpM232_4*s->dpt[1][65])+S33*(AlM132_4-s->dpt[2][65]*OpM331_4+
 s->dpt[3][65]*OpM232_4);
  OpM133_5 = OpM132_5*C33-OpM331_5*S33;
  OpM333_5 = OpM132_5*S33+OpM331_5*C33;
  AlM133_5 = C33*(AlM132_5-s->dpt[2][65]*OpM331_5+s->dpt[3][65]*OpM232_5)-S33*(AlM332_5+s->dpt[2][65]*OpM132_5-OpM232_5*
 s->dpt[1][65]);
  AlM233_5 = AlM232_5-s->dpt[3][65]*OpM132_5+OpM331_5*s->dpt[1][65];
  AlM333_5 = C33*(AlM332_5+s->dpt[2][65]*OpM132_5-OpM232_5*s->dpt[1][65])+S33*(AlM132_5-s->dpt[2][65]*OpM331_5+
 s->dpt[3][65]*OpM232_5);
  OpM133_6 = OpM132_6*C33-OpM331_6*S33;
  OpM333_6 = OpM132_6*S33+OpM331_6*C33;
  AlM133_6 = C33*(AlM132_6-s->dpt[2][65]*OpM331_6+s->dpt[3][65]*OpM232_6)-S33*(AlM332_6+s->dpt[2][65]*OpM132_6-OpM232_6*
 s->dpt[1][65]);
  AlM233_6 = AlM232_6-s->dpt[3][65]*OpM132_6+OpM331_6*s->dpt[1][65];
  AlM333_6 = C33*(AlM332_6+s->dpt[2][65]*OpM132_6-OpM232_6*s->dpt[1][65])+S33*(AlM132_6-s->dpt[2][65]*OpM331_6+
 s->dpt[3][65]*OpM232_6);
  OpM133_19 = OpM132_19*C33-OpM331_19*S33;
  OpM333_19 = OpM132_19*S33+OpM331_19*C33;
  AlM133_19 = C33*(AlM132_19-s->dpt[2][65]*OpM331_19+s->dpt[3][65]*OpM232_19)-S33*(AlM332_19+s->dpt[2][65]*OpM132_19-
 OpM232_19*s->dpt[1][65]);
  AlM233_19 = AlM232_19-s->dpt[3][65]*OpM132_19+OpM331_19*s->dpt[1][65];
  AlM333_19 = C33*(AlM332_19+s->dpt[2][65]*OpM132_19-OpM232_19*s->dpt[1][65])+S33*(AlM132_19-s->dpt[2][65]*OpM331_19+
 s->dpt[3][65]*OpM232_19);
  OpM133_20 = OpM132_20*C33-OpM331_20*S33;
  OpM333_20 = OpM132_20*S33+OpM331_20*C33;
  AlM133_20 = C33*(AlM132_20-s->dpt[2][65]*OpM331_20+s->dpt[3][65]*OpM232_20)-S33*(AlM332_20+s->dpt[2][65]*OpM132_20-
 OpM232_20*s->dpt[1][65]);
  AlM233_20 = AlM232_20-s->dpt[3][65]*OpM132_20+OpM331_20*s->dpt[1][65];
  AlM333_20 = C33*(AlM332_20+s->dpt[2][65]*OpM132_20-OpM232_20*s->dpt[1][65])+S33*(AlM132_20-s->dpt[2][65]*OpM331_20+
 s->dpt[3][65]*OpM232_20);
  OpM133_21 = OpM132_21*C33-OpM331_21*S33;
  OpM333_21 = OpM132_21*S33+OpM331_21*C33;
  AlM133_21 = C33*(AlM132_21-s->dpt[2][65]*OpM331_21+s->dpt[3][65]*OpM232_21)-S33*(AlM332_21+s->dpt[2][65]*OpM132_21-
 OpM232_21*s->dpt[1][65]);
  AlM233_21 = AlM232_21-s->dpt[3][65]*OpM132_21+OpM331_21*s->dpt[1][65];
  AlM333_21 = C33*(AlM332_21+s->dpt[2][65]*OpM132_21-OpM232_21*s->dpt[1][65])+S33*(AlM132_21-s->dpt[2][65]*OpM331_21+
 s->dpt[3][65]*OpM232_21);
  OpM133_29 = OpM132_29*C33-OpM331_29*S33;
  OpM333_29 = OpM132_29*S33+OpM331_29*C33;
  AlM133_29 = C33*(AlM132_29-s->dpt[2][65]*OpM331_29+s->dpt[3][65]*OpM232_29)-S33*(AlM332_29+s->dpt[2][65]*OpM132_29-
 OpM232_29*s->dpt[1][65]);
  AlM233_29 = AlM232_29-s->dpt[3][65]*OpM132_29+OpM331_29*s->dpt[1][65];
  AlM333_29 = C33*(AlM332_29+s->dpt[2][65]*OpM132_29-OpM232_29*s->dpt[1][65])+S33*(AlM132_29-s->dpt[2][65]*OpM331_29+
 s->dpt[3][65]*OpM232_29);
  OpM133_30 = OpM132_30*C33-S31*S33;
  OpM333_30 = OpM132_30*S33+S31*C33;
  AlM133_30 = C33*(AlM132_30-s->dpt[2][65]*S31+s->dpt[3][65]*OpM232_30)-S33*(AlM332_30+s->dpt[2][65]*OpM132_30-OpM232_30
 *s->dpt[1][65]);
  AlM233_30 = AlM232_30-s->dpt[3][65]*OpM132_30+s->dpt[1][65]*S31;
  AlM333_30 = C33*(AlM332_30+s->dpt[2][65]*OpM132_30-OpM232_30*s->dpt[1][65])+S33*(AlM132_30-s->dpt[2][65]*S31+
 s->dpt[3][65]*OpM232_30);
  OpM133_31 = S32*C33;
  OpM333_31 = S32*S33;
  ...
  BeF734 = BS334-OpF234;
  BeF834 = BS634+OpF134;
  AlF134 = C34*(AlF133+s->dpt[1][66]*BS133+s->dpt[3][66]*BeF333+BeF233*s->dpt[2][66])+S34*(AlF233+s->dpt[1][66]*BeF433+
 s->dpt[3][66]*BeF633+BS533*s->dpt[2][66]);
  AlF234 = C34*(AlF233+s->dpt[1][66]*BeF433+s->dpt[3][66]*BeF633+BS533*s->dpt[2][66])-S34*(AlF133+s->dpt[1][66]*BS133+
 s->dpt[3][66]*BeF333+BeF233*s->dpt[2][66]);
  ...
  AlM134_4 = C34*(AlM133_4+s->dpt[3][66]*OpM232_4-OpM333_4*s->dpt[2][66])+S34*(AlM233_4+s->dpt[1][66]*OpM333_4-
 s->dpt[3][66]*OpM133_4);
  AlM234_4 = C34*(AlM233_4+s->dpt[1][66]*OpM333_4-s->dpt[3][66]*OpM133_4)-S34*(AlM133_4+s->dpt[3][66]*OpM232_4-OpM333_4*
 s->dpt[2][66]);
  ...
  AlM134_5 = C34*(AlM133_5+s->dpt[3][66]*OpM232_5-OpM333_5*s->dpt[2][66])+S34*(AlM233_5+s->dpt[1][66]*OpM333_5-
 s->dpt[3][66]*OpM133_5);
  AlM234_5 = C34*(AlM233_5+s->dpt[1][66]*OpM333_5-s->dpt[3][66]*OpM133_5)-S34*(AlM133_5+s->dpt[3][66]*OpM232_5-OpM333_5*
 s->dpt[2][66]);
  ...
  AlM134_6 = C34*(AlM133_6+s->dpt[3][66]*OpM232_6-OpM333_6*s->dpt[2][66])+S34*(AlM233_6+s->dpt[1][66]*OpM333_6-
 s->dpt[3][66]*OpM133_6);
  AlM234_6 = C34*(AlM233_6+s->dpt[1][66]*OpM333_6-s->dpt[3][66]*OpM133_6)-S34*(AlM133_6+s->dpt[3][66]*OpM232_6-OpM333_6*
 s->dpt[2][66]);
  ...
  AlM134_19 = C34*(AlM133_19+s->dpt[3][66]*OpM232_19-OpM333_19*s->dpt[2][66])+S34*(AlM233_19+s->dpt[1][66]*OpM333_19-
 s->dpt[3][66]*OpM133_19);
  AlM234_19 = C34*(AlM233_19+s->dpt[1][66]*OpM333_19-s->dpt[3][66]*OpM133_19)-S34*(AlM133_19+s->dpt[3][66]*OpM232_19-
 OpM333_19*s->dpt[2][66]);
  ...
  AlM134_20 = C34*(AlM133_20+s->dpt[3][66]*OpM232_20-OpM333_20*s->dpt[2][66])+S34*(AlM233_20+s->dpt[1][66]*OpM333_20-
 s->dpt[3][66]*OpM133_20);
  AlM234_20 = C34*(AlM233_20+s->dpt[1][66]*OpM333_20-s->dpt[3][66]*OpM133_20)-S34*(AlM133_20+s->dpt[3][66]*OpM232_20-
 OpM333_20*s->dpt[2][66]);
  ...
  AlM134_21 = C34*(AlM133_21+s->dpt[3][66]*OpM232_21-OpM333_21*s->dpt[2][66])+S34*(AlM233_21+s->dpt[1][66]*OpM333_21-
 s->dpt[3][66]*OpM133_21);
  AlM234_21 = C34*(AlM233_21+s->dpt[1][66]*OpM333_21-s->dpt[3][66]*OpM133_21)-S34*(AlM133_21+s->dpt[3][66]*OpM232_21-
 OpM333_21*s->dpt[2][66]);
  ...
  AlM134_29 = C34*(AlM133_29+s->dpt[3][66]*OpM232_29-OpM333_29*s->dpt[2][66])+S34*(AlM233_29+s->dpt[1][66]*OpM333_29-
 s->dpt[3][66]*OpM133_29);
  AlM234_29 = C34*(AlM233_29+s->dpt[1][66]*OpM333_29-s->dpt[3][66]*OpM133_29)-S34*(AlM133_29+s->dpt[3][66]*OpM232_29-
 OpM333_29*s->dpt[2][66]);
  ...
  AlM134_30 = C34*(AlM133_30+s->dpt[3][66]*OpM232_30-OpM333_30*s->dpt[2][66])+S34*(AlM233_30+s->dpt[1][66]*OpM333_30-
 s->dpt[3][66]*OpM133_30);
  AlM234_30 = C34*(AlM233_30+s->dpt[1][66]*OpM333_30-s->dpt[3][66]*OpM133_30)-S34*(AlM133_30+s->dpt[3][66]*OpM232_30-
 OpM333_30*s->dpt[2][66]);
  ...
  AlM134_31 = C34*(AlM133_31+s->dpt[3][66]*C32-OpM333_31*s->dpt[2][66])+S34*(AlM233_31+s->dpt[1][66]*OpM333_31-
 s->dpt[3][66]*OpM133_31);
  AlM234_31 = C34*(AlM233_31+s->dpt[1][66]*OpM333_31-s->dpt[3][66]*OpM133_31)-S34*(AlM133_31+s->dpt[3][66]*C32-OpM333_31
 *s->dpt[2][66]);
...
// Backward Dynamics 
  ...
  FA128 = -(s->frc[1][28]-s->m[28]*(AlF127+s->dpt[1][56]*BS127+s->dpt[2][56]*BeF227+s->dpt[3][56]*BeF327-s->l[1][28]*(
 OM228*OM228+OM328*OM328)+s->l[2][28]*(BS228-OpF328)+s->l[3][28]*(BS328+OpF228)));
  FA228 = -(s->frc[2][28]-s->m[28]*(s->l[1][28]*(BS228+OpF328)-s->l[2][28]*(OM128*OM128+OM328*OM328)+s->l[3][28]*(BS628-
 OpF127)+C28*(AlF227+s->dpt[1][56]*BeF427+s->dpt[2][56]*BS527+s->dpt[3][56]*BeF627)+S28*(AlF327+s->dpt[1][56]*BeF727+
 s->dpt[2][56]*BeF827+s->dpt[3][56]*BS927)));
  FA328 = -(s->frc[3][28]-s->m[28]*(s->l[1][28]*(BS328-OpF228)+s->l[2][28]*(BS628+OpF127)-s->l[3][28]*(OM128*OM128+OM228
 *OM228)+C28*(AlF327+s->dpt[1][56]*BeF727+s->dpt[2][56]*BeF827+s->dpt[3][56]*BS927)-S28*(AlF227+s->dpt[1][56]*BeF427+
 s->dpt[2][56]*BS527+s->dpt[3][56]*BeF627)));
  CF128 = -(s->trq[1][28]-s->In[1][28]*OpF127-s->In[2][28]*OpF228-s->In[3][28]*OpF328-s->l[2][28]*FA328+s->l[3][28]*
 FA228+OM328*(s->In[5][28]*OM228+s->In[6][28]*OM328-s->In[9][28]*OM228));
  CF228 = -(s->trq[2][28]-s->In[5][28]*OpF228-s->In[6][28]*OpF328+s->l[1][28]*FA328-s->l[3][28]*FA128-OM328*(
 s->In[1][28]*OM128+s->In[2][28]*OM228+s->In[3][28]*OM328-s->In[9][28]*OM128));
  CF328 = -(s->trq[3][28]-s->In[9][28]*OpF328-s->l[1][28]*FA228+s->l[2][28]*FA128-OM128*(s->In[5][28]*OM228+s->In[6][28]
 *OM328)+OM228*(s->In[1][28]*OM128+s->In[2][28]*OM228+s->In[3][28]*OM328));
  ...
  FB228_4 = s->m[28]*(s->l[1][28]*OpM328_4-s->l[3][28]*OpM127_4+C28*(AlM227_4+s->dpt[1][56]*OpM326_4-s->dpt[3][56]*
 OpM127_4)+S28*(AlM327_4-s->dpt[1][56]*OpM227_4+s->dpt[2][56]*OpM127_4));
  FB328_4 = s->m[28]*(C28*(AlM327_4-s->dpt[1][56]*OpM227_4+s->dpt[2][56]*OpM127_4)-S28*(AlM227_4+s->dpt[1][56]*OpM326_4-
 s->dpt[3][56]*OpM127_4)-s->l[1][28]*OpM228_4+s->l[2][28]*OpM127_4);
  ...
  FB228_5 = s->m[28]*(s->l[1][28]*OpM328_5-s->l[3][28]*OpM127_5+C28*(AlM227_5+s->dpt[1][56]*OpM326_5-s->dpt[3][56]*
 OpM127_5)+S28*(AlM327_5-s->dpt[1][56]*OpM227_5+s->dpt[2][56]*OpM127_5));
  FB328_5 = s->m[28]*(C28*(AlM327_5-s->dpt[1][56]*OpM227_5+s->dpt[2][56]*OpM127_5)-S28*(AlM227_5+s->dpt[1][56]*OpM326_5-
 s->dpt[3][56]*OpM127_5)-s->l[1][28]*OpM228_5+s->l[2][28]*OpM127_5);
  ...
  FB228_6 = s->m[28]*(s->l[1][28]*OpM328_6-s->l[3][28]*OpM127_6+C28*(AlM227_6+s->dpt[1][56]*OpM326_6-s->dpt[3][56]*
 OpM127_6)+S28*(AlM327_6-s->dpt[1][56]*OpM227_6+s->dpt[2][56]*OpM127_6));
  FB328_6 = s->m[28]*(C28*(AlM327_6-s->dpt[1][56]*OpM227_6+s->dpt[2][56]*OpM127_6)-S28*(AlM227_6+s->dpt[1][56]*OpM326_6-
 s->dpt[3][56]*OpM127_6)-s->l[1][28]*OpM228_6+s->l[2][28]*OpM127_6);
  ...
  FB128_19 = s->m[28]*(AlM127_19-s->dpt[2][56]*OpM326_19+s->dpt[3][56]*OpM227_19-s->l[2][28]*OpM328_19+s->l[3][28]*
 OpM228_19);
  FB228_19 = s->m[28]*(s->l[1][28]*OpM328_19-s->l[3][28]*OpM127_19+C28*(AlM227_19+s->dpt[1][56]*OpM326_19-s->dpt[3][56]*
 OpM127_19)+S28*(AlM327_19-s->dpt[1][56]*OpM227_19+s->dpt[2][56]*OpM127_19));
  FB328_19 = s->m[28]*(C28*(AlM327_19-s->dpt[1][56]*OpM227_19+s->dpt[2][56]*OpM127_19)-S28*(AlM227_19+s->dpt[1][56]*
 OpM326_19-s->dpt[3][56]*OpM127_19)-s->l[1][28]*OpM228_19+s->l[2][28]*OpM127_19);
  CM128_19 = s->In[1][28]*OpM127_19+s->In[2][28]*OpM228_19+s->In[3][28]*OpM328_19+s->l[2][28]*FB328_19-s->l[3][28]*
 FB228_19;
  ...
  FB128_20 = s->m[28]*(AlM127_20-s->dpt[2][56]*OpM326_20+s->dpt[3][56]*OpM227_20-s->l[2][28]*OpM328_20+s->l[3][28]*
 OpM228_20);
  FB228_20 = s->m[28]*(s->l[1][28]*OpM328_20-s->l[3][28]*OpM127_20+C28*(AlM227_20+s->dpt[1][56]*OpM326_20-s->dpt[3][56]*
 OpM127_20)+S28*(AlM327_20-s->dpt[1][56]*OpM227_20+s->dpt[2][56]*OpM127_20));
  FB328_20 = s->m[28]*(C28*(AlM327_20-s->dpt[1][56]*OpM227_20+s->dpt[2][56]*OpM127_20)-S28*(AlM227_20+s->dpt[1][56]*
 OpM326_20-s->dpt[3][56]*OpM127_20)-s->l[1][28]*OpM228_20+s->l[2][28]*OpM127_20);
  CM128_20 = s->In[1][28]*OpM127_20+s->In[2][28]*OpM228_20+s->In[3][28]*OpM328_20+s->l[2][28]*FB328_20-s->l[3][28]*
 FB228_20;
  ...
  FB128_21 = s->m[28]*(AlM127_21-s->dpt[2][56]*OpM326_21+s->dpt[3][56]*OpM227_21-s->l[2][28]*OpM328_21+s->l[3][28]*
 OpM228_21);
  FB228_21 = s->m[28]*(s->l[1][28]*OpM328_21-s->l[3][28]*OpM127_21+C28*(AlM227_21+s->dpt[1][56]*OpM326_21-s->dpt[3][56]*
 OpM127_21)+S28*(AlM327_21-s->dpt[1][56]*OpM227_21+s->dpt[2][56]*OpM127_21));
  FB328_21 = s->m[28]*(C28*(AlM327_21-s->dpt[1][56]*OpM227_21+s->dpt[2][56]*OpM127_21)-S28*(AlM227_21+s->dpt[1][56]*
 OpM326_21-s->dpt[3][56]*OpM127_21)-s->l[1][28]*OpM228_21+s->l[2][28]*OpM127_21);
  CM128_21 = s->In[1][28]*OpM127_21+s->In[2][28]*OpM228_21+s->In[3][28]*OpM328_21+s->l[2][28]*FB328_21-s->l[3][28]*
 FB228_21;
  ...
  FB128_22 = s->m[28]*(AlM127_22-s->dpt[2][56]*OpM326_22+s->dpt[3][56]*OpM227_22-s->l[2][28]*OpM328_22+s->l[3][28]*
 OpM228_22);
  FB228_22 = s->m[28]*(s->l[1][28]*OpM328_22-s->l[3][28]*OpM127_22+C28*(AlM227_22+s->dpt[1][56]*OpM326_22-s->dpt[3][56]*
 OpM127_22)+S28*(AlM327_22-s->dpt[1][56]*OpM227_22+s->dpt[2][56]*OpM127_22));
  FB328_22 = s->m[28]*(C28*(AlM327_22-s->dpt[1][56]*OpM227_22+s->dpt[2][56]*OpM127_22)-S28*(AlM227_22+s->dpt[1][56]*
 OpM326_22-s->dpt[3][56]*OpM127_22)-s->l[1][28]*OpM228_22+s->l[2][28]*OpM127_22);
  CM128_22 = s->In[1][28]*OpM127_22+s->In[2][28]*OpM228_22+s->In[3][28]*OpM328_22+s->l[2][28]*FB328_22-s->l[3][28]*
 FB228_22;
  ...
  FB128_23 = s->m[28]*(AlM127_23-s->dpt[2][56]*OpM326_23+s->dpt[3][56]*OpM227_23-s->l[2][28]*OpM328_23+s->l[3][28]*
 OpM228_23);
  FB228_23 = s->m[28]*(s->l[1][28]*OpM328_23-s->l[3][28]*OpM127_23+C28*(AlM227_23+s->dpt[1][56]*OpM326_23-s->dpt[3][56]*
 OpM127_23)+S28*(AlM327_23-s->dpt[1][56]*OpM227_23+s->dpt[2][56]*OpM127_23));
  FB328_23 = s->m[28]*(C28*(AlM327_23-s->dpt[1][56]*OpM227_23+s->dpt[2][56]*OpM127_23)-S28*(AlM227_23+s->dpt[1][56]*
 OpM326_23-s->dpt[3][56]*OpM127_23)-s->l[1][28]*OpM228_23+s->l[2][28]*OpM127_23);
  CM128_23 = s->In[1][28]*OpM127_23+s->In[2][28]*OpM228_23+s->In[3][28]*OpM328_23+s->l[2][28]*FB328_23-s->l[3][28]*
 FB228_23;
  ...
  FB128_24 = s->m[28]*(AlM127_24-s->dpt[2][56]*OpM326_24+s->dpt[3][56]*OpM227_24-s->l[2][28]*OpM328_24+s->l[3][28]*
 OpM228_24);
  FB228_24 = s->m[28]*(s->l[1][28]*OpM328_24-s->l[3][28]*OpM127_24+C28*(AlM227_24+s->dpt[1][56]*OpM326_24-s->dpt[3][56]*
 OpM127_24)+S28*(AlM327_24-s->dpt[1][56]*OpM227_24+s->dpt[2][56]*OpM127_24));
  FB328_24 = s->m[28]*(C28*(AlM327_24-s->dpt[1][56]*OpM227_24+s->dpt[2][56]*OpM127_24)-S28*(AlM227_24+s->dpt[1][56]*
 OpM326_24-s->dpt[3][56]*OpM127_24)-s->l[1][28]*OpM228_24+s->l[2][28]*OpM127_24);
  CM128_24 = s->In[1][28]*OpM127_24+s->In[2][28]*OpM228_24+s->In[3][28]*OpM328_24+s->l[2][28]*FB328_24-s->l[3][28]*
 FB228_24;
  ...
  FB228_25 = s->m[28]*(s->l[1][28]*OpM328_25-s->l[3][28]*OpM127_25+C28*(AlM227_25+s->dpt[1][56]*C26-s->dpt[3][56]*
 OpM127_25)+S28*(AlM327_25-s->dpt[1][56]*OpM227_25+s->dpt[2][56]*OpM127_25));
  FB328_25 = s->m[28]*(C28*(AlM327_25-s->dpt[1][56]*OpM227_25+s->dpt[2][56]*OpM127_25)-S28*(AlM227_25+s->dpt[1][56]*C26-
 s->dpt[3][56]*OpM127_25)-s->l[1][28]*OpM228_25+s->l[2][28]*OpM127_25);
  CM128_25 = s->In[1][28]*OpM127_25+s->In[2][28]*OpM228_25+s->In[3][28]*OpM328_25+s->l[2][28]*FB328_25-s->l[3][28]*
 FB228_25;
  ...
  FB228_26 = s->m[28]*(s->l[1][28]*OpM328_26-s->l[3][28]*S27+C28*(AlM227_26-s->dpt[3][56]*S27)-S28*(s->dpt[1][55]+
 s->dpt[1][56]*C27-s->dpt[2][56]*S27));
  FB328_26 = s->m[28]*(S27*S28*(s->dpt[3][55]+s->dpt[3][56])-C28*(s->dpt[1][55]+s->dpt[1][56]*C27-s->dpt[2][56]*S27)-
 s->l[1][28]*OpM228_26+s->l[2][28]*S27);
  ...
  CF127 = -(s->trq[1][27]-CF128-s->In[1][27]*OpF127-s->In[2][27]*OpF227-s->In[3][27]*OpF326-s->dpt[2][56]*(FA228*S28+
 FA328*C28)+s->dpt[3][56]*(FA228*C28-FA328*S28)-s->l[2][27]*FA327+s->l[3][27]*FA227+OM327*(s->In[5][27]*OM227+s->In[6][27]*
 OM327-s->In[9][27]*OM227));
  CF227 = -(s->trq[2][27]-s->In[5][27]*OpF227-s->In[6][27]*OpF326+s->dpt[1][56]*(FA228*S28+FA328*C28)-s->dpt[3][56]*
 FA128+s->l[1][27]*FA327-s->l[3][27]*FA127-CF228*C28+CF328*S28-OM327*(s->In[1][27]*OM127+s->In[2][27]*OM227+s->In[3][27]*
 OM327-s->In[9][27]*OM127));
  CF327 = -(s->trq[3][27]-s->In[9][27]*OpF326-s->dpt[1][56]*(FA228*C28-FA328*S28)+s->dpt[2][56]*FA128-s->l[1][27]*FA227+
 s->l[2][27]*FA127-CF228*S28-CF328*C28-OM127*(s->In[5][27]*OM227+s->In[6][27]*OM327)+OM227*(s->In[1][27]*OM127+s->In[2][27]*
 OM227+s->In[3][27]*OM327));
  ...
  CM127_1 = CM128_1+s->dpt[2][56]*(FB228_1*S28+FB328_1*C28)-s->dpt[3][56]*(FB228_1*C28-FB328_1*S28)+s->l[2][27]*FB327_1-
 s->l[3][27]*FB227_1;
  CM227_1 = -(s->dpt[1][56]*(FB228_1*S28+FB328_1*C28)-s->dpt[3][56]*FB128_1+s->l[1][27]*FB327_1-s->l[3][27]*FB127_1-
 CM228_1*C28+CM328_1*S28);
  CM327_1 = s->dpt[1][56]*(FB228_1*C28-FB328_1*S28)-s->dpt[2][56]*FB128_1+s->l[1][27]*FB227_1-s->l[2][27]*FB127_1+
 CM228_1*S28+CM328_1*C28;
  ...
  CM127_2 = CM128_2+s->dpt[2][56]*(FB228_2*S28+FB328_2*C28)-s->dpt[3][56]*(FB228_2*C28-FB328_2*S28)+s->l[2][27]*FB327_2-
 s->l[3][27]*FB227_2;
  CM227_2 = -(s->dpt[1][56]*(FB228_2*S28+FB328_2*C28)-s->dpt[3][56]*FB128_2+s->l[1][27]*FB327_2-s->l[3][27]*FB127_2-
 CM228_2*C28+CM328_2*S28);
  CM327_2 = s->dpt[1][56]*(FB228_2*C28-FB328_2*S28)-s->dpt[2][56]*FB128_2+s->l[1][27]*FB227_2-s->l[2][27]*FB127_2+
 CM228_2*S28+CM328_2*C28;
  ...
  CM127_3 = CM128_3+s->dpt[2][56]*(FB228_3*S28+FB328_3*C28)-s->dpt[3][56]*(FB228_3*C28-FB328_3*S28)+s->l[2][27]*FB327_3-
 s->l[3][27]*FB227_3;
  CM227_3 = -(s->dpt[1][56]*(FB228_3*S28+FB328_3*C28)-s->dpt[3][56]*FB128_3+s->l[1][27]*FB327_3-s->l[3][27]*FB127_3-
 CM228_3*C28+CM328_3*S28);
  CM327_3 = s->dpt[1][56]*(FB228_3*C28-FB328_3*S28)-s->dpt[2][56]*FB128_3+s->l[1][27]*FB227_3-s->l[2][27]*FB127_3+
 CM228_3*S28+CM328_3*C28;
  ...
  CM127_4 = CM128_4+s->In[1][27]*OpM127_4+s->In[2][27]*OpM227_4+s->In[3][27]*OpM326_4+s->dpt[2][56]*(FB228_4*S28+FB328_4
 *C28)-s->dpt[3][56]*(FB228_4*C28-FB328_4*S28)+s->l[2][27]*FB327_4-s->l[3][27]*FB227_4;
  CM227_4 = s->In[5][27]*OpM227_4+s->In[6][27]*OpM326_4-s->dpt[1][56]*(FB228_4*S28+FB328_4*C28)+s->dpt[3][56]*FB128_4-
 s->l[1][27]*FB327_4+s->l[3][27]*FB127_4+CM228_4*C28-CM328_4*S28;
  CM327_4 = s->In[9][27]*OpM326_4+s->dpt[1][56]*(FB228_4*C28-FB328_4*S28)-s->dpt[2][56]*FB128_4+s->l[1][27]*FB227_4-
 s->l[2][27]*FB127_4+CM228_4*S28+CM328_4*C28;
  ...
  CM127_5 = CM128_5+s->In[1][27]*OpM127_5+s->In[2][27]*OpM227_5+s->In[3][27]*OpM326_5+s->dpt[2][56]*(FB228_5*S28+FB328_5
 *C28)-s->dpt[3][56]*(FB228_5*C28-FB328_5*S28)+s->l[2][27]*FB327_5-s->l[3][27]*FB227_5;
  CM227_5 = s->In[5][27]*OpM227_5+s->In[6][27]*OpM326_5-s->dpt[1][56]*(FB228_5*S28+FB328_5*C28)+s->dpt[3][56]*FB128_5-
 s->l[1][27]*FB327_5+s->l[3][27]*FB127_5+CM228_5*C28-CM328_5*S28;
  CM327_5 = s->In[9][27]*OpM326_5+s->dpt[1][56]*(FB228_5*C28-FB328_5*S28)-s->dpt[2][56]*FB128_5+s->l[1][27]*FB227_5-
 s->l[2][27]*FB127_5+CM228_5*S28+CM328_5*C28;
  ...
  CM127_6 = CM128_6+s->In[1][27]*OpM127_6+s->In[2][27]*OpM227_6+s->In[3][27]*OpM326_6+s->dpt[2][56]*(FB228_6*S28+FB328_6
 *C28)-s->dpt[3][56]*(FB228_6*C28-FB328_6*S28)+s->l[2][27]*FB327_6-s->l[3][27]*FB227_6;
  CM227_6 = s->In[5][27]*OpM227_6+s->In[6][27]*OpM326_6-s->dpt[1][56]*(FB228_6*S28+FB328_6*C28)+s->dpt[3][56]*FB128_6-
 s->l[1][27]*FB327_6+s->l[3][27]*FB127_6+CM228_6*C28-CM328_6*S28;
  CM327_6 = s->In[9][27]*OpM326_6+s->dpt[1][56]*(FB228_6*C28-FB328_6*S28)-s->dpt[2][56]*FB128_6+s->l[1][27]*FB227_6-
 s->l[2][27]*FB127_6+CM228_6*S28+CM328_6*C28;
  ...
  CM127_19 = CM128_19+s->In[1][27]*OpM127_19+s->In[2][27]*OpM227_19+s->In[3][27]*OpM326_19+s->dpt[2][56]*(FB228_19*S28+
 FB328_19*C28)-s->dpt[3][56]*(FB228_19*C28-FB328_19*S28)+s->l[2][27]*FB327_19-s->l[3][27]*FB227_19;
  CM227_19 = s->In[5][27]*OpM227_19+s->In[6][27]*OpM326_19-s->dpt[1][56]*(FB228_19*S28+FB328_19*C28)+s->dpt[3][56]*
 FB128_19-s->l[1][27]*FB327_19+s->l[3][27]*FB127_19+CM228_19*C28-CM328_19*S28;
  CM327_19 = s->In[9][27]*OpM326_19+s->dpt[1][56]*(FB228_19*C28-FB328_19*S28)-s->dpt[2][56]*FB128_19+s->l[1][27]*
 FB227_19-s->l[2][27]*FB127_19+CM228_19*S28+CM328_19*C28;
  ...
  CM127_20 = CM128_20+s->In[1][27]*OpM127_20+s->In[2][27]*OpM227_20+s->In[3][27]*OpM326_20+s->dpt[2][56]*(FB228_20*S28+
 FB328_20*C28)-s->dpt[3][56]*(FB228_20*C28-FB328_20*S28)+s->l[2][27]*FB327_20-s->l[3][27]*FB227_20;
  CM227_20 = s->In[5][27]*OpM227_20+s->In[6][27]*OpM326_20-s->dpt[1][56]*(FB228_20*S28+FB328_20*C28)+s->dpt[3][56]*
 FB128_20-s->l[1][27]*FB327_20+s->l[3][27]*FB127_20+CM228_20*C28-CM328_20*S28;
  CM327_20 = s->In[9][27]*OpM326_20+s->dpt[1][56]*(FB228_20*C28-FB328_20*S28)-s->dpt[2][56]*FB128_20+s->l[1][27]*
 FB227_20-s->l[2][27]*FB127_20+CM228_20*S28+CM328_20*C28;
  ...
  CM127_21 = CM128_21+s->In[1][27]*OpM127_21+s->In[2][27]*OpM227_21+s->In[3][27]*OpM326_21+s->dpt[2][56]*(FB228_21*S28+
 FB328_21*C28)-s->dpt[3][56]*(FB228_21*C28-FB328_21*S28)+s->l[2][27]*FB327_21-s->l[3][27]*FB227_21;
  CM227_21 = s->In[5][27]*OpM227_21+s->In[6][27]*OpM326_21-s->dpt[1][56]*(FB228_21*S28+FB328_21*C28)+s->dpt[3][56]*
 FB128_21-s->l[1][27]*FB327_21+s->l[3][27]*FB127_21+CM228_21*C28-CM328_21*S28;
  CM327_21 = s->In[9][27]*OpM326_21+s->dpt[1][56]*(FB228_21*C28-FB328_21*S28)-s->dpt[2][56]*FB128_21+s->l[1][27]*
 FB227_21-s->l[2][27]*FB127_21+CM228_21*S28+CM328_21*C28;
  ...
  CM127_22 = CM128_22+s->In[1][27]*OpM127_22+s->In[2][27]*OpM227_22+s->In[3][27]*OpM326_22+s->dpt[2][56]*(FB228_22*S28+
 FB328_22*C28)-s->dpt[3][56]*(FB228_22*C28-FB328_22*S28)+s->l[2][27]*FB327_22-s->l[3][27]*FB227_22;
  CM227_22 = s->In[5][27]*OpM227_22+s->In[6][27]*OpM326_22-s->dpt[1][56]*(FB228_22*S28+FB328_22*C28)+s->dpt[3][56]*
 FB128_22-s->l[1][27]*FB327_22+s->l[3][27]*FB127_22+CM228_22*C28-CM328_22*S28;
  CM327_22 = s->In[9][27]*OpM326_22+s->dpt[1][56]*(FB228_22*C28-FB328_22*S28)-s->dpt[2][56]*FB128_22+s->l[1][27]*
 FB227_22-s->l[2][27]*FB127_22+CM228_22*S28+CM328_22*C28;
  ...
  CM127_23 = CM128_23+s->In[1][27]*OpM127_23+s->In[2][27]*OpM227_23+s->In[3][27]*OpM326_23+s->dpt[2][56]*(FB228_23*S28+
 FB328_23*C28)-s->dpt[3][56]*(FB228_23*C28-FB328_23*S28)+s->l[2][27]*FB327_23-s->l[3][27]*FB227_23;
  CM227_23 = s->In[5][27]*OpM227_23+s->In[6][27]*OpM326_23-s->dpt[1][56]*(FB228_23*S28+FB328_23*C28)+s->dpt[3][56]*
 FB128_23-s->l[1][27]*FB327_23+s->l[3][27]*FB127_23+CM228_23*C28-CM328_23*S28;
  CM327_23 = s->In[9][27]*OpM326_23+s->dpt[1][56]*(FB228_23*C28-FB328_23*S28)-s->dpt[2][56]*FB128_23+s->l[1][27]*
 FB227_23-s->l[2][27]*FB127_23+CM228_23*S28+CM328_23*C28;
  ...
  CM127_24 = CM128_24+s->In[1][27]*OpM127_24+s->In[2][27]*OpM227_24+s->In[3][27]*OpM326_24+s->dpt[2][56]*(FB228_24*S28+
 FB328_24*C28)-s->dpt[3][56]*(FB228_24*C28-FB328_24*S28)+s->l[2][27]*FB327_24-s->l[3][27]*FB227_24;
  CM227_24 = s->In[5][27]*OpM227_24+s->In[6][27]*OpM326_24-s->dpt[1][56]*(FB228_24*S28+FB328_24*C28)+s->dpt[3][56]*
 FB128_24-s->l[1][27]*FB327_24+s->l[3][27]*FB127_24+CM228_24*C28-CM328_24*S28;
  CM327_24 = s->In[9][27]*OpM326_24+s->dpt[1][56]*(FB228_24*C28-FB328_24*S28)-s->dpt[2][56]*FB128_24+s->l[1][27]*
 FB227_24-s->l[2][27]*FB127_24+CM228_24*S28+CM328_24*C28;
  ...
  CM127_25 = CM128_25+s->In[1][27]*OpM127_25+s->In[2][27]*OpM227_25+s->In[3][27]*C26+s->dpt[2][56]*(FB228_25*S28+
 FB328_25*C28)-s->dpt[3][56]*(FB228_25*C28-FB328_25*S28)+s->l[2][27]*FB327_25-s->l[3][27]*FB227_25;
  CM227_25 = s->In[5][27]*OpM227_25+s->In[6][27]*C26-s->dpt[1][56]*(FB228_25*S28+FB328_25*C28)+s->dpt[3][56]*FB128_25-
 s->l[1][27]*FB327_25+s->l[3][27]*FB127_25+CM228_25*C28-CM328_25*S28;
  CM327_25 = s->In[9][27]*C26+s->dpt[1][56]*(FB228_25*C28-FB328_25*S28)-s->dpt[2][56]*FB128_25+s->l[1][27]*FB227_25-
 s->l[2][27]*FB127_25+CM228_25*S28+CM328_25*C28;
  ...
  CM327_26 = s->dpt[1][56]*(FB228_26*C28-FB328_26*S28)-s->dpt[2][56]*FB128_26+s->l[1][27]*FB227_26-s->l[2][27]*FB127_26+
 CM228_26*S28+CM328_26*C28;
  CM327_27 = s->In[9][27]+s->dpt[1][56]*(FB228_27*C28-FB328_27*S28)-s->dpt[2][56]*FB128_27+s->l[1][27]*s->l[1][27]*
 s->m[27]+s->l[2][27]*s->l[2][27]*s->m[27]+C28*(s->In[9][28]*C28+s->l[1][28]*FB228_27-s->l[2][28]*FB128_27)+S28*(s->In[5][28]
 *S28+s->In[6][28]*C28-s->l[1][28]*FB328_27+s->l[3][28]*FB128_27);
  ...
  FF326 = FA326+FF327;
  CF126 = -(s->trq[1][26]-s->In[1][26]*OpF126-s->In[2][26]*OpF225-s->In[3][26]*OpF326+s->dpt[3][55]*(FF127*S27+FF227*C27
 )+s->l[3][26]*FA226-CF127*C27+CF227*S27-FA326*s->l[2][26]-FF327*s->dpt[2][55]+OM326*(s->In[5][26]*OM226+s->In[6][26]*OM326-
 s->In[9][26]*OM226));
  CF226 = -(s->trq[2][26]-s->In[5][26]*OpF225-s->In[6][26]*OpF326+s->dpt[1][55]*FF327-s->dpt[3][55]*(FF127*C27-FF227*S27
 )+s->l[1][26]*FA326-s->l[3][26]*FA126-CF127*S27-CF227*C27-OM326*(s->In[1][26]*OM126+s->In[2][26]*OM226+s->In[3][26]*OM326-
 s->In[9][26]*OM126));
  CF326 = -(s->trq[3][26]-CF327-s->In[9][26]*OpF326-s->dpt[1][55]*(FF127*S27+FF227*C27)-s->l[1][26]*FA226+FA126*
 s->l[2][26]-OM126*(s->In[5][26]*OM226+s->In[6][26]*OM326)+OM226*(s->In[1][26]*OM126+s->In[2][26]*OM226+s->In[3][26]*OM326)+
 s->dpt[2][55]*(FF127*C27-FF227*S27));
  ...
  CM126_1 = -(s->dpt[3][55]*(FM127_1*S27+FM227_1*C27)+s->l[3][26]*FB226_1-CM127_1*C27+CM227_1*S27-FB326_1*s->l[2][26]-
 FM327_1*s->dpt[2][55]);
  CM226_1 = -(s->dpt[1][55]*FM327_1-s->dpt[3][55]*(FM127_1*C27-FM227_1*S27)+s->l[1][26]*FB326_1-s->l[3][26]*FB126_1-
 CM127_1*S27-CM227_1*C27);
  CM326_1 = CM327_1+s->dpt[1][55]*(FM127_1*S27+FM227_1*C27)+s->l[1][26]*FB226_1-FB126_1*s->l[2][26]-s->dpt[2][55]*(
 FM127_1*C27-FM227_1*S27);
  ...
  CM126_2 = -(s->dpt[3][55]*(FM127_2*S27+FM227_2*C27)+s->l[3][26]*FB226_2-CM127_2*C27+CM227_2*S27-FB326_2*s->l[2][26]-
 FM327_2*s->dpt[2][55]);
  CM226_2 = -(s->dpt[1][55]*FM327_2-s->dpt[3][55]*(FM127_2*C27-FM227_2*S27)+s->l[1][26]*FB326_2-s->l[3][26]*FB126_2-
 CM127_2*S27-CM227_2*C27);
  CM326_2 = CM327_2+s->dpt[1][55]*(FM127_2*S27+FM227_2*C27)+s->l[1][26]*FB226_2-FB126_2*s->l[2][26]-s->dpt[2][55]*(
 FM127_2*C27-FM227_2*S27);
  ...
  CM126_3 = -(s->dpt[3][55]*(FM127_3*S27+FM227_3*C27)+s->l[3][26]*FB226_3-CM127_3*C27+CM227_3*S27-FB326_3*s->l[2][26]-
 FM327_3*s->dpt[2][55]);
  CM226_3 = -(s->dpt[1][55]*FM327_3-s->dpt[3][55]*(FM127_3*C27-FM227_3*S27)+s->l[1][26]*FB326_3-s->l[3][26]*FB126_3-
 CM127_3*S27-CM227_3*C27);
  CM326_3 = CM327_3+s->dpt[1][55]*(FM127_3*S27+FM227_3*C27)+s->l[1][26]*FB226_3-FB126_3*s->l[2][26]-s->dpt[2][55]*(
 FM127_3*C27-FM227_3*S27);
  ...
  CM126_4 = s->In[1][26]*OpM126_4+s->In[2][26]*OpM225_4+s->In[3][26]*OpM326_4-s->dpt[3][55]*(FM127_4*S27+FM227_4*C27)-
 s->l[3][26]*FB226_4+CM127_4*C27-CM227_4*S27+FB326_4*s->l[2][26]+FM327_4*s->dpt[2][55];
  CM226_4 = s->In[5][26]*OpM225_4+s->In[6][26]*OpM326_4-s->dpt[1][55]*FM327_4+s->dpt[3][55]*(FM127_4*C27-FM227_4*S27)-
 s->l[1][26]*FB326_4+s->l[3][26]*FB126_4+CM127_4*S27+CM227_4*C27;
  CM326_4 = CM327_4+s->In[9][26]*OpM326_4+s->dpt[1][55]*(FM127_4*S27+FM227_4*C27)+s->l[1][26]*FB226_4-FB126_4*
 s->l[2][26]-s->dpt[2][55]*(FM127_4*C27-FM227_4*S27);
  ...
  CM126_5 = s->In[1][26]*OpM126_5+s->In[2][26]*OpM225_5+s->In[3][26]*OpM326_5-s->dpt[3][55]*(FM127_5*S27+FM227_5*C27)-
 s->l[3][26]*FB226_5+CM127_5*C27-CM227_5*S27+FB326_5*s->l[2][26]+FM327_5*s->dpt[2][55];
  CM226_5 = s->In[5][26]*OpM225_5+s->In[6][26]*OpM326_5-s->dpt[1][55]*FM327_5+s->dpt[3][55]*(FM127_5*C27-FM227_5*S27)-
 s->l[1][26]*FB326_5+s->l[3][26]*FB126_5+CM127_5*S27+CM227_5*C27;
  CM326_5 = CM327_5+s->In[9][26]*OpM326_5+s->dpt[1][55]*(FM127_5*S27+FM227_5*C27)+s->l[1][26]*FB226_5-FB126_5*
 s->l[2][26]-s->dpt[2][55]*(FM127_5*C27-FM227_5*S27);
  ...
  CM126_6 = s->In[1][26]*OpM126_6+s->In[2][26]*OpM225_6+s->In[3][26]*OpM326_6-s->dpt[3][55]*(FM127_6*S27+FM227_6*C27)-
 s->l[3][26]*FB226_6+CM127_6*C27-CM227_6*S27+FB326_6*s->l[2][26]+FM327_6*s->dpt[2][55];
  CM226_6 = s->In[5][26]*OpM225_6+s->In[6][26]*OpM326_6-s->dpt[1][55]*FM327_6+s->dpt[3][55]*(FM127_6*C27-FM227_6*S27)-
 s->l[1][26]*FB326_6+s->l[3][26]*FB126_6+CM127_6*S27+CM227_6*C27;
  CM326_6 = CM327_6+s->In[9][26]*OpM326_6+s->dpt[1][55]*(FM127_6*S27+FM227_6*C27)+s->l[1][26]*FB226_6-FB126_6*
 s->l[2][26]-s->dpt[2][55]*(FM127_6*C27-FM227_6*S27);
  ...
  CM126_19 = s->In[1][26]*OpM126_19+s->In[2][26]*OpM225_19+s->In[3][26]*OpM326_19-s->dpt[3][55]*(FM127_19*S27+FM227_19*
 C27)-s->l[3][26]*FB226_19+CM127_19*C27-CM227_19*S27+FB326_19*s->l[2][26]+FM327_19*s->dpt[2][55];
  CM226_19 = s->In[5][26]*OpM225_19+s->In[6][26]*OpM326_19-s->dpt[1][55]*FM327_19+s->dpt[3][55]*(FM127_19*C27-FM227_19*
 S27)-s->l[1][26]*FB326_19+s->l[3][26]*FB126_19+CM127_19*S27+CM227_19*C27;
  CM326_19 = CM327_19+s->In[9][26]*OpM326_19+s->dpt[1][55]*(FM127_19*S27+FM227_19*C27)+s->l[1][26]*FB226_19-FB126_19*
 s->l[2][26]-s->dpt[2][55]*(FM127_19*C27-FM227_19*S27);
  ...
  CM126_20 = s->In[1][26]*OpM126_20+s->In[2][26]*OpM225_20+s->In[3][26]*OpM326_20-s->dpt[3][55]*(FM127_20*S27+FM227_20*
 C27)-s->l[3][26]*FB226_20+CM127_20*C27-CM227_20*S27+FB326_20*s->l[2][26]+FM327_20*s->dpt[2][55];
  CM226_20 = s->In[5][26]*OpM225_20+s->In[6][26]*OpM326_20-s->dpt[1][55]*FM327_20+s->dpt[3][55]*(FM127_20*C27-FM227_20*
 S27)-s->l[1][26]*FB326_20+s->l[3][26]*FB126_20+CM127_20*S27+CM227_20*C27;
  CM326_20 = CM327_20+s->In[9][26]*OpM326_20+s->dpt[1][55]*(FM127_20*S27+FM227_20*C27)+s->l[1][26]*FB226_20-FB126_20*
 s->l[2][26]-s->dpt[2][55]*(FM127_20*C27-FM227_20*S27);
  ...
  CM126_21 = s->In[1][26]*OpM126_21+s->In[2][26]*OpM225_21+s->In[3][26]*OpM326_21-s->dpt[3][55]*(FM127_21*S27+FM227_21*
 C27)-s->l[3][26]*FB226_21+CM127_21*C27-CM227_21*S27+FB326_21*s->l[2][26]+FM327_21*s->dpt[2][55];
  CM226_21 = s->In[5][26]*OpM225_21+s->In[6][26]*OpM326_21-s->dpt[1][55]*FM327_21+s->dpt[3][55]*(FM127_21*C27-FM227_21*
 S27)-s->l[1][26]*FB326_21+s->l[3][26]*FB126_21+CM127_21*S27+CM227_21*C27;
  CM326_21 = CM327_21+s->In[9][26]*OpM326_21+s->dpt[1][55]*(FM127_21*S27+FM227_21*C27)+s->l[1][26]*FB226_21-FB126_21*
 s->l[2][26]-s->dpt[2][55]*(FM127_21*C27-FM227_21*S27);
  ...
  CM126_22 = s->In[1][26]*OpM126_22+s->In[2][26]*OpM225_22+s->In[3][26]*OpM326_22-s->dpt[3][55]*(FM127_22*S27+FM227_22*
 C27)-s->l[3][26]*FB226_22+CM127_22*C27-CM227_22*S27+FB326_22*s->l[2][26]+FM327_22*s->dpt[2][55];
  CM226_22 = s->In[5][26]*OpM225_22+s->In[6][26]*OpM326_22-s->dpt[1][55]*FM327_22+s->dpt[3][55]*(FM127_22*C27-FM227_22*
 S27)-s->l[1][26]*FB326_22+s->l[3][26]*FB126_22+CM127_22*S27+CM227_22*C27;
  CM326_22 = CM327_22+s->In[9][26]*OpM326_22+s->dpt[1][55]*(FM127_22*S27+FM227_22*C27)+s->l[1][26]*FB226_22-FB126_22*
 s->l[2][26]-s->dpt[2][55]*(FM127_22*C27-FM227_22*S27);
  ...
  CM126_23 = s->In[1][26]*OpM126_23+s->In[2][26]*OpM225_23+s->In[3][26]*OpM326_23-s->dpt[3][55]*(FM127_23*S27+FM227_23*
 C27)-s->l[3][26]*FB226_23+CM127_23*C27-CM227_23*S27+FB326_23*s->l[2][26]+FM327_23*s->dpt[2][55];
  CM226_23 = s->In[5][26]*OpM225_23+s->In[6][26]*OpM326_23-s->dpt[1][55]*FM327_23+s->dpt[3][55]*(FM127_23*C27-FM227_23*
 S27)-s->l[1][26]*FB326_23+s->l[3][26]*FB126_23+CM127_23*S27+CM227_23*C27;
  CM326_23 = CM327_23+s->In[9][26]*OpM326_23+s->dpt[1][55]*(FM127_23*S27+FM227_23*C27)+s->l[1][26]*FB226_23-FB126_23*
 s->l[2][26]-s->dpt[2][55]*(FM127_23*C27-FM227_23*S27);
  ...
  CM126_24 = s->In[1][26]*OpM126_24+s->In[2][26]*C25+s->In[3][26]*OpM326_24-s->dpt[3][55]*(FM127_24*S27+FM227_24*C27)-
 s->l[3][26]*FB226_24+CM127_24*C27-CM227_24*S27+FB326_24*s->l[2][26]+FM327_24*s->dpt[2][55];
  CM226_24 = s->In[5][26]*C25+s->In[6][26]*OpM326_24-s->dpt[1][55]*FM327_24+s->dpt[3][55]*(FM127_24*C27-FM227_24*S27)-
 s->l[1][26]*FB326_24+s->l[3][26]*FB126_24+CM127_24*S27+CM227_24*C27;
  CM326_24 = CM327_24+s->In[9][26]*OpM326_24+s->dpt[1][55]*(FM127_24*S27+FM227_24*C27)+s->l[1][26]*FB226_24-FB126_24*
 s->l[2][26]-s->dpt[2][55]*(FM127_24*C27-FM227_24*S27);
  ...
  CM226_25 = s->In[6][26]*C26-s->dpt[1][55]*FM327_25+s->dpt[3][55]*(FM127_25*C27-FM227_25*S27)-s->l[1][26]*FB326_25+
 s->l[3][26]*FB126_25+CM127_25*S27+CM227_25*C27;
  CM226_26 = s->In[5][26]-s->dpt[1][55]*(FB327_26+FB228_26*S28+FB328_26*C28)+s->dpt[3][55]*(C27*(FB127_26+FB128_26)-S27*
 (FB227_26+FB228_26*C28-FB328_26*S28))+s->l[1][26]*s->l[1][26]*s->m[26]+s->l[3][26]*s->l[3][26]*s->m[26]+C27*(s->In[5][27]*
 C27-s->dpt[1][56]*(FB228_26*S28+FB328_26*C28)+s->dpt[3][56]*FB128_26-s->l[1][27]*FB327_26+s->l[3][27]*FB127_26+CM228_26*C28-
 CM328_26*S28)+S27*(CM128_26+s->In[1][27]*S27+s->In[2][27]*C27+s->dpt[2][56]*(FB228_26*S28+FB328_26*C28)-s->dpt[3][56]*(
 FB228_26*C28-FB328_26*S28)+s->l[2][27]*FB327_26-s->l[3][27]*FB227_26);
  ...
  CF125 = -(s->trq[1][25]-s->In[1][25]*OpF125-s->In[2][25]*OpF225-s->In[3][25]*OpF324+s->dpt[2][54]*(FF126*S26-FF326*C26
 )+s->dpt[3][54]*FF226-CF126*C26-CF326*S26+FA225*s->l[3][25]-FA325*s->l[2][25]-OM225*(s->In[3][25]*OM125+s->In[6][25]*OM225+
 s->In[9][25]*OM325)+OM325*(s->In[2][25]*OM125+s->In[5][25]*OM225+s->In[6][25]*OM325));
  CF225 = -(s->trq[2][25]-CF226-s->In[2][25]*OpF125-s->In[5][25]*OpF225-s->In[6][25]*OpF324-s->dpt[3][54]*(FF126*C26+
 FF326*S26)-FA125*s->l[3][25]+FA325*s->l[1][25]+OM125*(s->In[3][25]*OM125+s->In[6][25]*OM225+s->In[9][25]*OM325)-OM325*(
 s->In[1][25]*OM125+s->In[2][25]*OM225+s->In[3][25]*OM325)-s->dpt[1][54]*(FF126*S26-FF326*C26));
  CF325 = -(s->trq[3][25]-s->In[3][25]*OpF125-s->In[6][25]*OpF225-s->In[9][25]*OpF324+s->dpt[2][54]*(FF126*C26+FF326*S26
 )+CF126*S26-CF326*C26+FA125*s->l[2][25]-FA225*s->l[1][25]-FF226*s->dpt[1][54]-OM125*(s->In[2][25]*OM125+s->In[5][25]*OM225+
 s->In[6][25]*OM325)+OM225*(s->In[1][25]*OM125+s->In[2][25]*OM225+s->In[3][25]*OM325));
  ...
  CM125_1 = -(s->dpt[2][54]*(FM126_1*S26-FM326_1*C26)+s->dpt[3][54]*FM226_1-CM126_1*C26-CM326_1*S26+FB225_1*s->l[3][25]-
 FB325_1*s->l[2][25]);
  CM225_1 = CM226_1+s->dpt[3][54]*(FM126_1*C26+FM326_1*S26)+FB125_1*s->l[3][25]-FB325_1*s->l[1][25]+s->dpt[1][54]*(
 FM126_1*S26-FM326_1*C26);
  CM325_1 = -(s->dpt[2][54]*(FM126_1*C26+FM326_1*S26)+CM126_1*S26-CM326_1*C26+FB125_1*s->l[2][25]-FB225_1*s->l[1][25]-
 FM226_1*s->dpt[1][54]);
  ...
  CM125_2 = -(s->dpt[2][54]*(FM126_2*S26-FM326_2*C26)+s->dpt[3][54]*FM226_2-CM126_2*C26-CM326_2*S26+FB225_2*s->l[3][25]-
 FB325_2*s->l[2][25]);
  CM225_2 = CM226_2+s->dpt[3][54]*(FM126_2*C26+FM326_2*S26)+FB125_2*s->l[3][25]-FB325_2*s->l[1][25]+s->dpt[1][54]*(
 FM126_2*S26-FM326_2*C26);
  CM325_2 = -(s->dpt[2][54]*(FM126_2*C26+FM326_2*S26)+CM126_2*S26-CM326_2*C26+FB125_2*s->l[2][25]-FB225_2*s->l[1][25]-
 FM226_2*s->dpt[1][54]);
  ...
  CM125_3 = -(s->dpt[2][54]*(FM126_3*S26-FM326_3*C26)+s->dpt[3][54]*FM226_3-CM126_3*C26-CM326_3*S26+FB225_3*s->l[3][25]-
 FB325_3*s->l[2][25]);
  CM225_3 = CM226_3+s->dpt[3][54]*(FM126_3*C26+FM326_3*S26)+FB125_3*s->l[3][25]-FB325_3*s->l[1][25]+s->dpt[1][54]*(
 FM126_3*S26-FM326_3*C26);
  CM325_3 = -(s->dpt[2][54]*(FM126_3*C26+FM326_3*S26)+CM126_3*S26-CM326_3*C26+FB125_3*s->l[2][25]-FB225_3*s->l[1][25]-
 FM226_3*s->dpt[1][54]);
  ...
  CM125_4 = s->In[1][25]*OpM125_4+s->In[2][25]*OpM225_4+s->In[3][25]*OpM324_4-s->dpt[2][54]*(FM126_4*S26-FM326_4*C26)-
 s->dpt[3][54]*FM226_4+CM126_4*C26+CM326_4*S26-FB225_4*s->l[3][25]+FB325_4*s->l[2][25];
  CM225_4 = CM226_4+s->In[2][25]*OpM125_4+s->In[5][25]*OpM225_4+s->In[6][25]*OpM324_4+s->dpt[3][54]*(FM126_4*C26+FM326_4
 *S26)+FB125_4*s->l[3][25]-FB325_4*s->l[1][25]+s->dpt[1][54]*(FM126_4*S26-FM326_4*C26);
  CM325_4 = s->In[3][25]*OpM125_4+s->In[6][25]*OpM225_4+s->In[9][25]*OpM324_4-s->dpt[2][54]*(FM126_4*C26+FM326_4*S26)-
 CM126_4*S26+CM326_4*C26-FB125_4*s->l[2][25]+FB225_4*s->l[1][25]+FM226_4*s->dpt[1][54];
  ...
  CM125_5 = s->In[1][25]*OpM125_5+s->In[2][25]*OpM225_5+s->In[3][25]*OpM324_5-s->dpt[2][54]*(FM126_5*S26-FM326_5*C26)-
 s->dpt[3][54]*FM226_5+CM126_5*C26+CM326_5*S26-FB225_5*s->l[3][25]+FB325_5*s->l[2][25];
  CM225_5 = CM226_5+s->In[2][25]*OpM125_5+s->In[5][25]*OpM225_5+s->In[6][25]*OpM324_5+s->dpt[3][54]*(FM126_5*C26+FM326_5
 *S26)+FB125_5*s->l[3][25]-FB325_5*s->l[1][25]+s->dpt[1][54]*(FM126_5*S26-FM326_5*C26);
  CM325_5 = s->In[3][25]*OpM125_5+s->In[6][25]*OpM225_5+s->In[9][25]*OpM324_5-s->dpt[2][54]*(FM126_5*C26+FM326_5*S26)-
 CM126_5*S26+CM326_5*C26-FB125_5*s->l[2][25]+FB225_5*s->l[1][25]+FM226_5*s->dpt[1][54];
  ...
  CM125_6 = s->In[1][25]*OpM125_6+s->In[2][25]*OpM225_6+s->In[3][25]*OpM324_6-s->dpt[2][54]*(FM126_6*S26-FM326_6*C26)-
 s->dpt[3][54]*FM226_6+CM126_6*C26+CM326_6*S26-FB225_6*s->l[3][25]+FB325_6*s->l[2][25];
  CM225_6 = CM226_6+s->In[2][25]*OpM125_6+s->In[5][25]*OpM225_6+s->In[6][25]*OpM324_6+s->dpt[3][54]*(FM126_6*C26+FM326_6
 *S26)+FB125_6*s->l[3][25]-FB325_6*s->l[1][25]+s->dpt[1][54]*(FM126_6*S26-FM326_6*C26);
  CM325_6 = s->In[3][25]*OpM125_6+s->In[6][25]*OpM225_6+s->In[9][25]*OpM324_6-s->dpt[2][54]*(FM126_6*C26+FM326_6*S26)-
 CM126_6*S26+CM326_6*C26-FB125_6*s->l[2][25]+FB225_6*s->l[1][25]+FM226_6*s->dpt[1][54];
  ...
  CM125_19 = s->In[1][25]*OpM125_19+s->In[2][25]*OpM225_19+s->In[3][25]*OpM324_19-s->dpt[2][54]*(FM126_19*S26-FM326_19*
 C26)-s->dpt[3][54]*FM226_19+CM126_19*C26+CM326_19*S26-FB225_19*s->l[3][25]+FB325_19*s->l[2][25];
  CM225_19 = CM226_19+s->In[2][25]*OpM125_19+s->In[5][25]*OpM225_19+s->In[6][25]*OpM324_19+s->dpt[3][54]*(FM126_19*C26+
 FM326_19*S26)+FB125_19*s->l[3][25]-FB325_19*s->l[1][25]+s->dpt[1][54]*(FM126_19*S26-FM326_19*C26);
  CM325_19 = s->In[3][25]*OpM125_19+s->In[6][25]*OpM225_19+s->In[9][25]*OpM324_19-s->dpt[2][54]*(FM126_19*C26+FM326_19*
 S26)-CM126_19*S26+CM326_19*C26-FB125_19*s->l[2][25]+FB225_19*s->l[1][25]+FM226_19*s->dpt[1][54];
  ...
  CM125_20 = s->In[1][25]*OpM125_20+s->In[2][25]*OpM225_20+s->In[3][25]*OpM324_20-s->dpt[2][54]*(FM126_20*S26-FM326_20*
 C26)-s->dpt[3][54]*FM226_20+CM126_20*C26+CM326_20*S26-FB225_20*s->l[3][25]+FB325_20*s->l[2][25];
  CM225_20 = CM226_20+s->In[2][25]*OpM125_20+s->In[5][25]*OpM225_20+s->In[6][25]*OpM324_20+s->dpt[3][54]*(FM126_20*C26+
 FM326_20*S26)+FB125_20*s->l[3][25]-FB325_20*s->l[1][25]+s->dpt[1][54]*(FM126_20*S26-FM326_20*C26);
  CM325_20 = s->In[3][25]*OpM125_20+s->In[6][25]*OpM225_20+s->In[9][25]*OpM324_20-s->dpt[2][54]*(FM126_20*C26+FM326_20*
 S26)-CM126_20*S26+CM326_20*C26-FB125_20*s->l[2][25]+FB225_20*s->l[1][25]+FM226_20*s->dpt[1][54];
  ...
  CM125_21 = s->In[1][25]*OpM125_21+s->In[2][25]*OpM225_21+s->In[3][25]*OpM324_21-s->dpt[2][54]*(FM126_21*S26-FM326_21*
 C26)-s->dpt[3][54]*FM226_21+CM126_21*C26+CM326_21*S26-FB225_21*s->l[3][25]+FB325_21*s->l[2][25];
  CM225_21 = CM226_21+s->In[2][25]*OpM125_21+s->In[5][25]*OpM225_21+s->In[6][25]*OpM324_21+s->dpt[3][54]*(FM126_21*C26+
 FM326_21*S26)+FB125_21*s->l[3][25]-FB325_21*s->l[1][25]+s->dpt[1][54]*(FM126_21*S26-FM326_21*C26);
  CM325_21 = s->In[3][25]*OpM125_21+s->In[6][25]*OpM225_21+s->In[9][25]*OpM324_21-s->dpt[2][54]*(FM126_21*C26+FM326_21*
 S26)-CM126_21*S26+CM326_21*C26-FB125_21*s->l[2][25]+FB225_21*s->l[1][25]+FM226_21*s->dpt[1][54];
  ...
  CM125_22 = s->In[1][25]*OpM125_22+s->In[2][25]*OpM225_22+s->In[3][25]*OpM324_22-s->dpt[2][54]*(FM126_22*S26-FM326_22*
 C26)-s->dpt[3][54]*FM226_22+CM126_22*C26+CM326_22*S26-FB225_22*s->l[3][25]+FB325_22*s->l[2][25];
  CM225_22 = CM226_22+s->In[2][25]*OpM125_22+s->In[5][25]*OpM225_22+s->In[6][25]*OpM324_22+s->dpt[3][54]*(FM126_22*C26+
 FM326_22*S26)+FB125_22*s->l[3][25]-FB325_22*s->l[1][25]+s->dpt[1][54]*(FM126_22*S26-FM326_22*C26);
  CM325_22 = s->In[3][25]*OpM125_22+s->In[6][25]*OpM225_22+s->In[9][25]*OpM324_22-s->dpt[2][54]*(FM126_22*C26+FM326_22*
 S26)-CM126_22*S26+CM326_22*C26-FB125_22*s->l[2][25]+FB225_22*s->l[1][25]+FM226_22*s->dpt[1][54];
  ...
  CM125_23 = s->In[1][25]*OpM125_23+s->In[2][25]*OpM225_23+s->In[3][25]*S24-s->dpt[2][54]*(FM126_23*S26-FM326_23*C26)-
 s->dpt[3][54]*FM226_23+CM126_23*C26+CM326_23*S26-FB225_23*s->l[3][25]+FB325_23*s->l[2][25];
  CM225_23 = CM226_23+s->In[2][25]*OpM125_23+s->In[5][25]*OpM225_23+s->In[6][25]*S24+s->dpt[3][54]*(FM126_23*C26+
 FM326_23*S26)+FB125_23*s->l[3][25]-FB325_23*s->l[1][25]+s->dpt[1][54]*(FM126_23*S26-FM326_23*C26);
  CM325_23 = s->In[3][25]*OpM125_23+s->In[6][25]*OpM225_23+s->In[9][25]*S24-s->dpt[2][54]*(FM126_23*C26+FM326_23*S26)-
 CM126_23*S26+CM326_23*C26-FB125_23*s->l[2][25]+FB225_23*s->l[1][25]+FM226_23*s->dpt[1][54];
  ...
  CM325_24 = s->In[3][25]*S25+s->In[6][25]*C25-s->dpt[2][54]*(FM126_24*C26+FM326_24*S26)-CM126_24*S26+CM326_24*C26-
 FB125_24*s->l[2][25]+FB225_24*s->l[1][25]+FM226_24*s->dpt[1][54];
  CM325_25 = s->In[9][25]-s->dpt[2][54]*(C26*(FB126_25+FM127_25*C27-FM227_25*S27)+S26*(FB326_25+FM327_25))+s->m[25]*
 s->l[1][25]*s->l[1][25]+s->m[25]*s->l[2][25]*s->l[2][25]+s->dpt[1][54]*(FB226_25+FM127_25*S27+FM227_25*C27)+C26*(CM327_25+
 s->In[9][26]*C26+s->dpt[1][55]*(FM127_25*S27+FM227_25*C27)+s->l[1][26]*FB226_25-FB126_25*s->l[2][26]-s->dpt[2][55]*(FM127_25
 *C27-FM227_25*S27))+S26*(s->In[1][26]*S26-s->In[3][26]*C26+s->dpt[3][55]*(FM127_25*S27+FM227_25*C27)+s->l[3][26]*FB226_25-
 CM127_25*C27+CM227_25*S27-FB326_25*s->l[2][26]-FM327_25*s->dpt[2][55]);
  ...
  FF324 = FA324+FF325;
  CF124 = -(s->trq[1][24]-s->In[1][24]*OpF124-s->In[2][24]*OpF223-s->In[3][24]*OpF324+s->dpt[3][52]*(FF125*S25+FF225*C25
 )-CF125*C25+CF225*S25+FA224*s->l[3][24]-FA324*s->l[2][24]-FF325*s->dpt[2][52]-OM224*(s->In[3][24]*OM124+s->In[6][24]*OM224+
 s->In[9][24]*OM324)+OM324*(s->In[2][24]*OM124+s->In[5][24]*OM224+s->In[6][24]*OM324));
  CF224 = -(s->trq[2][24]-s->In[2][24]*OpF124-s->In[5][24]*OpF223-s->In[6][24]*OpF324+s->dpt[1][52]*FF325-s->dpt[3][52]*
 (FF125*C25-FF225*S25)-CF125*S25-CF225*C25-FA124*s->l[3][24]+FA324*s->l[1][24]+OM124*(s->In[3][24]*OM124+s->In[6][24]*OM224+
 s->In[9][24]*OM324)-OM324*(s->In[1][24]*OM124+s->In[2][24]*OM224+s->In[3][24]*OM324));
  CF324 = -(s->trq[3][24]-CF325-s->In[3][24]*OpF124-s->In[6][24]*OpF223-s->In[9][24]*OpF324-s->dpt[1][52]*(FF125*S25+
 FF225*C25)+FA124*s->l[2][24]-FA224*s->l[1][24]-OM124*(s->In[2][24]*OM124+s->In[5][24]*OM224+s->In[6][24]*OM324)+OM224*(
 s->In[1][24]*OM124+s->In[2][24]*OM224+s->In[3][24]*OM324)+s->dpt[2][52]*(FF125*C25-FF225*S25));
  ...
  CM124_1 = -(s->dpt[3][52]*(FM125_1*S25+FM225_1*C25)-CM125_1*C25+CM225_1*S25+FB224_1*s->l[3][24]-FB324_1*s->l[2][24]-
 FM325_1*s->dpt[2][52]);
  CM224_1 = -(s->dpt[1][52]*FM325_1-s->dpt[3][52]*(FM125_1*C25-FM225_1*S25)-CM125_1*S25-CM225_1*C25-FB124_1*s->l[3][24]+
 FB324_1*s->l[1][24]);
  CM324_1 = CM325_1+s->dpt[1][52]*(FM125_1*S25+FM225_1*C25)-FB124_1*s->l[2][24]+FB224_1*s->l[1][24]-s->dpt[2][52]*(
 FM125_1*C25-FM225_1*S25);
  ...
  CM124_2 = -(s->dpt[3][52]*(FM125_2*S25+FM225_2*C25)-CM125_2*C25+CM225_2*S25+FB224_2*s->l[3][24]-FB324_2*s->l[2][24]-
 FM325_2*s->dpt[2][52]);
  CM224_2 = -(s->dpt[1][52]*FM325_2-s->dpt[3][52]*(FM125_2*C25-FM225_2*S25)-CM125_2*S25-CM225_2*C25-FB124_2*s->l[3][24]+
 FB324_2*s->l[1][24]);
  CM324_2 = CM325_2+s->dpt[1][52]*(FM125_2*S25+FM225_2*C25)-FB124_2*s->l[2][24]+FB224_2*s->l[1][24]-s->dpt[2][52]*(
 FM125_2*C25-FM225_2*S25);
  ...
  CM124_3 = -(s->dpt[3][52]*(FM125_3*S25+FM225_3*C25)-CM125_3*C25+CM225_3*S25+FB224_3*s->l[3][24]-FB324_3*s->l[2][24]-
 FM325_3*s->dpt[2][52]);
  CM224_3 = -(s->dpt[1][52]*FM325_3-s->dpt[3][52]*(FM125_3*C25-FM225_3*S25)-CM125_3*S25-CM225_3*C25-FB124_3*s->l[3][24]+
 FB324_3*s->l[1][24]);
  CM324_3 = CM325_3+s->dpt[1][52]*(FM125_3*S25+FM225_3*C25)-FB124_3*s->l[2][24]+FB224_3*s->l[1][24]-s->dpt[2][52]*(
 FM125_3*C25-FM225_3*S25);
  ...
  CM124_4 = s->In[1][24]*OpM124_4+s->In[2][24]*OpM223_4+s->In[3][24]*OpM324_4-s->dpt[3][52]*(FM125_4*S25+FM225_4*C25)+
 CM125_4*C25-CM225_4*S25-FB224_4*s->l[3][24]+FB324_4*s->l[2][24]+FM325_4*s->dpt[2][52];
  CM224_4 = s->In[2][24]*OpM124_4+s->In[5][24]*OpM223_4+s->In[6][24]*OpM324_4-s->dpt[1][52]*FM325_4+s->dpt[3][52]*(
 FM125_4*C25-FM225_4*S25)+CM125_4*S25+CM225_4*C25+FB124_4*s->l[3][24]-FB324_4*s->l[1][24];
  CM324_4 = CM325_4+s->In[3][24]*OpM124_4+s->In[6][24]*OpM223_4+s->In[9][24]*OpM324_4+s->dpt[1][52]*(FM125_4*S25+FM225_4
 *C25)-FB124_4*s->l[2][24]+FB224_4*s->l[1][24]-s->dpt[2][52]*(FM125_4*C25-FM225_4*S25);
  ...
  CM124_5 = s->In[1][24]*OpM124_5+s->In[2][24]*OpM223_5+s->In[3][24]*OpM324_5-s->dpt[3][52]*(FM125_5*S25+FM225_5*C25)+
 CM125_5*C25-CM225_5*S25-FB224_5*s->l[3][24]+FB324_5*s->l[2][24]+FM325_5*s->dpt[2][52];
  CM224_5 = s->In[2][24]*OpM124_5+s->In[5][24]*OpM223_5+s->In[6][24]*OpM324_5-s->dpt[1][52]*FM325_5+s->dpt[3][52]*(
 FM125_5*C25-FM225_5*S25)+CM125_5*S25+CM225_5*C25+FB124_5*s->l[3][24]-FB324_5*s->l[1][24];
  CM324_5 = CM325_5+s->In[3][24]*OpM124_5+s->In[6][24]*OpM223_5+s->In[9][24]*OpM324_5+s->dpt[1][52]*(FM125_5*S25+FM225_5
 *C25)-FB124_5*s->l[2][24]+FB224_5*s->l[1][24]-s->dpt[2][52]*(FM125_5*C25-FM225_5*S25);
  ...
  CM124_6 = s->In[1][24]*OpM124_6+s->In[2][24]*OpM223_6+s->In[3][24]*OpM324_6-s->dpt[3][52]*(FM125_6*S25+FM225_6*C25)+
 CM125_6*C25-CM225_6*S25-FB224_6*s->l[3][24]+FB324_6*s->l[2][24]+FM325_6*s->dpt[2][52];
  CM224_6 = s->In[2][24]*OpM124_6+s->In[5][24]*OpM223_6+s->In[6][24]*OpM324_6-s->dpt[1][52]*FM325_6+s->dpt[3][52]*(
 FM125_6*C25-FM225_6*S25)+CM125_6*S25+CM225_6*C25+FB124_6*s->l[3][24]-FB324_6*s->l[1][24];
  CM324_6 = CM325_6+s->In[3][24]*OpM124_6+s->In[6][24]*OpM223_6+s->In[9][24]*OpM324_6+s->dpt[1][52]*(FM125_6*S25+FM225_6
 *C25)-FB124_6*s->l[2][24]+FB224_6*s->l[1][24]-s->dpt[2][52]*(FM125_6*C25-FM225_6*S25);
  ...
  CM124_19 = s->In[1][24]*OpM124_19+s->In[2][24]*OpM223_19+s->In[3][24]*OpM324_19-s->dpt[3][52]*(FM125_19*S25+FM225_19*
 C25)+CM125_19*C25-CM225_19*S25-FB224_19*s->l[3][24]+FB324_19*s->l[2][24]+FM325_19*s->dpt[2][52];
  CM224_19 = s->In[2][24]*OpM124_19+s->In[5][24]*OpM223_19+s->In[6][24]*OpM324_19-s->dpt[1][52]*FM325_19+s->dpt[3][52]*(
 FM125_19*C25-FM225_19*S25)+CM125_19*S25+CM225_19*C25+FB124_19*s->l[3][24]-FB324_19*s->l[1][24];
  CM324_19 = CM325_19+s->In[3][24]*OpM124_19+s->In[6][24]*OpM223_19+s->In[9][24]*OpM324_19+s->dpt[1][52]*(FM125_19*S25+
 FM225_19*C25)-FB124_19*s->l[2][24]+FB224_19*s->l[1][24]-s->dpt[2][52]*(FM125_19*C25-FM225_19*S25);
  ...
  CM124_20 = s->In[1][24]*OpM124_20+s->In[2][24]*OpM223_20+s->In[3][24]*OpM324_20-s->dpt[3][52]*(FM125_20*S25+FM225_20*
 C25)+CM125_20*C25-CM225_20*S25-FB224_20*s->l[3][24]+FB324_20*s->l[2][24]+FM325_20*s->dpt[2][52];
  CM224_20 = s->In[2][24]*OpM124_20+s->In[5][24]*OpM223_20+s->In[6][24]*OpM324_20-s->dpt[1][52]*FM325_20+s->dpt[3][52]*(
 FM125_20*C25-FM225_20*S25)+CM125_20*S25+CM225_20*C25+FB124_20*s->l[3][24]-FB324_20*s->l[1][24];
  CM324_20 = CM325_20+s->In[3][24]*OpM124_20+s->In[6][24]*OpM223_20+s->In[9][24]*OpM324_20+s->dpt[1][52]*(FM125_20*S25+
 FM225_20*C25)-FB124_20*s->l[2][24]+FB224_20*s->l[1][24]-s->dpt[2][52]*(FM125_20*C25-FM225_20*S25);
  ...
  CM124_21 = s->In[1][24]*OpM124_21+s->In[2][24]*OpM223_21+s->In[3][24]*OpM324_21-s->dpt[3][52]*(FM125_21*S25+FM225_21*
 C25)+CM125_21*C25-CM225_21*S25-FB224_21*s->l[3][24]+FB324_21*s->l[2][24]+FM325_21*s->dpt[2][52];
  CM224_21 = s->In[2][24]*OpM124_21+s->In[5][24]*OpM223_21+s->In[6][24]*OpM324_21-s->dpt[1][52]*FM325_21+s->dpt[3][52]*(
 FM125_21*C25-FM225_21*S25)+CM125_21*S25+CM225_21*C25+FB124_21*s->l[3][24]-FB324_21*s->l[1][24];
  CM324_21 = CM325_21+s->In[3][24]*OpM124_21+s->In[6][24]*OpM223_21+s->In[9][24]*OpM324_21+s->dpt[1][52]*(FM125_21*S25+
 FM225_21*C25)-FB124_21*s->l[2][24]+FB224_21*s->l[1][24]-s->dpt[2][52]*(FM125_21*C25-FM225_21*S25);
  ...
  CM124_22 = s->In[1][24]*OpM124_22+s->In[2][24]*C23+s->In[3][24]*OpM324_22-s->dpt[3][52]*(FM125_22*S25+FM225_22*C25)+
 CM125_22*C25-CM225_22*S25-FB224_22*s->l[3][24]+FB324_22*s->l[2][24]+FM325_22*s->dpt[2][52];
  CM224_22 = s->In[2][24]*OpM124_22+s->In[5][24]*C23+s->In[6][24]*OpM324_22-s->dpt[1][52]*FM325_22+s->dpt[3][52]*(
 FM125_22*C25-FM225_22*S25)+CM125_22*S25+CM225_22*C25+FB124_22*s->l[3][24]-FB324_22*s->l[1][24];
  CM324_22 = CM325_22+s->In[3][24]*OpM124_22+s->In[6][24]*C23+s->In[9][24]*OpM324_22+s->dpt[1][52]*(FM125_22*S25+
 FM225_22*C25)-FB124_22*s->l[2][24]+FB224_22*s->l[1][24]-s->dpt[2][52]*(FM125_22*C25-FM225_22*S25);
  ...
  CM224_23 = s->In[2][24]*C24+s->In[6][24]*S24-s->dpt[1][52]*FM325_23+s->dpt[3][52]*(FM125_23*C25-FM225_23*S25)+CM125_23
 *S25+CM225_23*C25+FB124_23*s->l[3][24]-FB324_23*s->l[1][24];
  CM224_24 = s->In[5][24]-s->dpt[1][52]*(FB325_24-FM126_24*S26+FM326_24*C26)+s->dpt[3][52]*(C25*(FB125_24+FM126_24*C26+
 FM326_24*S26)-S25*(FB225_24+FM226_24))+s->m[24]*s->l[1][24]*s->l[1][24]+s->m[24]*s->l[3][24]*s->l[3][24]+C25*(CM226_24+
 s->In[2][25]*S25+s->In[5][25]*C25+s->dpt[3][54]*(FM126_24*C26+FM326_24*S26)+FB125_24*s->l[3][25]-FB325_24*s->l[1][25]+
 s->dpt[1][54]*(FM126_24*S26-FM326_24*C26))+S25*(s->In[1][25]*S25+s->In[2][25]*C25-s->dpt[2][54]*(FM126_24*S26-FM326_24*C26)-
 s->dpt[3][54]*FM226_24+CM126_24*C26+CM326_24*S26-FB225_24*s->l[3][25]+FB325_24*s->l[2][25]);
  ...
  CF123 = -(s->trq[1][23]-s->In[1][23]*OpF122-s->In[2][23]*OpF223-s->In[3][23]*OpF323+s->dpt[3][50]*FF224+s->l[3][23]*
 FA223-CF124*C24-CF324*S24-FA323*s->l[2][23]-OM223*(s->In[3][23]*OM123+s->In[6][23]*OM223+s->In[9][23]*OM323)+OM323*(
 s->In[2][23]*OM123+s->In[5][23]*OM223+s->In[6][23]*OM323)+s->dpt[2][50]*(FF124*S24-FF324*C24));
  CF223 = -(s->trq[2][23]-CF224-s->In[2][23]*OpF122-s->In[5][23]*OpF223-s->In[6][23]*OpF323-s->dpt[1][50]*(FF124*S24-
 FF324*C24)-s->dpt[3][50]*(FF124*C24+FF324*S24)-s->l[3][23]*FA123+FA323*s->l[1][23]+OM123*(s->In[3][23]*OM123+s->In[6][23]*
 OM223+s->In[9][23]*OM323)-OM323*(s->In[1][23]*OM123+s->In[2][23]*OM223+s->In[3][23]*OM323));
  CF323 = -(s->trq[3][23]-s->In[3][23]*OpF122-s->In[6][23]*OpF223-s->In[9][23]*OpF323-s->dpt[1][50]*FF224+CF124*S24-
 CF324*C24+FA123*s->l[2][23]-FA223*s->l[1][23]-OM123*(s->In[2][23]*OM123+s->In[5][23]*OM223+s->In[6][23]*OM323)+OM223*(
 s->In[1][23]*OM123+s->In[2][23]*OM223+s->In[3][23]*OM323)+s->dpt[2][50]*(FF124*C24+FF324*S24));
  ...
  CM123_1 = -(s->dpt[3][50]*FM224_1+s->l[3][23]*FB223_1-CM124_1*C24-CM324_1*S24-FB323_1*s->l[2][23]+s->dpt[2][50]*(
 FM124_1*S24-FM324_1*C24));
  CM223_1 = CM224_1+s->dpt[1][50]*(FM124_1*S24-FM324_1*C24)+s->dpt[3][50]*(FM124_1*C24+FM324_1*S24)+s->l[3][23]*FB123_1-
 FB323_1*s->l[1][23];
  CM323_1 = s->dpt[1][50]*FM224_1-CM124_1*S24+CM324_1*C24-FB123_1*s->l[2][23]+FB223_1*s->l[1][23]-s->dpt[2][50]*(FM124_1
 *C24+FM324_1*S24);
  ...
  CM123_2 = -(s->dpt[3][50]*FM224_2+s->l[3][23]*FB223_2-CM124_2*C24-CM324_2*S24-FB323_2*s->l[2][23]+s->dpt[2][50]*(
 FM124_2*S24-FM324_2*C24));
  CM223_2 = CM224_2+s->dpt[1][50]*(FM124_2*S24-FM324_2*C24)+s->dpt[3][50]*(FM124_2*C24+FM324_2*S24)+s->l[3][23]*FB123_2-
 FB323_2*s->l[1][23];
  CM323_2 = s->dpt[1][50]*FM224_2-CM124_2*S24+CM324_2*C24-FB123_2*s->l[2][23]+FB223_2*s->l[1][23]-s->dpt[2][50]*(FM124_2
 *C24+FM324_2*S24);
  ...
  CM123_3 = -(s->dpt[3][50]*FM224_3+s->l[3][23]*FB223_3-CM124_3*C24-CM324_3*S24-FB323_3*s->l[2][23]+s->dpt[2][50]*(
 FM124_3*S24-FM324_3*C24));
  CM223_3 = CM224_3+s->dpt[1][50]*(FM124_3*S24-FM324_3*C24)+s->dpt[3][50]*(FM124_3*C24+FM324_3*S24)+s->l[3][23]*FB123_3-
 FB323_3*s->l[1][23];
  CM323_3 = s->dpt[1][50]*FM224_3-CM124_3*S24+CM324_3*C24-FB123_3*s->l[2][23]+FB223_3*s->l[1][23]-s->dpt[2][50]*(FM124_3
 *C24+FM324_3*S24);
  ...
  CM123_4 = s->In[1][23]*OpM122_4+s->In[2][23]*OpM223_4+s->In[3][23]*OpM323_4-s->dpt[3][50]*FM224_4-s->l[3][23]*FB223_4+
 CM124_4*C24+CM324_4*S24+FB323_4*s->l[2][23]-s->dpt[2][50]*(FM124_4*S24-FM324_4*C24);
  CM223_4 = CM224_4+s->In[2][23]*OpM122_4+s->In[5][23]*OpM223_4+s->In[6][23]*OpM323_4+s->dpt[1][50]*(FM124_4*S24-FM324_4
 *C24)+s->dpt[3][50]*(FM124_4*C24+FM324_4*S24)+s->l[3][23]*FB123_4-FB323_4*s->l[1][23];
  CM323_4 = s->In[3][23]*OpM122_4+s->In[6][23]*OpM223_4+s->In[9][23]*OpM323_4+s->dpt[1][50]*FM224_4-CM124_4*S24+CM324_4*
 C24-FB123_4*s->l[2][23]+FB223_4*s->l[1][23]-s->dpt[2][50]*(FM124_4*C24+FM324_4*S24);
  ...
  CM123_5 = s->In[1][23]*OpM122_5+s->In[2][23]*OpM223_5+s->In[3][23]*OpM323_5-s->dpt[3][50]*FM224_5-s->l[3][23]*FB223_5+
 CM124_5*C24+CM324_5*S24+FB323_5*s->l[2][23]-s->dpt[2][50]*(FM124_5*S24-FM324_5*C24);
  CM223_5 = CM224_5+s->In[2][23]*OpM122_5+s->In[5][23]*OpM223_5+s->In[6][23]*OpM323_5+s->dpt[1][50]*(FM124_5*S24-FM324_5
 *C24)+s->dpt[3][50]*(FM124_5*C24+FM324_5*S24)+s->l[3][23]*FB123_5-FB323_5*s->l[1][23];
  CM323_5 = s->In[3][23]*OpM122_5+s->In[6][23]*OpM223_5+s->In[9][23]*OpM323_5+s->dpt[1][50]*FM224_5-CM124_5*S24+CM324_5*
 C24-FB123_5*s->l[2][23]+FB223_5*s->l[1][23]-s->dpt[2][50]*(FM124_5*C24+FM324_5*S24);
  ...
  CM123_6 = s->In[1][23]*OpM122_6+s->In[2][23]*OpM223_6+s->In[3][23]*OpM323_6-s->dpt[3][50]*FM224_6-s->l[3][23]*FB223_6+
 CM124_6*C24+CM324_6*S24+FB323_6*s->l[2][23]-s->dpt[2][50]*(FM124_6*S24-FM324_6*C24);
  CM223_6 = CM224_6+s->In[2][23]*OpM122_6+s->In[5][23]*OpM223_6+s->In[6][23]*OpM323_6+s->dpt[1][50]*(FM124_6*S24-FM324_6
 *C24)+s->dpt[3][50]*(FM124_6*C24+FM324_6*S24)+s->l[3][23]*FB123_6-FB323_6*s->l[1][23];
  CM323_6 = s->In[3][23]*OpM122_6+s->In[6][23]*OpM223_6+s->In[9][23]*OpM323_6+s->dpt[1][50]*FM224_6-CM124_6*S24+CM324_6*
 C24-FB123_6*s->l[2][23]+FB223_6*s->l[1][23]-s->dpt[2][50]*(FM124_6*C24+FM324_6*S24);
  ...
  CM123_19 = s->In[1][23]*OpM122_19+s->In[2][23]*OpM223_19+s->In[3][23]*OpM323_19-s->dpt[3][50]*FM224_19-s->l[3][23]*
 FB223_19+CM124_19*C24+CM324_19*S24+FB323_19*s->l[2][23]-s->dpt[2][50]*(FM124_19*S24-FM324_19*C24);
  CM223_19 = CM224_19+s->In[2][23]*OpM122_19+s->In[5][23]*OpM223_19+s->In[6][23]*OpM323_19+s->dpt[1][50]*(FM124_19*S24-
 FM324_19*C24)+s->dpt[3][50]*(FM124_19*C24+FM324_19*S24)+s->l[3][23]*FB123_19-FB323_19*s->l[1][23];
  CM323_19 = s->In[3][23]*OpM122_19+s->In[6][23]*OpM223_19+s->In[9][23]*OpM323_19+s->dpt[1][50]*FM224_19-CM124_19*S24+
 CM324_19*C24-FB123_19*s->l[2][23]+FB223_19*s->l[1][23]-s->dpt[2][50]*(FM124_19*C24+FM324_19*S24);
  ...
  CM123_20 = s->In[1][23]*OpM122_20+s->In[2][23]*OpM223_20+s->In[3][23]*OpM323_20-s->dpt[3][50]*FM224_20-s->l[3][23]*
 FB223_20+CM124_20*C24+CM324_20*S24+FB323_20*s->l[2][23]-s->dpt[2][50]*(FM124_20*S24-FM324_20*C24);
  CM223_20 = CM224_20+s->In[2][23]*OpM122_20+s->In[5][23]*OpM223_20+s->In[6][23]*OpM323_20+s->dpt[1][50]*(FM124_20*S24-
 FM324_20*C24)+s->dpt[3][50]*(FM124_20*C24+FM324_20*S24)+s->l[3][23]*FB123_20-FB323_20*s->l[1][23];
  CM323_20 = s->In[3][23]*OpM122_20+s->In[6][23]*OpM223_20+s->In[9][23]*OpM323_20+s->dpt[1][50]*FM224_20-CM124_20*S24+
 CM324_20*C24-FB123_20*s->l[2][23]+FB223_20*s->l[1][23]-s->dpt[2][50]*(FM124_20*C24+FM324_20*S24);
  ...
  CM123_21 = -(s->In[1][23]*S22-s->In[2][23]*OpM223_21-s->In[3][23]*OpM323_21+s->dpt[3][50]*FM224_21+s->l[3][23]*
 FB223_21-CM124_21*C24-CM324_21*S24-FB323_21*s->l[2][23]+s->dpt[2][50]*(FM124_21*S24-FM324_21*C24));
  CM223_21 = CM224_21-s->In[2][23]*S22+s->In[5][23]*OpM223_21+s->In[6][23]*OpM323_21+s->dpt[1][50]*(FM124_21*S24-
 FM324_21*C24)+s->dpt[3][50]*(FM124_21*C24+FM324_21*S24)+s->l[3][23]*FB123_21-FB323_21*s->l[1][23];
  CM323_21 = s->dpt[1][50]*FM224_21-CM124_21*S24+CM324_21*C24-s->dpt[2][50]*(FM124_21*C24+FM324_21*S24)-s->In[3][23]*S22
 +s->In[6][23]*OpM223_21+s->In[9][23]*OpM323_21-FB123_21*s->l[2][23]+FB223_21*s->l[1][23];
  ...
  CM123_22 = s->In[2][23]*C23-s->In[3][23]*S23-s->dpt[3][50]*FM224_22-s->l[3][23]*FB223_22+CM124_22*C24+CM324_22*S24+
 FB323_22*s->l[2][23]-s->dpt[2][50]*(FM124_22*S24-FM324_22*C24);
  CM123_23 = s->In[1][23]-s->dpt[3][50]*(FB224_23+FM125_23*S25+FM225_23*C25)+s->l[3][23]*s->l[3][23]*s->m[23]+s->m[23]*
 s->l[2][23]*s->l[2][23]+s->dpt[2][50]*(C24*(FB324_23+FM325_23)-S24*(FB124_23+FM125_23*C25-FM225_23*S25))+C24*(s->In[1][24]*
 C24+s->In[3][24]*S24-s->dpt[3][52]*(FM125_23*S25+FM225_23*C25)+CM125_23*C25-CM225_23*S25-FB224_23*s->l[3][24]+FB324_23*
 s->l[2][24]+FM325_23*s->dpt[2][52])+S24*(CM325_23+s->In[3][24]*C24+s->In[9][24]*S24+s->dpt[1][52]*(FM125_23*S25+FM225_23*C25
 )-FB124_23*s->l[2][24]+FB224_23*s->l[1][24]-s->dpt[2][52]*(FM125_23*C25-FM225_23*S25));
  ...
  CF122 = -(s->trq[1][22]-CF123-s->In[1][22]*OpF122-s->In[2][22]*OpF221-s->In[3][22]*OpF322+s->dpt[3][48]*(FF223*C23-
 FF323*S23)+FA222*s->l[3][22]-FA322*s->l[2][22]-OM222*(s->In[3][22]*OM122+s->In[6][22]*OM222+s->In[9][22]*OM322)+OM322*(
 s->In[2][22]*OM122+s->In[5][22]*OM222+s->In[6][22]*OM322)-s->dpt[2][48]*(FF223*S23+FF323*C23));
  CF222 = -(s->trq[2][22]-s->In[2][22]*OpF122-s->In[5][22]*OpF221-s->In[6][22]*OpF322+s->dpt[1][48]*(FF223*S23+FF323*C23
 )-s->dpt[3][48]*FF123-CF223*C23+CF323*S23-FA122*s->l[3][22]+FA322*s->l[1][22]+OM122*(s->In[3][22]*OM122+s->In[6][22]*OM222+
 s->In[9][22]*OM322)-OM322*(s->In[1][22]*OM122+s->In[2][22]*OM222+s->In[3][22]*OM322));
  CF322 = -(s->trq[3][22]-s->In[3][22]*OpF122-s->In[6][22]*OpF221-s->In[9][22]*OpF322-s->dpt[1][48]*(FF223*C23-FF323*S23
 )-CF223*S23-CF323*C23+FA122*s->l[2][22]-FA222*s->l[1][22]+FF123*s->dpt[2][48]-OM122*(s->In[2][22]*OM122+s->In[5][22]*OM222+
 s->In[6][22]*OM322)+OM222*(s->In[1][22]*OM122+s->In[2][22]*OM222+s->In[3][22]*OM322));
  ...
  CM122_1 = CM123_1-s->dpt[3][48]*(FM223_1*C23-FM323_1*S23)-FB222_1*s->l[3][22]+FB322_1*s->l[2][22]+s->dpt[2][48]*(
 FM223_1*S23+FM323_1*C23);
  CM222_1 = -(s->dpt[1][48]*(FM223_1*S23+FM323_1*C23)-s->dpt[3][48]*FM123_1-CM223_1*C23+CM323_1*S23-FB122_1*s->l[3][22]+
 FB322_1*s->l[1][22]);
  CM322_1 = s->dpt[1][48]*(FM223_1*C23-FM323_1*S23)+CM223_1*S23+CM323_1*C23-FB122_1*s->l[2][22]+FB222_1*s->l[1][22]-
 FM123_1*s->dpt[2][48];
  ...
  CM122_2 = CM123_2-s->dpt[3][48]*(FM223_2*C23-FM323_2*S23)-FB222_2*s->l[3][22]+FB322_2*s->l[2][22]+s->dpt[2][48]*(
 FM223_2*S23+FM323_2*C23);
  CM222_2 = -(s->dpt[1][48]*(FM223_2*S23+FM323_2*C23)-s->dpt[3][48]*FM123_2-CM223_2*C23+CM323_2*S23-FB122_2*s->l[3][22]+
 FB322_2*s->l[1][22]);
  CM322_2 = s->dpt[1][48]*(FM223_2*C23-FM323_2*S23)+CM223_2*S23+CM323_2*C23-FB122_2*s->l[2][22]+FB222_2*s->l[1][22]-
 FM123_2*s->dpt[2][48];
  ...
  CM122_3 = CM123_3-s->dpt[3][48]*(FM223_3*C23-FM323_3*S23)-FB222_3*s->l[3][22]+FB322_3*s->l[2][22]+s->dpt[2][48]*(
 FM223_3*S23+FM323_3*C23);
  CM222_3 = -(s->dpt[1][48]*(FM223_3*S23+FM323_3*C23)-s->dpt[3][48]*FM123_3-CM223_3*C23+CM323_3*S23-FB122_3*s->l[3][22]+
 FB322_3*s->l[1][22]);
  CM322_3 = s->dpt[1][48]*(FM223_3*C23-FM323_3*S23)+CM223_3*S23+CM323_3*C23-FB122_3*s->l[2][22]+FB222_3*s->l[1][22]-
 FM123_3*s->dpt[2][48];
  ...
  CM122_4 = CM123_4+s->In[1][22]*OpM122_4+s->In[2][22]*OpM221_4+s->In[3][22]*OpM322_4-s->dpt[3][48]*(FM223_4*C23-FM323_4
 *S23)-FB222_4*s->l[3][22]+FB322_4*s->l[2][22]+s->dpt[2][48]*(FM223_4*S23+FM323_4*C23);
  CM222_4 = s->In[2][22]*OpM122_4+s->In[5][22]*OpM221_4+s->In[6][22]*OpM322_4-s->dpt[1][48]*(FM223_4*S23+FM323_4*C23)+
 s->dpt[3][48]*FM123_4+CM223_4*C23-CM323_4*S23+FB122_4*s->l[3][22]-FB322_4*s->l[1][22];
  CM322_4 = s->In[3][22]*OpM122_4+s->In[6][22]*OpM221_4+s->In[9][22]*OpM322_4+s->dpt[1][48]*(FM223_4*C23-FM323_4*S23)+
 CM223_4*S23+CM323_4*C23-FB122_4*s->l[2][22]+FB222_4*s->l[1][22]-FM123_4*s->dpt[2][48];
  ...
  CM122_5 = CM123_5+s->In[1][22]*OpM122_5+s->In[2][22]*OpM221_5+s->In[3][22]*OpM322_5-s->dpt[3][48]*(FM223_5*C23-FM323_5
 *S23)-FB222_5*s->l[3][22]+FB322_5*s->l[2][22]+s->dpt[2][48]*(FM223_5*S23+FM323_5*C23);
  CM222_5 = s->In[2][22]*OpM122_5+s->In[5][22]*OpM221_5+s->In[6][22]*OpM322_5-s->dpt[1][48]*(FM223_5*S23+FM323_5*C23)+
 s->dpt[3][48]*FM123_5+CM223_5*C23-CM323_5*S23+FB122_5*s->l[3][22]-FB322_5*s->l[1][22];
  CM322_5 = s->In[3][22]*OpM122_5+s->In[6][22]*OpM221_5+s->In[9][22]*OpM322_5+s->dpt[1][48]*(FM223_5*C23-FM323_5*S23)+
 CM223_5*S23+CM323_5*C23-FB122_5*s->l[2][22]+FB222_5*s->l[1][22]-FM123_5*s->dpt[2][48];
  ...
  CM122_6 = CM123_6+s->In[1][22]*OpM122_6+s->In[2][22]*OpM221_6+s->In[3][22]*OpM322_6-s->dpt[3][48]*(FM223_6*C23-FM323_6
 *S23)-FB222_6*s->l[3][22]+FB322_6*s->l[2][22]+s->dpt[2][48]*(FM223_6*S23+FM323_6*C23);
  CM222_6 = s->In[2][22]*OpM122_6+s->In[5][22]*OpM221_6+s->In[6][22]*OpM322_6-s->dpt[1][48]*(FM223_6*S23+FM323_6*C23)+
 s->dpt[3][48]*FM123_6+CM223_6*C23-CM323_6*S23+FB122_6*s->l[3][22]-FB322_6*s->l[1][22];
  CM322_6 = s->In[3][22]*OpM122_6+s->In[6][22]*OpM221_6+s->In[9][22]*OpM322_6+s->dpt[1][48]*(FM223_6*C23-FM323_6*S23)+
 CM223_6*S23+CM323_6*C23-FB122_6*s->l[2][22]+FB222_6*s->l[1][22]-FM123_6*s->dpt[2][48];
  ...
  CM122_19 = CM123_19+s->In[1][22]*OpM122_19+s->In[2][22]*OpM221_19+s->In[3][22]*OpM322_19-s->dpt[3][48]*(FM223_19*C23-
 FM323_19*S23)-FB222_19*s->l[3][22]+FB322_19*s->l[2][22]+s->dpt[2][48]*(FM223_19*S23+FM323_19*C23);
  CM222_19 = s->In[2][22]*OpM122_19+s->In[5][22]*OpM221_19+s->In[6][22]*OpM322_19-s->dpt[1][48]*(FM223_19*S23+FM323_19*
 C23)+s->dpt[3][48]*FM123_19+CM223_19*C23-CM323_19*S23+FB122_19*s->l[3][22]-FB322_19*s->l[1][22];
  CM322_19 = s->In[3][22]*OpM122_19+s->In[6][22]*OpM221_19+s->In[9][22]*OpM322_19+s->dpt[1][48]*(FM223_19*C23-FM323_19*
 S23)+CM223_19*S23+CM323_19*C23-FB122_19*s->l[2][22]+FB222_19*s->l[1][22]-FM123_19*s->dpt[2][48];
  ...
  CM122_20 = CM123_20+s->In[1][22]*OpM122_20+s->In[2][22]*C21+s->In[3][22]*OpM322_20-s->dpt[3][48]*(FM223_20*C23-
 FM323_20*S23)-FB222_20*s->l[3][22]+FB322_20*s->l[2][22]+s->dpt[2][48]*(FM223_20*S23+FM323_20*C23);
  CM222_20 = s->In[2][22]*OpM122_20+s->In[5][22]*C21+s->In[6][22]*OpM322_20-s->dpt[1][48]*(FM223_20*S23+FM323_20*C23)+
 s->dpt[3][48]*FM123_20+CM223_20*C23-CM323_20*S23+FB122_20*s->l[3][22]-FB322_20*s->l[1][22];
  CM322_20 = s->In[3][22]*OpM122_20+s->In[6][22]*C21+s->In[9][22]*OpM322_20+s->dpt[1][48]*(FM223_20*C23-FM323_20*S23)+
 CM223_20*S23+CM323_20*C23-FB122_20*s->l[2][22]+FB222_20*s->l[1][22]-FM123_20*s->dpt[2][48];
  ...
  CM222_21 = -(s->In[2][22]*S22-s->In[6][22]*C22+s->dpt[1][48]*(FM223_21*S23+FM323_21*C23)-s->dpt[3][48]*FM123_21-
 CM223_21*C23+CM323_21*S23-FB122_21*s->l[3][22]+FB322_21*s->l[1][22]);
  CM222_22 = s->In[5][22]-s->dpt[1][48]*(C23*(FB323_22-FM124_22*S24+FM324_22*C24)+S23*(FB223_22+FM224_22))+s->dpt[3][48]
 *(FB123_22+FM124_22*C24+FM324_22*S24)+s->m[22]*s->l[1][22]*s->l[1][22]+s->m[22]*s->l[3][22]*s->l[3][22]+C23*(CM224_22+
 s->In[5][23]*C23-s->In[6][23]*S23+s->dpt[1][50]*(FM124_22*S24-FM324_22*C24)+s->dpt[3][50]*(FM124_22*C24+FM324_22*S24)+
 s->l[3][23]*FB123_22-FB323_22*s->l[1][23])-S23*(s->In[6][23]*C23-s->In[9][23]*S23+s->dpt[1][50]*FM224_22-CM124_22*S24+
 CM324_22*C24-FB123_22*s->l[2][23]+FB223_22*s->l[1][23]-s->dpt[2][50]*(FM124_22*C24+FM324_22*S24));

// = = Block_0_2_0_1_0_6 = = 
 
// Backward Dynamics 

  FA135 = -(s->frc[1][35]-s->m[35]*(AlF134+s->dpt[1][67]*BS134+s->dpt[2][67]*BeF234+s->dpt[3][67]*BeF334-s->l[1][35]*(
 OM235*OM235+OM335*OM335)+s->l[2][35]*(BS235-OpF335)+s->l[3][35]*(BS335+OpF235)));
  FA235 = -(s->frc[2][35]-s->m[35]*(s->l[1][35]*(BS235+OpF335)-s->l[2][35]*(OM135*OM135+OM335*OM335)+s->l[3][35]*(BS635-
 OpF134)+C35*(AlF234+s->dpt[1][67]*BeF434+s->dpt[2][67]*BS534+s->dpt[3][67]*BeF634)+S35*(AlF334+s->dpt[1][67]*BeF734+
 s->dpt[2][67]*BeF834+s->dpt[3][67]*BS934)));
  FA335 = -(s->frc[3][35]-s->m[35]*(s->l[1][35]*(BS335-OpF235)+s->l[2][35]*(BS635+OpF134)-s->l[3][35]*(OM135*OM135+OM235
 *OM235)+C35*(AlF334+s->dpt[1][67]*BeF734+s->dpt[2][67]*BeF834+s->dpt[3][67]*BS934)-S35*(AlF234+s->dpt[1][67]*BeF434+
 s->dpt[2][67]*BS534+s->dpt[3][67]*BeF634)));
  CF135 = -(s->trq[1][35]-s->In[1][35]*OpF134-s->In[2][35]*OpF235-s->In[3][35]*OpF335-s->l[2][35]*FA335+s->l[3][35]*
 FA235+OM335*(s->In[5][35]*OM235+s->In[6][35]*OM335-s->In[9][35]*OM235));
  CF235 = -(s->trq[2][35]-s->In[5][35]*OpF235-s->In[6][35]*OpF335+s->l[1][35]*FA335-s->l[3][35]*FA135-OM335*(
 s->In[1][35]*OM135+s->In[2][35]*OM235+s->In[3][35]*OM335-s->In[9][35]*OM135));
  CF335 = -(s->trq[3][35]-s->In[9][35]*OpF335-s->l[1][35]*FA235+s->l[2][35]*FA135-OM135*(s->In[5][35]*OM235+s->In[6][35]
 *OM335)+OM235*(s->In[1][35]*OM135+s->In[2][35]*OM235+s->In[3][35]*OM335));
  ...
  FB235_4 = s->m[35]*(s->l[1][35]*OpM335_4-s->l[3][35]*OpM134_4+C35*(AlM234_4+s->dpt[1][67]*OpM333_4-s->dpt[3][67]*
 OpM134_4)+S35*(AlM334_4-s->dpt[1][67]*OpM234_4+s->dpt[2][67]*OpM134_4));
  FB335_4 = s->m[35]*(C35*(AlM334_4-s->dpt[1][67]*OpM234_4+s->dpt[2][67]*OpM134_4)-S35*(AlM234_4+s->dpt[1][67]*OpM333_4-
 s->dpt[3][67]*OpM134_4)-s->l[1][35]*OpM235_4+s->l[2][35]*OpM134_4);
  ...
  FB235_5 = s->m[35]*(s->l[1][35]*OpM335_5-s->l[3][35]*OpM134_5+C35*(AlM234_5+s->dpt[1][67]*OpM333_5-s->dpt[3][67]*
 OpM134_5)+S35*(AlM334_5-s->dpt[1][67]*OpM234_5+s->dpt[2][67]*OpM134_5));
  FB335_5 = s->m[35]*(C35*(AlM334_5-s->dpt[1][67]*OpM234_5+s->dpt[2][67]*OpM134_5)-S35*(AlM234_5+s->dpt[1][67]*OpM333_5-
 s->dpt[3][67]*OpM134_5)-s->l[1][35]*OpM235_5+s->l[2][35]*OpM134_5);
  ...
  FB235_6 = s->m[35]*(s->l[1][35]*OpM335_6-s->l[3][35]*OpM134_6+C35*(AlM234_6+s->dpt[1][67]*OpM333_6-s->dpt[3][67]*
 OpM134_6)+S35*(AlM334_6-s->dpt[1][67]*OpM234_6+s->dpt[2][67]*OpM134_6));
  FB335_6 = s->m[35]*(C35*(AlM334_6-s->dpt[1][67]*OpM234_6+s->dpt[2][67]*OpM134_6)-S35*(AlM234_6+s->dpt[1][67]*OpM333_6-
 s->dpt[3][67]*OpM134_6)-s->l[1][35]*OpM235_6+s->l[2][35]*OpM134_6);
  ...
  FB135_19 = s->m[35]*(AlM134_19-s->dpt[2][67]*OpM333_19+s->dpt[3][67]*OpM234_19-s->l[2][35]*OpM335_19+s->l[3][35]*
 OpM235_19);
  FB235_19 = s->m[35]*(s->l[1][35]*OpM335_19-s->l[3][35]*OpM134_19+C35*(AlM234_19+s->dpt[1][67]*OpM333_19-s->dpt[3][67]*
 OpM134_19)+S35*(AlM334_19-s->dpt[1][67]*OpM234_19+s->dpt[2][67]*OpM134_19));
  FB335_19 = s->m[35]*(C35*(AlM334_19-s->dpt[1][67]*OpM234_19+s->dpt[2][67]*OpM134_19)-S35*(AlM234_19+s->dpt[1][67]*
 OpM333_19-s->dpt[3][67]*OpM134_19)-s->l[1][35]*OpM235_19+s->l[2][35]*OpM134_19);
  CM135_19 = s->In[1][35]*OpM134_19+s->In[2][35]*OpM235_19+s->In[3][35]*OpM335_19+s->l[2][35]*FB335_19-s->l[3][35]*
 FB235_19;
  ...
  FB135_20 = s->m[35]*(AlM134_20-s->dpt[2][67]*OpM333_20+s->dpt[3][67]*OpM234_20-s->l[2][35]*OpM335_20+s->l[3][35]*
 OpM235_20);
  FB235_20 = s->m[35]*(s->l[1][35]*OpM335_20-s->l[3][35]*OpM134_20+C35*(AlM234_20+s->dpt[1][67]*OpM333_20-s->dpt[3][67]*
 OpM134_20)+S35*(AlM334_20-s->dpt[1][67]*OpM234_20+s->dpt[2][67]*OpM134_20));
  FB335_20 = s->m[35]*(C35*(AlM334_20-s->dpt[1][67]*OpM234_20+s->dpt[2][67]*OpM134_20)-S35*(AlM234_20+s->dpt[1][67]*
 OpM333_20-s->dpt[3][67]*OpM134_20)-s->l[1][35]*OpM235_20+s->l[2][35]*OpM134_20);
  CM135_20 = s->In[1][35]*OpM134_20+s->In[2][35]*OpM235_20+s->In[3][35]*OpM335_20+s->l[2][35]*FB335_20-s->l[3][35]*
 FB235_20;
  ...
  FB135_21 = s->m[35]*(AlM134_21-s->dpt[2][67]*OpM333_21+s->dpt[3][67]*OpM234_21-s->l[2][35]*OpM335_21+s->l[3][35]*
 OpM235_21);
  FB235_21 = s->m[35]*(s->l[1][35]*OpM335_21-s->l[3][35]*OpM134_21+C35*(AlM234_21+s->dpt[1][67]*OpM333_21-s->dpt[3][67]*
 OpM134_21)+S35*(AlM334_21-s->dpt[1][67]*OpM234_21+s->dpt[2][67]*OpM134_21));
  FB335_21 = s->m[35]*(C35*(AlM334_21-s->dpt[1][67]*OpM234_21+s->dpt[2][67]*OpM134_21)-S35*(AlM234_21+s->dpt[1][67]*
 OpM333_21-s->dpt[3][67]*OpM134_21)-s->l[1][35]*OpM235_21+s->l[2][35]*OpM134_21);
  CM135_21 = s->In[1][35]*OpM134_21+s->In[2][35]*OpM235_21+s->In[3][35]*OpM335_21+s->l[2][35]*FB335_21-s->l[3][35]*
 FB235_21;
  ...
  FB135_29 = s->m[35]*(AlM134_29-s->dpt[2][67]*OpM333_29+s->dpt[3][67]*OpM234_29-s->l[2][35]*OpM335_29+s->l[3][35]*
 OpM235_29);
  FB235_29 = s->m[35]*(s->l[1][35]*OpM335_29-s->l[3][35]*OpM134_29+C35*(AlM234_29+s->dpt[1][67]*OpM333_29-s->dpt[3][67]*
 OpM134_29)+S35*(AlM334_29-s->dpt[1][67]*OpM234_29+s->dpt[2][67]*OpM134_29));
  FB335_29 = s->m[35]*(C35*(AlM334_29-s->dpt[1][67]*OpM234_29+s->dpt[2][67]*OpM134_29)-S35*(AlM234_29+s->dpt[1][67]*
 OpM333_29-s->dpt[3][67]*OpM134_29)-s->l[1][35]*OpM235_29+s->l[2][35]*OpM134_29);
  CM135_29 = s->In[1][35]*OpM134_29+s->In[2][35]*OpM235_29+s->In[3][35]*OpM335_29+s->l[2][35]*FB335_29-s->l[3][35]*
 FB235_29;
  ...
  FB135_30 = s->m[35]*(AlM134_30-s->dpt[2][67]*OpM333_30+s->dpt[3][67]*OpM234_30-s->l[2][35]*OpM335_30+s->l[3][35]*
 OpM235_30);
  FB235_30 = s->m[35]*(s->l[1][35]*OpM335_30-s->l[3][35]*OpM134_30+C35*(AlM234_30+s->dpt[1][67]*OpM333_30-s->dpt[3][67]*
 OpM134_30)+S35*(AlM334_30-s->dpt[1][67]*OpM234_30+s->dpt[2][67]*OpM134_30));
  FB335_30 = s->m[35]*(C35*(AlM334_30-s->dpt[1][67]*OpM234_30+s->dpt[2][67]*OpM134_30)-S35*(AlM234_30+s->dpt[1][67]*
 OpM333_30-s->dpt[3][67]*OpM134_30)-s->l[1][35]*OpM235_30+s->l[2][35]*OpM134_30);
  CM135_30 = s->In[1][35]*OpM134_30+s->In[2][35]*OpM235_30+s->In[3][35]*OpM335_30+s->l[2][35]*FB335_30-s->l[3][35]*
 FB235_30;
  ...
  FB135_31 = s->m[35]*(AlM134_31-s->dpt[2][67]*OpM333_31+s->dpt[3][67]*OpM234_31-s->l[2][35]*OpM335_31+s->l[3][35]*
 OpM235_31);
  FB235_31 = s->m[35]*(s->l[1][35]*OpM335_31-s->l[3][35]*OpM134_31+C35*(AlM234_31+s->dpt[1][67]*OpM333_31-s->dpt[3][67]*
 OpM134_31)+S35*(AlM334_31-s->dpt[1][67]*OpM234_31+s->dpt[2][67]*OpM134_31));
  FB335_31 = s->m[35]*(C35*(AlM334_31-s->dpt[1][67]*OpM234_31+s->dpt[2][67]*OpM134_31)-S35*(AlM234_31+s->dpt[1][67]*
 OpM333_31-s->dpt[3][67]*OpM134_31)-s->l[1][35]*OpM235_31+s->l[2][35]*OpM134_31);
  CM135_31 = s->In[1][35]*OpM134_31+s->In[2][35]*OpM235_31+s->In[3][35]*OpM335_31+s->l[2][35]*FB335_31-s->l[3][35]*
 FB235_31;
  ...
  FB235_32 = s->m[35]*(s->l[1][35]*OpM335_32-s->l[3][35]*OpM134_32+C35*(AlM234_32+s->dpt[1][67]*C33-s->dpt[3][67]*
 OpM134_32)+S35*(AlM334_32-s->dpt[1][67]*OpM234_32+s->dpt[2][67]*OpM134_32));
  FB335_32 = s->m[35]*(C35*(AlM334_32-s->dpt[1][67]*OpM234_32+s->dpt[2][67]*OpM134_32)-S35*(AlM234_32+s->dpt[1][67]*C33-
 s->dpt[3][67]*OpM134_32)-s->l[1][35]*OpM235_32+s->l[2][35]*OpM134_32);
  CM135_32 = s->In[1][35]*OpM134_32+s->In[2][35]*OpM235_32+s->In[3][35]*OpM335_32+s->l[2][35]*FB335_32-s->l[3][35]*
 FB235_32;
  ...
  FB235_33 = s->m[35]*(s->l[1][35]*OpM335_33-s->l[3][35]*S34+C35*(AlM234_33-s->dpt[3][67]*S34)-S35*(s->dpt[1][66]+
 s->dpt[1][67]*C34-s->dpt[2][67]*S34));
  FB335_33 = s->m[35]*(S34*S35*(s->dpt[3][66]+s->dpt[3][67])-C35*(s->dpt[1][66]+s->dpt[1][67]*C34-s->dpt[2][67]*S34)-
 s->l[1][35]*OpM235_33+s->l[2][35]*S34);
  ...
  CF134 = -(s->trq[1][34]-CF135-s->In[1][34]*OpF134-s->In[2][34]*OpF234-s->In[3][34]*OpF333-s->dpt[2][67]*(FA235*S35+
 FA335*C35)+s->dpt[3][67]*(FA235*C35-FA335*S35)-s->l[2][34]*FA334+s->l[3][34]*FA234+OM334*(s->In[5][34]*OM234+s->In[6][34]*
 OM334-s->In[9][34]*OM234));
  CF234 = -(s->trq[2][34]-s->In[5][34]*OpF234-s->In[6][34]*OpF333+s->dpt[1][67]*(FA235*S35+FA335*C35)-s->dpt[3][67]*
 FA135+s->l[1][34]*FA334-s->l[3][34]*FA134-CF235*C35+CF335*S35-OM334*(s->In[1][34]*OM134+s->In[2][34]*OM234+s->In[3][34]*
 OM334-s->In[9][34]*OM134));
  CF334 = -(s->trq[3][34]-s->In[9][34]*OpF333-s->dpt[1][67]*(FA235*C35-FA335*S35)+s->dpt[2][67]*FA135-s->l[1][34]*FA234+
 s->l[2][34]*FA134-CF235*S35-CF335*C35-OM134*(s->In[5][34]*OM234+s->In[6][34]*OM334)+OM234*(s->In[1][34]*OM134+s->In[2][34]*
 OM234+s->In[3][34]*OM334));
  ...
  CM134_1 = CM135_1+s->dpt[2][67]*(FB235_1*S35+FB335_1*C35)-s->dpt[3][67]*(FB235_1*C35-FB335_1*S35)+s->l[2][34]*FB334_1-
 s->l[3][34]*FB234_1;
  CM234_1 = -(s->dpt[1][67]*(FB235_1*S35+FB335_1*C35)-s->dpt[3][67]*FB135_1+s->l[1][34]*FB334_1-s->l[3][34]*FB134_1-
 CM235_1*C35+CM335_1*S35);
  CM334_1 = s->dpt[1][67]*(FB235_1*C35-FB335_1*S35)-s->dpt[2][67]*FB135_1+s->l[1][34]*FB234_1-s->l[2][34]*FB134_1+
 CM235_1*S35+CM335_1*C35;
  ...
  CM134_2 = CM135_2+s->dpt[2][67]*(FB235_2*S35+FB335_2*C35)-s->dpt[3][67]*(FB235_2*C35-FB335_2*S35)+s->l[2][34]*FB334_2-
 s->l[3][34]*FB234_2;
  CM234_2 = -(s->dpt[1][67]*(FB235_2*S35+FB335_2*C35)-s->dpt[3][67]*FB135_2+s->l[1][34]*FB334_2-s->l[3][34]*FB134_2-
 CM235_2*C35+CM335_2*S35);
  CM334_2 = s->dpt[1][67]*(FB235_2*C35-FB335_2*S35)-s->dpt[2][67]*FB135_2+s->l[1][34]*FB234_2-s->l[2][34]*FB134_2+
 CM235_2*S35+CM335_2*C35;
  ...
  CM134_3 = CM135_3+s->dpt[2][67]*(FB235_3*S35+FB335_3*C35)-s->dpt[3][67]*(FB235_3*C35-FB335_3*S35)+s->l[2][34]*FB334_3-
 s->l[3][34]*FB234_3;
  CM234_3 = -(s->dpt[1][67]*(FB235_3*S35+FB335_3*C35)-s->dpt[3][67]*FB135_3+s->l[1][34]*FB334_3-s->l[3][34]*FB134_3-
 CM235_3*C35+CM335_3*S35);
  CM334_3 = s->dpt[1][67]*(FB235_3*C35-FB335_3*S35)-s->dpt[2][67]*FB135_3+s->l[1][34]*FB234_3-s->l[2][34]*FB134_3+
 CM235_3*S35+CM335_3*C35;
  ...
  CM134_4 = CM135_4+s->In[1][34]*OpM134_4+s->In[2][34]*OpM234_4+s->In[3][34]*OpM333_4+s->dpt[2][67]*(FB235_4*S35+FB335_4
 *C35)-s->dpt[3][67]*(FB235_4*C35-FB335_4*S35)+s->l[2][34]*FB334_4-s->l[3][34]*FB234_4;
  CM234_4 = s->In[5][34]*OpM234_4+s->In[6][34]*OpM333_4-s->dpt[1][67]*(FB235_4*S35+FB335_4*C35)+s->dpt[3][67]*FB135_4-
 s->l[1][34]*FB334_4+s->l[3][34]*FB134_4+CM235_4*C35-CM335_4*S35;
  CM334_4 = s->In[9][34]*OpM333_4+s->dpt[1][67]*(FB235_4*C35-FB335_4*S35)-s->dpt[2][67]*FB135_4+s->l[1][34]*FB234_4-
 s->l[2][34]*FB134_4+CM235_4*S35+CM335_4*C35;
  ...
  CM134_5 = CM135_5+s->In[1][34]*OpM134_5+s->In[2][34]*OpM234_5+s->In[3][34]*OpM333_5+s->dpt[2][67]*(FB235_5*S35+FB335_5
 *C35)-s->dpt[3][67]*(FB235_5*C35-FB335_5*S35)+s->l[2][34]*FB334_5-s->l[3][34]*FB234_5;
  CM234_5 = s->In[5][34]*OpM234_5+s->In[6][34]*OpM333_5-s->dpt[1][67]*(FB235_5*S35+FB335_5*C35)+s->dpt[3][67]*FB135_5-
 s->l[1][34]*FB334_5+s->l[3][34]*FB134_5+CM235_5*C35-CM335_5*S35;
  CM334_5 = s->In[9][34]*OpM333_5+s->dpt[1][67]*(FB235_5*C35-FB335_5*S35)-s->dpt[2][67]*FB135_5+s->l[1][34]*FB234_5-
 s->l[2][34]*FB134_5+CM235_5*S35+CM335_5*C35;
  ...
  CM134_6 = CM135_6+s->In[1][34]*OpM134_6+s->In[2][34]*OpM234_6+s->In[3][34]*OpM333_6+s->dpt[2][67]*(FB235_6*S35+FB335_6
 *C35)-s->dpt[3][67]*(FB235_6*C35-FB335_6*S35)+s->l[2][34]*FB334_6-s->l[3][34]*FB234_6;
  CM234_6 = s->In[5][34]*OpM234_6+s->In[6][34]*OpM333_6-s->dpt[1][67]*(FB235_6*S35+FB335_6*C35)+s->dpt[3][67]*FB135_6-
 s->l[1][34]*FB334_6+s->l[3][34]*FB134_6+CM235_6*C35-CM335_6*S35;
  CM334_6 = s->In[9][34]*OpM333_6+s->dpt[1][67]*(FB235_6*C35-FB335_6*S35)-s->dpt[2][67]*FB135_6+s->l[1][34]*FB234_6-
 s->l[2][34]*FB134_6+CM235_6*S35+CM335_6*C35;
  ...
  CM134_19 = CM135_19+s->In[1][34]*OpM134_19+s->In[2][34]*OpM234_19+s->In[3][34]*OpM333_19+s->dpt[2][67]*(FB235_19*S35+
 FB335_19*C35)-s->dpt[3][67]*(FB235_19*C35-FB335_19*S35)+s->l[2][34]*FB334_19-s->l[3][34]*FB234_19;
  CM234_19 = s->In[5][34]*OpM234_19+s->In[6][34]*OpM333_19-s->dpt[1][67]*(FB235_19*S35+FB335_19*C35)+s->dpt[3][67]*
 FB135_19-s->l[1][34]*FB334_19+s->l[3][34]*FB134_19+CM235_19*C35-CM335_19*S35;
  CM334_19 = s->In[9][34]*OpM333_19+s->dpt[1][67]*(FB235_19*C35-FB335_19*S35)-s->dpt[2][67]*FB135_19+s->l[1][34]*
 FB234_19-s->l[2][34]*FB134_19+CM235_19*S35+CM335_19*C35;
  ...
  CM134_20 = CM135_20+s->In[1][34]*OpM134_20+s->In[2][34]*OpM234_20+s->In[3][34]*OpM333_20+s->dpt[2][67]*(FB235_20*S35+
 FB335_20*C35)-s->dpt[3][67]*(FB235_20*C35-FB335_20*S35)+s->l[2][34]*FB334_20-s->l[3][34]*FB234_20;
  CM234_20 = s->In[5][34]*OpM234_20+s->In[6][34]*OpM333_20-s->dpt[1][67]*(FB235_20*S35+FB335_20*C35)+s->dpt[3][67]*
 FB135_20-s->l[1][34]*FB334_20+s->l[3][34]*FB134_20+CM235_20*C35-CM335_20*S35;
  CM334_20 = s->In[9][34]*OpM333_20+s->dpt[1][67]*(FB235_20*C35-FB335_20*S35)-s->dpt[2][67]*FB135_20+s->l[1][34]*
 FB234_20-s->l[2][34]*FB134_20+CM235_20*S35+CM335_20*C35;
  ...
  CM134_21 = CM135_21+s->In[1][34]*OpM134_21+s->In[2][34]*OpM234_21+s->In[3][34]*OpM333_21+s->dpt[2][67]*(FB235_21*S35+
 FB335_21*C35)-s->dpt[3][67]*(FB235_21*C35-FB335_21*S35)+s->l[2][34]*FB334_21-s->l[3][34]*FB234_21;
  CM234_21 = s->In[5][34]*OpM234_21+s->In[6][34]*OpM333_21-s->dpt[1][67]*(FB235_21*S35+FB335_21*C35)+s->dpt[3][67]*
 FB135_21-s->l[1][34]*FB334_21+s->l[3][34]*FB134_21+CM235_21*C35-CM335_21*S35;
  CM334_21 = s->In[9][34]*OpM333_21+s->dpt[1][67]*(FB235_21*C35-FB335_21*S35)-s->dpt[2][67]*FB135_21+s->l[1][34]*
 FB234_21-s->l[2][34]*FB134_21+CM235_21*S35+CM335_21*C35;
  ...
  CM134_29 = CM135_29+s->In[1][34]*OpM134_29+s->In[2][34]*OpM234_29+s->In[3][34]*OpM333_29+s->dpt[2][67]*(FB235_29*S35+
 FB335_29*C35)-s->dpt[3][67]*(FB235_29*C35-FB335_29*S35)+s->l[2][34]*FB334_29-s->l[3][34]*FB234_29;
  CM234_29 = s->In[5][34]*OpM234_29+s->In[6][34]*OpM333_29-s->dpt[1][67]*(FB235_29*S35+FB335_29*C35)+s->dpt[3][67]*
 FB135_29-s->l[1][34]*FB334_29+s->l[3][34]*FB134_29+CM235_29*C35-CM335_29*S35;
  CM334_29 = s->In[9][34]*OpM333_29+s->dpt[1][67]*(FB235_29*C35-FB335_29*S35)-s->dpt[2][67]*FB135_29+s->l[1][34]*
 FB234_29-s->l[2][34]*FB134_29+CM235_29*S35+CM335_29*C35;
  ...
  CM134_30 = CM135_30+s->In[1][34]*OpM134_30+s->In[2][34]*OpM234_30+s->In[3][34]*OpM333_30+s->dpt[2][67]*(FB235_30*S35+
 FB335_30*C35)-s->dpt[3][67]*(FB235_30*C35-FB335_30*S35)+s->l[2][34]*FB334_30-s->l[3][34]*FB234_30;
  CM234_30 = s->In[5][34]*OpM234_30+s->In[6][34]*OpM333_30-s->dpt[1][67]*(FB235_30*S35+FB335_30*C35)+s->dpt[3][67]*
 FB135_30-s->l[1][34]*FB334_30+s->l[3][34]*FB134_30+CM235_30*C35-CM335_30*S35;
  CM334_30 = s->In[9][34]*OpM333_30+s->dpt[1][67]*(FB235_30*C35-FB335_30*S35)-s->dpt[2][67]*FB135_30+s->l[1][34]*
 FB234_30-s->l[2][34]*FB134_30+CM235_30*S35+CM335_30*C35;
  ...
  CM134_31 = CM135_31+s->In[1][34]*OpM134_31+s->In[2][34]*OpM234_31+s->In[3][34]*OpM333_31+s->dpt[2][67]*(FB235_31*S35+
 FB335_31*C35)-s->dpt[3][67]*(FB235_31*C35-FB335_31*S35)+s->l[2][34]*FB334_31-s->l[3][34]*FB234_31;
  CM234_31 = s->In[5][34]*OpM234_31+s->In[6][34]*OpM333_31-s->dpt[1][67]*(FB235_31*S35+FB335_31*C35)+s->dpt[3][67]*
 FB135_31-s->l[1][34]*FB334_31+s->l[3][34]*FB134_31+CM235_31*C35-CM335_31*S35;
  CM334_31 = s->In[9][34]*OpM333_31+s->dpt[1][67]*(FB235_31*C35-FB335_31*S35)-s->dpt[2][67]*FB135_31+s->l[1][34]*
 FB234_31-s->l[2][34]*FB134_31+CM235_31*S35+CM335_31*C35;
  ...
  CM134_32 = CM135_32+s->In[1][34]*OpM134_32+s->In[2][34]*OpM234_32+s->In[3][34]*C33+s->dpt[2][67]*(FB235_32*S35+
 FB335_32*C35)-s->dpt[3][67]*(FB235_32*C35-FB335_32*S35)+s->l[2][34]*FB334_32-s->l[3][34]*FB234_32;
  CM234_32 = s->In[5][34]*OpM234_32+s->In[6][34]*C33-s->dpt[1][67]*(FB235_32*S35+FB335_32*C35)+s->dpt[3][67]*FB135_32-
 s->l[1][34]*FB334_32+s->l[3][34]*FB134_32+CM235_32*C35-CM335_32*S35;
  CM334_32 = s->In[9][34]*C33+s->dpt[1][67]*(FB235_32*C35-FB335_32*S35)-s->dpt[2][67]*FB135_32+s->l[1][34]*FB234_32-
 s->l[2][34]*FB134_32+CM235_32*S35+CM335_32*C35;
  ...
  CM334_33 = s->dpt[1][67]*(FB235_33*C35-FB335_33*S35)-s->dpt[2][67]*FB135_33+s->l[1][34]*FB234_33-s->l[2][34]*FB134_33+
 CM235_33*S35+CM335_33*C35;
  CM334_34 = s->In[9][34]+s->dpt[1][67]*(FB235_34*C35-FB335_34*S35)-s->dpt[2][67]*FB135_34+s->l[1][34]*s->l[1][34]*
 s->m[34]+s->l[2][34]*s->l[2][34]*s->m[34]+C35*(s->In[9][35]*C35+s->l[1][35]*FB235_34-s->l[2][35]*FB135_34)+S35*(s->In[5][35]
 *S35+s->In[6][35]*C35-s->l[1][35]*FB335_34+s->l[3][35]*FB135_34);
  ...
  FF333 = FA333+FF334;
  CF133 = -(s->trq[1][33]-s->In[1][33]*OpF133-s->In[2][33]*OpF232-s->In[3][33]*OpF333+s->dpt[3][66]*(FF134*S34+FF234*C34
 )+s->l[3][33]*FA233-CF134*C34+CF234*S34-FA333*s->l[2][33]-FF334*s->dpt[2][66]+OM333*(s->In[5][33]*OM233+s->In[6][33]*OM333-
 s->In[9][33]*OM233));
  CF233 = -(s->trq[2][33]-s->In[5][33]*OpF232-s->In[6][33]*OpF333+s->dpt[1][66]*FF334-s->dpt[3][66]*(FF134*C34-FF234*S34
 )+s->l[1][33]*FA333-s->l[3][33]*FA133-CF134*S34-CF234*C34-OM333*(s->In[1][33]*OM133+s->In[2][33]*OM233+s->In[3][33]*OM333-
 s->In[9][33]*OM133));
  CF333 = -(s->trq[3][33]-CF334-s->In[9][33]*OpF333-s->dpt[1][66]*(FF134*S34+FF234*C34)-s->l[1][33]*FA233+FA133*
 s->l[2][33]-OM133*(s->In[5][33]*OM233+s->In[6][33]*OM333)+OM233*(s->In[1][33]*OM133+s->In[2][33]*OM233+s->In[3][33]*OM333)+
 s->dpt[2][66]*(FF134*C34-FF234*S34));
  ...
  CM133_1 = -(s->dpt[3][66]*(FM134_1*S34+FM234_1*C34)+s->l[3][33]*FB233_1-CM134_1*C34+CM234_1*S34-FB333_1*s->l[2][33]-
 FM334_1*s->dpt[2][66]);
  CM233_1 = -(s->dpt[1][66]*FM334_1-s->dpt[3][66]*(FM134_1*C34-FM234_1*S34)+s->l[1][33]*FB333_1-s->l[3][33]*FB133_1-
 CM134_1*S34-CM234_1*C34);
  CM333_1 = CM334_1+s->dpt[1][66]*(FM134_1*S34+FM234_1*C34)+s->l[1][33]*FB233_1-FB133_1*s->l[2][33]-s->dpt[2][66]*(
 FM134_1*C34-FM234_1*S34);
  ...
  CM133_2 = -(s->dpt[3][66]*(FM134_2*S34+FM234_2*C34)+s->l[3][33]*FB233_2-CM134_2*C34+CM234_2*S34-FB333_2*s->l[2][33]-
 FM334_2*s->dpt[2][66]);
  CM233_2 = -(s->dpt[1][66]*FM334_2-s->dpt[3][66]*(FM134_2*C34-FM234_2*S34)+s->l[1][33]*FB333_2-s->l[3][33]*FB133_2-
 CM134_2*S34-CM234_2*C34);
  CM333_2 = CM334_2+s->dpt[1][66]*(FM134_2*S34+FM234_2*C34)+s->l[1][33]*FB233_2-FB133_2*s->l[2][33]-s->dpt[2][66]*(
 FM134_2*C34-FM234_2*S34);
  ...
  CM133_3 = -(s->dpt[3][66]*(FM134_3*S34+FM234_3*C34)+s->l[3][33]*FB233_3-CM134_3*C34+CM234_3*S34-FB333_3*s->l[2][33]-
 FM334_3*s->dpt[2][66]);
  CM233_3 = -(s->dpt[1][66]*FM334_3-s->dpt[3][66]*(FM134_3*C34-FM234_3*S34)+s->l[1][33]*FB333_3-s->l[3][33]*FB133_3-
 CM134_3*S34-CM234_3*C34);
  CM333_3 = CM334_3+s->dpt[1][66]*(FM134_3*S34+FM234_3*C34)+s->l[1][33]*FB233_3-FB133_3*s->l[2][33]-s->dpt[2][66]*(
 FM134_3*C34-FM234_3*S34);
  ...
  CM133_4 = s->In[1][33]*OpM133_4+s->In[2][33]*OpM232_4+s->In[3][33]*OpM333_4-s->dpt[3][66]*(FM134_4*S34+FM234_4*C34)-
 s->l[3][33]*FB233_4+CM134_4*C34-CM234_4*S34+FB333_4*s->l[2][33]+FM334_4*s->dpt[2][66];
  CM233_4 = s->In[5][33]*OpM232_4+s->In[6][33]*OpM333_4-s->dpt[1][66]*FM334_4+s->dpt[3][66]*(FM134_4*C34-FM234_4*S34)-
 s->l[1][33]*FB333_4+s->l[3][33]*FB133_4+CM134_4*S34+CM234_4*C34;
  CM333_4 = CM334_4+s->In[9][33]*OpM333_4+s->dpt[1][66]*(FM134_4*S34+FM234_4*C34)+s->l[1][33]*FB233_4-FB133_4*
 s->l[2][33]-s->dpt[2][66]*(FM134_4*C34-FM234_4*S34);
  ...
  CM133_5 = s->In[1][33]*OpM133_5+s->In[2][33]*OpM232_5+s->In[3][33]*OpM333_5-s->dpt[3][66]*(FM134_5*S34+FM234_5*C34)-
 s->l[3][33]*FB233_5+CM134_5*C34-CM234_5*S34+FB333_5*s->l[2][33]+FM334_5*s->dpt[2][66];
  CM233_5 = s->In[5][33]*OpM232_5+s->In[6][33]*OpM333_5-s->dpt[1][66]*FM334_5+s->dpt[3][66]*(FM134_5*C34-FM234_5*S34)-
 s->l[1][33]*FB333_5+s->l[3][33]*FB133_5+CM134_5*S34+CM234_5*C34;
  CM333_5 = CM334_5+s->In[9][33]*OpM333_5+s->dpt[1][66]*(FM134_5*S34+FM234_5*C34)+s->l[1][33]*FB233_5-FB133_5*
 s->l[2][33]-s->dpt[2][66]*(FM134_5*C34-FM234_5*S34);
  ...
  CM133_6 = s->In[1][33]*OpM133_6+s->In[2][33]*OpM232_6+s->In[3][33]*OpM333_6-s->dpt[3][66]*(FM134_6*S34+FM234_6*C34)-
 s->l[3][33]*FB233_6+CM134_6*C34-CM234_6*S34+FB333_6*s->l[2][33]+FM334_6*s->dpt[2][66];
  CM233_6 = s->In[5][33]*OpM232_6+s->In[6][33]*OpM333_6-s->dpt[1][66]*FM334_6+s->dpt[3][66]*(FM134_6*C34-FM234_6*S34)-
 s->l[1][33]*FB333_6+s->l[3][33]*FB133_6+CM134_6*S34+CM234_6*C34;
  CM333_6 = CM334_6+s->In[9][33]*OpM333_6+s->dpt[1][66]*(FM134_6*S34+FM234_6*C34)+s->l[1][33]*FB233_6-FB133_6*
 s->l[2][33]-s->dpt[2][66]*(FM134_6*C34-FM234_6*S34);
  ...
  CM133_19 = s->In[1][33]*OpM133_19+s->In[2][33]*OpM232_19+s->In[3][33]*OpM333_19-s->dpt[3][66]*(FM134_19*S34+FM234_19*
 C34)-s->l[3][33]*FB233_19+CM134_19*C34-CM234_19*S34+FB333_19*s->l[2][33]+FM334_19*s->dpt[2][66];
  CM233_19 = s->In[5][33]*OpM232_19+s->In[6][33]*OpM333_19-s->dpt[1][66]*FM334_19+s->dpt[3][66]*(FM134_19*C34-FM234_19*
 S34)-s->l[1][33]*FB333_19+s->l[3][33]*FB133_19+CM134_19*S34+CM234_19*C34;
  CM333_19 = CM334_19+s->In[9][33]*OpM333_19+s->dpt[1][66]*(FM134_19*S34+FM234_19*C34)+s->l[1][33]*FB233_19-FB133_19*
 s->l[2][33]-s->dpt[2][66]*(FM134_19*C34-FM234_19*S34);
  ...
  CM133_20 = s->In[1][33]*OpM133_20+s->In[2][33]*OpM232_20+s->In[3][33]*OpM333_20-s->dpt[3][66]*(FM134_20*S34+FM234_20*
 C34)-s->l[3][33]*FB233_20+CM134_20*C34-CM234_20*S34+FB333_20*s->l[2][33]+FM334_20*s->dpt[2][66];
  CM233_20 = s->In[5][33]*OpM232_20+s->In[6][33]*OpM333_20-s->dpt[1][66]*FM334_20+s->dpt[3][66]*(FM134_20*C34-FM234_20*
 S34)-s->l[1][33]*FB333_20+s->l[3][33]*FB133_20+CM134_20*S34+CM234_20*C34;
  CM333_20 = CM334_20+s->In[9][33]*OpM333_20+s->dpt[1][66]*(FM134_20*S34+FM234_20*C34)+s->l[1][33]*FB233_20-FB133_20*
 s->l[2][33]-s->dpt[2][66]*(FM134_20*C34-FM234_20*S34);
  ...
  CM133_21 = s->In[1][33]*OpM133_21+s->In[2][33]*OpM232_21+s->In[3][33]*OpM333_21-s->dpt[3][66]*(FM134_21*S34+FM234_21*
 C34)-s->l[3][33]*FB233_21+CM134_21*C34-CM234_21*S34+FB333_21*s->l[2][33]+FM334_21*s->dpt[2][66];
  CM233_21 = s->In[5][33]*OpM232_21+s->In[6][33]*OpM333_21-s->dpt[1][66]*FM334_21+s->dpt[3][66]*(FM134_21*C34-FM234_21*
 S34)-s->l[1][33]*FB333_21+s->l[3][33]*FB133_21+CM134_21*S34+CM234_21*C34;
  CM333_21 = CM334_21+s->In[9][33]*OpM333_21+s->dpt[1][66]*(FM134_21*S34+FM234_21*C34)+s->l[1][33]*FB233_21-FB133_21*
 s->l[2][33]-s->dpt[2][66]*(FM134_21*C34-FM234_21*S34);
  ...
  CM133_29 = s->In[1][33]*OpM133_29+s->In[2][33]*OpM232_29+s->In[3][33]*OpM333_29-s->dpt[3][66]*(FM134_29*S34+FM234_29*
 C34)-s->l[3][33]*FB233_29+CM134_29*C34-CM234_29*S34+FB333_29*s->l[2][33]+FM334_29*s->dpt[2][66];
  CM233_29 = s->In[5][33]*OpM232_29+s->In[6][33]*OpM333_29-s->dpt[1][66]*FM334_29+s->dpt[3][66]*(FM134_29*C34-FM234_29*
 S34)-s->l[1][33]*FB333_29+s->l[3][33]*FB133_29+CM134_29*S34+CM234_29*C34;
  CM333_29 = CM334_29+s->In[9][33]*OpM333_29+s->dpt[1][66]*(FM134_29*S34+FM234_29*C34)+s->l[1][33]*FB233_29-FB133_29*
 s->l[2][33]-s->dpt[2][66]*(FM134_29*C34-FM234_29*S34);
  ...
  CM133_30 = s->In[1][33]*OpM133_30+s->In[2][33]*OpM232_30+s->In[3][33]*OpM333_30-s->dpt[3][66]*(FM134_30*S34+FM234_30*
 C34)-s->l[3][33]*FB233_30+CM134_30*C34-CM234_30*S34+FB333_30*s->l[2][33]+FM334_30*s->dpt[2][66];
  CM233_30 = s->In[5][33]*OpM232_30+s->In[6][33]*OpM333_30-s->dpt[1][66]*FM334_30+s->dpt[3][66]*(FM134_30*C34-FM234_30*
 S34)-s->l[1][33]*FB333_30+s->l[3][33]*FB133_30+CM134_30*S34+CM234_30*C34;
  CM333_30 = CM334_30+s->In[9][33]*OpM333_30+s->dpt[1][66]*(FM134_30*S34+FM234_30*C34)+s->l[1][33]*FB233_30-FB133_30*
 s->l[2][33]-s->dpt[2][66]*(FM134_30*C34-FM234_30*S34);
  ...
  CM133_31 = s->In[1][33]*OpM133_31+s->In[2][33]*C32+s->In[3][33]*OpM333_31-s->dpt[3][66]*(FM134_31*S34+FM234_31*C34)-
 s->l[3][33]*FB233_31+CM134_31*C34-CM234_31*S34+FB333_31*s->l[2][33]+FM334_31*s->dpt[2][66];
  CM233_31 = s->In[5][33]*C32+s->In[6][33]*OpM333_31-s->dpt[1][66]*FM334_31+s->dpt[3][66]*(FM134_31*C34-FM234_31*S34)-
 s->l[1][33]*FB333_31+s->l[3][33]*FB133_31+CM134_31*S34+CM234_31*C34;
  CM333_31 = CM334_31+s->In[9][33]*OpM333_31+s->dpt[1][66]*(FM134_31*S34+FM234_31*C34)+s->l[1][33]*FB233_31-FB133_31*
 s->l[2][33]-s->dpt[2][66]*(FM134_31*C34-FM234_31*S34);
  ...
  CM233_32 = s->In[6][33]*C33-s->dpt[1][66]*FM334_32+s->dpt[3][66]*(FM134_32*C34-FM234_32*S34)-s->l[1][33]*FB333_32+
 s->l[3][33]*FB133_32+CM134_32*S34+CM234_32*C34;
  CM233_33 = s->In[5][33]-s->dpt[1][66]*(FB334_33+FB235_33*S35+FB335_33*C35)+s->dpt[3][66]*(C34*(FB134_33+FB135_33)-S34*
 (FB234_33+FB235_33*C35-FB335_33*S35))+s->l[1][33]*s->l[1][33]*s->m[33]+s->l[3][33]*s->l[3][33]*s->m[33]+C34*(s->In[5][34]*
 C34-s->dpt[1][67]*(FB235_33*S35+FB335_33*C35)+s->dpt[3][67]*FB135_33-s->l[1][34]*FB334_33+s->l[3][34]*FB134_33+CM235_33*C35-
 CM335_33*S35)+S34*(CM135_33+s->In[1][34]*S34+s->In[2][34]*C34+s->dpt[2][67]*(FB235_33*S35+FB335_33*C35)-s->dpt[3][67]*(
 FB235_33*C35-FB335_33*S35)+s->l[2][34]*FB334_33-s->l[3][34]*FB234_33);
  ...
  CF132 = -(s->trq[1][32]-s->In[1][32]*OpF132-s->In[2][32]*OpF232-s->In[3][32]*OpF331+s->dpt[2][65]*(FF133*S33-FF333*C33
 )+s->dpt[3][65]*FF233+s->l[3][32]*FA232-CF133*C33-CF333*S33-FA332*s->l[2][32]-OM232*(s->In[3][32]*OM132+s->In[6][32]*OM232+
 s->In[9][32]*OM332)+OM332*(s->In[2][32]*OM132+s->In[5][32]*OM232+s->In[6][32]*OM332));
  CF232 = -(s->trq[2][32]-CF233-s->In[2][32]*OpF132-s->In[5][32]*OpF232-s->In[6][32]*OpF331-s->dpt[3][65]*(FF133*C33+
 FF333*S33)+s->l[1][32]*FA332-s->l[3][32]*FA132+OM132*(s->In[3][32]*OM132+s->In[6][32]*OM232+s->In[9][32]*OM332)-OM332*(
 s->In[1][32]*OM132+s->In[2][32]*OM232+s->In[3][32]*OM332)-s->dpt[1][65]*(FF133*S33-FF333*C33));
  CF332 = -(s->trq[3][32]-s->In[3][32]*OpF132-s->In[6][32]*OpF232-s->In[9][32]*OpF331+s->dpt[2][65]*(FF133*C33+FF333*S33
 )-s->l[1][32]*FA232+CF133*S33-CF333*C33+FA132*s->l[2][32]-FF233*s->dpt[1][65]-OM132*(s->In[2][32]*OM132+s->In[5][32]*OM232+
 s->In[6][32]*OM332)+OM232*(s->In[1][32]*OM132+s->In[2][32]*OM232+s->In[3][32]*OM332));
  ...
  CM132_1 = -(s->dpt[2][65]*(FM133_1*S33-FM333_1*C33)+s->dpt[3][65]*FM233_1+s->l[3][32]*FB232_1-CM133_1*C33-CM333_1*S33-
 FB332_1*s->l[2][32]);
  CM232_1 = CM233_1+s->dpt[3][65]*(FM133_1*C33+FM333_1*S33)-s->l[1][32]*FB332_1+s->l[3][32]*FB132_1+s->dpt[1][65]*(
 FM133_1*S33-FM333_1*C33);
  CM332_1 = -(s->dpt[2][65]*(FM133_1*C33+FM333_1*S33)-s->l[1][32]*FB232_1+CM133_1*S33-CM333_1*C33+FB132_1*s->l[2][32]-
 FM233_1*s->dpt[1][65]);
  ...
  CM132_2 = -(s->dpt[2][65]*(FM133_2*S33-FM333_2*C33)+s->dpt[3][65]*FM233_2+s->l[3][32]*FB232_2-CM133_2*C33-CM333_2*S33-
 FB332_2*s->l[2][32]);
  CM232_2 = CM233_2+s->dpt[3][65]*(FM133_2*C33+FM333_2*S33)-s->l[1][32]*FB332_2+s->l[3][32]*FB132_2+s->dpt[1][65]*(
 FM133_2*S33-FM333_2*C33);
  CM332_2 = -(s->dpt[2][65]*(FM133_2*C33+FM333_2*S33)-s->l[1][32]*FB232_2+CM133_2*S33-CM333_2*C33+FB132_2*s->l[2][32]-
 FM233_2*s->dpt[1][65]);
  ...
  CM132_3 = -(s->dpt[2][65]*(FM133_3*S33-FM333_3*C33)+s->dpt[3][65]*FM233_3+s->l[3][32]*FB232_3-CM133_3*C33-CM333_3*S33-
 FB332_3*s->l[2][32]);
  CM232_3 = CM233_3+s->dpt[3][65]*(FM133_3*C33+FM333_3*S33)-s->l[1][32]*FB332_3+s->l[3][32]*FB132_3+s->dpt[1][65]*(
 FM133_3*S33-FM333_3*C33);
  CM332_3 = -(s->dpt[2][65]*(FM133_3*C33+FM333_3*S33)-s->l[1][32]*FB232_3+CM133_3*S33-CM333_3*C33+FB132_3*s->l[2][32]-
 FM233_3*s->dpt[1][65]);
  ...
  CM132_4 = s->In[1][32]*OpM132_4+s->In[2][32]*OpM232_4+s->In[3][32]*OpM331_4-s->dpt[2][65]*(FM133_4*S33-FM333_4*C33)-
 s->dpt[3][65]*FM233_4-s->l[3][32]*FB232_4+CM133_4*C33+CM333_4*S33+FB332_4*s->l[2][32];
  CM232_4 = CM233_4+s->In[2][32]*OpM132_4+s->In[5][32]*OpM232_4+s->In[6][32]*OpM331_4+s->dpt[3][65]*(FM133_4*C33+FM333_4
 *S33)-s->l[1][32]*FB332_4+s->l[3][32]*FB132_4+s->dpt[1][65]*(FM133_4*S33-FM333_4*C33);
  CM332_4 = s->In[3][32]*OpM132_4+s->In[6][32]*OpM232_4+s->In[9][32]*OpM331_4-s->dpt[2][65]*(FM133_4*C33+FM333_4*S33)+
 s->l[1][32]*FB232_4-CM133_4*S33+CM333_4*C33-FB132_4*s->l[2][32]+FM233_4*s->dpt[1][65];
  ...
  CM132_5 = s->In[1][32]*OpM132_5+s->In[2][32]*OpM232_5+s->In[3][32]*OpM331_5-s->dpt[2][65]*(FM133_5*S33-FM333_5*C33)-
 s->dpt[3][65]*FM233_5-s->l[3][32]*FB232_5+CM133_5*C33+CM333_5*S33+FB332_5*s->l[2][32];
  CM232_5 = CM233_5+s->In[2][32]*OpM132_5+s->In[5][32]*OpM232_5+s->In[6][32]*OpM331_5+s->dpt[3][65]*(FM133_5*C33+FM333_5
 *S33)-s->l[1][32]*FB332_5+s->l[3][32]*FB132_5+s->dpt[1][65]*(FM133_5*S33-FM333_5*C33);
  CM332_5 = s->In[3][32]*OpM132_5+s->In[6][32]*OpM232_5+s->In[9][32]*OpM331_5-s->dpt[2][65]*(FM133_5*C33+FM333_5*S33)+
 s->l[1][32]*FB232_5-CM133_5*S33+CM333_5*C33-FB132_5*s->l[2][32]+FM233_5*s->dpt[1][65];
  ...
  CM132_6 = s->In[1][32]*OpM132_6+s->In[2][32]*OpM232_6+s->In[3][32]*OpM331_6-s->dpt[2][65]*(FM133_6*S33-FM333_6*C33)-
 s->dpt[3][65]*FM233_6-s->l[3][32]*FB232_6+CM133_6*C33+CM333_6*S33+FB332_6*s->l[2][32];
  CM232_6 = CM233_6+s->In[2][32]*OpM132_6+s->In[5][32]*OpM232_6+s->In[6][32]*OpM331_6+s->dpt[3][65]*(FM133_6*C33+FM333_6
 *S33)-s->l[1][32]*FB332_6+s->l[3][32]*FB132_6+s->dpt[1][65]*(FM133_6*S33-FM333_6*C33);
  CM332_6 = s->In[3][32]*OpM132_6+s->In[6][32]*OpM232_6+s->In[9][32]*OpM331_6-s->dpt[2][65]*(FM133_6*C33+FM333_6*S33)+
 s->l[1][32]*FB232_6-CM133_6*S33+CM333_6*C33-FB132_6*s->l[2][32]+FM233_6*s->dpt[1][65];
  ...
  CM132_19 = s->In[1][32]*OpM132_19+s->In[2][32]*OpM232_19+s->In[3][32]*OpM331_19-s->dpt[2][65]*(FM133_19*S33-FM333_19*
 C33)-s->dpt[3][65]*FM233_19-s->l[3][32]*FB232_19+CM133_19*C33+CM333_19*S33+FB332_19*s->l[2][32];
  CM232_19 = CM233_19+s->In[2][32]*OpM132_19+s->In[5][32]*OpM232_19+s->In[6][32]*OpM331_19+s->dpt[3][65]*(FM133_19*C33+
 FM333_19*S33)-s->l[1][32]*FB332_19+s->l[3][32]*FB132_19+s->dpt[1][65]*(FM133_19*S33-FM333_19*C33);
  CM332_19 = s->In[3][32]*OpM132_19+s->In[6][32]*OpM232_19+s->In[9][32]*OpM331_19-s->dpt[2][65]*(FM133_19*C33+FM333_19*
 S33)+s->l[1][32]*FB232_19-CM133_19*S33+CM333_19*C33-FB132_19*s->l[2][32]+FM233_19*s->dpt[1][65];
  ...
  CM132_20 = s->In[1][32]*OpM132_20+s->In[2][32]*OpM232_20+s->In[3][32]*OpM331_20-s->dpt[2][65]*(FM133_20*S33-FM333_20*
 C33)-s->dpt[3][65]*FM233_20-s->l[3][32]*FB232_20+CM133_20*C33+CM333_20*S33+FB332_20*s->l[2][32];
  CM232_20 = CM233_20+s->In[2][32]*OpM132_20+s->In[5][32]*OpM232_20+s->In[6][32]*OpM331_20+s->dpt[3][65]*(FM133_20*C33+
 FM333_20*S33)-s->l[1][32]*FB332_20+s->l[3][32]*FB132_20+s->dpt[1][65]*(FM133_20*S33-FM333_20*C33);
  CM332_20 = s->In[3][32]*OpM132_20+s->In[6][32]*OpM232_20+s->In[9][32]*OpM331_20-s->dpt[2][65]*(FM133_20*C33+FM333_20*
 S33)+s->l[1][32]*FB232_20-CM133_20*S33+CM333_20*C33-FB132_20*s->l[2][32]+FM233_20*s->dpt[1][65];
  ...
  CM132_21 = s->In[1][32]*OpM132_21+s->In[2][32]*OpM232_21+s->In[3][32]*OpM331_21-s->dpt[2][65]*(FM133_21*S33-FM333_21*
 C33)-s->dpt[3][65]*FM233_21-s->l[3][32]*FB232_21+CM133_21*C33+CM333_21*S33+FB332_21*s->l[2][32];
  CM232_21 = CM233_21+s->In[2][32]*OpM132_21+s->In[5][32]*OpM232_21+s->In[6][32]*OpM331_21+s->dpt[3][65]*(FM133_21*C33+
 FM333_21*S33)-s->l[1][32]*FB332_21+s->l[3][32]*FB132_21+s->dpt[1][65]*(FM133_21*S33-FM333_21*C33);
  CM332_21 = s->In[3][32]*OpM132_21+s->In[6][32]*OpM232_21+s->In[9][32]*OpM331_21-s->dpt[2][65]*(FM133_21*C33+FM333_21*
 S33)+s->l[1][32]*FB232_21-CM133_21*S33+CM333_21*C33-FB132_21*s->l[2][32]+FM233_21*s->dpt[1][65];
  ...
  CM132_29 = s->In[1][32]*OpM132_29+s->In[2][32]*OpM232_29+s->In[3][32]*OpM331_29-s->dpt[2][65]*(FM133_29*S33-FM333_29*
 C33)-s->dpt[3][65]*FM233_29-s->l[3][32]*FB232_29+CM133_29*C33+CM333_29*S33+FB332_29*s->l[2][32];
  CM232_29 = CM233_29+s->In[2][32]*OpM132_29+s->In[5][32]*OpM232_29+s->In[6][32]*OpM331_29+s->dpt[3][65]*(FM133_29*C33+
 FM333_29*S33)-s->l[1][32]*FB332_29+s->l[3][32]*FB132_29+s->dpt[1][65]*(FM133_29*S33-FM333_29*C33);
  CM332_29 = s->In[3][32]*OpM132_29+s->In[6][32]*OpM232_29+s->In[9][32]*OpM331_29-s->dpt[2][65]*(FM133_29*C33+FM333_29*
 S33)+s->l[1][32]*FB232_29-CM133_29*S33+CM333_29*C33-FB132_29*s->l[2][32]+FM233_29*s->dpt[1][65];
  ...
  CM132_30 = s->In[1][32]*OpM132_30+s->In[2][32]*OpM232_30+s->In[3][32]*S31-s->dpt[2][65]*(FM133_30*S33-FM333_30*C33)-
 s->dpt[3][65]*FM233_30-s->l[3][32]*FB232_30+CM133_30*C33+CM333_30*S33+FB332_30*s->l[2][32];
  CM232_30 = CM233_30+s->In[2][32]*OpM132_30+s->In[5][32]*OpM232_30+s->In[6][32]*S31+s->dpt[3][65]*(FM133_30*C33+
 FM333_30*S33)-s->l[1][32]*FB332_30+s->l[3][32]*FB132_30+s->dpt[1][65]*(FM133_30*S33-FM333_30*C33);
  CM332_30 = s->In[3][32]*OpM132_30+s->In[6][32]*OpM232_30+s->In[9][32]*S31-s->dpt[2][65]*(FM133_30*C33+FM333_30*S33)+
 s->l[1][32]*FB232_30-CM133_30*S33+CM333_30*C33-FB132_30*s->l[2][32]+FM233_30*s->dpt[1][65];
  ...
  CM332_31 = s->In[3][32]*S32+s->In[6][32]*C32-s->dpt[2][65]*(FM133_31*C33+FM333_31*S33)+s->l[1][32]*FB232_31-CM133_31*
 S33+CM333_31*C33-FB132_31*s->l[2][32]+FM233_31*s->dpt[1][65];
  CM332_32 = s->In[9][32]-s->dpt[2][65]*(C33*(FB133_32+FM134_32*C34-FM234_32*S34)+S33*(FB333_32+FM334_32))+s->l[1][32]*
 s->l[1][32]*s->m[32]+s->m[32]*s->l[2][32]*s->l[2][32]+s->dpt[1][65]*(FB233_32+FM134_32*S34+FM234_32*C34)+C33*(CM334_32+
 s->In[9][33]*C33+s->dpt[1][66]*(FM134_32*S34+FM234_32*C34)+s->l[1][33]*FB233_32-FB133_32*s->l[2][33]-s->dpt[2][66]*(FM134_32
 *C34-FM234_32*S34))+S33*(s->In[1][33]*S33-s->In[3][33]*C33+s->dpt[3][66]*(FM134_32*S34+FM234_32*C34)+s->l[3][33]*FB233_32-
 CM134_32*C34+CM234_32*S34-FB333_32*s->l[2][33]-FM334_32*s->dpt[2][66]);
  ...
  FF331 = FA331+FF332;
  CF131 = -(s->trq[1][31]-s->In[1][31]*OpF131-s->In[2][31]*OpF230-s->In[3][31]*OpF331+s->dpt[3][63]*(FF132*S32+FF232*C32
 )-CF132*C32+CF232*S32+FA231*s->l[3][31]-FA331*s->l[2][31]-FF332*s->dpt[2][63]-OM231*(s->In[3][31]*OM131+s->In[6][31]*OM231+
 s->In[9][31]*OM331)+OM331*(s->In[2][31]*OM131+s->In[5][31]*OM231+s->In[6][31]*OM331));
  CF231 = -(s->trq[2][31]-s->In[2][31]*OpF131-s->In[5][31]*OpF230-s->In[6][31]*OpF331-s->dpt[3][63]*(FF132*C32-FF232*S32
 )-CF132*S32-CF232*C32-FA131*s->l[3][31]+FA331*s->l[1][31]+FF332*s->dpt[1][63]+OM131*(s->In[3][31]*OM131+s->In[6][31]*OM231+
 s->In[9][31]*OM331)-OM331*(s->In[1][31]*OM131+s->In[2][31]*OM231+s->In[3][31]*OM331));
  CF331 = -(s->trq[3][31]-CF332-s->In[3][31]*OpF131-s->In[6][31]*OpF230-s->In[9][31]*OpF331+FA131*s->l[2][31]-FA231*
 s->l[1][31]-OM131*(s->In[2][31]*OM131+s->In[5][31]*OM231+s->In[6][31]*OM331)+OM231*(s->In[1][31]*OM131+s->In[2][31]*OM231+
 s->In[3][31]*OM331)-s->dpt[1][63]*(FF132*S32+FF232*C32)+s->dpt[2][63]*(FF132*C32-FF232*S32));
  ...
  CM131_1 = -(s->dpt[3][63]*(FM132_1*S32+FM232_1*C32)-CM132_1*C32+CM232_1*S32+FB231_1*s->l[3][31]-FB331_1*s->l[2][31]-
 FM332_1*s->dpt[2][63]);
  CM231_1 = s->dpt[3][63]*(FM132_1*C32-FM232_1*S32)+CM132_1*S32+CM232_1*C32+FB131_1*s->l[3][31]-FB331_1*s->l[1][31]-
 FM332_1*s->dpt[1][63];
  CM331_1 = CM332_1-FB131_1*s->l[2][31]+FB231_1*s->l[1][31]+s->dpt[1][63]*(FM132_1*S32+FM232_1*C32)-s->dpt[2][63]*(
 FM132_1*C32-FM232_1*S32);
  ...
  CM131_2 = -(s->dpt[3][63]*(FM132_2*S32+FM232_2*C32)-CM132_2*C32+CM232_2*S32+FB231_2*s->l[3][31]-FB331_2*s->l[2][31]-
 FM332_2*s->dpt[2][63]);
  CM231_2 = s->dpt[3][63]*(FM132_2*C32-FM232_2*S32)+CM132_2*S32+CM232_2*C32+FB131_2*s->l[3][31]-FB331_2*s->l[1][31]-
 FM332_2*s->dpt[1][63];
  CM331_2 = CM332_2-FB131_2*s->l[2][31]+FB231_2*s->l[1][31]+s->dpt[1][63]*(FM132_2*S32+FM232_2*C32)-s->dpt[2][63]*(
 FM132_2*C32-FM232_2*S32);
  ...
  CM131_3 = -(s->dpt[3][63]*(FM132_3*S32+FM232_3*C32)-CM132_3*C32+CM232_3*S32+FB231_3*s->l[3][31]-FB331_3*s->l[2][31]-
 FM332_3*s->dpt[2][63]);
  CM231_3 = s->dpt[3][63]*(FM132_3*C32-FM232_3*S32)+CM132_3*S32+CM232_3*C32+FB131_3*s->l[3][31]-FB331_3*s->l[1][31]-
 FM332_3*s->dpt[1][63];
  CM331_3 = CM332_3-FB131_3*s->l[2][31]+FB231_3*s->l[1][31]+s->dpt[1][63]*(FM132_3*S32+FM232_3*C32)-s->dpt[2][63]*(
 FM132_3*C32-FM232_3*S32);
  ...
  CM131_4 = s->In[1][31]*OpM131_4+s->In[2][31]*OpM230_4+s->In[3][31]*OpM331_4-s->dpt[3][63]*(FM132_4*S32+FM232_4*C32)+
 CM132_4*C32-CM232_4*S32-FB231_4*s->l[3][31]+FB331_4*s->l[2][31]+FM332_4*s->dpt[2][63];
  CM231_4 = s->In[2][31]*OpM131_4+s->In[5][31]*OpM230_4+s->In[6][31]*OpM331_4+s->dpt[3][63]*(FM132_4*C32-FM232_4*S32)+
 CM132_4*S32+CM232_4*C32+FB131_4*s->l[3][31]-FB331_4*s->l[1][31]-FM332_4*s->dpt[1][63];
  CM331_4 = CM332_4+s->In[3][31]*OpM131_4+s->In[6][31]*OpM230_4+s->In[9][31]*OpM331_4-FB131_4*s->l[2][31]+FB231_4*
 s->l[1][31]+s->dpt[1][63]*(FM132_4*S32+FM232_4*C32)-s->dpt[2][63]*(FM132_4*C32-FM232_4*S32);
  ...
  CM131_5 = s->In[1][31]*OpM131_5+s->In[2][31]*OpM230_5+s->In[3][31]*OpM331_5-s->dpt[3][63]*(FM132_5*S32+FM232_5*C32)+
 CM132_5*C32-CM232_5*S32-FB231_5*s->l[3][31]+FB331_5*s->l[2][31]+FM332_5*s->dpt[2][63];
  CM231_5 = s->In[2][31]*OpM131_5+s->In[5][31]*OpM230_5+s->In[6][31]*OpM331_5+s->dpt[3][63]*(FM132_5*C32-FM232_5*S32)+
 CM132_5*S32+CM232_5*C32+FB131_5*s->l[3][31]-FB331_5*s->l[1][31]-FM332_5*s->dpt[1][63];
  CM331_5 = CM332_5+s->In[3][31]*OpM131_5+s->In[6][31]*OpM230_5+s->In[9][31]*OpM331_5-FB131_5*s->l[2][31]+FB231_5*
 s->l[1][31]+s->dpt[1][63]*(FM132_5*S32+FM232_5*C32)-s->dpt[2][63]*(FM132_5*C32-FM232_5*S32);
  ...
  CM131_6 = s->In[1][31]*OpM131_6+s->In[2][31]*OpM230_6+s->In[3][31]*OpM331_6-s->dpt[3][63]*(FM132_6*S32+FM232_6*C32)+
 CM132_6*C32-CM232_6*S32-FB231_6*s->l[3][31]+FB331_6*s->l[2][31]+FM332_6*s->dpt[2][63];
  CM231_6 = s->In[2][31]*OpM131_6+s->In[5][31]*OpM230_6+s->In[6][31]*OpM331_6+s->dpt[3][63]*(FM132_6*C32-FM232_6*S32)+
 CM132_6*S32+CM232_6*C32+FB131_6*s->l[3][31]-FB331_6*s->l[1][31]-FM332_6*s->dpt[1][63];
  CM331_6 = CM332_6+s->In[3][31]*OpM131_6+s->In[6][31]*OpM230_6+s->In[9][31]*OpM331_6-FB131_6*s->l[2][31]+FB231_6*
 s->l[1][31]+s->dpt[1][63]*(FM132_6*S32+FM232_6*C32)-s->dpt[2][63]*(FM132_6*C32-FM232_6*S32);
  ...
  CM131_19 = s->In[1][31]*OpM131_19+s->In[2][31]*OpM230_19+s->In[3][31]*OpM331_19-s->dpt[3][63]*(FM132_19*S32+FM232_19*
 C32)+CM132_19*C32-CM232_19*S32-FB231_19*s->l[3][31]+FB331_19*s->l[2][31]+FM332_19*s->dpt[2][63];
  CM231_19 = s->In[2][31]*OpM131_19+s->In[5][31]*OpM230_19+s->In[6][31]*OpM331_19+s->dpt[3][63]*(FM132_19*C32-FM232_19*
 S32)+CM132_19*S32+CM232_19*C32+FB131_19*s->l[3][31]-FB331_19*s->l[1][31]-FM332_19*s->dpt[1][63];
  CM331_19 = CM332_19+s->In[3][31]*OpM131_19+s->In[6][31]*OpM230_19+s->In[9][31]*OpM331_19-FB131_19*s->l[2][31]+FB231_19
 *s->l[1][31]+s->dpt[1][63]*(FM132_19*S32+FM232_19*C32)-s->dpt[2][63]*(FM132_19*C32-FM232_19*S32);
  ...
  CM131_20 = s->In[1][31]*OpM131_20+s->In[2][31]*OpM230_20+s->In[3][31]*OpM331_20-s->dpt[3][63]*(FM132_20*S32+FM232_20*
 C32)+CM132_20*C32-CM232_20*S32-FB231_20*s->l[3][31]+FB331_20*s->l[2][31]+FM332_20*s->dpt[2][63];
  CM231_20 = s->In[2][31]*OpM131_20+s->In[5][31]*OpM230_20+s->In[6][31]*OpM331_20+s->dpt[3][63]*(FM132_20*C32-FM232_20*
 S32)+CM132_20*S32+CM232_20*C32+FB131_20*s->l[3][31]-FB331_20*s->l[1][31]-FM332_20*s->dpt[1][63];
  CM331_20 = CM332_20+s->In[3][31]*OpM131_20+s->In[6][31]*OpM230_20+s->In[9][31]*OpM331_20-FB131_20*s->l[2][31]+FB231_20
 *s->l[1][31]+s->dpt[1][63]*(FM132_20*S32+FM232_20*C32)-s->dpt[2][63]*(FM132_20*C32-FM232_20*S32);
  ...
  CM131_21 = s->In[1][31]*OpM131_21+s->In[2][31]*OpM230_21+s->In[3][31]*OpM331_21-s->dpt[3][63]*(FM132_21*S32+FM232_21*
 C32)+CM132_21*C32-CM232_21*S32-FB231_21*s->l[3][31]+FB331_21*s->l[2][31]+FM332_21*s->dpt[2][63];
  CM231_21 = s->In[2][31]*OpM131_21+s->In[5][31]*OpM230_21+s->In[6][31]*OpM331_21+s->dpt[3][63]*(FM132_21*C32-FM232_21*
 S32)+CM132_21*S32+CM232_21*C32+FB131_21*s->l[3][31]-FB331_21*s->l[1][31]-FM332_21*s->dpt[1][63];
  CM331_21 = CM332_21+s->In[3][31]*OpM131_21+s->In[6][31]*OpM230_21+s->In[9][31]*OpM331_21-FB131_21*s->l[2][31]+FB231_21
 *s->l[1][31]+s->dpt[1][63]*(FM132_21*S32+FM232_21*C32)-s->dpt[2][63]*(FM132_21*C32-FM232_21*S32);
  ...
  CM131_29 = s->In[1][31]*OpM131_29+s->In[2][31]*C30+s->In[3][31]*OpM331_29-s->dpt[3][63]*(FM132_29*S32+FM232_29*C32)+
 CM132_29*C32-CM232_29*S32-FB231_29*s->l[3][31]+FB331_29*s->l[2][31]+FM332_29*s->dpt[2][63];
  CM231_29 = s->In[2][31]*OpM131_29+s->In[5][31]*C30+s->In[6][31]*OpM331_29+s->dpt[3][63]*(FM132_29*C32-FM232_29*S32)+
 CM132_29*S32+CM232_29*C32+FB131_29*s->l[3][31]-FB331_29*s->l[1][31]-FM332_29*s->dpt[1][63];
  CM331_29 = CM332_29+s->In[3][31]*OpM131_29+s->In[6][31]*C30+s->In[9][31]*OpM331_29-FB131_29*s->l[2][31]+FB231_29*
 s->l[1][31]+s->dpt[1][63]*(FM132_29*S32+FM232_29*C32)-s->dpt[2][63]*(FM132_29*C32-FM232_29*S32);
  ...
  CM231_30 = s->In[2][31]*C31+s->In[6][31]*S31+s->dpt[3][63]*(FM132_30*C32-FM232_30*S32)+CM132_30*S32+CM232_30*C32+
 FB131_30*s->l[3][31]-FB331_30*s->l[1][31]-FM332_30*s->dpt[1][63];
  CM231_31 = s->In[5][31]+s->dpt[3][63]*(C32*(FB132_31+FM133_31*C33+FM333_31*S33)-S32*(FB232_31+FM233_31))+s->m[31]*
 s->l[1][31]*s->l[1][31]+s->m[31]*s->l[3][31]*s->l[3][31]-s->dpt[1][63]*(FB332_31-FM133_31*S33+FM333_31*C33)+C32*(CM233_31+
 s->In[2][32]*S32+s->In[5][32]*C32+s->dpt[3][65]*(FM133_31*C33+FM333_31*S33)-s->l[1][32]*FB332_31+s->l[3][32]*FB132_31+
 s->dpt[1][65]*(FM133_31*S33-FM333_31*C33))+S32*(s->In[1][32]*S32+s->In[2][32]*C32-s->dpt[2][65]*(FM133_31*S33-FM333_31*C33)-
 s->dpt[3][65]*FM233_31-s->l[3][32]*FB232_31+CM133_31*C33+CM333_31*S33+FB332_31*s->l[2][32]);
  ...
  CF130 = -(s->trq[1][30]-s->In[1][30]*OpF129-s->In[2][30]*OpF230-s->In[3][30]*OpF330+s->dpt[3][61]*FF231-CF131*C31-
 CF331*S31+FA230*s->l[3][30]-FA330*s->l[2][30]-OM230*(s->In[3][30]*OM130+s->In[6][30]*OM230+s->In[9][30]*OM330)+OM330*(
 s->In[2][30]*OM130+s->In[5][30]*OM230+s->In[6][30]*OM330)+s->dpt[2][61]*(FF131*S31-FF331*C31));
  CF230 = -(s->trq[2][30]-CF231-s->In[2][30]*OpF129-s->In[5][30]*OpF230-s->In[6][30]*OpF330-s->dpt[1][61]*(FF131*S31-
 FF331*C31)-s->dpt[3][61]*(FF131*C31+FF331*S31)-FA130*s->l[3][30]+FA330*s->l[1][30]+OM130*(s->In[3][30]*OM130+s->In[6][30]*
 OM230+s->In[9][30]*OM330)-OM330*(s->In[1][30]*OM130+s->In[2][30]*OM230+s->In[3][30]*OM330));
  CF330 = -(s->trq[3][30]-s->In[3][30]*OpF129-s->In[6][30]*OpF230-s->In[9][30]*OpF330-s->dpt[1][61]*FF231+CF131*S31-
 CF331*C31+FA130*s->l[2][30]-FA230*s->l[1][30]-OM130*(s->In[2][30]*OM130+s->In[5][30]*OM230+s->In[6][30]*OM330)+OM230*(
 s->In[1][30]*OM130+s->In[2][30]*OM230+s->In[3][30]*OM330)+s->dpt[2][61]*(FF131*C31+FF331*S31));
  ...
  CM130_1 = -(s->dpt[3][61]*FM231_1-CM131_1*C31-CM331_1*S31+FB230_1*s->l[3][30]-FB330_1*s->l[2][30]+s->dpt[2][61]*(
 FM131_1*S31-FM331_1*C31));
  CM230_1 = CM231_1+s->dpt[1][61]*(FM131_1*S31-FM331_1*C31)+s->dpt[3][61]*(FM131_1*C31+FM331_1*S31)+FB130_1*s->l[3][30]-
 FB330_1*s->l[1][30];
  CM330_1 = s->dpt[1][61]*FM231_1-CM131_1*S31+CM331_1*C31-FB130_1*s->l[2][30]+FB230_1*s->l[1][30]-s->dpt[2][61]*(FM131_1
 *C31+FM331_1*S31);
  ...
  CM130_2 = -(s->dpt[3][61]*FM231_2-CM131_2*C31-CM331_2*S31+FB230_2*s->l[3][30]-FB330_2*s->l[2][30]+s->dpt[2][61]*(
 FM131_2*S31-FM331_2*C31));
  CM230_2 = CM231_2+s->dpt[1][61]*(FM131_2*S31-FM331_2*C31)+s->dpt[3][61]*(FM131_2*C31+FM331_2*S31)+FB130_2*s->l[3][30]-
 FB330_2*s->l[1][30];
  CM330_2 = s->dpt[1][61]*FM231_2-CM131_2*S31+CM331_2*C31-FB130_2*s->l[2][30]+FB230_2*s->l[1][30]-s->dpt[2][61]*(FM131_2
 *C31+FM331_2*S31);
  ...
  CM130_3 = -(s->dpt[3][61]*FM231_3-CM131_3*C31-CM331_3*S31+FB230_3*s->l[3][30]-FB330_3*s->l[2][30]+s->dpt[2][61]*(
 FM131_3*S31-FM331_3*C31));
  CM230_3 = CM231_3+s->dpt[1][61]*(FM131_3*S31-FM331_3*C31)+s->dpt[3][61]*(FM131_3*C31+FM331_3*S31)+FB130_3*s->l[3][30]-
 FB330_3*s->l[1][30];
  CM330_3 = s->dpt[1][61]*FM231_3-CM131_3*S31+CM331_3*C31-FB130_3*s->l[2][30]+FB230_3*s->l[1][30]-s->dpt[2][61]*(FM131_3
 *C31+FM331_3*S31);
  ...
  CM130_4 = s->In[1][30]*OpM129_4+s->In[2][30]*OpM230_4+s->In[3][30]*OpM330_4-s->dpt[3][61]*FM231_4+CM131_4*C31+CM331_4*
 S31-FB230_4*s->l[3][30]+FB330_4*s->l[2][30]-s->dpt[2][61]*(FM131_4*S31-FM331_4*C31);
  CM230_4 = CM231_4+s->In[2][30]*OpM129_4+s->In[5][30]*OpM230_4+s->In[6][30]*OpM330_4+s->dpt[1][61]*(FM131_4*S31-FM331_4
 *C31)+s->dpt[3][61]*(FM131_4*C31+FM331_4*S31)+FB130_4*s->l[3][30]-FB330_4*s->l[1][30];
  CM330_4 = s->In[3][30]*OpM129_4+s->In[6][30]*OpM230_4+s->In[9][30]*OpM330_4+s->dpt[1][61]*FM231_4-CM131_4*S31+CM331_4*
 C31-FB130_4*s->l[2][30]+FB230_4*s->l[1][30]-s->dpt[2][61]*(FM131_4*C31+FM331_4*S31);
  ...
  CM130_5 = s->In[1][30]*OpM129_5+s->In[2][30]*OpM230_5+s->In[3][30]*OpM330_5-s->dpt[3][61]*FM231_5+CM131_5*C31+CM331_5*
 S31-FB230_5*s->l[3][30]+FB330_5*s->l[2][30]-s->dpt[2][61]*(FM131_5*S31-FM331_5*C31);
  CM230_5 = CM231_5+s->In[2][30]*OpM129_5+s->In[5][30]*OpM230_5+s->In[6][30]*OpM330_5+s->dpt[1][61]*(FM131_5*S31-FM331_5
 *C31)+s->dpt[3][61]*(FM131_5*C31+FM331_5*S31)+FB130_5*s->l[3][30]-FB330_5*s->l[1][30];
  CM330_5 = s->In[3][30]*OpM129_5+s->In[6][30]*OpM230_5+s->In[9][30]*OpM330_5+s->dpt[1][61]*FM231_5-CM131_5*S31+CM331_5*
 C31-FB130_5*s->l[2][30]+FB230_5*s->l[1][30]-s->dpt[2][61]*(FM131_5*C31+FM331_5*S31);
  ...
  CM130_6 = s->In[1][30]*OpM129_6+s->In[2][30]*OpM230_6+s->In[3][30]*OpM330_6-s->dpt[3][61]*FM231_6+CM131_6*C31+CM331_6*
 S31-FB230_6*s->l[3][30]+FB330_6*s->l[2][30]-s->dpt[2][61]*(FM131_6*S31-FM331_6*C31);
  CM230_6 = CM231_6+s->In[2][30]*OpM129_6+s->In[5][30]*OpM230_6+s->In[6][30]*OpM330_6+s->dpt[1][61]*(FM131_6*S31-FM331_6
 *C31)+s->dpt[3][61]*(FM131_6*C31+FM331_6*S31)+FB130_6*s->l[3][30]-FB330_6*s->l[1][30];
  CM330_6 = s->In[3][30]*OpM129_6+s->In[6][30]*OpM230_6+s->In[9][30]*OpM330_6+s->dpt[1][61]*FM231_6-CM131_6*S31+CM331_6*
 C31-FB130_6*s->l[2][30]+FB230_6*s->l[1][30]-s->dpt[2][61]*(FM131_6*C31+FM331_6*S31);
  ...
  CM130_19 = s->In[1][30]*OpM129_19+s->In[2][30]*OpM230_19+s->In[3][30]*OpM330_19-s->dpt[3][61]*FM231_19+CM131_19*C31+
 CM331_19*S31-FB230_19*s->l[3][30]+FB330_19*s->l[2][30]-s->dpt[2][61]*(FM131_19*S31-FM331_19*C31);
  CM230_19 = CM231_19+s->In[2][30]*OpM129_19+s->In[5][30]*OpM230_19+s->In[6][30]*OpM330_19+s->dpt[1][61]*(FM131_19*S31-
 FM331_19*C31)+s->dpt[3][61]*(FM131_19*C31+FM331_19*S31)+FB130_19*s->l[3][30]-FB330_19*s->l[1][30];
  CM330_19 = s->In[3][30]*OpM129_19+s->In[6][30]*OpM230_19+s->In[9][30]*OpM330_19+s->dpt[1][61]*FM231_19-CM131_19*S31+
 CM331_19*C31-FB130_19*s->l[2][30]+FB230_19*s->l[1][30]-s->dpt[2][61]*(FM131_19*C31+FM331_19*S31);
  ...
  CM130_20 = s->In[1][30]*OpM129_20+s->In[2][30]*OpM230_20+s->In[3][30]*OpM330_20-s->dpt[3][61]*FM231_20+CM131_20*C31+
 CM331_20*S31-FB230_20*s->l[3][30]+FB330_20*s->l[2][30]-s->dpt[2][61]*(FM131_20*S31-FM331_20*C31);
  CM230_20 = CM231_20+s->In[2][30]*OpM129_20+s->In[5][30]*OpM230_20+s->In[6][30]*OpM330_20+s->dpt[1][61]*(FM131_20*S31-
 FM331_20*C31)+s->dpt[3][61]*(FM131_20*C31+FM331_20*S31)+FB130_20*s->l[3][30]-FB330_20*s->l[1][30];
  CM330_20 = s->In[3][30]*OpM129_20+s->In[6][30]*OpM230_20+s->In[9][30]*OpM330_20+s->dpt[1][61]*FM231_20-CM131_20*S31+
 CM331_20*C31-FB130_20*s->l[2][30]+FB230_20*s->l[1][30]-s->dpt[2][61]*(FM131_20*C31+FM331_20*S31);
  ...
  CM130_21 = -(s->In[1][30]*S29-s->In[2][30]*OpM230_21-s->In[3][30]*OpM330_21+s->dpt[3][61]*FM231_21-CM131_21*C31-
 CM331_21*S31+FB230_21*s->l[3][30]-FB330_21*s->l[2][30]+s->dpt[2][61]*(FM131_21*S31-FM331_21*C31));
  CM230_21 = CM231_21-s->In[2][30]*S29+s->In[5][30]*OpM230_21+s->In[6][30]*OpM330_21+s->dpt[1][61]*(FM131_21*S31-
 FM331_21*C31)+s->dpt[3][61]*(FM131_21*C31+FM331_21*S31)+FB130_21*s->l[3][30]-FB330_21*s->l[1][30];
  CM330_21 = s->dpt[1][61]*FM231_21-CM131_21*S31+CM331_21*C31-s->dpt[2][61]*(FM131_21*C31+FM331_21*S31)-s->In[3][30]*S29
 +s->In[6][30]*OpM230_21+s->In[9][30]*OpM330_21-FB130_21*s->l[2][30]+FB230_21*s->l[1][30];
  ...
  CM130_29 = s->In[2][30]*C30-s->In[3][30]*S30-s->dpt[3][61]*FM231_29+CM131_29*C31+CM331_29*S31-FB230_29*s->l[3][30]+
 FB330_29*s->l[2][30]-s->dpt[2][61]*(FM131_29*S31-FM331_29*C31);
  CM130_30 = s->In[1][30]-s->dpt[3][61]*(FB231_30+FM132_30*S32+FM232_30*C32)+s->m[30]*s->l[2][30]*s->l[2][30]+s->m[30]*
 s->l[3][30]*s->l[3][30]+s->dpt[2][61]*(C31*(FB331_30+FM332_30)-S31*(FB131_30+FM132_30*C32-FM232_30*S32))+C31*(s->In[1][31]*
 C31+s->In[3][31]*S31-s->dpt[3][63]*(FM132_30*S32+FM232_30*C32)+CM132_30*C32-CM232_30*S32-FB231_30*s->l[3][31]+FB331_30*
 s->l[2][31]+FM332_30*s->dpt[2][63])+S31*(CM332_30+s->In[3][31]*C31+s->In[9][31]*S31-FB131_30*s->l[2][31]+FB231_30*
 s->l[1][31]+s->dpt[1][63]*(FM132_30*S32+FM232_30*C32)-s->dpt[2][63]*(FM132_30*C32-FM232_30*S32));
  ...
  CF129 = -(s->trq[1][29]-CF130-s->In[1][29]*OpF129-s->In[2][29]*OpF221-s->In[3][29]*OpF329+s->dpt[3][59]*(FF230*C30-
 FF330*S30)+FA229*s->l[3][29]-FA329*s->l[2][29]-OM229*(s->In[3][29]*OM129+s->In[6][29]*OM229+s->In[9][29]*OM329)+OM329*(
 s->In[2][29]*OM129+s->In[5][29]*OM229+s->In[6][29]*OM329)-s->dpt[2][59]*(FF230*S30+FF330*C30));
  CF229 = -(s->trq[2][29]-s->In[2][29]*OpF129-s->In[5][29]*OpF221-s->In[6][29]*OpF329+s->dpt[1][59]*(FF230*S30+FF330*C30
 )-s->dpt[3][59]*FF130-CF230*C30+CF330*S30-FA129*s->l[3][29]+FA329*s->l[1][29]+OM129*(s->In[3][29]*OM129+s->In[6][29]*OM229+
 s->In[9][29]*OM329)-OM329*(s->In[1][29]*OM129+s->In[2][29]*OM229+s->In[3][29]*OM329));
  CF329 = -(s->trq[3][29]-s->In[3][29]*OpF129-s->In[6][29]*OpF221-s->In[9][29]*OpF329-s->dpt[1][59]*(FF230*C30-FF330*S30
 )-CF230*S30-CF330*C30+FA129*s->l[2][29]-FA229*s->l[1][29]+FF130*s->dpt[2][59]-OM129*(s->In[2][29]*OM129+s->In[5][29]*OM229+
 s->In[6][29]*OM329)+OM229*(s->In[1][29]*OM129+s->In[2][29]*OM229+s->In[3][29]*OM329));
  ...
  CM129_1 = CM130_1-s->dpt[3][59]*(FM230_1*C30-FM330_1*S30)-FB229_1*s->l[3][29]+FB329_1*s->l[2][29]+s->dpt[2][59]*(
 FM230_1*S30+FM330_1*C30);
  CM229_1 = -(s->dpt[1][59]*(FM230_1*S30+FM330_1*C30)-s->dpt[3][59]*FM130_1-CM230_1*C30+CM330_1*S30-FB129_1*s->l[3][29]+
 FB329_1*s->l[1][29]);
  CM329_1 = s->dpt[1][59]*(FM230_1*C30-FM330_1*S30)+CM230_1*S30+CM330_1*C30-FB129_1*s->l[2][29]+FB229_1*s->l[1][29]-
 FM130_1*s->dpt[2][59];
  ...
  CM129_2 = CM130_2-s->dpt[3][59]*(FM230_2*C30-FM330_2*S30)-FB229_2*s->l[3][29]+FB329_2*s->l[2][29]+s->dpt[2][59]*(
 FM230_2*S30+FM330_2*C30);
  CM229_2 = -(s->dpt[1][59]*(FM230_2*S30+FM330_2*C30)-s->dpt[3][59]*FM130_2-CM230_2*C30+CM330_2*S30-FB129_2*s->l[3][29]+
 FB329_2*s->l[1][29]);
  CM329_2 = s->dpt[1][59]*(FM230_2*C30-FM330_2*S30)+CM230_2*S30+CM330_2*C30-FB129_2*s->l[2][29]+FB229_2*s->l[1][29]-
 FM130_2*s->dpt[2][59];
  ...
  CM129_3 = CM130_3-s->dpt[3][59]*(FM230_3*C30-FM330_3*S30)-FB229_3*s->l[3][29]+FB329_3*s->l[2][29]+s->dpt[2][59]*(
 FM230_3*S30+FM330_3*C30);
  CM229_3 = -(s->dpt[1][59]*(FM230_3*S30+FM330_3*C30)-s->dpt[3][59]*FM130_3-CM230_3*C30+CM330_3*S30-FB129_3*s->l[3][29]+
 FB329_3*s->l[1][29]);
  CM329_3 = s->dpt[1][59]*(FM230_3*C30-FM330_3*S30)+CM230_3*S30+CM330_3*C30-FB129_3*s->l[2][29]+FB229_3*s->l[1][29]-
 FM130_3*s->dpt[2][59];
  ...
  CM129_4 = CM130_4+s->In[1][29]*OpM129_4+s->In[2][29]*OpM221_4+s->In[3][29]*OpM329_4-s->dpt[3][59]*(FM230_4*C30-FM330_4
 *S30)-FB229_4*s->l[3][29]+FB329_4*s->l[2][29]+s->dpt[2][59]*(FM230_4*S30+FM330_4*C30);
  CM229_4 = s->In[2][29]*OpM129_4+s->In[5][29]*OpM221_4+s->In[6][29]*OpM329_4-s->dpt[1][59]*(FM230_4*S30+FM330_4*C30)+
 s->dpt[3][59]*FM130_4+CM230_4*C30-CM330_4*S30+FB129_4*s->l[3][29]-FB329_4*s->l[1][29];
  CM329_4 = s->In[3][29]*OpM129_4+s->In[6][29]*OpM221_4+s->In[9][29]*OpM329_4+s->dpt[1][59]*(FM230_4*C30-FM330_4*S30)+
 CM230_4*S30+CM330_4*C30-FB129_4*s->l[2][29]+FB229_4*s->l[1][29]-FM130_4*s->dpt[2][59];
  ...
  CM129_5 = CM130_5+s->In[1][29]*OpM129_5+s->In[2][29]*OpM221_5+s->In[3][29]*OpM329_5-s->dpt[3][59]*(FM230_5*C30-FM330_5
 *S30)-FB229_5*s->l[3][29]+FB329_5*s->l[2][29]+s->dpt[2][59]*(FM230_5*S30+FM330_5*C30);
  CM229_5 = s->In[2][29]*OpM129_5+s->In[5][29]*OpM221_5+s->In[6][29]*OpM329_5-s->dpt[1][59]*(FM230_5*S30+FM330_5*C30)+
 s->dpt[3][59]*FM130_5+CM230_5*C30-CM330_5*S30+FB129_5*s->l[3][29]-FB329_5*s->l[1][29];
  CM329_5 = s->In[3][29]*OpM129_5+s->In[6][29]*OpM221_5+s->In[9][29]*OpM329_5+s->dpt[1][59]*(FM230_5*C30-FM330_5*S30)+
 CM230_5*S30+CM330_5*C30-FB129_5*s->l[2][29]+FB229_5*s->l[1][29]-FM130_5*s->dpt[2][59];
  ...
  CM129_6 = CM130_6+s->In[1][29]*OpM129_6+s->In[2][29]*OpM221_6+s->In[3][29]*OpM329_6-s->dpt[3][59]*(FM230_6*C30-FM330_6
 *S30)-FB229_6*s->l[3][29]+FB329_6*s->l[2][29]+s->dpt[2][59]*(FM230_6*S30+FM330_6*C30);
  CM229_6 = s->In[2][29]*OpM129_6+s->In[5][29]*OpM221_6+s->In[6][29]*OpM329_6-s->dpt[1][59]*(FM230_6*S30+FM330_6*C30)+
 s->dpt[3][59]*FM130_6+CM230_6*C30-CM330_6*S30+FB129_6*s->l[3][29]-FB329_6*s->l[1][29];
  CM329_6 = s->In[3][29]*OpM129_6+s->In[6][29]*OpM221_6+s->In[9][29]*OpM329_6+s->dpt[1][59]*(FM230_6*C30-FM330_6*S30)+
 CM230_6*S30+CM330_6*C30-FB129_6*s->l[2][29]+FB229_6*s->l[1][29]-FM130_6*s->dpt[2][59];
  ...
  CM129_19 = CM130_19+s->In[1][29]*OpM129_19+s->In[2][29]*OpM221_19+s->In[3][29]*OpM329_19-s->dpt[3][59]*(FM230_19*C30-
 FM330_19*S30)-FB229_19*s->l[3][29]+FB329_19*s->l[2][29]+s->dpt[2][59]*(FM230_19*S30+FM330_19*C30);
  CM229_19 = s->In[2][29]*OpM129_19+s->In[5][29]*OpM221_19+s->In[6][29]*OpM329_19-s->dpt[1][59]*(FM230_19*S30+FM330_19*
 C30)+s->dpt[3][59]*FM130_19+CM230_19*C30-CM330_19*S30+FB129_19*s->l[3][29]-FB329_19*s->l[1][29];
  CM329_19 = s->In[3][29]*OpM129_19+s->In[6][29]*OpM221_19+s->In[9][29]*OpM329_19+s->dpt[1][59]*(FM230_19*C30-FM330_19*
 S30)+CM230_19*S30+CM330_19*C30-FB129_19*s->l[2][29]+FB229_19*s->l[1][29]-FM130_19*s->dpt[2][59];
  ...
  CM129_20 = CM130_20+s->In[1][29]*OpM129_20+s->In[2][29]*C21+s->In[3][29]*OpM329_20-s->dpt[3][59]*(FM230_20*C30-
 FM330_20*S30)-FB229_20*s->l[3][29]+FB329_20*s->l[2][29]+s->dpt[2][59]*(FM230_20*S30+FM330_20*C30);
  CM229_20 = s->In[2][29]*OpM129_20+s->In[5][29]*C21+s->In[6][29]*OpM329_20-s->dpt[1][59]*(FM230_20*S30+FM330_20*C30)+
 s->dpt[3][59]*FM130_20+CM230_20*C30-CM330_20*S30+FB129_20*s->l[3][29]-FB329_20*s->l[1][29];
  CM329_20 = s->In[3][29]*OpM129_20+s->In[6][29]*C21+s->In[9][29]*OpM329_20+s->dpt[1][59]*(FM230_20*C30-FM330_20*S30)+
 CM230_20*S30+CM330_20*C30-FB129_20*s->l[2][29]+FB229_20*s->l[1][29]-FM130_20*s->dpt[2][59];
  ...
  CM229_21 = -(s->In[2][29]*S29-s->In[6][29]*C29+s->dpt[1][59]*(FM230_21*S30+FM330_21*C30)-s->dpt[3][59]*FM130_21-
 CM230_21*C30+CM330_21*S30-FB129_21*s->l[3][29]+FB329_21*s->l[1][29]);
  CM229_29 = s->In[5][29]-s->dpt[1][59]*(C30*(FB330_29-FM131_29*S31+FM331_29*C31)+S30*(FB230_29+FM231_29))+s->dpt[3][59]
 *(FB130_29+FM131_29*C31+FM331_29*S31)+s->m[29]*s->l[1][29]*s->l[1][29]+s->m[29]*s->l[3][29]*s->l[3][29]+C30*(CM231_29+
 s->In[5][30]*C30-s->In[6][30]*S30+s->dpt[1][61]*(FM131_29*S31-FM331_29*C31)+s->dpt[3][61]*(FM131_29*C31+FM331_29*S31)+
 FB130_29*s->l[3][30]-FB330_29*s->l[1][30])-S30*(s->In[6][30]*C30-s->In[9][30]*S30+s->dpt[1][61]*FM231_29-CM131_29*S31+
 CM331_29*C31-FB130_29*s->l[2][30]+FB230_29*s->l[1][30]-s->dpt[2][61]*(FM131_29*C31+FM331_29*S31));
...
// Backward Dynamics 
 ...
 CF329*S29+FA221*s->l[3][21]-FA321*s->l[2][21]+FF222*s->dpt[3][44]+FF229*s->dpt[3][45]-OM221*(s->In[3][21]*OM121+s->In[6][21]
 *OM221+s->In[9][21]*OM321)+OM321*(s->In[2][21]*OM121+s->In[5][21]*OM221+s->In[6][21]*OM321)+s->dpt[2][44]*(FF122*S22-FF322*
 C22)+s->dpt[2][45]*(FF129*S29-FF329*C29));
 ...
 OM221+s->In[3][21]*OM321)-s->dpt[1][44]*(FF122*S22-FF322*C22)-s->dpt[1][45]*(FF129*S29-FF329*C29)-s->dpt[3][44]*(FF122*C22+
 FF322*S22)-s->dpt[3][45]*(FF129*C29+FF329*S29));
  CF321 = -(s->trq[3][21]-s->In[3][21]*OpF121-s->In[6][21]*OpF221-s->In[9][21]*OpF320+CF122*S22+CF129*S29-CF322*C22-
 CF329*C29+FA121*s->l[2][21]-FA221*s->l[1][21]-FF222*s->dpt[1][44]-FF229*s->dpt[1][45]-OM121*(s->In[2][21]*OM121+s->In[5][21]
 *OM221+s->In[6][21]*OM321)+OM221*(s->In[1][21]*OM121+s->In[2][21]*OM221+s->In[3][21]*OM321)+s->dpt[2][44]*(FF122*C22+FF322*
 S22)+s->dpt[2][45]*(FF129*C29+FF329*S29));
 ...
 s->dpt[3][44]-FM229_1*s->dpt[3][45]-s->dpt[2][44]*(FM122_1*S22-FM322_1*C22)-s->dpt[2][45]*(FM129_1*S29-FM329_1*C29);
  CM221_1 = CM222_1+CM229_1+FB121_1*s->l[3][21]-FB321_1*s->l[1][21]+s->dpt[1][44]*(FM122_1*S22-FM322_1*C22)+
 s->dpt[1][45]*(FM129_1*S29-FM329_1*C29)+s->dpt[3][44]*(FM122_1*C22+FM322_1*S22)+s->dpt[3][45]*(FM129_1*C29+FM329_1*S29);
  CM321_1 = -(CM122_1*S22+CM129_1*S29-CM322_1*C22-CM329_1*C29+FB121_1*s->l[2][21]-FB221_1*s->l[1][21]-FM222_1*
 s->dpt[1][44]-FM229_1*s->dpt[1][45]+s->dpt[2][44]*(FM122_1*C22+FM322_1*S22)+s->dpt[2][45]*(FM129_1*C29+FM329_1*S29));
 ...
 s->dpt[3][44]-FM229_2*s->dpt[3][45]-s->dpt[2][44]*(FM122_2*S22-FM322_2*C22)-s->dpt[2][45]*(FM129_2*S29-FM329_2*C29);
  CM221_2 = CM222_2+CM229_2+FB121_2*s->l[3][21]-FB321_2*s->l[1][21]+s->dpt[1][44]*(FM122_2*S22-FM322_2*C22)+
 s->dpt[1][45]*(FM129_2*S29-FM329_2*C29)+s->dpt[3][44]*(FM122_2*C22+FM322_2*S22)+s->dpt[3][45]*(FM129_2*C29+FM329_2*S29);
  CM321_2 = -(CM122_2*S22+CM129_2*S29-CM322_2*C22-CM329_2*C29+FB121_2*s->l[2][21]-FB221_2*s->l[1][21]-FM222_2*
 s->dpt[1][44]-FM229_2*s->dpt[1][45]+s->dpt[2][44]*(FM122_2*C22+FM322_2*S22)+s->dpt[2][45]*(FM129_2*C29+FM329_2*S29));
 ...
 s->dpt[3][44]-FM229_3*s->dpt[3][45]-s->dpt[2][44]*(FM122_3*S22-FM322_3*C22)-s->dpt[2][45]*(FM129_3*S29-FM329_3*C29);
  CM221_3 = CM222_3+CM229_3+FB121_3*s->l[3][21]-FB321_3*s->l[1][21]+s->dpt[1][44]*(FM122_3*S22-FM322_3*C22)+
 s->dpt[1][45]*(FM129_3*S29-FM329_3*C29)+s->dpt[3][44]*(FM122_3*C22+FM322_3*S22)+s->dpt[3][45]*(FM129_3*C29+FM329_3*S29);
  CM321_3 = -(CM122_3*S22+CM129_3*S29-CM322_3*C22-CM329_3*C29+FB121_3*s->l[2][21]-FB221_3*s->l[1][21]-FM222_3*
 s->dpt[1][44]-FM229_3*s->dpt[1][45]+s->dpt[2][44]*(FM122_3*C22+FM322_3*S22)+s->dpt[2][45]*(FM129_3*C29+FM329_3*S29));
 ...
 CM329_4*S29-FB221_4*s->l[3][21]+FB321_4*s->l[2][21]-FM222_4*s->dpt[3][44]-FM229_4*s->dpt[3][45]-s->dpt[2][44]*(FM122_4*S22-
 FM322_4*C22)-s->dpt[2][45]*(FM129_4*S29-FM329_4*C29);
  CM221_4 = CM222_4+CM229_4+s->In[2][21]*OpM121_4+s->In[5][21]*OpM221_4+s->In[6][21]*OpM320_4+FB121_4*s->l[3][21]-
 FB321_4*s->l[1][21]+s->dpt[1][44]*(FM122_4*S22-FM322_4*C22)+s->dpt[1][45]*(FM129_4*S29-FM329_4*C29)+s->dpt[3][44]*(FM122_4*
 C22+FM322_4*S22)+s->dpt[3][45]*(FM129_4*C29+FM329_4*S29);
  CM321_4 = s->In[3][21]*OpM121_4+s->In[6][21]*OpM221_4+s->In[9][21]*OpM320_4-CM122_4*S22-CM129_4*S29+CM322_4*C22+
 CM329_4*C29-FB121_4*s->l[2][21]+FB221_4*s->l[1][21]+FM222_4*s->dpt[1][44]+FM229_4*s->dpt[1][45]-s->dpt[2][44]*(FM122_4*C22+
 FM322_4*S22)-s->dpt[2][45]*(FM129_4*C29+FM329_4*S29);
 ...
 CM329_5*S29-FB221_5*s->l[3][21]+FB321_5*s->l[2][21]-FM222_5*s->dpt[3][44]-FM229_5*s->dpt[3][45]-s->dpt[2][44]*(FM122_5*S22-
 FM322_5*C22)-s->dpt[2][45]*(FM129_5*S29-FM329_5*C29);
  CM221_5 = CM222_5+CM229_5+s->In[2][21]*OpM121_5+s->In[5][21]*OpM221_5+s->In[6][21]*OpM320_5+FB121_5*s->l[3][21]-
 FB321_5*s->l[1][21]+s->dpt[1][44]*(FM122_5*S22-FM322_5*C22)+s->dpt[1][45]*(FM129_5*S29-FM329_5*C29)+s->dpt[3][44]*(FM122_5*
 C22+FM322_5*S22)+s->dpt[3][45]*(FM129_5*C29+FM329_5*S29);
  CM321_5 = s->In[3][21]*OpM121_5+s->In[6][21]*OpM221_5+s->In[9][21]*OpM320_5-CM122_5*S22-CM129_5*S29+CM322_5*C22+
 CM329_5*C29-FB121_5*s->l[2][21]+FB221_5*s->l[1][21]+FM222_5*s->dpt[1][44]+FM229_5*s->dpt[1][45]-s->dpt[2][44]*(FM122_5*C22+
 FM322_5*S22)-s->dpt[2][45]*(FM129_5*C29+FM329_5*S29);
 ...
 CM329_6*S29-FB221_6*s->l[3][21]+FB321_6*s->l[2][21]-FM222_6*s->dpt[3][44]-FM229_6*s->dpt[3][45]-s->dpt[2][44]*(FM122_6*S22-
 FM322_6*C22)-s->dpt[2][45]*(FM129_6*S29-FM329_6*C29);
  CM221_6 = CM222_6+CM229_6+s->In[2][21]*OpM121_6+s->In[5][21]*OpM221_6+s->In[6][21]*OpM320_6+FB121_6*s->l[3][21]-
 FB321_6*s->l[1][21]+s->dpt[1][44]*(FM122_6*S22-FM322_6*C22)+s->dpt[1][45]*(FM129_6*S29-FM329_6*C29)+s->dpt[3][44]*(FM122_6*
 C22+FM322_6*S22)+s->dpt[3][45]*(FM129_6*C29+FM329_6*S29);
  CM321_6 = s->In[3][21]*OpM121_6+s->In[6][21]*OpM221_6+s->In[9][21]*OpM320_6-CM122_6*S22-CM129_6*S29+CM322_6*C22+
 CM329_6*C29-FB121_6*s->l[2][21]+FB221_6*s->l[1][21]+FM222_6*s->dpt[1][44]+FM229_6*s->dpt[1][45]-s->dpt[2][44]*(FM122_6*C22+
 FM322_6*S22)-s->dpt[2][45]*(FM129_6*C29+FM329_6*S29);
 ...
 CM329_19*S29-FB221_19*s->l[3][21]+FB321_19*s->l[2][21]-FM222_19*s->dpt[3][44]-FM229_19*s->dpt[3][45]-s->dpt[2][44]*(FM122_19
 *S22-FM322_19*C22)-s->dpt[2][45]*(FM129_19*S29-FM329_19*C29);
  CM221_19 = CM222_19+CM229_19+s->In[2][21]*OpM121_19+s->In[5][21]*OpM221_19+s->In[6][21]*S20+FB121_19*s->l[3][21]-
 FB321_19*s->l[1][21]+s->dpt[1][44]*(FM122_19*S22-FM322_19*C22)+s->dpt[1][45]*(FM129_19*S29-FM329_19*C29)+s->dpt[3][44]*(
 FM122_19*C22+FM322_19*S22)+s->dpt[3][45]*(FM129_19*C29+FM329_19*S29);
  CM321_19 = s->In[3][21]*OpM121_19+s->In[6][21]*OpM221_19+s->In[9][21]*S20-CM122_19*S22-CM129_19*S29+CM322_19*C22+
 CM329_19*C29-FB121_19*s->l[2][21]+FB221_19*s->l[1][21]+FM222_19*s->dpt[1][44]+FM229_19*s->dpt[1][45]-s->dpt[2][44]*(FM122_19
 *C22+FM322_19*S22)-s->dpt[2][45]*(FM129_19*C29+FM329_19*S29);
 ...
 FB221_20*s->l[1][21]+FM222_20*s->dpt[1][44]+FM229_20*s->dpt[1][45]-s->dpt[2][44]*(FM122_20*C22+FM322_20*S22)-s->dpt[2][45]*(
 FM129_20*C29+FM329_20*S29);
  CM321_21 = s->In[9][21]+s->m[21]*s->l[1][21]*s->l[1][21]+s->m[21]*s->l[2][21]*s->l[2][21]+s->dpt[1][44]*(FB222_21+
 FM223_21*C23-FM323_21*S23)+s->dpt[1][45]*(FB229_21+FM230_21*C30-FM330_21*S30)-s->dpt[2][44]*(C22*(FB122_21+FM123_21)+S22*(
 FB322_21+FM223_21*S23+FM323_21*C23))-s->dpt[2][45]*(C29*(FB129_21+FM130_21)+S29*(FB329_21+FM230_21*S30+FM330_21*C30))-C22*(
 s->In[3][22]*S22-s->In[9][22]*C22-s->dpt[1][48]*(FM223_21*C23-FM323_21*S23)-CM223_21*S23-CM323_21*C23+FB122_21*s->l[2][22]-
 FB222_21*s->l[1][22]+FM123_21*s->dpt[2][48])-S22*(CM123_21-s->In[1][22]*S22+s->In[3][22]*C22-s->dpt[3][48]*(FM223_21*C23-
 FM323_21*S23)-FB222_21*s->l[3][22]+FB322_21*s->l[2][22]+s->dpt[2][48]*(FM223_21*S23+FM323_21*C23))-C29*(s->In[3][29]*S29-
 s->In[9][29]*C29-s->dpt[1][59]*(FM230_21*C30-FM330_21*S30)-CM230_21*S30-CM330_21*C30+FB129_21*s->l[2][29]-FB229_21*
 s->l[1][29]+FM130_21*s->dpt[2][59])-S29*(CM130_21-s->In[1][29]*S29+s->In[3][29]*C29-s->dpt[3][59]*(FM230_21*C30-FM330_21*S30
 )-FB229_21*s->l[3][29]+FB329_21*s->l[2][29]+s->dpt[2][59]*(FM230_21*S30+FM330_21*C30));
 ...
 *C21)-s->dpt[2][40]*(FM121_5*C21-FM221_5*S21)-FB120_5*s->l[2][20]+FB220_5*s->l[1][20];
 ...
 FB320_19*s->l[1][20]+s->dpt[3][40]*(FM121_19*C21-FM221_19*S21);
  CM220_20 = s->In[5][20]-s->dpt[1][40]*(FB321_20-FM122_20*S22-FM129_20*S29+FM322_20*C22+FM329_20*C29)+s->m[20]*
 s->l[1][20]*s->l[1][20]+s->m[20]*s->l[3][20]*s->l[3][20]+s->dpt[3][40]*(C21*(FB121_20+FM122_20*C22+FM129_20*C29+FM322_20*S22
 +FM329_20*S29)-S21*(FB221_20+FM222_20+FM229_20))+C21*(CM222_20+CM229_20+s->In[2][21]*S21+s->In[5][21]*C21+FB121_20*
 s->l[3][21]-FB321_20*s->l[1][21]+s->dpt[1][44]*(FM122_20*S22-FM322_20*C22)+s->dpt[1][45]*(FM129_20*S29-FM329_20*C29)+
 s->dpt[3][44]*(FM122_20*C22+FM322_20*S22)+s->dpt[3][45]*(FM129_20*C29+FM329_20*S29))+S21*(s->In[1][21]*S21+s->In[2][21]*C21+
 CM122_20*C22+CM129_20*C29+CM322_20*S22+CM329_20*S29-FB221_20*s->l[3][21]+FB321_20*s->l[2][21]-FM222_20*s->dpt[3][44]-
 FM229_20*s->dpt[3][45]-s->dpt[2][44]*(FM122_20*S22-FM322_20*C22)-s->dpt[2][45]*(FM129_20*S29-FM329_20*C29));
